...
export default {
  ...
  admin_shop: {
    ...
    apps: {
      ...
      my_apps: {
        ...
        subtitle:
          "Selldone App Store を使用してビジネス アプリケーションを簡単に管理できることを実感してください。当社のプラットフォームは、ビジネス運営を最適化するために設計された包括的なツールスイートを提供します。革新的な管理ソ​​リューションから生産性を向上させるアプリまで、Selldone は効率と成長を求める企業にシームレスなエクスペリエンスを提供します。",
        all: "すべて",
      },
      /** {@see BAppShopStore} **/
      store: {
  ...
  vendor_shipping_services: {
    ...
    subtitle_pickup:
      "マーケットプレイスではベンダーの受け取りが可能で、購入者は配送オプションとしてあなたの所在地からの受け取りを選択できます。プロフィールに受け取り場所を追加できます (倉庫がデフォルトの受け取り場所として使用されます)。",
    action: "サービスを追加",

    add_dialog: {
      select_service_msg:
        "配送方法はマーケットプレイスによって設定されており、顧客はその中から選択できます。ベンダーはこれらのオプションを制御できませんが、パネルを配送サービスと統合してラベルを直接購入することができます。利用可能なサービスを表示するには、以下のリストから方法を選択してください。下のリストから配送サービスを選択してください。ここには、ストアに追加できる利用可能なサービスのみが表示されます。",
  ...
  variant_graphical_assets: {
    ...
    tips: {
      how_it_works:
        "<b>仕組み:</b><br />パターンまたはアイテムの画像をここにアップロードします。これらの画像をバリアント オプションとして使用するには、バリアント値に <b>{filename}</b> を含めます。このコードは <b><s>color</s></b> 値では使用できないことに注意してください。",
      how_set_name:
        "<b>命名に関するヒント:</b><br />アップロードされたファイル名の最初の 12 文字がアセット名として使用されます。この機能は、オートバイのタイヤ サイズや生地のパターンなど、製品のカスタマイズ可能な側面を紹介するのに最適です。この機能の使用を最適化するには、家具のさまざまな木材の種類など、グラフィック アセットの数が 100 未満でない限り、ここでバリアント画像をアップロードしないでください。",
    },
  },
  ...
  b_page_shop_finance_gateway: {
    ...
    add_gateway_dialog: {
      ...
      gateway_step: {
        title: "有効な支払い方法",
        subtitle:
          "ご利用可能なお支払い方法からお選びください。ゲートウェイを選択すると、ショップを希望の支払い方法に直接リンクするために必要な接続の詳細を入力できるようになります。",
      },
  ...
  campaign: {
    ...
    setting: {
      ...
      time_setting: {
        title: "期間",
        sub_title:
          "キャンペーンの開始日時と終了日時を設定するオプションがあります。",
        start_input: "始める",
      ...
      banner_setting: {
        title: "ショップバナー",
        sub_title:
          "このメッセージはショップページの上部にバナーとして目立つように表示されます。",
  ...
  order_vendor_payment: {
    ...
    automatic_payout_list: {
      subtitle:
        "これは、接続されている銀行口座への自動支払いのリストです。ここでは自動支払いのみが表示され、手動支払いは表示されないことに注意してください。",
    },
  ...
  shop_license: {
    ...
    active_license: {
      title: "アクティブライセンス",
      subtitle:
        "これはアクティブなライセンス情報です。上位プランにアップグレードすると、サービス料金を削減できます。",
      subtitle_partner:
        "アクティブな {name} ライセンス情報。このショップは現在、有効なパートナー契約を結んでいます。取引をキャンセルして上位プランにアップグレードしたい場合は、弊社のサポート チームにお問い合わせください。",
    },
    licenses_table: {
      title: "購入履歴",
      subtitle:
        "これは、アクティブなライセンスと保留中のライセンスのリストです。ウォレットに資金を入金した後、セールを購入できます。さらに、サブスクリプションをキャンセルすると、サブスクリプションの残りの金額が仮想ウォレットに返されることにご注意ください。",
    },
    license_detail: {
      title: "詳細",
      subtitle:
        "これらは現在のプランの制限です。詳細については、料金ページをご覧ください。無料プランを含むすべてのプランのすべての機能にアクセスして、ビジネスを開始し、成長させることができます。ビジネスを拡大する際には、より上位のプランにアップグレードしてサービス料金を下げることを検討してください。",
    },
  ...
  my_affiliate: {
    title: "私のアフィリエイト契約",
    message:
      "他店舗との提携店舗一覧です。ストアの所有者があなたをアフィリエイトとして指定すると、ここで手数料、注文の詳細、関連する統計を確認できます。",
  },
  ...
  affiliate_edit: {
    ...
    delete: {
      subtitle:
        "ショップから借金を削除する前に、アフィリエイトで未払いの借金を解決することができます。アフィリエイト情報は、削除後も一定期間アクセスできるようになります。",
    },
  },
  ...
  shop_valuations: {
    ...
    delete_dialog: {
      title: "項目 削除",
      message:
        "この価格設定フォームを削除してもよろしいですか?まず、このカスタム価格設定戦略がすべての関連製品から削除されていることを確認してください。",
      action: "はい、今すぐ削除",
    },
    notifications: {
  ...
  affiliate_dashboard: {
    link: {
      title: "項目 リンク",
      subtitle:
        "アフィリエイト パートナーが売上と手数料を追跡するための固有のリンクを生成します。紹介コード「{code}」をリンクに追加するか、アフィリエイトにカスタム専用ドメインを割り当てます。システムによって 48 時間追跡されます。",
    },
    fix_commission: "固定手数料",
  ...
  marketplace_products: {
    title: "販売者 商品",
    subtitle:
      "このカタログには、ベンダーが提供するすべての製品がリストされています。マーケットプレイスでは、製品を 1 つ以上のベンダーにリンクできます。製品に関連付けられた各ベンダーには、そのベンダーに固有の在庫と価格設定の詳細を含む固有のエントリがあります。",
    filter_vendor: {
  ...
  marketplace_wallets: {
    title: "ベンダーウォレット",
    subtitle:
      "ウォレットを手動で追加する必要はありません。ベンダーウォレットは自動的に作成されます。分割支払いをサポートする支払い方法 (Stripe Connect など) を有効にすると、システムは接続されているベンダーのアカウントに支払いを自動的に分配します。この機能が有効になっていない場合は、ベンダーに手動で支払う必要があります。ウォレット リストでベンダーへの未払い金額を確認できます。",
    filter_vendor: {
      placeholder: "フィルター 項目 販売者...",
    },
  },
  ...
  vendor_account_transactions: {
    subtitle:
      "このセクションには、選択したウォレットのすべてのトランザクションの詳細なリストが表示されます。顧客が注文の支払いを正常に完了すると、請求トランザクションが記録されます。注文がキャンセルまたは一部返金された場合、対応する返金取引もここに記録されます。",
    vendor_bank: "販売者 項目",
    order_fee: "注文 項目",
    order_refund: "注文 返金",
    reverse_fund: "項目 項目",
  ...
  vendor_payout_add: {
    ...
    payment: {
      title: "支払い",
      subtitle:
        "通貨を選択し、ベンダーに送金する金額を入力します。マイナスの金額を入力すると、資金はベンダーのウォレットから引き出されます。支払いオプションのある接続されたアカウントの場合、資金はベンダーの Stripe アカウントなどの接続されたアカウントから差し引かれます。",
    },
    history: {
      title: "歴史",
      subtitle:
        "この支払いの一部は取り消し送金を通じて返金されました。つまり、残高がベンダーの口座から差し引かれ、あなたの口座に返されました。",
    },
    refund: {
      title: "返金",
      subtitle:
        "返金金額は販売者の残高から差し引かれます。ベンダーのアカウント (Stripe Connect など) のすべての支払い (または残額) は、取消送金を通じて返金されます。",
    },
    inputs: {
      vendor: {
  ...
  shop_theme: {
    ...
    theme_colors_description:
      "ここでショップの原色パレットをカスタマイズできます。各テンプレートはこれらの色を利用して、ブランドに合わせた完全な色の範囲を自動的に生成できます。",
  ...
  b_shop_theme_header: {
    ...
    header_title: {
      title: "項目 タイトル",
      subtitle:
        "ここでページのヘッダーに表示されるタイトルをカスタマイズできます。完全に削除したい場合は「空のタイトルを設定」ボタンをクリックしてください。",
    },
  ...
  property_set_add: {
    ...
    variants: {
      title: "バリアント",
      subtitle:
        "ここでバリアント名、アイコン、順序をカスタマイズできます。デフォルトの 6 つのバリエーションに適合しない独自のバリエーションを持つさまざまな商品がある場合は、ここで各商品にカスタム バリエーションを設定できます。",
    },
  ...
  finance_report: {
    ...
    export_sub_title:
      "財務情報を含む 1 つのファイルを取得します。これには、オンラインと店舗の両方の注文の詳細と、選択した期間の製品ごとの販売データが含まれます。",
  ...
  shop_home_edit: {
    title: "ホームページの設定",
    sub_title:
      "このセクションでは、Web サイトのデフォルト ページを設定します。また、ドメイン設定を通じて各ドメインのカスタム ホームページを個別に指定することもできます。",
  ...
  avocado_process: {
    ...
    invoice: {
      subtitle:
        "このフォームを使用すると、特定の金額の支払いリンクを作成できます。また、請求書の追跡と支払い完了の確認も簡単かつ簡単になります。",
    },
  },
  ...
  shop_configuration: {
    ...
    login: {
      ...
      tips: "<b>重要.</b> ユーザーがショップに登録すると、対応する Selldone ユーザーが作成されます (まだ存在しない場合)。このユーザーは、すべてのショップのアドレス帳にアクセスでき、ショップが閉店した場合でも注文履歴を表示できます。この情報はマーケティング目的には使用されませんが、双方の詐欺を防止するために必要となります。透明性を維持するために、登録を通知する電子メールをユーザーに送信します。",
    },
  ...
  vendors_list: {
    title: "私のベンダー",
    message:
      "これはベンダー アカウントのリストです。 Selldone プラットフォームを利用しているショップに関連付けられたすべてのベンダー アカウントがここに表示され、簡単に管理できるようになります。",
  },
  ...
  l_page_editor_repository: {
    ...
    add_dialog: {
      ...
      configuration: {
        title: "設定",
        subtitle:
          "カスタムデザインのセクションを保存して、将来ページデザインで使用できます。これらの保存されたセクションには、このストアのすべての管理者がアクセスできます。",
      },
      image: {
        title: "画像",
        subtitle: "項目 項目 項目 項目 項目 項目.",
