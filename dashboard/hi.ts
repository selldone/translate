...
export default {
  ...
  admin_shop: {
    ...
    apps: {
      ...
      my_apps: {
        ...
        subtitle:
          "सेल्डडन ऐप स्टोर के साथ अपने व्यावसायिक अनुप्रयोगों को प्रबंधित करने में आसानी का पता लगाएं। हमारा प्लेटफ़ॉर्म आपके व्यवसाय संचालन को अनुकूलित करने के लिए डिज़ाइन किए गए उपकरणों का एक व्यापक सूट प्रदान करता है। नवीन प्रबंधन समाधानों से लेकर उत्पादकता बढ़ाने वाले ऐप्स तक, सेल्डडोन दक्षता और विकास चाहने वाले व्यवसायों के लिए एक सहज अनुभव प्रदान करता है।",
        all: "सब",
      },
      /** {@see BAppShopStore} **/
      store: {
  ...
  process_center: {
    ...
    basket_list: {
      checklist: [
        ...
        "यदि वस्तु अनुपलब्ध है, तो उस वस्तु के लिए भुगतान की गई राशि ग्राहक को वापस कर दी जानी चाहिए।",
      ],
      message:
  ...
  shop_license: {
    ...
    active_license: {
      ...
      subtitle_partner:
        "आपकी सक्रिय {name} लाइसेंस जानकारी। इस दुकान में वर्तमान में एक सक्रिय भागीदार सौदा है। यदि आप सौदा रद्द करना चाहते हैं और उच्च स्तरीय योजना में अपग्रेड करना चाहते हैं, तो सहायता के लिए कृपया हमारी सहायता टीम से संपर्क करें।",
    },
    licenses_table: {
      title: "खरीदा इतिहास",
      subtitle:
        "यह सक्रिय और लंबित लाइसेंसों की एक सूची है। आप अपने वॉलेट में पैसे डालने के बाद सौदे खरीद सकते हैं। इसके अतिरिक्त, कृपया ध्यान दें कि जब आप कोई सदस्यता रद्द करते हैं, तो शेष सदस्यता राशि आपके वर्चुअल वॉलेट में वापस कर दी जाएगी।",
    },
    license_detail: {
      title: "विवरण",
      subtitle:
        "ये आपकी वर्तमान योजना की सीमाएँ हैं। अधिक जानकारी के लिए, कृपया मूल्य निर्धारण पृष्ठ पर जाएँ। आप अपने व्यवसाय को शुरू करने और आगे बढ़ने के लिए निःशुल्क योजना सहित सभी योजनाओं की सभी सुविधाओं तक पहुँच प्राप्त कर सकते हैं। जैसे-जैसे आप अपना व्यवसाय बढ़ाते हैं, अपनी सेवा शुल्क कम करने के लिए उच्च स्तरीय योजना में अपग्रेड करने पर विचार करें।",
    },
  ...
  offers: {
    title: "ऑफर",
    sub_title:
      "आप अपने ग्राहकों के लिए विशेष ऑफ़र बना सकते हैं ताकि, एक वस्तु खरीदने के बाद, उन्हें छूट पर या मुफ़्त में दूसरी वस्तु प्राप्त हो।",
  ...
  privacy: {
    ...
    subtitle:
      "गोपनीयता नीति एक बयान या कानूनी दस्तावेज़ है जो किसी पार्टी द्वारा ग्राहक या ग्राहक के डेटा को इकट्ठा करने, उपयोग करने, प्रकट करने और प्रबंधित करने के कुछ या सभी तरीकों का खुलासा करता है।",
  },
  ...
  shop_connect: {
    ...
    edit: {
      ...
      migration_tips:
        "<b>सुझाव:</b> यदि आप कार्यक्षमता का परीक्षण करना चाहते हैं, तो कृपया <b>सीमित</b> विकल्प चुनें। 'सभी सिंक करें' चुनने पर हम आपकी कनेक्टेड सेवाओं से सभी " +
        "डेटा प्राप्त करेंगे और संबंधित छवियाँ डाउनलोड करेंगे, इसलिए आपका मुफ़्त स्टोरेज कम होगा। साथ ही, कई उत्पादों, श्रेणियों और ग्राहकों को हटाना कठिन हो सकता है!",
  ...
  product_cross_selling: {
    ...
    subtitle:
      "इस अनुभाग में, आप इस उत्पाद पृष्ठ के लिए क्रॉस-सेल उत्पाद जोड़ और प्रबंधित कर सकते हैं। इन उत्पादों को ग्राहकों के लिए मुख्य वस्तु के साथ खरीदारी के सुझाव के रूप में प्रदर्शित किया जाएगा। आप अतिरिक्त खरीदारी को प्रोत्साहित और प्रोत्साहित करने के लिए छूट भी निर्धारित कर सकते हैं। सिस्टम ग्राहक के विचार हेतु अधिकतम 3 आइटम प्रदर्शित करेगा।",
    dialog: {
  ...
  augment_form: {
    ...
    help_dialog: {
      ...
      how_it_works_tips:
        "लैंडिंग पृष्ठों में, आपके पास पाठ और छवियों दोनों के लिए गतिशील प्लेसहोल्डर निर्दिष्ट करने की सुविधा है। ये प्लेसहोल्डर संदर्भ के अनुसार सामग्री को अनुकूलित करने में महत्वपूर्ण भूमिका निभाते हैं।   इन प्लेसहोल्डर्स की गतिशील प्रकृति उन्हें संवर्द्धन मूल्यों द्वारा पॉप्युलेट करने की अनुमति देती है, जो विभिन्न कारकों के आधार पर भिन्न हो सकते हैं। उदाहरण के लिए, प्रत्येक उत्पाद या श्रेणी के लिए वृद्धि मान भिन्न हो सकते हैं। इस सुविधा का वास्तविक लाभ तब सामने आता है जब आपके पास अलग-अलग विशेषताओं वाले विभिन्न प्रकार के आइटम होते हैं। आप प्रत्येक आइटम के प्रदर्शन को वैयक्तिकृत करने और बढ़ाने के लिए इन गतिशील प्लेसहोल्डर्स का प्रभावी ढंग से उपयोग कर सकते हैं, जिससे आपके लैंडिंग पृष्ठों पर एक अद्वितीय और इंटरैक्टिव अनुभव बन सकता है।",
      assign_tips:
  ...
  shop_logistic_includes: {
    ...
    add_caption: "नया आइटम जोड़ें",
    subtitle:
      "यहां, आप अपने उत्पादों में शामिल वस्तुओं का प्रबंधन कर सकते हैं। अपने स्टोर की दोषरहित उपस्थिति सुनिश्चित करने के लिए, सभी उत्पादों में समान छवि पैटर्न वाली वस्तुओं, जैसे वायरफ़्रेम, का लगातार उपयोग करें।",
  ...
  include_item_add: {
    ...
    mode: {
      ...
      external_link: {
        ...
        tips: "आप आइटम के साथ कोई भी URL संलग्न कर सकते हैं. जब उपयोगकर्ता उत्पाद पृष्ठ पर आइटम पर क्लिक करते हैं, तो उन्हें उस लिंक पर पुनः निर्देशित किया जाएगा।",
      },
      internal_link: {
        title: "आंतरिक लिंक",
        description:
  ...
  referral_wallets: {
    title: "पर्स",
    subtitle:
      "यहां आप अपने द्वारा अर्जित कमीशन फीस देख सकते हैं। आप अपनी कमीशन फीस अपने बैंक खाते या अपने सेल्डडोन वॉलेट में स्थानांतरित कर सकते हैं।",
