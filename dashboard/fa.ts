...
export default {
  ...
  add_product: {
    ...
    edit_info: {
      ...
      unit_float: "واحد شناور (به زودی)",
      unit_float_hint:
        "برای مثال، مشتری می‌تواند 3 کیلوگرم میوه سفارش دهد، اما مقدار ارسالی به مشتری کمی با مقدار سفارش داده شده متفاوت است.",
      unit_float_message:
        "در طی فرآیند سفارش، مقدار تحویل داده شده ممکن است با مقدار سفارش داده شده متفاوت باشد. سیستم به طور خودکار این تفاوت را محاسبه و آن را به عنوان بدهی شما به مشتری ثبت می‌کند که می‌تواند در سفارش‌های بعدی اعمال شود.",
      marketplace: {
