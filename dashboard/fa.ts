...
export default {
  ...
  admin_shop: {
    ...
    dashboard: {
      ...
      active_orders: {
        title: "سفارشات",
        title_small: "سفارشات فیزیکی، فایلی، مجازی، خدمات و اشتراک از طریق کانال های آنلاین، آووکادو و هایپر.",
    ...
    logistic: {
      ...
      delivery: {
        ...
        delivery_form: {
          ...
          max_weight_input_message: "مقدار 0 یا -1 به معنی عدم محدودیت می باشد.",
          ...
          price_cof_input_message: "شامل هزینه بیمه و خدمات جانبی مثل پرداخت در محل.",
          ...
          sod_true_message: "از امکان پس کرایه توسط سرویس حمل و نقل خود اطمینان حاصل نمایید.",
          sod_false: "محاسبه خودکار هزینه",
          cod_input: "آیا امکان پرداخت هزینه سفارش (سبد خرید) در محل وجود دارد؟",
          cod_true: "پذیرش پرداخت در محل",
          cod_false: "فقط پذیرش پرداخت آنلاین",
          cod_true_message: "مطمئن شوید سرویس ارسال شما پرداخت در محل را می‌پذیرد.",
          notifications: {
    ...
    apps: {
      ...
      my_apps: {
        ...
        subtitle: "سهولت مدیریت برنامه های تجاری خود را با فروشگاه App Selldone کشف کنید. پلتفرم ما مجموعه ای جامع از ابزارهای طراحی شده برای بهینه سازی عملیات کسب و کار شما را ارائه می دهد. از راه‌حل‌های مدیریتی نوآورانه گرفته تا برنامه‌های افزایش بهره‌وری، Selldone تجربه‌ای بی‌نظیر برای کسب‌وکارهایی که به دنبال کارایی و رشد هستند، ارائه می‌کند.",
        all: "همه",
      },
      /** {@see BAppShopStore} **/
      store: {
  ...
  timeline: {
    ...
    confirm: "تأیید سفارش، <b> {success} </b> تأیید شد و <b> {fail} </b> رد شد.",
    ...
    "delivery-returned": "سفارش ارسالی به دست مشتری نرسیده و برگشت خورده است. نیاز به ارسال مجدد مرسوله می باشد.",
    "delivery-canceled": "ارسال لغو شده است.  نیاز به ارسال مجدد مرسوله می باشد",
    ...
    "payment-cash-confirm": "پرداخت صورت حساب به مبلغ {amount} {currency} به صورت نقدی تایید گردید.",
    ...
    "vendor-sms": "🔔 پیامک اطلاع رسانی سفارش به <b>{vendor}</b> ╏ ارسال شد {phone}.",
  ...
  user_monetize_plans: {
    ...
    sub_title: "پاداش‌های معرفی به کیف پول سلدان شما واریز می‌شود و می‌توانید از این اعتبار برای پرداخت هزینه سرویس‌های سلدان استفاده کنید. توجه داشته باشید که فقط شرکای تجاری VIP سلدان امکان برداشت این اعتبارهای معرفی را دارند و این گزینه برای همه کاربران فعال نیست.",
    discount: "تخفیف",
    your_income: "درآمد شما",
    level_2: "از سطح دوم",
    level_3: "از سطح سوم",
    link_message: "تعداد عضویت: {registered}  ،  تعداد پذیرفته شده: {accepted}",
    link_tip: "شما می توانید عبارت ?ref={link_code} را در انتهای هر آدرسی که به اشتراک می گذارید قرار دهید.",
    table: {
      currency: "ارز",
      amount: "مبلغ",
  ...
  user_access_control: {
    ...
    connected_apps_message: "لیست تمام فروشگاه ها و اپلیکیشن هایی که به حساب کاربری سلدان شما متصل است را در زیر مشاهده می نمایید. می توانید دسترسی به هر یک از آن ها را حذف نمایید.",
    clients_title: "کلاینت‌ها",
    clients_message: "این کلیدها برای ساخت توکن دسترسی توسط سرور شما استفاده می‌شوند. توجه داشته باشید که این کلیدها محرمانه هستند و فقط باید روی سرور نگهداری شوند تا برای دیگران قابل مشاهده نباشند.",
    personal_keys_title: "کلید های دسترسی شخصی",
    personal_keys_message: "شما می توانید کلیدهای دسترسی به حساب کاربری خود را در اینجا ایجاد نمایید. دقت نمایید این کلیدها امکان دسترسی به حساب شما را خواهند داشت و تنها در صورتی این کلیدها را ایجاد و مصرف نمایید که دقیقا از کاری که می کنید اطلاع داشته باشید.",
  ...
  scopes: {
    profile: {
      name: "پروفایل",
      description: "خواندن اطلاعات پروفایل شامل نام، آدرس ایمیل، تصویر و وضعیت تایید هویت.",
    },
    phone: {
      name: "شماره تلفن",
  ...
  shop_license: {
    ...
    active_license: {
      ...
      subtitle_partner: "اطلاعات مجوز {name} فعال شما. این فروشگاه در حال حاضر یک معامله شریک فعال دارد. اگر می‌خواهید معامله را لغو کنید و به یک طرح سطح بالاتر ارتقا دهید، لطفاً برای کمک با تیم پشتیبانی ما تماس بگیرید.",
    },
    licenses_table: {
      title: "پلن های خریداری شده",
      subtitle: "این لیستی از مجوزهای فعال و معلق است. پس از تامین مالی کیف پول خود می توانید معاملاتی را خریداری کنید. علاوه بر این، لطفاً توجه داشته باشید که هنگام لغو اشتراک، مبلغ اشتراک باقی مانده به کیف پول مجازی شما بازگردانده می شود.",
    },
    license_detail: {
      title: "جزئیات پلن",
      subtitle: "اینها محدودیت های طرح فعلی شما هستند. برای جزئیات بیشتر، لطفا به صفحه قیمت مراجعه کنید. برای شروع کسب و کار و رشد می توانید به همه ویژگی ها در همه برنامه ها، از جمله طرح رایگان دسترسی داشته باشید. همانطور که کسب و کار خود را افزایش می دهید، برای کاهش هزینه های خدمات خود، به یک طرح سطح بالاتر ارتقا دهید.",
    },
  ...
  shop_tax: {
    ...
    calculate_tax_message: "با فعال کردن این گزینه مالیات بر ارزش افزوده برای سفارشات شما محاسبه و اعمال خواهد شد.",
    tax_number: "شماره مالیاتی",
    tax_number_message: "کد مالیاتی خود را وارد نمایید. این کد در فاکتور خریدار ثبت می گردد.",
    tax_included_in_price_input: "مالیات در قیمت محصولات لحاظ شده است",
    tax_included_in_price_message: "اگر مبلغ مالیات را در قیمت محصول خود لحاظ کرده اید، این گزینه را انتخاب نمایید. مبلغ مالیات با فرمول زیر محاسبه خواهد شد:",
    tax_included_in_price_formula: "مالیات = (قیمت * نرخ ارزش افزوده) / ( 1+ نرخ ارزش افزوده)، برای مثال مبلغ مالیات برای یک کالا به قیمت 1000 تومان با نرخ ارزش افزوده 9% می شود 82 تومان.",
    tax_exclude_title: "غیرشامل ╏ مالیات هنگام تسویه‌حساب اضافه می‌شود",
    tax_excluded_message: "مالیات‌ها پیش از پرداخت در مرحله تسویه‌حساب محاسبه می‌شوند و بسته به شواهد مشتری، به قیمت بدون مالیات اضافه خواهند شد.",
    tax_on_shipping_input: "اعمال مالیات بر روی هزینه حمل و نقل",
    tax_on_shipping_message: "با انتخاب این گزینه، مالیات بر روی هزینه حمل و نقل اعمال خواهد شد.",
    fixed_tax_rate: "نرخ مالیات ثابت",
    dynamic_tax_rate: "مالیات بر اساس مکان",
    locations_tip: "در لیست فوق تنها کشورهایی نمایش داده می شوند که در بخش تنظیمات فروشگاه > محدوده، به عنوان کشورهایی که به آنها سرویس می دهید، انتخابشان نموده اید.",
  ...
  styler: {
    ...
    products: {
      ...
      categories_limit_msg: "حداکثر تعداد دسته‌بندی‌ها را وارد کنید. برای بدون محدودیت، صفر قرار دهید.",
    },
  },
  ...
  instagram: {
    ...
    link_box_msg: "این لینک را در بایو اینستاگرام، تلگرام و یا دیگر شبکه های اجتماعیتان قرار دهید تا مخاطبانتان سریعتر، ساده تر، دقیقتر و در نهایت بیشتر از شما خرید کنند.",
  ...
  shop_channel_instagram: {
    ...
    subtitle: "برای محصولات خود یک دسته‌بندی اختصاصی همراه با تصویر و ویدئو بسازید و آن را در شبکه‌های اجتماعی به اشتراک بگذارید. شبیه اینستاگرام و تیک‌تاک است، اما با کنترل کامل تا بتوانید محصولات خود را مستقیم بفروشید.",
  },
  service_bill: {
    task: {
      title: "لیست کارها",
  ...
  external_services: {
    ...
    subtitle: "آخرین وضعیت سرویس‌های خارجی مانند پیامک و ایمیل را از اینجا پایش کنید.",
  },
  shop_quota: {
    title: "سهمیه مصرف",
    sub_title: "این فهرست سهمیه مصرف فروشگاه شماست. می‌توانید با ارتقای لایسنس فروشگاه، این محدودیت‌ها را افزایش دهید. اگر از محدودیت‌ها عبور کنید، می‌توانید از ما سهمیه روزانه اضافی درخواست کنید. همه مصرف‌ها روزانه بازنشانی می‌شوند.\n",
  },
  app_card: {
    category: "دسته بندی",
    installs: "نصب",
  ...
  transportation_boxes_input: {
    ...
    define_package_hint: "اندازه‌های بسته‌بندی از پیش تعریف‌شده خود را ایجاد یا ویرایش کنید",
  },
  listing: {
    name: "لیستینگ",
    message: "یک دایرکتوری قابل جستجو و قابل نظارت برای هر نوع لیستینگ بسازید؛ املاک، هتل‌ها، پزشکان، خدمات و موارد بیشتر.",
  },
  shop_listing: {
    name: "لیستینگ",
    message: "یک دایرکتوری قابل جستجو و قابل نظارت برای هر نوع لیستینگ بسازید؛ املاک، هتل‌ها، پزشکان، خدمات و موارد بیشتر.",
    items: {
      title: "آیتم‌ها",
      sub_title: "آیتم‌های لیستینگ را ایجاد، ویرایش و مدیریت کنید. وضعیت، قیمت‌گذاری، اطلاعات تماس و رسانه‌ها را کنترل کنید.",
      empty_title: "هنوز آیتمی وجود ندارد",
      empty_subtitle: "اولین آیتم لیستینگ را بسازید تا ساخت دایرکتوری خود را شروع کنید.",
      add_title: "افزودن آیتم",
      edit_title: "ویرایش آیتم",
      price_to: "قیمت تا",
      price_unit: "واحد قیمت",
    ...
    categories: {
      title: "دسته‌بندی‌ها",
      sub_title: "دایرکتوری خود را با دسته‌بندی‌ها و زیردسته‌ها سازمان‌دهی کنید. این کار مسیریابی و فیلترکردن را بهتر می‌کند.",
      empty_title: "هنوز دسته‌بندی‌ای وجود ندارد",
      empty_subtitle: "برای ساختاردهی به لیستینگ و بهبود مرور، دسته‌بندی ایجاد کنید.",
      add_title: "افزودن دسته‌بندی",
      edit_title: "ویرایش دسته‌بندی",
      parent_filter: "فیلتر بر اساس والد",
      parent: "دسته‌بندی والد",
    ...
    options: {
      ...
      moderation_title: "نظارت",
      moderation_mode: "حالت نظارت",
      require_first_approved_before_more: "نیاز به تأیید اولین مورد پیش از ارسال موارد بیشتر",
      limits_title: "محدودیت‌ها",
    ...
    supervision: {
      title: "نظارت",
      sub_title: "آیتم‌های ارسال‌شده را بررسی کنید و تصمیم بگیرید چه اتفاقی بیفتد: تأیید، انتشار، رد، آرشیو یا بازگردانی به حالت در انتظار.",
      empty_title: "آیتمی برای بررسی وجود ندارد",
      empty_subtitle: "وقتی کاربران آیتم جدیدی ارسال کنند، برای نظارت در اینجا نمایش داده می‌شود.",
    ...
    designs: {
      title: "طراحی‌ها",
      sub_title: "چند مجموعه طراحی بسازید (قالب کارت و جزئیات) و آن‌ها را به دسته‌بندی‌ها اختصاص دهید. دسته‌بندی‌ها می‌توانند طراحی‌های متفاوتی داشته باشند.",
      empty_title: "هنوز طراحی‌ای وجود ندارد",
      empty_subtitle: "اولین مجموعه طراحی خود را اضافه کنید تا سفارشی‌سازی ظاهر دسته‌بندی‌ها را شروع کنید.",
      ...
      delete_message: "این طراحی حذف شود؟ دسته‌بندی‌هایی که از آن استفاده می‌کنند به‌صورت خودکار design_id خود را از دست می‌دهند.",
    },
    badges: {
      title: "نشان‌ها",
      sub_title: "نشان‌های ویترین را ایجاد و مدیریت کنید. نشان‌ها می‌توانند به آیتم‌های لیستینگ اختصاص داده شوند تا ویژگی‌های خاص را برجسته کنند.",
      empty_title: "هنوز نشانی وجود ندارد",
      empty_subtitle: "اولین نشان خود را اضافه کنید تا برجسته‌سازی آیتم‌های لیستینگ را شروع کنید.",
    ...
    companies: {
      title: "شرکت‌ها",
      sub_title: "شرکت‌ها را ایجاد و مدیریت کنید. هر آیتم لیستینگ می‌تواند به‌صورت اختیاری به یک شرکت متصل شود.",
      empty_title: "هنوز شرکتی وجود ندارد",
      empty_subtitle: "اولین شرکت خود را اضافه کنید تا آن را به آیتم‌های لیستینگ متصل کنید.",
      ...
      delete_message: "این شرکت حذف شود؟ آیتم‌هایی که از آن استفاده می‌کنند به‌صورت خودکار لینک شرکت را از دست می‌دهند.",
    },
    messages: {
      title: "پیام‌ها",
      sub_title: "پیام‌های ارسال‌شده توسط کاربران از پروفایل‌های لیستینگ را مدیریت کنید.",
      empty_title: "پیامی وجود ندارد",
      empty_subtitle: "پیام‌های ارسال‌شده توسط کاربران در اینجا نمایش داده می‌شوند.",
      sender: "فرستنده",
      item: "آیتم",
      has_reply: "پاسخ",
      ...
      reply: "پاسخ",
      reply_hint: "یک پاسخ برای کاربر بنویسید. همچنین می‌توانید از بخش اقدام‌ها پیام را خوانده‌شده یا اسپم علامت‌گذاری کنید.",
    ...
    enable: {
      title: "لیستینگ",
      subtitle: "صفحه عمومی لیستینگ خود را فعال یا غیرفعال کنید. هنگام اولین فعال‌سازی، سلدان پیکربندی لیستینگ را به‌صورت خودکار ایجاد می‌کند.",
      true_description: "لیستینگ فعال است. مشتریان می‌توانند صفحه‌های لیستینگ را مرور کنند.",
      false_description: "لیستینگ غیرفعال است. صفحه‌های لیستینگ و ارسال‌ها مسدود هستند.",
      open_listing: "بازکردن لیستینگ",
      note: "بعداً می‌توانید نظارت، محدودیت‌ها، فرم‌ها و طراحی را در تنظیمات لیستینگ پیکربندی کنید.",
      vendor_prereq_text: "می‌خواهید فروشندگان از پنل فروشنده آیتم‌های لیستینگ اضافه کنند؟ ابتدا مدل کسب‌وکار خود را به Marketplace تغییر دهید.",
      vendor_prereq_button: "تنظیم مدل کسب‌وکار Marketplace",
      vendor_access_text: "اکنون می‌توانید تعیین کنید فروشندگان به قابلیت‌های لیستینگ (آیتم‌ها و شرکت‌ها) دسترسی داشته باشند یا نه. آن را در تنظیمات Marketplace فعال کنید.",
      vendor_access_button: "فعال‌سازی لیستینگ برای فروشندگان",
      more_options_text: "کنترل‌های بیشتری در تنظیمات لیستینگ در دسترس است. می‌توانید ورودی‌ها، رابط کاربری/ظاهر، نظارت، محدودیت‌ها و گزینه‌های درآمدزایی را پیکربندی کنید.",
    ...
    search: {
      title: "تنظیمات جستجو",
      subtitle: "نحوه جستجوی مشتریان در لیستینگ را طراحی کنید. جستجوی مبتنی بر موقعیت را فعال کنید و از فیلدهای فرم سفارشی خود فیلتر بسازید.",
      location_title: "جستجوی موقعیت",
      location_subtitle: "به مشتریان اجازه دهید یک موقعیت انتخاب کنند و نتایج نزدیک را در شعاع قابل تنظیم پیدا کنند.",
      location_enabled_true: "فیلتر موقعیت فعال است. مشتریان می‌توانند بر اساس فاصله جستجو کنند.",
      location_enabled_false: "فیلتر موقعیت غیرفعال است. نتایج بر اساس فاصله فیلتر نمی‌شوند.",
      radius_default: "شعاع پیش‌فرض (کیلومتر)",
      radius_default_hint: "وقتی مشتری موقعیت را انتخاب کرده اما شعاعی انتخاب نکرده است استفاده می‌شود.",
      radius_max: "حداکثر شعاع (کیلومتر)",
      radius_max_hint: "شعاع ویترین به این مقدار محدود می‌شود.",
      radius_options: "گزینه‌های شعاع (کیلومتر)",
      radius_options_hint: "این مقادیر می‌توانند به‌عنوان گزینه‌های سریع در رابط ویترین نمایش داده شوند.",
      filters_title: "فیلترهای جستجو",
      filters_subtitle: "فیلترهایی اضافه کنید که مقدارها را از فیلدهای متای آیتم می‌خوانند (فیلدهای فرم لیستینگ/دسته‌بندی شما). از تولید خودکار برای جمع‌آوری گزینه‌های واقعی از آیتم‌های منتشرشده استفاده کنید.",
      ...
      filter_options_hint: "برای فیلترهای انتخابی، گزینه‌ها می‌توانند دستی یا تولیدشده باشند.",
      multiple: "چندتایی",
      single: "تکی",
      kv_mode: "حالت کلید/مقدار",
      requires_listing_active: "لیستینگ فعال نیست. ابتدا لیستینگ را فعال کنید تا بتوانید از آن در ویترین استفاده کنید.",
    },
  },
  suggestions: {
    /**
