...
export default {
  commons: {
    ...
    domains: "دامنه ها",
    home_page: "صفحه اصلی",
    google_icon_font_sample: "نمونه فونت گوگل",
    fontawesome_icon_font_sample: "نمونه فونت Fontawesome (V6)",
  },
  ...
  helps: {
    ...
    subtitle:
      "به آکادمی سلدان خوش آمدید. اینجا راهنمای جامع شما برای ساخت و مدیریت یک فروشگاه آنلاین در یک سیستم عامل کسب‌وکاری قدرتمند است. منابع، آموزش‌ها و بهترین روش‌ها را مرور کنید تا فرآیند راه‌اندازی فروشگاه خود را ساده‌تر کرده، کارایی را افزایش داده و رشد کسب‌وکارتان را تسریع نمایید.",
  ...
  admin_shop: {
    ...
    dashboard: {
      ...
      setup_packages: {
        nav: "پکیج‌های راه‌اندازی",
        eyebrow: "خدمات راه‌اندازی سلدان",
        title: "پکیج‌های راه‌اندازی",
        subtitle:
          "مسیر مناسب راه‌اندازی {shop} را انتخاب کنید و پایین همین صفحه، پروژه‌های خریداری‌شده و پیشرفتشان را ببینید.",
        refund_policy:
          "تا ۲۴ ساعت پس از خرید و فقط پیش از شروع کار تیم ما می‌توانید درخواست بازپرداخت بدهید. پس از شروع کار، هزینهٔ خدمات قابل بازپرداخت نیست.",
        paths_eyebrow: "روش شروع را انتخاب کنید",
        paths_title: "دو مسیر برای راه‌اندازی فروشگاه",
        paths_body:
          "پیشنهاد ما پکیج آماده است: محدودهٔ مشخص، تخفیف چشمگیر و سریع‌ترین مسیر برای شروع فروش. اگر نیازهای ویژه دارید، سفارش اختصاصی را انتخاب کنید.",
        preview_loading: "در حال دریافت پکیج‌های پیشنهادی...",
        preview_unavailable_title: "پیش‌نمایش پکیج‌ها موقتاً در دسترس نیست",
        preview_unavailable_body:
          "تا زمان اتصال دوبارهٔ پیش‌نمایش‌ها، همچنان می‌توانید کاتالوگ کامل را باز کنید.",
        recommended: "پیشنهاد ما",
        up_to_discount: "تا {value}٪ تخفیف",
        ready_eyebrow: "مسیر آماده",
        ready_title: "سریع‌تر و با هزینه‌ای بسیار کمتر راه بیفتید",
        ready_body:
          "یک پکیج امتحان‌شده با قیمت شفاف و محدودهٔ تحویل مشخص انتخاب کنید؛ سریع‌ترین راه برای آماده‌شدن فروشگاه و رسیدن به درآمد است.",
        ready_benefit_scope: "محدودهٔ روشن و ثابت",
        ready_benefit_speed: "راه‌اندازی سریع‌تر",
        ready_benefit_value: "بیشترین ارزش خرید",
        available_now: "آمادهٔ خرید",
        featured_title: "پکیج‌های موجود",
        offer_count: "{count} انتخاب",
        discount_badge: "{value}٪ تخفیف",
        choose_package: "انتخاب پکیج",
        view_package: "مشاهده پکیج",
        delivery_range: "{min} تا {max} روز",
        delivery_up_to: "حداکثر {max} روز",
        offer_aria: "باز کردن {title} با قیمت {price} در زبانهٔ جدید",
        offers_empty_title: "فعلاً پیش‌نمایش واجد شرایطی نداریم",
        offers_empty_body:
          "همچنان می‌توانید کاتالوگ کامل را ببینید و همهٔ پکیج‌های موجود را مقایسه کنید.",
        ready_action: "مشاهده همه پکیج‌ها",
        ready_note: "همهٔ پکیج‌ها و محدودهٔ کامل خدمات را مقایسه کنید.",
        custom_badge: "ساخت اختصاصی ویژه",
        custom_eyebrow: "خدمات کاملاً اختصاصی",
        custom_title: "راه‌اندازی متناسب با کسب‌وکار شما",
        custom_body:
          "مدل کسب‌وکار، تعداد محصولات، وضعیت داده‌ها، طراحی، ابعاد مارکت‌پلیس و افزونه‌ها را انتخاب کنید تا برآورد محاسبه‌شده بگیرید.",
        custom_step_brief: "کسب‌وکار خود را شرح دهید",
        custom_step_brief_body:
          "دربارهٔ کاتالوگ، داده‌ها و هدف راه‌اندازی به ما بگویید.",
        custom_step_estimate: "برآورد محاسبه‌شده را ببینید",
        custom_step_estimate_body:
          "انتخاب‌های شما محدودهٔ کار و مبلغ تقریبی را به‌روز می‌کنند.",
        custom_step_review: "بررسی تیم سلدان",
        custom_step_review_body:
          "تیم ما محدودهٔ کار، زمان‌بندی و مبلغ قابل پرداخت را تأیید می‌کند.",
        custom_quote_note:
          "وقتی پکیج آماده مناسب کسب‌وکار شما نیست، این مسیر را انتخاب کنید.",
        custom_action: "محاسبه سفارش اختصاصی",
        custom_payment_note: "پرداخت پس از بررسی تیم در دسترس قرار می‌گیرد.",
        active_eyebrow: "خدمات راه‌اندازی",
        active_title: "سفارش‌های فعال راه‌اندازی",
        active_subtitle:
          "کارهایی را که تیم راه‌اندازی سلدان برای این فروشگاه انجام می‌دهد دنبال کنید.",
        view_all: "مشاهده همه",
        loading: "در حال دریافت سفارش‌های راه‌اندازی...",
        loading_body:
          "آخرین وضعیت پیشرفت پکیج‌های این فروشگاه را دریافت می‌کنیم.",
        error_title: "سفارش‌های راه‌اندازی در دسترس نیستند",
        error_body:
          "فعلاً نتوانستیم این سفارش‌ها را دریافت کنیم. سایر اطلاعات داشبورد بدون تغییر است.",
        retry: "تلاش دوباره",
        more_active: "و {count} سفارش فعال دیگر",
        empty_active_title: "سفارش راه‌اندازی فعالی ندارید",
        empty_active_body:
          "پس از خرید پکیج برای این فروشگاه، پیشرفت آن اینجا نمایش داده می‌شود.",
        promo_title: "راه‌اندازی فروشگاه را به ما بسپارید",
        promo_body: "پکیج‌های آماده را ببینید.",
        explore: "مشاهده پکیج‌ها",
        progress: "پیشرفت راه‌اندازی: {value}٪",
        summary_aria: "خلاصه سفارش‌های راه‌اندازی",
        total_orders: "همه سفارش‌ها",
        active_orders: "سفارش‌های فعال",
        refundable: "قابل بازپرداخت",
        projects_eyebrow: "خریداری‌شده برای این فروشگاه",
        projects_title: "پروژه‌های راه‌اندازی",
        orders_count: "{count} سفارش",
        loaded_count: "{loaded} از {total} سفارش نمایش داده شده",
        load_more: "نمایش بیشتر",
        load_more_aria:
          "نمایش سفارش‌های بیشتر راه‌اندازی ({count} سفارش باقی مانده)",
        load_more_error: "سفارش‌های بعدی دریافت نشدند. دوباره تلاش کنید.",
        buyer_only: "جزئیات سفارش فقط برای خریدار در دسترس است.",
        progress_label: "پیشرفت",
        amount: "مبلغ",
        status: "وضعیت",
        refund_available: "امکان بازپرداخت فعال است",
        refund_until: "مهلت بازپرداخت: {date}",
        view_project: "مشاهده پروژه",
        manage_refund: "مدیریت یا بازپرداخت",
        empty_title: "هنوز پروژهٔ راه‌اندازی ندارید",
        empty_body:
          "پس از خرید پکیج آماده، سفارش و پیشرفت زندهٔ آن اینجا نمایش داده می‌شود.",
      },
      ...
      info: {
        ...
        table: {
          ...
          externally_hosted: "میزبانی خارجی",
        },
        add_dialog: {
          ...
          hosting: {
            title: "میزبانی استورفرانت",
            subtitle: "مشخص کنید استورفرانت این دامنه کجا میزبانی می‌شود.",
            selldone_title: "میزبانی توسط سلدان",
            selldone_description:
              "از استورفرانت سلدان استفاده کنید؛ دامنه با A/CNAME متصل و با TXT تأیید می‌شود.",
            external_title: "فروشگاه خارجی (فروشگاه سفارشی)",
            external_description:
              "استورفرانت سفارشی شما روی Cloudflare یا سرویس میزبانی دیگری باقی می‌ماند.",
            external_note:
              "سلدان فقط مالکیت دامنه را تأیید می‌کند؛ مقصد DNS، میزبانی و SSL همچنان خارج از سلدان مدیریت می‌شوند.",
          },
          ownership: {
            title: "تأیید مالکیت",
            subtitle:
              "یکی از روش‌ها را انتخاب کنید. استورفرانت خارجی به رکورد A یا CNAME سلدان نیاز ندارد.",
            meta_title: "متاتگ HTML",
            meta_description:
              "این تگ را داخل <head> همان میزبانی که پایین نشان داده شده منتشر کنید. آن میزبان باید بدون تغییر مسیر، HTML اولیه موفق برگرداند؛ تگ‌هایی که فقط با JavaScript تزریق می‌شوند شناسایی نخواهند شد.",
            meta_code: "متاتگ تأیید",
            meta_url: "صفحه‌ای که سلدان بررسی می‌کند",
            txt_title: "رکورد DNS TXT",
            txt_description:
              "توکن TXT را در میزبان اختصاصی تأیید که پایین نشان داده شده ثبت کنید؛ رکورد A یا CNAME لازم نیست.",
          },
      ...
      active_orders: {
        title: "سفارشات",
        title_small:
          "سفارشات فیزیکی، فایلی، مجازی، خدمات و اشتراک از طریق کانال های آنلاین، آووکادو و هایپر.",
        pending_orders: "عدد سفارش فعال",
        physical: "سفارش کالاهای فیزیکی",
        virtual: "سفارش کالاهای مجازی",
        file: "سفارش فایل",
        service: "سفارش خدمات",
        subscription: "سفارش‌های اشتراکی",
      },
    ...
    products: {
      ...
      menu_advanced_options_description:
        "اتصال به گوگل شیت، حذف محصولات تکراری و موارد دیگر...",
      ...
      table_mode: {
        ...
        false_description:
          "مشاهده محصولات به‌صورت سازمان‌یافته در دسته‌بندی‌ها و زیرمجموعه‌ها.",
    ...
    logistic: {
      ...
      delivery: {
        ...
        delivery_form: {
          ...
          cod_true: "پذیرش پرداخت در محل",
          cod_false: "فقط پذیرش پرداخت آنلاین",
          cod_true_message:
            "مطمئن شوید سرویس ارسال شما پرداخت در محل را می‌پذیرد.",
          notifications: {
    ...
    apps: {
      ...
      my_apps: {
        ...
        subtitle:
          "سهولت مدیریت برنامه های تجاری خود را با فروشگاه App Selldone کشف کنید. پلتفرم ما مجموعه ای جامع از ابزارهای طراحی شده برای بهینه سازی عملیات کسب و کار شما را ارائه می دهد. از راه‌حل‌های مدیریتی نوآورانه گرفته تا برنامه‌های افزایش بهره‌وری، Selldone تجربه‌ای بی‌نظیر برای کسب‌وکارهایی که به دنبال کارایی و رشد هستند، ارائه می‌کند.",
        all: "همه",
      },
      /** {@see BAppShopStore} **/
      store: {
    ...
    edit: {
      ...
      info: {
        ...
        favicon: {
          title: "فاویکون",
          subtitle:
            "فاویکون‌ها تصاویر کوچک و نمادینی هستند که نماینده یک وب‌سایت در زبانه‌های مرورگر، بوکمارک‌ها و رابط‌های برنامه‌های موبایل می‌باشند.",
        },
      },
  ...
  add_product: {
    ...
    edit_info: {
      ...
      unit_float_hint:
        "به عنوان مثال، ممکن است مشتری ۲.۵ کیلوگرم میوه سفارش دهد، اما مقدار نهایی که ارسال می‌شود کمی با مقدار سفارش داده شده متفاوت باشد.",
      unit_float_message:
        "اگر بین مقدار سفارش داده شده و مقدار تحویل داده شده تفاوتی وجود داشته باشد، سیستم به‌صورت خودکار این اختلاف را به‌عنوان مبلغ بازپرداخت محاسبه می‌کند. سپس می‌توانید این مبلغ را به کارت مشتری بازگردانید یا به‌صورت اعتبار در کیف پول او اعمال کنید.",
  ...
  virtual_items_list: {
    ...
    add_virtual_item_desc:
      "برای فروش محصولات مجازی می توانید آنها را در این قسمت اضافه کنید. تعداد آیتم های مجازی با تعداد آیتم های رایگان این قسمت برابر است. هنگامی که مشتریان کالای مجازی را خریداری کردند، لینک برای آنها ارسال می شود.",
  ...
  timeline: {
    ...
    confirm:
      "تأیید سفارش، <b> {success} </b> تأیید شد و <b> {fail} </b> رد شد.",
    ...
    "connect-canceled": "سفارش توسط همکار لغو شد.  {reason}",
    ...
    "sms-ready-to-ship":
      "ارسال پیامک اطلاع‌رسانی آماده شدن سفارش برای ارسال به مشتری از طریق {phone}.",
    "sms-ready-to-pickup":
      "ارسال پیامک اطلاع‌رسانی آماده شدن سفارش برای تحویل به مشتری از طریق {phone}.",
    "sms-order-confirmation":
      "ارسال پیامک تأیید سفارش به مشتری از طریق {phone}.",
    "count-adjustment":
      'تعداد محصول "{product}" از {from} به {to} تغییر یافته است.',
  ...
  user_monetize_plans: {
    title: "همکاری و درآمدزایی",
    sub_title:
      "پاداش‌های معرفی به کیف پول سلدان شما واریز می‌شود و می‌توانید از این اعتبار برای پرداخت هزینه سرویس‌های سلدان استفاده کنید. توجه داشته باشید که فقط شرکای تجاری VIP سلدان امکان برداشت این اعتبارهای معرفی را دارند و این گزینه برای همه کاربران فعال نیست.",
    discount: "تخفیف",
  ...
  basic_information: {
    ...
    profile_dialog: {
      title: "پروفایل اصلی",
      subtitle:
        "در اینجا می‌توانید اطلاعات پروفایل عمومی خود را ویرایش کنید. این اطلاعات ممکن است برای مشتریان یا کاربران دیگر قابل مشاهده باشد.",
  ...
  user_access_control: {
    ...
    clients_message:
      "این کلیدها برای ساخت توکن دسترسی توسط سرور شما استفاده می‌شوند. توجه داشته باشید که این کلیدها محرمانه هستند و فقط باید روی سرور نگهداری شوند تا برای دیگران قابل مشاهده نباشند.",
  ...
  scopes: {
    ...
    phone: {
      name: "شماره تلفن",
      description: "دسترسی به شماره تماس.",
    },
    address: {
      name: "آدرس ها",
    ...
    "user:profile:write": {
      name: "مدیریت پروفایل",
      description: "اطلاعات پروفایل کاربر را ویرایش و مدیریت کنید.",
    },
    "my-gift-cards": {
      name: "کارت های هدیه",
    ...
    buy: {
      name: "خرید",
      description: "ثبت سفارش و خرید از فروشگاه.",
    },
    articles: {
      name: "ویرایش مطالب",
    ...
    "backoffice:notifications": {
      ...
      description: "اعلان‌ها را ارسال و دریافت کنید.",
    },
    "backoffice:order:write": {
      name: "مدیریت سفارش‌ها",
      description: "سفارش‌های فروشگاه را ویرایش و مدیریت کنید.",
    },
    "backoffice:order:read": {
      name: "دسترسی به سفارش‌ها",
      description: "سفارش‌های فروشگاه را بخوانید.",
    },
    "backoffice:support-tickets": {
      name: "تیکت‌های پشتیبانی",
      description: "تیکت‌های پشتیبانی را مدیریت کنید.",
    },
    "backoffice:shop:read": {
      name: "اطلاعات فروشگاه",
      description: "جزئیات و آمار فروشگاه را بخوانید.",
    },
    "backoffice:shop:write": {
      name: "مدیریت فروشگاه",
      description: "جزئیات فروشگاه را ایجاد و مدیریت کنید.",
    },
    "backoffice:shop:add": {
      name: "افزودن فروشگاه",
      description: "یک فروشگاه جدید به سیستم اضافه کنید.",
    },
    "backoffice:shop:delete": {
      name: "حذف فروشگاه",
      description: "یک فروشگاه را از سیستم حذف کنید.",
    },
    "backoffice:giftcard:write": {
      name: "مدیریت کارت هدیه",
      description: "کارت‌های هدیه را ایجاد و مدیریت کنید.",
    },
    "backoffice:giftcard:read": {
      name: "دسترسی به کارت هدیه",
      description: "جزئیات و آمار کارت‌های هدیه را بخوانید.",
    },
    "backoffice:faq:write": {
      name: "مدیریت پرسش‌های متداول",
      description: "پرسش‌های متداول را ایجاد و مدیریت کنید.",
    },
    "backoffice:faq:read": {
      name: "دسترسی به پرسش‌های متداول",
      description: "جزئیات و آمار پرسش‌های متداول را بخوانید.",
    },
    "backoffice:category:write": {
      name: "مدیریت دسته‌بندی‌ها",
      description: "دسته‌بندی‌های محصول را ایجاد و مدیریت کنید.",
    },
    "backoffice:category:read": {
      name: "دسترسی به دسته‌بندی‌ها",
      description: "جزئیات و آمار دسته‌بندی‌ها را بخوانید.",
    },
    "backoffice:product:write": {
      name: "مدیریت محصولات",
      description: "محصولات را اضافه و مدیریت کنید.",
    },
    "backoffice:product:read": {
      name: "دسترسی به محصولات",
      description: "جزئیات و آمار محصولات را بخوانید.",
    },
    "backoffice:report:read": {
      name: "دسترسی به گزارش‌ها",
      description: "گزارش‌ها و اطلاعات فروشگاه را بخوانید.",
    },
    "backoffice:finance:write": {
      name: "مدیریت حساب‌های مالی",
      description: "حساب‌های مالی متصل به فروشگاه را مدیریت کنید.",
    },
    "backoffice:finance:read": {
      name: "دسترسی به حساب‌های مالی",
      description: "جزئیات و آمار حساب‌های مالی را بخوانید.",
    },
    "backoffice:page:write": {
      name: "مدیریت صفحه‌ها",
      description: "صفحه‌های فروشگاه را ویرایش کنید.",
    },
    "backoffice:page:read": {
      name: "دسترسی به صفحه‌ها",
      description: "جزئیات و آمار صفحه‌های فروشگاه را بخوانید.",
    },
    "backoffice:logistic:write": {
      name: "مدیریت لجستیک",
      description: "اطلاعات لجستیک را مدیریت کنید.",
    },
    "backoffice:logistic:read": {
      name: "دسترسی به لجستیک",
      description: "جزئیات و آمار لجستیک را بخوانید.",
    },
    "backoffice:staff:write": {
      name: "مدیریت کارکنان",
      description: "جزئیات کارکنان را ویرایش و مدیریت کنید.",
    },
    "backoffice:staff:read": {
      name: "دسترسی به کارکنان",
      description: "اطلاعات و آمار کارکنان را بخوانید.",
    },
    "backoffice:business-profile:write": {
      name: "مدیریت پروفایل کسب‌وکار",
      description: "پروفایل‌های کسب‌وکار را مدیریت کنید.",
    },
    "backoffice:business-profile:read": {
      name: "دسترسی به پروفایل کسب‌وکار",
      description: "جزئیات پروفایل کسب‌وکار را بخوانید.",
    },
    "backoffice:discount-code:write": {
      name: "مدیریت کدهای تخفیف",
      description: "کدهای تخفیف فروشگاه را مدیریت کنید.",
    },
    "backoffice:discount-code:read": {
      name: "دسترسی به کدهای تخفیف",
      description: "جزئیات و آمار کدهای تخفیف را بخوانید.",
    },
    "backoffice:wallet:write": {
      name: "مدیریت کیف پول‌ها",
      description: "کیف پول‌های کاربران را مدیریت کنید.",
    },
    "backoffice:wallet:read": {
      name: "دسترسی به کیف پول‌ها",
      description: "اطلاعات و آمار کیف پول‌ها را بخوانید.",
    },
    "backoffice:coupon:write": {
      name: "مدیریت کوپن‌ها",
      description: "کوپن‌های فروشگاه را مدیریت کنید.",
    },
    "backoffice:coupon:read": {
      name: "دسترسی به کوپن‌ها",
      description: "جزئیات و آمار کوپن‌ها را بخوانید.",
    },
    "backoffice:offer:write": {
      name: "مدیریت پیشنهادها",
      description: "پیشنهادهای فروشگاه را مدیریت کنید.",
    },
    "backoffice:offer:read": {
      name: "دسترسی به پیشنهادها",
      description: "اطلاعات و آمار پیشنهادها را بخوانید.",
    },
    "backoffice:cashback:write": {
      name: "مدیریت کش‌بک",
      description: "پیشنهادهای کش‌بک فروشگاه را مدیریت کنید.",
    },
    "backoffice:cashback:read": {
      name: "دسترسی به کش‌بک",
      description: "جزئیات و آمار کش‌بک را بخوانید.",
    },
    "backoffice:lottery:write": {
      name: "مدیریت قرعه‌کشی‌ها",
      description: "قرعه‌کشی‌های فروشگاه را مدیریت کنید.",
    },
    "backoffice:lottery:read": {
      name: "دسترسی به قرعه‌کشی‌ها",
      description: "جزئیات و آمار قرعه‌کشی‌ها را بخوانید.",
    },
    "backoffice:community:write": {
      name: "مدیریت انجمن",
      description: "فعالیت‌های انجمن را مدیریت کنید.",
    },
    "backoffice:community:read": {
      name: "دسترسی به انجمن",
      description: "جزئیات و آمار انجمن را بخوانید.",
    },
    "backoffice:customer:write": {
      name: "مدیریت مشتریان",
      description: "جزئیات مشتریان را مدیریت کنید.",
    },
    "backoffice:customer:read": {
      name: "دسترسی به مشتریان",
      description: "اطلاعات و آمار مشتریان را بخوانید.",
    },
    "backoffice:ribbon:write": {
      name: "مدیریت روبان‌ها",
      description: "روبان‌های فروشگاه را مدیریت کنید.",
    },
    "backoffice:ribbon:read": {
      name: "دسترسی به روبان‌ها",
      description: "جزئیات و آمار روبان‌ها را بخوانید.",
    },
    "backoffice:ai:write": {
      name: "مدیریت هوش مصنوعی",
      description: "تنظیمات هوش مصنوعی را مدیریت کنید.",
    },
    "backoffice:ai:read": {
      name: "دسترسی به هوش مصنوعی",
      description: "تنظیمات و آمار هوش مصنوعی را بخوانید.",
    },
    "backoffice:vendor-payment:write": {
      name: "مدیریت پرداخت فروشندگان",
      description: "پرداخت‌های فروشندگان را مدیریت کنید.",
    },
    "backoffice:vendor-payment:read": {
      name: "دسترسی به پرداخت فروشندگان",
      description: "جزئیات و آمار پرداخت‌های فروشندگان را بخوانید.",
    },
    "backoffice:company:read": {
      name: "دسترسی به شرکت‌ها",
      description: "جزئیات و آمار شرکت‌ها را بخوانید.",
    },
    "backoffice:company:write": {
      name: "مدیریت شرکت‌ها",
      description: "اطلاعات شرکت را مدیریت کنید.",
    },
    "backoffice:note:read": {
      name: "دسترسی به یادداشت‌ها",
      description: "یادداشت‌ها و جزئیات مرتبط را بخوانید.",
    },
    "backoffice:note:write": {
      name: "مدیریت یادداشت‌ها",
      description: "یادداشت‌ها را مدیریت کنید.",
    },
    "backoffice:affiliate:write": {
      name: "مدیریت افیلیت",
      description: "اطلاعات افیلیت را مدیریت کنید.",
    },
    "backoffice:affiliate:read": {
      name: "دسترسی به افیلیت",
      description: "جزئیات و آمار افیلیت را بخوانید.",
    },
    "backoffice:print:write": {
      name: "مدیریت چاپ",
      description: "گزینه‌های چاپ را مدیریت کنید.",
    },
    "backoffice:print:read": {
      name: "دسترسی به چاپ",
      description: "جزئیات چاپ را بخوانید.",
    },
    "selldone:token:read": {
      name: "دسترسی به توکن‌ها",
      description: "جزئیات و آمار توکن‌ها را بخوانید.",
    },
    "selldone:token:write": {
      name: "مدیریت توکن‌ها",
      description: "توکن‌ها را مدیریت کنید.",
    },
    "selldone:monetization:read": {
      name: "دسترسی به درآمدزایی",
      description: "جزئیات و آمار درآمدزایی را بخوانید.",
    },
    "selldone:monetization:write": {
      name: "مدیریت درآمدزایی",
      description: "درآمدزایی، از جمله برنامه‌های معرفی را مدیریت کنید.",
    },
    "selldone:identification": {
      name: "دسترسی به احراز هویت",
      description: "به جزئیات احراز هویت کاربر دسترسی داشته باشید.",
    },
    "selldone:developer:read": {
      name: "دسترسی توسعه‌دهنده",
      description: "جزئیات و آمار توسعه‌دهنده را بخوانید.",
    },
    "selldone:developer:write": {
      name: "مدیریت توسعه‌دهنده",
      description: "اطلاعات توسعه‌دهنده را مدیریت کنید.",
    },
    "selldone:security:write": {
      name: "مدیریت امنیت",
      description: "تنظیمات امنیتی را مدیریت کنید.",
    },
    "connect:provider:write": {
      name: "مدیریت ارائه‌دهنده",
      description: "ارائه‌دهندگان سرویس متصل را مدیریت کنید.",
    },
    "connect:provider:read": {
      name: "دسترسی به ارائه‌دهنده",
      description: "جزئیات و آمار ارائه‌دهنده را بخوانید.",
    },
    "agency:read": {
      name: "دسترسی به آژانس",
      description: "جزئیات و آمار آژانس را بخوانید.",
    },
    "agency:write": {
      name: "مدیریت آژانس",
      description: "اطلاعات آژانس را مدیریت کنید.",
    },
    "vendor-read": {
      name: "دسترسی به فروشنده",
      description: "جزئیات و آمار فروشنده را بخوانید.",
    },
    "vendor-write": {
      name: "مدیریت فروشنده",
      description: "اطلاعات فروشنده را مدیریت کنید.",
    },
    notifications: {
  ...
  scope_group: {
    backoffice: {
      title: "بک‌آفیس",
      description: "دسترسی به قابلیت‌های بک‌آفیس و مدیریت فروشگاه.",
    },
    storefront: {
      title: "ویترین فروشگاه",
      description: "دسترسی به اطلاعات مشتری و فروشگاه.",
    },
    profile: {
      title: "پروفایل",
      description: "دسترسی به اطلاعات پروفایل کاربر.",
    },
    selldone: {
      title: "سلدان",
      description: "دسترسی به سرویس‌ها و قابلیت‌های سلدان.",
    },
    others: {
      title: "سایر موارد",
      description: "دسترسی‌های متفرقه‌ای که در سیستم تعریف نشده‌اند.",
    },
    vendor: {
      title: "فروشنده",
      description: "دسترسی به اطلاعات و قابلیت‌های مدیریت فروشنده.",
    },
    connect: {
      title: "Connect OS",
      description: "دسترسی به سرویس‌ها و ارائه‌دهندگان متصل.",
    },
    agency: {
      title: "آژانس",
      description: "دسترسی به اطلاعات و مدیریت آژانس.",
    },
  },
  company_page: {
    title: "تجاری",
  ...
  price_calculator: {
    ...
    hypernova_plan: "برای Hypernova %0 درخواست دهید!",
  ...
  shop_license: {
    ...
    active_license: {
      ...
      subtitle_partner:
        "اطلاعات مجوز {name} فعال شما. این فروشگاه در حال حاضر یک معامله شریک فعال دارد. اگر می‌خواهید معامله را لغو کنید و به یک طرح سطح بالاتر ارتقا دهید، لطفاً برای کمک با تیم پشتیبانی ما تماس بگیرید.",
    },
    licenses_table: {
      title: "پلن های خریداری شده",
      subtitle:
        "این لیستی از مجوزهای فعال و معلق است. پس از تامین مالی کیف پول خود می توانید معاملاتی را خریداری کنید. علاوه بر این، لطفاً توجه داشته باشید که هنگام لغو اشتراک، مبلغ اشتراک باقی مانده به کیف پول مجازی شما بازگردانده می شود.",
    },
    license_detail: {
      title: "جزئیات پلن",
      subtitle:
        "اینها محدودیت های طرح فعلی شما هستند. برای جزئیات بیشتر، لطفا به صفحه قیمت مراجعه کنید. برای شروع کسب و کار و رشد می توانید به همه ویژگی ها در همه برنامه ها، از جمله طرح رایگان دسترسی داشته باشید. همانطور که کسب و کار خود را افزایش می دهید، برای کاهش هزینه های خدمات خود، به یک طرح سطح بالاتر ارتقا دهید.",
    },
  ...
  affiliate_dashboard: {
    link: {
      title: "لینک همکاری در فروش",
      subtitle:
        "یک لینک منحصربه‌فرد برای شریک همکاری خود ایجاد کنید تا فروش و کمیسیون‌هایشان را ردیابی کنند. می‌توانید کدهای ارجاع '{code}' را به هر لینکی اضافه کنید یا یک دامنه اختصاصی سفارشی برای همکار خود تنظیم کنید. هر ورود برای 48 ساعت توسط سیستم ترک خواهد شد.",
    },
  ...
  user_funnel: {
    ...
    SEGMENTS: {
      title: "بخش ها",
      description: "مشتریان را به یک بخش‌بندی دستی مشخص محدود کنید.",
    },
  },
  ...
  shop_tax: {
    ...
    tax_exclude_title: "غیرشامل ╏ مالیات هنگام تسویه‌حساب اضافه می‌شود",
    tax_excluded_message:
      "مالیات‌ها پیش از پرداخت در مرحله تسویه‌حساب محاسبه می‌شوند و بسته به شواهد مشتری، به قیمت بدون مالیات اضافه خواهند شد.",
  ...
  marketplace_setting: {
    ...
    inputs: {
      ...
      listing: {
        label: "لیستینگ برای فروشنده‌ها",
        true_description:
          "لیستینگ برای فروشنده‌ها فعال است. فروشنده‌ها می‌توانند آیتم‌ها و کمپانی‌های لیستینگ را مدیریت کنند.",
        false_description:
          "لیستینگ برای فروشنده‌ها غیرفعال است. فقط مالک فروشگاه می‌تواند آیتم‌ها و کمپانی‌های لیستینگ را مدیریت کند.",
        requires_listing_active_text:
          "برای اینکه فروشنده‌ها بتوانند از لیستینگ (آیتم‌ها و کمپانی‌ها) استفاده کنند، ابتدا قابلیت لیستینگ فروشگاه را در مسیر «کانال → لیستینگ» فعال کنید. سپس به این بخش برگردید و دسترسی فروشنده‌ها را فعال کنید.",
        requires_listing_active_button: "رفتن به تنظیمات کانال لیستینگ",
      },
    },
    notifications: {
  ...
  shop_theme: {
    ...
    theme_colors_description:
      "اینجا می‌توانید پالت رنگ اصلی فروشگاه خود را شخصی‌سازی کنید. هر قالب می‌تواند از این رنگ‌ها برای ایجاد خودکار یک طیف رنگ کامل که با برند شما هماهنگ است، استفاده کند.",
    ...
    animation: {
      ...
      static: {
        ...
        false_description:
          "دسته‌بندی‌ها و محصولات دارای انیمیشن‌های تعاملی برای نمایش عملکرد هستند.",
        true_title: "ایستا",
    ...
    quick_actions: {
      ...
      hover: {
        false_description:
          "حالت ساده و مینیمال بدون هیچ عملیات اضافی روی کارت محصولات.",
        true_description:
          "دکمه‌های خرید سریع و افزودن به مقایسه را هنگام هاور کردن روی کارت محصول نشان می‌دهد.",
    ...
    filter_products: {
      ...
      only_available: {
        false_description:
          "نمایش تمام محصولات در لیست فروشگاه به صورت پیش‌فرض.",
        true_description:
          "نمایش فقط محصولات موجود در لیست فروشگاه به صورت پیش‌فرض.",
    ...
    filter_categories: {
      ...
      hide_empty_folders: {
        ...
        true_description:
          "نمایش فقط دسته‌بندی‌هایی که محصول دارند در لیست فروشگاه.",
      },
    },
    ...
    product_page: {
      title: "صفحه محصول",
      subtitle:
        "صفحه محصول خود را اینجا شخصی‌سازی کنید. می‌توانید نمایش قیمت‌ها را تنظیم کنید و ترتیب بخش‌ها را مطابق با سلیقه خود تغییر دهید.",
      buy_button_color: "رنگ دکمه خرید",
      smart_price: {
        title: "قیمت واحد هوشمند",
        true_description:
          "محاسبه قیمت واحد با در نظر گرفتن وزن، حجم و ویژگی‌های بسته‌بندی. مثال: اگر یک واریانت با اندازه ۲ لیتری و قیمت ۵ دلار داشته باشید، مشتری در صفحه محصول ۲.۵ دلار/لیتر را مشاهده خواهد کرد.",
      },
      reverse_currency: {
        ...
        false_description:
          "نماد ارز در ابتدای اعداد قرار می‌گیرد. مثال: $95 , €30",
        true_description:
          "نماد ارز در انتهای اعداد قرار می‌گیرد. مثال: 95$ , 30€",
      },
      variants_selector: {
        title: "انتخاب‌کننده واریانت‌ها",
        subtitle:
          "می‌توانید روش‌های مختلفی برای نمایش واریانت‌ها در صفحه محصول انتخاب کنید.",
      },
      tabs_order: {
        title: "ترتیب تب‌ها",
  ...
  b_shop_theme_vendor: {
    onboarding: {
      title: "آغاز و ورود",
      subtitle:
        "تجربه آغاز و ورود فروشنده را با ویدئو، تصویر یا پیام سفارشی شخصی‌سازی کنید.",
    },
    inputs: {
      page_vendor_login: {
        label: "صفحه ورود فروشنده",
        message:
          "یک صفحه فرود سفارشی برای ورود فروشنده انتخاب کنید. برای طراحی منحصر به فرد، ویدئو، تصاویر یا متن را اضافه کنید. این صفحه به فروشندگانی که وارد نشده‌اند نمایش داده می‌شود.",
      },
      page_vendor_registered: {
        label: "صفحه فروشنده وارد شده",
        message:
          "یک صفحه سفارشی برای فروشندگانی که وارد شده‌اند انتخاب کنید. این صفحه در صورتی نمایش داده می‌شود که بازار شما از چند فروشنده برای هر کاربر پشتیبانی می‌کند.",
      },
    },
  },
  ...
  b_shop_options_variants: {
    custom_variants: {
      title: "انواع سفارشی",
      subtitle:
        "محصولات فیزیکی می‌توانند انواع مختلفی داشته باشند. شما می‌توانید نام پیش‌فرض انواع را تغییر دهید. پیشنهاد ما این است که این موارد را به صورت پیش‌فرض و خالی رها کنید تا سلدان به طور خودکار آن‌ها را برای مشتریان شما به زبان‌های آن‌ها ترجمه کند. حداکثر طول ۲۴ کاراکتر است.",
    },
  },
  ...
  b_shop_theme_typography: {
    main_font: {
      title: "فونت اصلی وب‌سایت",
      subtitle: "یک فونت سفارشی آپلودشده یا فونتی از گوگل فونت انتخاب کنید.",
      custom_font: "فونت سفارشی آپلودشده",
      custom_font_message:
        "یک فونت آپلودشده انتخاب کنید تا خانواده و منبع فونت هر دو خودکار ساخته شوند.",
      custom_resource_message:
        "این منبع خودکار از فایل‌های عمومی فونت روی CDN ساخته شده است.",
    },
    custom_fonts: {
      title: "فونت‌های سفارشی",
      subtitle:
        "فونت‌های اختصاصی فروشگاه را آپلود و مدیریت کنید. برای هر وزن و استایل موردنیاز یک حالت جداگانه بسازید.",
      quota: "{used} از {limit} فونت",
      quota_reached: "به سقف تعداد فونت در لایسنس فعلی رسیده‌اید.",
      css_name: "نام font-family در CSS",
      css_name_hint:
        "این مقدار را برای استفاده از فونت در صفحه‌ساز یا CSS سفارشی کپی کنید.",
      file_hint:
        "حجم هر فایل حداکثر {size} است. فرمت‌های مجاز: {formats}. برای مرورگرهای جدید WOFF2 پیشنهاد می‌شود.",
      empty_title: "هنوز فونت سفارشی ندارید",
      empty_description:
        "اولین خانواده فونت را آپلود کنید تا در فروشگاه و صفحه‌ساز قابل استفاده باشد.",
      actions: {
        add: "افزودن فونت سفارشی",
        add_weight: "افزودن وزن",
      },
      dialog: {
        add_title: "افزودن فونت سفارشی",
        edit_title: "ویرایش فونت سفارشی",
        subtitle:
          "خانواده فونت را تعریف کنید و فقط وزن‌ها و استایل‌های موردنیاز فروشگاه را اضافه کنید.",
      },
      inputs: {
        name: "نام فونت",
        name_message: "یک نام قابل تشخیص برای نمایش فونت در داشبورد.",
        fallback: "خانواده جایگزین",
        fallback_message:
          "اگر فونت سفارشی بارگذاری نشود، این فونت استفاده می‌شود.",
        weight: "وزن",
        style: "استایل",
        files: "فایل‌های فونت",
      },
      faces: {
        title: "وزن‌ها و استایل‌های فونت",
        subtitle:
          "برای هر ترکیب وزن و استایل، یک یا چند فرمت مرورگر پیوست کنید.",
        face: "حالت {index}",
      },
      styles: {
        normal: "عادی",
      ...
      errors: {
        name_required: "یک نام برای این فونت وارد کنید.",
        format: "فرمت فایل {name} پشتیبانی نمی‌شود.",
        size: "حجم فایل {name} از محدودیت {size} بیشتر است.",
        duplicate_format: "برای این حالت فقط یک فایل {format} قابل افزودن است.",
        name_length: "نام فونت نمی‌تواند بیشتر از ۸۰ کاراکتر باشد.",
        face_required: "حداقل یک حالت فونت اضافه کنید.",
        duplicate_face: "ترکیب وزن و استایل هر حالت باید یکتا باشد.",
        file_required: "حداقل یک فایل به این حالت فونت پیوست کنید.",
      },
      delete: {
        title: "حذف فونت سفارشی",
        message:
          "فونت {name} و همه فایل‌های آپلودشده آن حذف شوند؟ صفحات استفاده‌کننده به فونت جایگزین بعدی برمی‌گردند.",
      },
      notifications: {
        created: "فونت سفارشی ساخته شد.",
        updated: "فونت سفارشی به‌روزرسانی شد.",
        deleted: "فونت سفارشی حذف شد.",
      },
    },
    inputs: {
      font_family: {
        label: "خانواده فونت",
        message: "مقدار خانواده فونت را وارد کنید.",
      },
      font_res: {
        label: "منبع فونت",
        message: "منبع فونت را مشخص کنید.",
      },
    },
  },
  ...
  b_shop_theme_header: {
    logo: {
      title: "لوگوی هدر",
      subtitle:
        "لوگوی فروشگاه شما به طور پیش‌فرض در هدر نمایش داده می‌شود. می‌توانید لوگوی سفارشی خود را بارگذاری کنید. اگر لوگوی شما نسبت ابعادی مربعی ندارد، ممکن است نیاز به تنظیم دستی ارتفاع و عرض آن برای نمایش بهینه باشد.",
    },
    header_title: {
      title: "عنوان هدر",
      subtitle:
        "عنوان نمایش داده شده در هدر صفحات خود را در اینجا شخصی‌سازی کنید. برای حذف کامل آن، روی دکمه 'تنظیم عنوان خالی' کلیک کنید.",
    },
  ...
  shop_theme_variants_mode: {
    smart: {
      title: "حالت هوشمند",
      description:
        "واریانت‌ها را به صورت گزینه‌های جداگانه و قابل انتخاب به صورت فشرده نمایش می‌دهد که برای اکثر موارد مناسب است.",
    },
    select: {
      title: "حالت لیستی",
      description:
        "تمام واریانت‌ها را در یک منوی کشویی نمایش می‌دهد که برای تعداد زیادی از واریانت‌ها ایده‌آل است.",
    },
  },
  ...
  property_set_add: {
    ...
    config: {
      subtitle:
        "عنوان و توضیحات مجموعه ویژگی خود را تعیین کنید. این اطلاعات فقط برای کارکنان قابل مشاهده خواهد بود.",
    },
    variants: {
      title: "واریانت‌ها",
      subtitle:
        "می‌توانید نام، آیکون و ترتیب واریانت‌ها را اینجا شخصی‌سازی کنید. اگر محصولات متنوعی با واریانت‌های خاص دارید که در ۶ واریانت پیش‌فرض نمی‌گنجند، می‌توانید برای هر محصول واریانت‌های سفارشی تعریف کنید.",
    },
    inputs: {
      title: {
  ...
  property_set_variant_row: {
    inputs: {
      values: {
        ...
        messages:
          "می‌توانید پیشنهاداتی برای مقادیر ارائه دهید و ترتیب آن‌ها را سفارشی کنید.",
      },
    },
  },
  ...
  order_delivery: {
    ...
    checklist: [
      ...
      "بسته‌بندی مناسب محصولات و تحویل به‌موقع می‌تواند نرخ بازگشت مشتریان شما را افزایش دهد.",
    ],
    manual: {
  ...
  styler: {
    ...
    products: {
      ...
      categories_limit: "محدودیت دسته‌بندی‌ها",
      categories_limit_msg:
        "حداکثر تعداد دسته‌بندی‌ها را وارد کنید. برای بدون محدودیت، صفر قرار دهید.",
    },
  },
  ...
  shop_channel_instagram: {
    title: "کانال فروش اینستاگرام",
    subtitle:
      "برای محصولات خود یک دسته‌بندی اختصاصی همراه با تصویر و ویدئو بسازید و آن را در شبکه‌های اجتماعی به اشتراک بگذارید. شبیه اینستاگرام و تیک‌تاک است، اما با کنترل کامل تا بتوانید محصولات خود را مستقیم بفروشید.",
  },
  service_bill: {
    task: {
      title: "لیست کارها",
    ...
    charge: {
      title: "شارژ",
      message:
        "شما هزینه ای برای این مورد تعیین کرده اید. می توانید مبلغ شارژ کالای خریداری شده توسط مشتری را تغییر دهید.",
      charge: "شارژ",
    },
  ...
  shops_list: {
    ...
    created_at: "ساخته‌شده {time}",
    total_views: "مجموع بازدیدهای فروشگاه",
    empty: "فروشگاهی برای نمایش وجود ندارد.",
    ...
    sort: {
      label: "مرتب‌سازی فروشگاه‌ها",
      newest: "جدیدترین",
      oldest: "قدیمی‌ترین",
      most_visited: "پربازدیدترین",
    },
    deleted: {
      message: "فقط فروشگاه‌های حذف‌شده‌ی قابل‌بازیابی شما نمایش داده می‌شوند.",
      deleted_at: "حذف‌شده {time}",
      recover: "بازیابی فروشگاه",
      recovered_title: "فروشگاه بازیابی شد",
      recovered_message: "فروشگاه {shop} دوباره فعال شد.",
      recovery_dialog: {
        title: "بازیابی فروشگاه",
        message:
          "با بازیابی فروشگاه {shop}، این فروشگاه دوباره فعال و در لیست فروشگاه‌های شما نمایش داده می‌شود.",
        instruction: "برای تأیید، عبارت زیر را در کادر وارد کنید.",
        input_label: "عبارت تأیید",
        input_hint: "برای ادامه عبارت {phrase} را وارد کنید.",
      },
    },
  ...
  shop_configuration: {
    ...
    checkout_form: {
      ...
      subtitle:
        "فیلدهای فرم تسویه‌حساب را برای جمع‌آوری اطلاعات موردنیاز از مشتریان خود سفارشی کنید.",
    },
  },
  ...
  external_services: {
    ...
    subtitle:
      "آخرین وضعیت سرویس‌های خارجی مانند پیامک و ایمیل را از اینجا پایش کنید.",
  },
  shop_quota: {
    title: "سهمیه مصرف",
    eyebrow: "سهمیه اکشن‌های روزانه",
    beta: "بتا",
    sub_title:
      "ببینید هر سهمیه روزانه با چه کاری مصرف می‌شود، چه مقدار باقی‌مانده و ظرفیت آن از لایسنس می‌آید یا سهمیه سفارشی.",
    refresh: "به‌روزرسانی مصرف سهمیه",
    loading: "در حال بارگذاری سهمیه‌های روزانه",
    loading_hint: "آخرین میزان مصرف این فروشگاه در حال دریافت است.",
    load_failed: "مصرف سهمیه بارگذاری نشد",
    load_failed_hint:
      "اطلاعات جدید سهمیه روزانه فعلاً در دسترس نیست. دوباره تلاش کنید.",
    refresh_failed:
      "به‌روزرسانی جدید ناموفق بود. آخرین مقادیر بارگذاری‌شده همچنان نمایش داده می‌شوند.",
    retry: "تلاش دوباره",
    search: "جست‌وجوی سهمیه‌ها",
    no_results: "سهمیه‌ای پیدا نشد",
    no_results_hint:
      "عبارت دیگری جست‌وجو کنید یا همه سهمیه‌ها را دوباره نمایش دهید.",
    show_all: "نمایش همه سهمیه‌ها",
    resource_open_accessible:
      "{resource}؛ {status}. {usage} از {total} مصرف شده و {available} باقی‌مانده است. نمایش جزئیات.",
    resource_close_accessible:
      "{resource}؛ {status}. {usage} از {total} مصرف شده و {available} باقی‌مانده است. بستن جزئیات.",
    filters: {
      all: "همه",
    ...
    overview: {
      resources: "سهمیه‌های روزانه",
      attention: "نیازمند توجه",
      custom: "سهمیه‌های سفارشی",
      last_reset: "آخرین بازنشانی",
      not_reset: "هنوز بازنشانی نشده",
      rolling_reset: "مصرف در یک بازه روزانه شناور بازنشانی می‌شود.",
    },
    guide: {
      title: "سهمیه روزانه با محدودیت لایسنس فرق دارد",
      body: "بیشتر سهمیه‌ها فقط پس از ساخت موفق یک مورد جدید مصرف می‌شوند. ویرایش، بازیابی، اکشن ناموفق و حذف معمولاً مصرفی ندارند؛ حذف یک مورد نیز ظرفیت را برنمی‌گرداند. سفارش‌ها، ایمپورت محصول و سرویس‌های AI از قواعدی پیروی می‌کنند که در جزئیات هر ردیف آمده است. محدودیت تعداد فعلی منابع در لایسنس نیز می‌تواند جداگانه اعمال شود. اگر ظرفیت روزانه بیشتری لازم دارید، لایسنس فروشگاه را ارتقا دهید یا برای سهمیه سفارشی با سلدان تماس بگیرید.",
    },
    groups: {
      catalog: {
        title: "کاتالوگ",
        description: "محصولات، لیست‌های مارکت‌پلیس و ساختار کاتالوگ.",
      },
      storefront: {
        title: "ویترین فروشگاه",
        description: "دامنه‌ها و محتوایی که مشتری در فروشگاه می‌بیند.",
      },
      promotions: {
        title: "پروموشن",
        description: "تخفیف‌ها، کمپین‌ها، افیلیت و ابزارهای ارتباطی.",
      },
      operations: {
        title: "عملیات",
        description: "مشتری‌ها، پیک‌ها و وندورهای مارکت‌پلیس.",
      },
      orders_community: {
        title: "سفارش‌ها و کامیونیتی",
        description: "رویدادهای شمارش‌شده سفارش و فعالیت کامیونیتی فروشگاه.",
      },
      ai: {
        title: "سرویس‌های AI",
        description: "مصرف اندازه‌گیری‌شده AI و حذف پس‌زمینه تصویر.",
      },
      other: {
        title: "سایر",
        description: "منابع سهمیه جدیدی که هنوز مستند نشده‌اند.",
      },
    },
    capacity: {
      available: "در دسترس",
      near_limit: "نزدیک سقف",
      at_limit: "سقف پر شده",
      exceeded: "بیش از سقف",
      no_capacity: "بدون ظرفیت",
      available_count: "{count} در دسترس",
      custom: "سفارشی",
      license_only: "سهمیه لایسنس",
      accessible: "{usage} از مجموع سهمیه روزانه {total} مصرف شده است",
    },
    details: {
      counts: "چه چیزی این سهمیه را مصرف می‌کند",
      allowance: "ظرفیت روزانه",
      included: "لایسنس",
      extra: "سفارشی",
      daily_total: "مجموع",
    },
    rules: {
      create:
        "فقط ساخت موفق یک مورد جدید، یک واحد مصرف می‌کند. ویرایش، بازیابی، خطای اعتبارسنجی و عملیاتی که تراکنش آن بازگردانده می‌شود مصرفی ندارد. حذف مورد نیز واحد مصرف‌شده را در بازه فعلی سهمیه برنمی‌گرداند.",
      product:
        "ساخت محصول به‌صورت دستی، کلون، AI، ریپازیتوری، کانکتور، دراپ‌شیپینگ یا گیفت‌کارت یک واحد مصرف می‌کند. ردیف ایمپورتی که قرار است محصول جدید بسازد ممکن است هنگام ورود به صف محاسبه شود؛ اگر بعداً با محصول موجود تطبیق داده شود یا پردازش‌گر ناموفق باشد، فعلاً آن واحد برنمی‌گردد. ویرایش، بازیابی و حذف محاسبه نمی‌شوند.",
      online_order:
        "سفارش‌های استاندارد، آووکادو و هایپر اولین باری که از Open به Reserved یا COD می‌روند یک واحد مصرف می‌کنند. سفارش آووکادویی که فروشنده از ابتدا به‌صورت Reserved می‌سازد و سبد اشتراک جدیدی که Reserved ساخته می‌شود، هنگام ساخت یک واحد مصرف می‌کنند. تلاش مجدد و تغییر وضعیت‌های بعدی دوباره محاسبه نمی‌شوند و لغو، انقضا یا بازپرداخت نیز آن واحد را برنمی‌گرداند.",
      pos_order:
        "سفارش POS اولین باری که از Open به Reserved یا COD می‌رود یک واحد مصرف می‌کند. تلاش مجدد و تغییر وضعیت‌های بعدی دوباره محاسبه نمی‌شوند و لغو نیز آن واحد را برنمی‌گرداند.",
      ai_tokens:
        "این یک سهمیه تجمیعی مصرف AI است. درخواست‌های پشتیبانی‌شده ابتدا با مقدار تخمینی بررسی می‌شوند و سپس توکن واقعی گزارش‌شده را اضافه می‌کنند؛ ترجمه قدیمی AI ممکن است واحد کاراکتر در تعداد زبان را اضافه کند. برخی مسیرهای تبدیل صدا به متن فعلاً در این سهمیه نیستند.",
      bg_remove:
        "وقتی نتیجه حذف پس‌زمینه از قبل در کش نباشد، اجرای سرویس ارائه‌دهنده یک واحد مصرف می‌کند. استفاده دوباره از نتیجه کش‌شده مصرفی ندارد.",
      unknown:
        "این سهمیه در رجیستری مشترک وجود دارد، اما روش شمارش آن در این نسخه داشبورد مستند نشده است.",
    },
    resources: {
      Product: {
        title: "محصول",
        description:
          "محصولات جدیدی که دستی، با کلون یا AI، از طریق ایمپورت، ریپازیتوری، دراپ‌شیپینگ، گیفت‌کارت یا کانال‌های متصل ساخته می‌شوند.",
      },
      ListingItem: {
        title: "آیتم لیستینگ",
        description: "آیتم‌های لیستینگ جدید مارکت‌پلیس برای این فروشگاه.",
      },
      Category: {
        title: "دسته‌بندی",
        description:
          "دسته‌های جدیدی که دستی، با ایمپورت، AI، ریپازیتوری، ابزارهای متصل یا هنگام پردازش محصول ساخته می‌شوند.",
      },
      Domain: {
        title: "دامنه",
        description:
          "دامنه مدیریت‌شده یا خارجی جدیدی که به فروشگاه وصل می‌شود. ویرایش یا بازیابی دامنه موجود محاسبه نمی‌شود.",
      },
      DiscountCodes: {
        title: "کد تخفیف",
        description:
          "کدهای تخفیف جدیدی که دستی، با AI یا هنگام راه‌اندازی فروشگاه ساخته می‌شوند.",
      },
      Coupon: {
        title: "کوپن",
        description:
          "کوپن‌های جدیدی که دستی، با AI یا هنگام راه‌اندازی فروشگاه ساخته می‌شوند.",
      },
      Offer: {
        title: "آفر",
        description: "آفرهای تبلیغاتی جدید برای محصولات یا سبدها.",
      },
      Lottery: {
        title: "لاتاری",
        description: "مشوق‌های لاتاری جدیدی که برای این فروشگاه ساخته می‌شوند.",
      },
      Campaign: {
        title: "کمپین",
        description: "کمپین‌های بازاریابی جدید این فروشگاه.",
      },
      Affiliate: {
        title: "افیلیت",
        description:
          "برنامه‌های افیلیت جدید؛ اتصال دامنه اختیاری بخشی از همان ساخت است.",
      },
      EmailMarketing: {
        title: "ایمیل مارکتینگ",
        description: "کمپین‌های ایمیل مارکتینگ جدید این فروشگاه.",
      },
      Courier: {
        title: "پیک",
        description: "اتصال پیک جدید. ویرایش پیک موجود محاسبه نمی‌شود.",
      },
      Page: {
        title: "صفحه",
        description:
          "صفحه‌های جدید ویترین که دستی، با ابزارهای MCP یا هنگام راه‌اندازی و کلون ساخته می‌شوند.",
      },
      Popup: {
        title: "پاپ‌آپ",
        description: "پاپ‌آپ‌های جدیدی که برای ویترین فروشگاه ساخته می‌شوند.",
      },
      Customer: {
        title: "مشتری",
        description:
          "مشتری‌های جدیدی که فروشنده دستی، گروهی، با ایمپورت، اینتگریشن یا جریان گیفت‌کارت می‌سازد. ثبت‌نام مستقیم خریدار محاسبه نمی‌شود.",
      },
      CommunityPost: {
        title: "پست کامیونیتی",
        description:
          "پست‌های جدید در کامیونیتی همین فروشگاه. پست‌های کامیونیتی عمومی سلدان محاسبه نمی‌شوند.",
      },
      CommunityComment: {
        title: "کامنت کامیونیتی",
        description:
          "کامنت‌های جدید در کامیونیتی همین فروشگاه. کامنت‌های کامیونیتی عمومی سلدان محاسبه نمی‌شوند.",
      },
      OnlineOrder: {
        title: "سفارش آنلاین",
        description:
          "سفارش‌های آنلاین، آووکادو، هایپر و اشتراک وقتی برای نخستین بار Reserved یا COD می‌شوند محاسبه می‌شوند.",
      },
      POSOrder: {
        title: "سفارش POS",
        description:
          "سفارش‌های فروش حضوری وقتی برای نخستین بار از Open به Reserved یا COD می‌روند محاسبه می‌شوند.",
      },
      Blog: {
        title: "پست بلاگ",
        description:
          "پست‌های بلاگ جدید، از جمله کلون‌های اولیه. ویرایش پست موجود محاسبه نمی‌شود.",
      },
      AITokens: {
        title: "توکن‌های AI",
        description:
          "مصرف تجمیعی AI: توکن گزارش‌شده برای سرویس‌های پشتیبانی‌شده، به‌علاوه واحد قدیمی ترجمه AI.",
      },
      BgRemove: {
        title: "حذف پس‌زمینه با AI",
        description:
          "حذف پس‌زمینه با سرویس ارائه‌دهنده. نتیجه‌ای که از کش خوانده شود سهمیه مصرف نمی‌کند.",
      },
      Vendor: {
        title: "وندور",
        description:
          "وندور واقعاً جدیدی که دستی، با ایمپورت یا درخواست وندور ساخته می‌شود. ردیف وندور موجود محاسبه نمی‌شود.",
      },
    },
  },
  app_card: {
  ...
  product_status: {
    ...
    unlisted: {
      ...
      title: "غیر فهرست شده",
      description:
        "این محصول در فروشگاه فهرست نشده است، اما از طریق لینک مستقیم قابل دسترسی است.",
    },
  },
  ...
  shop_connect: {
    ...
    products: {
      title: "محصولات",
      subtitle:
        "لیست محصولات اضافه‌شده از <b>{name}</b>. مطمئن شوید محصول شما <b>نام و شناسه (SKU) منحصربه‌فرد</b> دارد. برخی از سرویس‌های Connect برای مهاجرت استفاده می‌شوند؛ بنابراین اگر محصولاتی با شناسه‌های تکراری داشته باشید، ممکن است هنگام همگام‌سازی به مشکل بخورید.",
    ...
    edit: {
      ...
      migration_tips:
        "<b>نکات: </b>اگر می‌خواهید عملکرد را تست کنید، گزینه <b>محدود</b> را انتخاب کنید. با انتخاب 'همگام‌سازی همه'، تمام داده‌ها را از خدمات متصل شما دریافت " +
        "می‌کنیم و تصاویر مرتبط را دانلود می‌کنیم، بنابراین فضای ذخیره‌سازی رایگان شما کاهش می‌یابد. همچنین، حذف بسیاری از محصولات، دسته‌ها، و مشتریان دشوار خواهد بود!",
  ...
  shop_logistic_includes: {
    ...
    delete_dialog: {
      ...
      message:
        "آیا مطمئن هستید که می خواهید این مورد را برای همیشه حذف کنید؟ لطفاً توجه داشته باشید که از تمام محصولات مرتبط نیز حذف خواهد شد!",
      action: "بله، اکنون حذف کن",
    },
    actions: {
  ...
  include_item_add: {
    ...
    mode: {
      ...
      external_link: {
        ...
        tips: "می توانید هر URL را به آیتم پیوست کنید. هنگامی که کاربران روی کالای موجود در صفحه محصول کلیک می کنند، به آن لینک هدایت می شوند.",
      },
      internal_link: {
        title: "لینک داخلی",
        description:
  ...
  shop_logistic_property_set: {
    ...
    subtitle:
      "در اینجا می‌توانید مجموعه‌های خصوصیت را ایجاد و مدیریت کنید. مجموعه‌های خصوصیت برای تعریف خصوصیات محصولات و خدمات استفاده می‌شوند. شما می‌توانید این مجموعه‌ها را در داشبورد محصول > ویرایش به محصولات اختصاص دهید.",
  },
  ...
  product_property_set: {
    profile: {
      ...
      subtitle:
        "شما می‌توانید نام‌های تنوع این محصول را سفارشی کنید و جایگزین موارد پیش‌فرض کنید.",
    },
   ...
   */
  transportation_boxes_input: {
    select_box: "انتخاب بسته",
    define_package: "تعریف بسته",
    define_package_hint:
      "اندازه‌های بسته‌بندی از پیش تعریف‌شده خود را ایجاد یا ویرایش کنید",
  },
  listing: {
    name: "لیستینگ",
    message:
      "یک دایرکتوری قابل جستجو و قابل نظارت برای هر نوع لیستینگ بسازید؛ املاک، هتل‌ها، پزشکان، خدمات و موارد بیشتر.",
  },
  shop_listing: {
    name: "لیستینگ",
    message:
    ...
    items: {
      title: "آیتم‌ها",
      sub_title:
        "آیتم‌های لیستینگ را ایجاد، ویرایش و مدیریت کنید. وضعیت، قیمت‌گذاری، اطلاعات تماس و رسانه‌ها را کنترل کنید.",
      empty_title: "هنوز آیتمی وجود ندارد",
      empty_subtitle:
        "اولین آیتم لیستینگ را بسازید تا ساخت دایرکتوری خود را شروع کنید.",
      add_title: "افزودن آیتم",
      edit_title: "ویرایش آیتم",
      price_to: "قیمت تا",
      price_unit: "واحد قیمت",
    ...
    categories: {
      title: "دسته‌بندی‌ها",
      sub_title:
        "دایرکتوری خود را با دسته‌بندی‌ها و زیردسته‌ها سازمان‌دهی کنید. این کار مسیریابی و فیلترکردن را بهتر می‌کند.",
      empty_title: "هنوز دسته‌بندی‌ای وجود ندارد",
      empty_subtitle:
        "برای ساختاردهی به لیستینگ و بهبود مرور، دسته‌بندی ایجاد کنید.",
      add_title: "افزودن دسته‌بندی",
      edit_title: "ویرایش دسته‌بندی",
      parent_filter: "فیلتر بر اساس والد",
      parent: "دسته‌بندی والد",
      price_format: "فرمت قیمت",
      icon: "آیکون",
      design_id: "شناسه طراحی",
      delete_title: "حذف دسته‌بندی",
      delete_message: "آیا مطمئن هستید که می‌خواهید این دسته‌بندی را حذف کنید؟",
      delete_success: "دسته‌بندی با موفقیت حذف شد.",
      form_schema: "فیلدهای فرم دسته‌بندی",
    },
    options: {
      submission_title: "ارسال",
      submission_enabled: "فعال‌سازی ارسال‌ها",
      moderation_title: "نظارت",
      moderation_mode: "حالت نظارت",
      require_first_approved_before_more:
        "نیاز به تأیید اولین مورد پیش از ارسال موارد بیشتر",
      limits_title: "محدودیت‌ها",
      max_pending_per_user: "حداکثر موارد در انتظار برای هر کاربر",
      max_items_per_user: "حداکثر آیتم‌ها برای هر کاربر",
      limits_hint: "راهنمای محدودیت‌ها",
      templates_title: "قالب‌ها",
      card_template: "قالب کارت",
      details_template: "قالب جزئیات",
      form_schema_title: "شِمای فرم",
      settings_title: "تنظیمات اضافی",
    },
    supervision: {
      title: "نظارت",
      sub_title:
        "آیتم‌های ارسال‌شده را بررسی کنید و تصمیم بگیرید چه اتفاقی بیفتد: تأیید، انتشار، رد، آرشیو یا بازگردانی به حالت در انتظار.",
      empty_title: "آیتمی برای بررسی وجود ندارد",
      empty_subtitle:
        "وقتی کاربران آیتم جدیدی ارسال کنند، برای نظارت در اینجا نمایش داده می‌شود.",
      review_title: "بررسی آیتم",
      approve_publish: "تأیید و انتشار",
      submitted_at: "ارسال‌شده",
      quick_actions: "اقدام‌های سریع",
      open_review: "بازکردن بررسی",
      reset_to_pending: "بازگردانی به در انتظار",
      items_title: "آیتم‌ها",
    },
    moderation: {
      approve_success: "آیتم با موفقیت تأیید شد.",
      publish_success: "آیتم با موفقیت منتشر شد.",
      unpublish_success: "آیتم با موفقیت از انتشار خارج شد.",
      archive_success: "آیتم با موفقیت آرشیو شد.",
      reject_success: "آیتم با موفقیت رد شد.",
    ...
    media: {
      ...
      url_type: "نوع",
      url: "URL",
      is_main: "تنظیم به‌عنوان اصلی",
    },
    designs: {
      title: "طراحی‌ها",
      sub_title:
        "چند مجموعه طراحی بسازید (قالب کارت و جزئیات) و آن‌ها را به دسته‌بندی‌ها اختصاص دهید. دسته‌بندی‌ها می‌توانند طراحی‌های متفاوتی داشته باشند.",
      empty_title: "هنوز طراحی‌ای وجود ندارد",
      empty_subtitle:
        "اولین مجموعه طراحی خود را اضافه کنید تا سفارشی‌سازی ظاهر دسته‌بندی‌ها را شروع کنید.",
      add_title: "افزودن طراحی",
      edit_title: "ویرایش طراحی",
      card_template: "قالب کارت",
      details_template: "قالب جزئیات",
      notifications: {
        add_success: "طراحی با موفقیت ایجاد شد.",
        edit_success: "طراحی با موفقیت به‌روزرسانی شد.",
        delete_success: "طراحی با موفقیت حذف شد.",
      },
      delete_title: "حذف طراحی",
      delete_message:
        "این طراحی حذف شود؟ دسته‌بندی‌هایی که از آن استفاده می‌کنند به‌صورت خودکار design_id خود را از دست می‌دهند.",
    },
    badges: {
      title: "نشان‌ها",
      sub_title:
        "نشان‌های ویترین را ایجاد و مدیریت کنید. نشان‌ها می‌توانند به آیتم‌های لیستینگ اختصاص داده شوند تا ویژگی‌های خاص را برجسته کنند.",
      empty_title: "هنوز نشانی وجود ندارد",
      empty_subtitle:
        "اولین نشان خود را اضافه کنید تا برجسته‌سازی آیتم‌های لیستینگ را شروع کنید.",
      add_title: "افزودن نشان",
      edit_title: "ویرایش نشان",
      notifications: {
        add_success: "نشان با موفقیت ایجاد شد.",
        edit_success: "نشان با موفقیت به‌روزرسانی شد.",
        delete_success: "نشان با موفقیت حذف شد.",
      },
      delete_title: "حذف نشان",
      delete_message: "آیا مطمئن هستید که می‌خواهید این نشان را حذف کنید؟",
    },
    companies: {
      title: "شرکت‌ها",
      sub_title:
        "شرکت‌ها را ایجاد و مدیریت کنید. هر آیتم لیستینگ می‌تواند به‌صورت اختیاری به یک شرکت متصل شود.",
      empty_title: "هنوز شرکتی وجود ندارد",
      empty_subtitle:
        "اولین شرکت خود را اضافه کنید تا آن را به آیتم‌های لیستینگ متصل کنید.",
      add_title: "افزودن شرکت",
      edit_title: "ویرایش شرکت",
      notifications: {
        add_success: "شرکت با موفقیت ایجاد شد.",
        edit_success: "شرکت با موفقیت به‌روزرسانی شد.",
        delete_success: "شرکت با موفقیت حذف شد.",
      },
      delete_title: "حذف شرکت",
      delete_message:
        "این شرکت حذف شود؟ آیتم‌هایی که از آن استفاده می‌کنند به‌صورت خودکار لینک شرکت را از دست می‌دهند.",
    },
    messages: {
      title: "پیام‌ها",
      sub_title:
        "پیام‌های ارسال‌شده توسط کاربران از پروفایل‌های لیستینگ را مدیریت کنید.",
      empty_title: "پیامی وجود ندارد",
      empty_subtitle:
        "پیام‌های ارسال‌شده توسط کاربران در اینجا نمایش داده می‌شوند.",
      sender: "فرستنده",
      item: "آیتم",
      has_reply: "پاسخ",
      has_reply_yes: "پاسخ دارد",
      has_reply_no: "بدون پاسخ",
      dialog_title: "پیام",
      owner_reply: "پاسخ مالک",
      reply: "پاسخ",
      reply_hint:
        "یک پاسخ برای کاربر بنویسید. همچنین می‌توانید از بخش اقدام‌ها پیام را خوانده‌شده یا اسپم علامت‌گذاری کنید.",
      mark_read: "علامت‌گذاری به‌عنوان خوانده‌شده",
      mark_unread: "علامت‌گذاری به‌عنوان خوانده‌نشده",
      archive: "آرشیو",
      unarchive: "خروج از آرشیو",
      mark_spam: "علامت‌گذاری به‌عنوان اسپم",
      mark_not_spam: "اسپم نیست",
      delete_confirm: "این پیام حذف شود؟",
    },
    enable: {
      title: "لیستینگ",
      subtitle:
        "صفحه عمومی لیستینگ خود را فعال یا غیرفعال کنید. هنگام اولین فعال‌سازی، سلدان پیکربندی لیستینگ را به‌صورت خودکار ایجاد می‌کند.",
      true_description:
        "لیستینگ فعال است. مشتریان می‌توانند صفحه‌های لیستینگ را مرور کنند.",
      false_description:
        "لیستینگ غیرفعال است. صفحه‌های لیستینگ و ارسال‌ها مسدود هستند.",
      open_listing: "بازکردن لیستینگ",
      note: "بعداً می‌توانید نظارت، محدودیت‌ها، فرم‌ها و طراحی را در تنظیمات لیستینگ پیکربندی کنید.",
      vendor_prereq_text:
        "می‌خواهید فروشندگان از پنل فروشنده آیتم‌های لیستینگ اضافه کنند؟ ابتدا مدل کسب‌وکار خود را به Marketplace تغییر دهید.",
      vendor_prereq_button: "تنظیم مدل کسب‌وکار Marketplace",
      vendor_access_text:
        "اکنون می‌توانید تعیین کنید فروشندگان به قابلیت‌های لیستینگ (آیتم‌ها و شرکت‌ها) دسترسی داشته باشند یا نه. آن را در تنظیمات Marketplace فعال کنید.",
      vendor_access_button: "فعال‌سازی لیستینگ برای فروشندگان",
      more_options_text:
        "کنترل‌های بیشتری در تنظیمات لیستینگ در دسترس است. می‌توانید ورودی‌ها، رابط کاربری/ظاهر، نظارت، محدودیت‌ها و گزینه‌های درآمدزایی را پیکربندی کنید.",
      more_options_button: "رفتن به تنظیمات لیستینگ",
      updated: "لیستینگ به‌روزرسانی شد.",
      update_failed: "به‌روزرسانی لیستینگ ناموفق بود.",
    },
    search: {
      title: "تنظیمات جستجو",
      subtitle:
        "نحوه جستجوی مشتریان در لیستینگ را طراحی کنید. جستجوی مبتنی بر موقعیت را فعال کنید و از فیلدهای فرم سفارشی خود فیلتر بسازید.",
      location_title: "جستجوی موقعیت",
      location_subtitle:
        "به مشتریان اجازه دهید یک موقعیت انتخاب کنند و نتایج نزدیک را در شعاع قابل تنظیم پیدا کنند.",
      location_enabled_true:
        "فیلتر موقعیت فعال است. مشتریان می‌توانند بر اساس فاصله جستجو کنند.",
      location_enabled_false:
        "فیلتر موقعیت غیرفعال است. نتایج بر اساس فاصله فیلتر نمی‌شوند.",
      radius_default: "شعاع پیش‌فرض (کیلومتر)",
      radius_default_hint:
        "وقتی مشتری موقعیت را انتخاب کرده اما شعاعی انتخاب نکرده است استفاده می‌شود.",
      radius_max: "حداکثر شعاع (کیلومتر)",
      radius_max_hint: "شعاع ویترین به این مقدار محدود می‌شود.",
      radius_options: "گزینه‌های شعاع (کیلومتر)",
      radius_options_hint:
        "این مقادیر می‌توانند به‌عنوان گزینه‌های سریع در رابط ویترین نمایش داده شوند.",
      filters_title: "فیلترهای جستجو",
      filters_subtitle:
        "فیلترهایی اضافه کنید که مقدارها را از فیلدهای متای آیتم می‌خوانند (فیلدهای فرم لیستینگ/دسته‌بندی شما). از تولید خودکار برای جمع‌آوری گزینه‌های واقعی از آیتم‌های منتشرشده استفاده کنید.",
      no_filters: "هنوز فیلتری اضافه نشده است.",
      auto_generate: "تولید خودکار گزینه‌ها",
      filter_field: "کلید فیلد",
      filter_label: "برچسب",
      filter_type: "نوع",
      filter_options: "گزینه‌ها",
      filter_options_hint:
        "برای فیلترهای انتخابی، گزینه‌ها می‌توانند دستی یا تولیدشده باشند.",
      multiple: "چندتایی",
      single: "تکی",
      kv_mode: "حالت کلید/مقدار",
      requires_listing_active:
        "لیستینگ فعال نیست. ابتدا لیستینگ را فعال کنید تا بتوانید از آن در ویترین استفاده کنید.",
    },
  },
  suggestions: {
    /**
    ...
    shop_email: {
      ...
      subject: [
        "⏰ پیشنهاد محدود! محبوب‌های خود را همین حالا بگیرید",
        "🌼 فصل جدید، استایل‌های جدید - جدیدترین کالکشن ما را ببینید",
        "👑 فروش ویژه VIP فقط برای شما",
        "💃 با تازه‌واردهای ما بدرخشید",
        "🔚 آخرین فرصت برای استفاده از 20٪ تخفیف روی همه‌چیز",
        "🎁 هدیه‌ای برای شما: 10 دلار اعتبار داخل حساب!",
        "☀️ با پیشنهادهای داغ ما برای تابستان آماده شوید",
        "🛍️ کمد لباس خود را ارتقا دهید - حق شماست",
        "👀 پیش‌نمایش: محصولات جدید به‌زودی می‌آیند!",
        "🎂 تولدت مبارک! هدیه ویژه‌ات منتظر توست",
        "🖤 برای تخفیف‌های بلک فرایدی آماده‌اید؟",
        "🎯 انتخاب‌های ویژه برای شما - تجربه خرید شخصی‌سازی‌شده",
        "🍹 وقت رسیدگی به خودتان است - فروش فوری آخر هفته!",
        "🧹 حراج پایان فصل - همه‌چیز باید فروخته شود!",
        "🚀 شایسته‌اش هستید! ارسال رایگان برای سفارش بعدی شما",
        "📢 از دست ندهید - آیتم‌های لیست علاقه‌مندی شما اکنون حراج شده‌اند",
        "🏡 با کالکشن دکوراسیون خانه ما شادی را به خانه بیاورید",
        "🎉 یک سورپرایز فقط برای شما! تخفیف مرموز خود را باز کنید",
      ],
    },
    ...
    offer: {
      ...
      description: [
        "وقتی محصولات انتخابی را دسته بندی می کنید، پس انداز زیادی کسب کنید. عجله کنید، پیشنهاد زمان محدود!",
        "معاملات هوشمند در انتظار! هنگام خرید اقلام برجسته ما با هم بیشتر صرفه جویی کنید.",
        "کشف راه هوشمند برای صرفه جویی! موارد دلخواه خود را بسته بندی کنید و کاهش قیمت را تماشا کنید.",
        "هنگام خرید اقلام انتخابی به صورت ترکیبی از تخفیف های منحصر به فرد برخوردار شوید. همین الان اقدام کن",
        "بیشتر بخرید، بیشتر پس انداز کنید! تخفیف های بی نظیر در بسته های محصولات ویژه ما.",
        "با پیشنهادات ویژه ما هوشمندانه خرید کنید. قیمت های تخفیفی در بسته های منتخب محصول.",
        "با قیمت کمتر بیشتر دریافت کنید! با خرید بسته های منتخب ما، تخفیف های شگفت انگیزی به شما ارائه می شود.",
        "هنگام بسته‌بندی، صرفه‌جویی زیادی کنید! معاملات انحصاری در مورد موارد منتخب برای مدت زمان محدود.",
        "ترکیب کنید و ذخیره کنید! با خرید یکجا محصولات منتخب ما با تخفیف استثنایی.",
        "هر چه بیشتر بخرید، بیشتر پس انداز می کنید! با بسته های ویژه ما هوشمند شوید.",
      ],
    },
