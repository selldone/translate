...
export default {
  ...
  add_product: {
    ...
    edit_spec: {
      ...
      title: "مشخصات فنی",
      subtitle: "مشخصات محصول را در اینجا وارد کنید. این اطلاعات به مشتریان نمایش داده خواهد شد و همچنین می‌تواند در سیستم فیلتر هوشمند دسته‌بندی استفاده شود.",
      manual: {
        title: 'به صورت دستی',
        subtitle: "به کمک این گزینه می توانید مشخصات کالای دیگر را برای این کالا وارد نمایید.",
      ...
      ai: {
        title: 'هوش مصنوعی',
        subtitle: "می‌توانید با ارسال داده‌های خام محصول به صورت متنی، مشخصات محصول را به طور خودکار ایجاد کنید.",
        action_title: 'ایجاد خودکار توسط هوش مصنوعی',
        action_subtitle: "مشخصات محصول را با استفاده از درخواست انتزاعی ایجاد کنید.",
      },
