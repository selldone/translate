...
export default {
  ...
  admin_shop: {
    ...
    logistic: {
      ...
      restriction: {
        ...
        subtitle: "شما می‌توانید محدودیت‌هایی اعمال کنید تا فقط مشتریانی که در مناطق تعیین‌شده حمل و نقل هستند بتوانند از شما خرید کنند!",
        no_enable_shipping_error: "هیچ‌کس نمی‌تواند از شما خرید کند زیرا هیچ روش حمل و نقل فعالی ندارید!",
        customer_must_select_a_shipping_msg: "مشتری باید برای ثبت سفارش یک روش حمل و نقل را انتخاب کند.",
        customer_can_order_without_shipping_method_msg: "مشتری می‌تواند سفارش را ثبت کند حتی اگر برای مکان انتخابی هیچ روش حمل و نقلی پشتیبانی نشود.",
        inputs: {
          restriction: {
            false_description: "مشتریان همچنان می‌توانند سفارش ثبت کنند حتی اگر روش حمل و نقل خاصی انتخاب نشده باشد.",
            false_title: "پذیرش همه سفارش‌ها",
            true_title: "پذیرش محدود سفارش",
            true_description: "مشتریان باید برای تکمیل خرید خود یک گزینه حمل و نقل یا دریافت حضوری را انتخاب کنند."
          }
        }
      },
      ...
      no_multi_warehouse_support_message: "برای ساده‌سازی، این ویژگی در فروشگاه‌های معمولی در دسترس نیست.",
  ...
  bulk_price_dialog: {
    ...
    check_description:"قیمت برای دسته‌بندی انتخاب شده و تمام زیرمجموعه‌های آن تغییر خواهد کرد.",
    ...
    marketplace:{
      ...
      subtitle:"این گزینه به شما امکان می‌دهد قیمت فهرست‌بندی محصولات را در بازار به‌صورت خودکار به‌روزرسانی کنید. گاهی اوقات، قیمت اصلی محصول ممکن است به دلیل تغییرات دستی قیمت با قیمت فروشنده هماهنگ نباشد.",
      strategy:{
        min:{
          title:'تنظیم قیمت حداقل',
          description: 'قیمت حداقل محصول را به عنوان قیمت فهرست‌بندی تنظیم کنید.',
        },
        max:{
    ...
    vendor:{
      subtitle:"محدود کردن اقدامات عمده به یک فروشنده خاص. وقتی یک فروشنده انتخاب شود، به‌روزرسانی قیمت برای محصولات آن فروشنده اعمال می‌شود، که قیمت فروش برای آن فروشنده را نشان می‌دهد.",
      listing_price_need_update_msg:"اگر می‌خواهید قیمت فهرست‌بندی (قیمتی که در فهرست محصولات نمایش داده می‌شود) را به‌روزرسانی کنید، باید به‌روزرسانی عمده را با همان فیلترها ولی بدون انتخاب فروشنده دوباره ارسال کنید."
    },
  ...
  referral_bank: {
    title: "داشبورد ارجاع",
    subtitle:"با درخواست شما، کارمزد کمیسیون به حساب بانکی که مشخص کرده‌اید پرداخت می‌شود. لطفاً اطلاعات بانکی خود را در اینجا وارد کنید.",
    ...
    bank_dialog:{
      ...
      info:{
        title:"بانک",
        subtitle:"لطفاً اطلاعات بانکی خود را در اینجا وارد کنید. ما از این اطلاعات برای انتقال وجه استفاده خواهیم کرد. اطمینان حاصل کنید که حساب بانکی به نام شما یا نام کسب و کار شما، در صورت لزوم، باشد."
      },
      inputs:{
        name:{
          label:"نام بانک",
        ...
        routing_number:{
          ...
          message:"شماره‌ای که شعبه بانک خاصی را شناسایی می‌کند (اصطلاحات مختلف در کشورهای مختلف استفاده می‌شود)."
        },
        swift:{
          label:"کد SWIFT/BIC",
          message:"کدی بین‌المللی که برای شناسایی بانک‌ها در سطح جهانی استفاده می‌شود، به‌ویژه برای انتقالات بین‌المللی."
        },
        iban:{
          label:"شماره حساب بانکی بین‌المللی (IBAN)",
          message:"این شماره عمدتاً در اروپا استفاده می‌شود و سیستم مورد توافق بین‌المللی برای شناسایی حساب‌های بانکی در مرزهای ملی است."
        },
        contact:{
          label:"اطلاعات تماس",
   ...
   */
  referral_tier: {
    message:"از تمام هزینه‌های خدمات، اشتراک و سایر پرداخت‌هایی که توسط ارجاعات شما انجام شده است."
  },
  ...
  selldone_referral_payment: {
    title: "برداشت‌ها",
    subtitle: "این لیست تراکنش‌های برداشت است. هنگامی که مبلغی را از کیف پول ارجاع خود به حساب بانکی یا کیف پول سلدان منتقل می‌کنید، در اینجا فهرست می‌شود.",
  ...
  shop_logistic_includes: {
    ...
    add_caption: "افزودن آیتم جدید",
    subtitle: "در اینجا می‌توانید اقلام موجود در محصولات خود را مدیریت کنید. برای داشتن ظاهری بی‌نقص در فروشگاه خود، همیشه از آیتم‌هایی با الگوی تصویری مشابه، مانند فریم‌های سیمی، در تمام محصولات استفاده کنید.",
    ...
    delete_dialog: {
      ...
      message: "آیا مطمئن هستید که می‌خواهید این آیتم را به‌طور دائم حذف کنید؟ لطفاً توجه داشته باشید که این آیتم همچنین از تمام محصولات مرتبط نیز حذف خواهد شد!",
      action: "بله، اکنون حذف کن",
    },
    actions:{
  ...
  include_item_add: {
    ...
    title: 'آیتم موجود',
    subtitle: "یک عنوان کوتاه انتخاب کنید، ایده‌آل با 2 تا 3 کلمه. از تصاویر مربعی استفاده کنید، زیرا ما تصاویر آپلود شده را به صورت خودکار به قالب مربعی 256x256 تغییر اندازه می‌دهیم. برای بهترین ظاهر در تمامی قالب‌ها، از تصاویر مینیمالیستی با پس‌زمینه شفاف استفاده کنید و الگوی یکنواختی را در تمام محصولات خود حفظ کنید.",
    inputs: {
      title: {
    ...
    mode: {
      ...
      internal_link: {
        title: 'لینک داخلی',
        description: 'ایجاد صفحه دینامیک با استفاده از داده‌های تکمیلی برای این آیتم.',
  ...
  shop_logistic_returns: {
    ...
    subtitle: "مشتریان شما می‌توانند سفارشات فیزیکی خود را مرجوع کنند، و شما می‌توانید درخواست‌های مرجوعی را در صفحه پردازش سفارشات مشاهده کنید یا به لیست کامل سفارشات مرجوعی در اینجا دسترسی پیدا کنید."
  },
  ...
  referral_fees: {
    title:"کمیسیون‌ها",
    subtitle:"لیست تمام کمیسیون‌هایی که از ارجاعات خود کسب کرده‌اید. تا 30 روز طول می‌کشد تا کمیسیون تأیید شود و به کیف پول شما منتقل شود.",
  },
  ...
  referral_wallets: {
    title:'کیف پول‌ها',
    subtitle:"در اینجا می‌توانید کارمزدهای کمیسیونی که کسب کرده‌اید را مشاهده کنید. می‌توانید کارمزدهای کمیسیون خود را به حساب بانکی یا کیف پول سلدان خود منتقل کنید.",
    ...
    withdraw_dialog:{
      ...
      to_wallet:{
        title:"به کیف پول",
        subtitle:"با این گزینه، می‌توانید کارمزدهای کمیسیون خود را به کیف پول سلدان خود منتقل کنید. لطفاً مطمئن شوید که کیف پولی به عنوان کیف پول هدیه متصل است و با همان ارز عمل می‌کند."
      },
      to_bank:{
        title:"به بانک",
        subtitle:"با این گزینه، می‌توانید کارمزدهای کمیسیون خود را به حساب بانکی خود منتقل کنید. لطفاً مطمئن شوید که اطلاعات بانکی شما به‌درستی وارد شده است.",

      },
      inputs:{
        verify_to_wallet:{
          true_description:"می‌خواهم کارمزد کمیسیون خود را به کیف پول سلدان خود منتقل کنم."
        },
        verify_to_bank:{
          true_description:"اطلاعات بانکی خود را تأیید می‌کنم و می‌خواهم کارمزد کمیسیون خود را به حساب بانکی خود منتقل کنم."
        }
      },
      actions:{
    ...
    notifications:{
      request_transfer_to_bank_success:"درخواست شما با موفقیت دریافت شد و ما آن را بررسی خواهیم کرد."
    }
  },
  ...
  monetize_referral: {
    ...
    intro:{
      ...
      message:"برنامه همکاری در فروش سلدان ساده و سرراست است و برای شما طراحی شده تا به راحتی کسب درآمد کنید. لینک همکاری خود را به اشتراک بگذارید تا کاربران جدید را به سلدان دعوت کنید، و شما از هر تراکنشی که انجام می‌دهند، برای همیشه کمیسیون دریافت خواهید کرد. این شامل درآمد از اشتراک‌ها، کارمزد خدمات، ارتقاء فروشگاه و تمامی منابع درآمدی دیگر می‌شود. بدون هیچ محدودیتی در زمان یا درآمد، سهم خود را از درآمد شروع کنید. به ما بپیوندید و شبکه خود را به یک منبع درآمد پایدار تبدیل کنید!",
