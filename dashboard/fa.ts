...
export default {
  ...
  b_shop_theme_vendor: {
    onboarding: {
      title: 'آغاز و ورود',
      subtitle: 'تجربه آغاز و ورود فروشنده را با ویدئو، تصویر یا پیام سفارشی شخصی‌سازی کنید.'
    },
    inputs: {
      page_vendor_login: {
        label: 'صفحه ورود فروشنده',
        message: 'یک صفحه فرود سفارشی برای ورود فروشنده انتخاب کنید. برای طراحی منحصر به فرد، ویدئو، تصاویر یا متن را اضافه کنید. این صفحه به فروشندگانی که وارد نشده‌اند نمایش داده می‌شود.'
      },
      page_vendor_registered: {
        label: 'صفحه فروشنده وارد شده',
        message: 'یک صفحه سفارشی برای فروشندگانی که وارد شده‌اند انتخاب کنید. این صفحه در صورتی نمایش داده می‌شود که بازار شما از چند فروشنده برای هر کاربر پشتیبانی می‌کند.'
      }
    }
  },
  ...
  b_shop_options_variants: {
    custom_variants: {
      title: 'انواع سفارشی',
      subtitle: 'محصولات فیزیکی می‌توانند انواع مختلفی داشته باشند. شما می‌توانید نام پیش‌فرض انواع را تغییر دهید. پیشنهاد ما این است که این موارد را به صورت پیش‌فرض و خالی رها کنید تا سلدان به طور خودکار آن‌ها را برای مشتریان شما به زبان‌های آن‌ها ترجمه کند. حداکثر طول ۲۴ کاراکتر است.'
    }
  },
  ...
  b_shop_theme_header: {
    logo: {
      title: "لوگوی هدر",
      subtitle: "لوگوی فروشگاه شما به طور پیش‌فرض در هدر نمایش داده می‌شود. می‌توانید لوگوی سفارشی خود را بارگذاری کنید. اگر لوگوی شما نسبت ابعادی مربعی ندارد، ممکن است نیاز به تنظیم دستی ارتفاع و عرض آن برای نمایش بهینه باشد."
    },
    header_title: {
      title: "عنوان هدر",
      subtitle: "عنوان نمایش داده شده در هدر صفحات خود را در اینجا شخصی‌سازی کنید. برای حذف کامل آن، روی دکمه 'تنظیم عنوان خالی' کلیک کنید."
    },
  ...
  product_status: {
    ...
    unlisted: {
      name: "غیر فهرست شده",
      title: "غیر فهرست شده",
      description: "این محصول در فروشگاه فهرست نشده است، اما از طریق لینک مستقیم قابل دسترسی است.",
    }
