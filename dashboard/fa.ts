...
export default {
  ...
  add_product: {
    ...
    edit_spec: {
      ...
      ai: {
        ...
        action_subtitle:
          "مشخصات محصول را با کمی توضیحات ایجاد کنید.",
      },
      ...
      dialog_ai: {
        ...
        prompt: {
          ...
          subtitle: "لطفاً یک توضیح مختصر و واضح از محصول ارائه دهید، با تأکید بر ویژگی‌ها و جزئیات کلیدی آن. از این اطلاعات برای تولید خودکار مشخصات محصول استفاده خواهد شد."
        },
        generated_spec: {
        ...
        actions: {
          run: {
            title: "تولید مشخصات",
            subtitle: "برای ایجاد خودکار مشخصات محصول از نمای کلی ارائه‌شده کلیک کنید."
          },
  ...
  vendor_add: {
    ...
    page: {
      title: "صفحه سفارشی",
      subtitle: "یک صفحه فرود سفارشی برای فروشنده تنظیم کنید و یک لینک منحصر به فرد برای صفحه اختصاصی آن‌ها فراهم کنید.",
      ...
      we_can_create_dedicated_landing_msg: "ما می‌توانیم یک صفحه فرود اختصاصی برای شما ایجاد کنیم."
    },
    contact: {
      title: "اطلاعات تماس",
    ...
    business: {
      ...
      subtitle: "لطفاً اطلاعات دقیقی در مورد کسب‌وکار خود ارائه دهید تا فرایند جمع‌آوری درآمد به صورت سریع و روان انجام شود."
    },
    bank: {
    ...
    default_pricing: {
      ...
      subtitle: "شما می‌توانید یک مدل قیمت‌گذاری پیش‌فرض برای فروشنده تعیین کنید. هنگامی که فروشنده یک محصول جدید اضافه می‌کند، این مدل قیمت‌گذاری برای محاسبه حاشیه بازار بر روی قیمت محصول استفاده خواهد شد. شما می‌توانید بعداً مدل قیمت‌گذاری را برای هر محصول به صورت جداگانه تنظیم کنید.",
      no_pricing: "بدون قیمت‌گذاری"
    },
    shipping: {
      title: "حمل‌ونقل",
      subtitle: "فروشندگان می‌توانند خدمات حمل‌ونقل و پیک‌های خود را تنظیم کنند.",
    ...
    delete: {
      title: "حذف فروشنده",
      action: "حذف فروشنده",
      verify_description: "من می‌دانم که تمام روابط محصولات فروشنده حذف خواهد شد!",
      verify_title: "من می‌خواهم این فروشنده را حذف کنم."
    },
    send_invitation_tips: "ما یک ایمیل دعوت به این کاربر ارسال خواهیم کرد. اگر کاربر به عنوان فروشنده به فروشگاه شما بپیوندد، حساب کاربری او به طور خودکار به او اختصاص داده می‌شود.",
    only_marketplace_owner_can_edit_user: "فقط مالک بازار می‌تواند کاربر را ویرایش کند. اگر می‌خواهید مالک این فروشنده را تغییر دهید، می‌توانید درخواست خود را به ما ارسال کنید.",
    vendor_is_disable_msg: 'فروشنده غیرفعال است.',
    email_not_match_with_user_msg: "ایمیل وارد شده با ایمیل کاربر (<b>{user_name}:</b>{user_email}) مطابقت ندارد. آیا مطمئن هستید که می‌خواهید ایمیل‌ها را به <b>{email}</b> ارسال کنید؟",
    we_will_send_invitation_to_user_msg: "ما یک ایمیل دعوت به کاربر ارسال خواهیم کرد.",
    ...
    inputs: {
      ...
      email: {
        message: "این ایمیل تمام اعلان‌ها و به‌روزرسانی‌ها را دریافت خواهد کرد."
      },
      business: {
      ...
      enable: {
        ...
        true_description: 'آنها قادر خواهند بود محصولات خود را از طریق بازار شما بفروشند.'
      },
      access: {
        label: "پنل و دسترسی فروشنده",
        true_description: "فروشنده یک پنل اختصاصی برای به‌روزرسانی مقدار و قیمت دارد.",
  ...
  vendor_documents_list: {
    ...
    vendor_subtitle: "لطفاً اسناد لازم برای تأیید کسب‌وکار، مالکیت معنوی، و آدرس را بارگذاری کنید. ما به این اطلاعات نیاز داریم تا همکاری شما را تأیید کرده و دسترسی لازم را برای شما فراهم کنیم.",
    marketplace_subtitle: "فروشندگان می‌توانند اسنادی مانند تأیید کسب‌وکار، مالکیت معنوی و آدرس را برای تسهیل فرایند احراز هویت (KYC) خود ارسال کنند، تا بتوانید دسترسی مناسب را به آن‌ها ارائه دهید.",
    upload_dialog: {
      title: "بارگذاری سند",
      type: {
        title: 'نوع سند',
        subtitle: "لطفاً فقط اسناد لازم را بارگذاری کنید. از اشتراک‌گذاری هرگونه اسناد حاوی اطلاعات حساس خودداری کنید. ما درخواست اسنادی داریم که به صورت عمومی در دسترس هستند."
      }
    }
  },
  ...
  product_badges: {
    ...
    add_custom_badge: {
      title: 'نشان سفارشی',
      subtitle: "یک نشان سفارشی جدید به فروشگاه من اضافه کنید. تعداد نشان‌ها را کمتر از ۱۰ نگه دارید. نشان‌های بیشتر سرعت فروشگاه شما را کاهش می‌دهند.",
      ...
      inputs: {
        ...
        pattern: {
          label: "الگو",
          message: "این نشان را به صورت خودکار برای محصولاتی که این مقدار را در مشخصات خود دارند نشان دهید. پشتیبانی از Regex.",
      ...
      notifications: {
        ...
        item_not_found_error: "مورد یافت نشد! صفحه را تازه کنید یا با پشتیبانی تماس بگیرید."
      }
    }
  },
  ...
  product_tags: {
    ...
    inputs: {
      tags: {
        placeholder: "برچسب‌ها را اینجا بنویسید و اینتر را فشار دهید. مثلاً مجموعه جدید"
      }
    },
    notifications: {
  ...
  edit_gateway: {
    ...
    debug:{
      ...
      subtitle: "می‌توانید حالت اشکال‌زدایی را برای تست درگاه پرداخت فعال کنید."
    ...
    manual_input: {
      false_description: "وضعیت پرداخت به صورت خودکار از در انتظار به تأیید شده در سیستم ارائه‌دهنده پرداخت تغییر خواهد کرد.",
      false_title: "تأیید خودکار پرداخت",
      true_title: "نگه‌داشتن پرداخت‌ها و تأیید دستی",
      true_description: "پرداخت را در حالت تعلیق قرار دهید تا نیاز به تأیید دستی پرداخت‌ها برای تغییر وضعیت آنها از در انتظار به تأیید شده در سیستم ارائه‌دهنده پرداخت باشد."
    },

    delete_verify_input: {
      true_title: "می‌خواهم این روش پرداخت را حذف کنم.",
      true_description: "این روش پرداخت از فروشگاه حذف خواهد شد و برای مشتریان در دسترس نخواهد بود."
    },

    delete_alert: {
      title: "حذف روش پرداخت",
      message: "آیا مطمئن هستید که می‌خواهید این روش پرداخت را از فروشگاه خود حذف کنید؟",
    ...
    dialog: {
      ...
      discount: {
        ...
        mismatch_type_warning:
          "تخفیف‌ها را نمی‌توان به انواع دیگری غیر از نوع محصولات اصلی اعمال کرد، زیرا آیتم‌های منبع و هدف در سبدهای جداگانه قرار نمی‌گیرند.",
