...
export default {
  ...
  vendor_add: {
    ...
    order_information_email_to_email: "ما اطلاعات سفارش‌ها را به <b>{email}</b> ارسال خواهیم کرد.",

    set_a_user_for_the_vendor_first_msg: "ابتدا یک کاربر برای فروشنده تعیین کنید.",
  ...
  b_page_shop_finance_gateway: {
    ...
    add_gateway_dialog: {
      ...
      currency_step: {
        title: 'انتخاب ارز',
        subtitle: "تلاش کنید تعداد ارزهای موجود در فروشگاه خود را به حداقل برسانید — ایده‌آل کمتر از ۳ ارز. بیشتر درگاه‌های پرداخت توانایی پردازش تراکنش‌ها را در تقریباً هر ارزی دارند.",
        add_first_currency: {
      ...
      gateway_step: {
        ...
        subtitle: "لطفاً از میان روش‌های پرداخت موجود انتخاب کنید. پس از انتخاب درگاه، می‌توانید اطلاعات اتصال لازم را وارد کنید تا فروشگاه خود را مستقیماً به روش پرداخت مورد نظر خود متصل کنید."
      },
      ...
      request_add_new_gateway: {
        ...
        subtitle: "اگر ارائه‌دهنده پرداخت محلی شما در لیست نیست، به یکی از پلن‌های سالانه (از جمله پلن استارتاپ برای مقرون‌به‌صرفه بودن) اشتراک بگیرید و درخواست یکپارچه‌سازی کنید. ما در صورت ارائه حساب آزمایشی و مستندات، ظرف ۴۸ ساعت آن را تکمیل خواهیم کرد."
      },
      ...
      inputs: {
        ...
        manual: {
          ...
          true_description: "می‌توانید تنظیمات درگاه را به صورت دستی انجام دهید.",

          false_title: 'اتصال خودکار',
          false_description: 'سیستم به‌طور خودکار به درگاه متصل می‌شود اگر قبلاً یک درگاه پیکربندی شده داشته باشید.',
        }
      }
  ...
  vendor_member: {
    title: "اعضای تیم",
    subtitle: "این لیست کاربران است که به پنل فروشنده شما دسترسی دارند. شما می‌توانید اعضای جدید تیم را اضافه کرده و مجوزهای آن‌ها را در اینجا سفارشی کنید.",
  ...
  vendor_member_add: {
    ...
    member: {
      ...
      subtitle: "یک عضو جدید تیم اضافه کنید و مجوزهای آن‌ها را تنظیم کنید. برای تنظیم دسترسی خواندن/نوشتن روی هر مورد کلیک کنید. هر ردیف مربوط به یک سطح مجوز برای داشبورد اصلی فروشگاه است."
    },
    access: {
  ...
  order_vendor_payment: {
    ...
    automatic_payout_list: {
      subtitle: "این فهرستی از پرداخت‌های خودکار به حساب بانکی متصل شما است. لطفاً توجه داشته باشید که تنها پرداخت‌های خودکار در اینجا نمایش داده می‌شوند و پرداخت‌های دستی نمایش داده نخواهند شد."
    },
  ...
  b_order_chat_box: {
    title: 'اقدامات سریع',
    subtitle: "شما می‌توانید تنها با یک کلیک ایمیل به‌روزرسانی وضعیت را به خریدار ارسال کنید. همچنین می‌توانید پیام‌های رایج را اینجا تعریف کنید تا نیازی به نوشتن دوباره آن‌ها نباشد.",
    ...
    send_update_email: {
      ...
      need_set_service_alert: {
        message: "لطفاً ارائه‌دهنده سرویس ایمیل خود را تنظیم کنید تا ایمیل ارسال شود.",
    ...
    add_template: {
      ...
      message: "شما باید عنوان و متن پیام را اینجا تنظیم کنید. عنوان فقط برای مرجع شما استفاده می‌شود و به مشتری ارسال نخواهد شد.",
      ...
      inputs: {
        ...
        body: {
          ...
          messages: "می‌توانید مقادیر پویا را با {order_id} و {buyer_name} تنظیم کنید."
        }
      }
    }
  },
  ...
  b_order_share: {
    ...
    guest_checkout_message: "خریداران مهمان می‌توانند به‌طور خودکار سفارش خود را در همان مرورگر مشاهده کنند. اما اگر مشتری مهمان است و نیاز به اشتراک‌گذاری جزئیات سفارش دارید، می‌توانید یک لینک امن برای آن‌ها ایجاد کنید.",
