  ...
  shop_sms: {
    ...
    template_edit: {
      ...
      template: {
        ...
        subtitle:
          "شما می‌توانید کلید و مقدار قالب را اینجا تنظیم کنید. کد قالب باید دقیقاً همان چیزی باشد که شما در ارائه‌دهنده خدمات اس‌ام‌اس خود تنظیم کرده‌اید، و کلید همان چیزی است که ارائه‌دهنده شما می‌خواهد کد را از طریق آن ارسال کند. اگر فیلد <code>value</code> خالی باشد، سپس <code>{code}</code> به عنوان کد قالب در نظر گرفته می‌شود.",
