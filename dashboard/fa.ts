...
export default {
  ...
  layout: {
    ...
    menu: {
      ...
      security_subtitle: "تنظیم احراز هویت دو مرحله‌ای و مدیریت گزینه‌های ورود از طریق شبکه‌های اجتماعی.",
      ...
      my_subscriptions_subtitle: "دسترسی به ویژگی‌های پیشرفته AI و سفارشی‌سازی.",
    },
  },
  ...
  product_studio: {
    ...
    info: {
      subtitle: "برای تولید محصول، می‌توانید فقط جزئیات ضروری مورد نیاز برای ساخت آن را وارد کنید."
    },
    price: {
      subtitle: "قیمت و تخفیف این محصول را وارد کنید. پس از افزودن محصول، به گزینه‌های بیشتری دسترسی خواهید داشت."
    }
