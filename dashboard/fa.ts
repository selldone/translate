...
export default {
  ...
  process_center: {
    ...
    basket_list: {
      ...
      need_to_refund: {
        title: 'نیاز به بازپرداخت به مشتری',
        message: "ما مبلغ کل بازپرداخت‌هایی که باید به صورت دستی انجام دهید را محاسبه می‌کنیم. این محاسبه بر اساس اقلام موجود و مبالغ کل بازپرداخت‌ها انجام می‌شود."
      },
      need_payback: {
        title: "نیاز به بازپرداخت از مشتری",
        message: "ما متوجه شدیم که مبلغ کل بازپرداخت به مشتری بیشتر از مبلغ مورد نیاز بر اساس اقلام موجود در سبد خرید است. ممکن است نیاز باشد که از مشتری برای جبران مبلغ اضافی هزینه دریافت کنید."
      },
      need_no_refund: {
      ...
      total_refund: {
        ...
        message: "این مبلغ کل بازپرداخت‌هایی است که به صورت خودکار توسط درگاه پرداخت شما انجام شده است. تنها برخی از خدمات پرداخت این ویژگی را پشتیبانی می‌کنند، بنابراین ممکن است نیاز باشد که به صورت دستی بازپرداخت کنید."
      }
  ...
  cashback: {
    ...
    delete_alert: {
      ...
      message: "آیا مطمئن هستید که می‌خواهید این برنامه بازگشت وجه را حذف کنید؟",
  ...
  cashback_edit: {
    ...
    design: {
      subtitle: "عنوان و توضیح کوتاه برنامه بازگشت وجه را تنظیم کنید. این اطلاعات به مشتریان نمایش داده می‌شود.",
    },
    title_input: {
      title: "عنوان",
    },
    ...
    qualify_input: {
      ...
      true_msg: "برنامه بازگشت وجه فقط برای مشتریان واجد شرایط در دسترس خواهد بود.",
    },
    club: {
      subtitle: "باشگاه را برای برنامه بازگشت وجه تنظیم کنید. برنامه بازگشت وجه فقط برای مشتریانی که در این باشگاه هستند در دسترس خواهد بود.",
    },
    cluster: {
      subtitle: "با اختصاص یک خوشه به برنامه بازگشت وجه، می‌توانید آن را مؤثرتر مدیریت کنید.",
    },
    notifications: {
    ...
    enable_input: {
      true_msg: "برنامه بازگشت وجه فعال است و مشتریان می‌توانند از آن استفاده کنند.",
      false_msg: "برنامه بازگشت وجه غیرفعال است و مشتریان نمی‌توانند از آن استفاده کنند.",
    },
    boosted_input: {
      false_title: "عادی",
      true_title: "افزایش (بازگشت وجه 2 برابر)",
      true_msg: "برنامه بازگشت وجه در حالت افزایش است و مشتریان بازگشت وجه 2 برابر دریافت خواهند کرد.",
      false_msg: "برنامه بازگشت وجه در حالت عادی است و مشتریان بازگشت وجه عادی دریافت خواهند کرد.",
    },
  },
