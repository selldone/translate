...
export default {
  ...
  shop_quota: {
    title: "سهمیه مصرف",
    sub_title:
      "این فهرست سهمیه مصرف فروشگاه شماست. می‌توانید با ارتقای لایسنس فروشگاه، این محدودیت‌ها را افزایش دهید. اگر از محدودیت‌ها عبور کنید، می‌توانید از ما سهمیه روزانه اضافی درخواست کنید. همه مصرف‌ها روزانه بازنشانی می‌شوند.\n",
  },
  app_card: {
    category: "دسته بندی",
    installs: "نصب",
