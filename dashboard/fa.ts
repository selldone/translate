...
export default {
  ...
  discount_codes: {
    ...
    dialog: {
      ...
      config: {
        ...
        subtitle: 'فرمول محاسبه کد تخفیف به صورت زیر است: max (محدودیت، درصد * قیمت سبد خرید). به یاد داشته باشید که کدها را مرتبط و آسان برای به خاطر سپردن کنید.'
      },
      limit: {
        title: 'محدودیت‌ها',
        subtitle: 'در این بخش می‌توانید حداکثر استفاده از هر کد تخفیف و همچنین حداکثر مقدار تخفیف را تعریف کنید.'
      },
      duration: {
        title: 'محدودیت مدت',
        subtitle: 'اگر می‌خواهید کد تخفیف را برای یک بازه زمانی خاص فعال کنید، می‌توانید آن مدت را اینجا تعیین کنید.'
      },
      design: {
        subtitle: 'می‌توانید یک عنوان و توضیح برای هر کد تخفیف تنظیم کنید. این جزئیات به کاربر نمایش داده خواهد شد.'
      },
      cluster: {
        subtitle: 'با مرتبط کردن این کد تخفیف با یک خوشه، می‌توانید آن را به راحتی همراه با سایر منابع در یک مکان مدیریت کنید.'
      }
  ...
  coupon_edit: {
    ...
    config: {
      subtitle: 'فرمول محاسبه تخفیف کوپن به صورت زیر است: هزینه + max (محدودیت، درصد * قیمت سبد خرید).'
    },
    limit: {
      subtitle: 'در این بخش، می‌توانید حداکثر تعداد استفاده‌ها برای هر کوپن و بالاترین مقدار تخفیفی که هر کوپن می‌تواند ارائه دهد را تنظیم کنید.',
      zero_message: 'صفر: هیچ محدودیتی وجود ندارد!'

    },
    duration: {
      subtitle: 'اگر می‌خواهید یک بازه زمانی خاص برای فعال بودن یک کوپن تعیین کنید، می‌توانید مدت زمان را در این بخش پیکربندی کنید.'
    },
    design: {
      subtitle: 'هر کوپن امکان افزودن یک عنوان و توضیح را دارد. این جزئیات برای مشتری قابل مشاهده خواهد بود.'
    },
    constraints: {
      subtitle: 'اینجا می‌توانید پارامترهای شخصی‌سازی شده اضافی برای کوپن را تنظیم کنید.',
    ...
    club: {
      subtitle: 'استفاده از این کوپن می‌تواند به اعضای باشگاه‌های مشتریان منتخب محدود شود.'
    },
    cluster: {
      subtitle: 'با مرتبط کردن این کوپن با یک خوشه، می‌توانید آن را به راحتی همراه با سایر منابع در یک مکان مدیریت کنید.'
    },
    preview: {
  ...
  offer_edit: {
    ...
    config: {
      subtitle: 'با تعیین عنوان، توضیحات و وضعیت دسترسی عمومی، شروع به ساختن یک پیشنهاد هوشمند کنید.'
    },
    limit: {
      subtitle: 'حداکثر محدودیت استفاده برای این پیشنهاد را در این بخش تنظیم کنید.'
    },
    duration: {
      subtitle: 'اگر می‌خواهید یک بازه زمانی خاص برای یک پیشنهاد تعیین کنید، می‌توانید مدت زمان را اینجا پیکربندی کنید.'
    },
    constraints: {
      subtitle: 'معیارها و شرایط واجد شرایط بودن برای این پیشنهاد را اینجا تنظیم کنید. این پیشنهاد به اقلام سبد خرید که این شرایط را دارا هستند اعمال می‌شود.'
    },
    discounted_products: {
      title: 'محصولات تخفیف خورده',
      subtitle: 'می‌توانید محصولاتی که این پیشنهاد به آن‌ها تخفیف اعمال می‌کند را مشخص کنید.'
    },
    cluster: {
      subtitle: 'با مرتبط کردن این پیشنهاد با یک خوشه، می‌توانید آن را به راحتی همراه با سایر منابع در یک مکان مدیریت کنید.'
    }
  ...
  shop_lotteries: {
    ...
    config:{
      subtitle:"با ایجاد تجربه‌ای گیمیفاید در فروشگاه خود، خرید مشتریان را افزایش دهید. جوایز و شانس برنده شدن را برای مشتریانی که با خرید توکن کسب می‌کنند، تنظیم کنید. هر بار بازی ۱۰ توکن هزینه دارد و می‌توانید جوایز ویژه‌ای برای خریداران اولین بار ارائه دهید. بازی پیش‌فرض چرخ شانس است، اما می‌توانید آن را بر اساس چیدمان فروشگاه خود سفارشی کنید."
    },
  ...
  lottery_edit: {
    ...
    not_free_for_first_message: "این جایزه برای اولین بازی رایگان در دسترس نیست.",
    ...
    config:{
      subtitle:"در اینجا می‌توانید جوایز لاتاری فروشگاه خود را ایجاد کنید. عنوان، توضیحات، رنگ و تصویر هر جایزه را تنظیم کنید."
    },
    design:{
    ...
    prize:{
      ...
      subtitle:"جزئیات جایزه را اینجا تنظیم کنید. گزینه‌ها شامل کدهای تخفیف، کارت‌های هدیه، اعتبار و سایر تخفیفات به عنوان جوایز لاتاری هستند."
    },
    product_input:{
      label:'جایزه محصول',
  ...
  shop_customers: {
    ...
    subtitle:"مشتریان می‌توانند به روش‌های مختلفی به فروشگاه شما اضافه شوند؛ به صورت دستی، واردات دسته‌جمعی اکسل، از طریق POS یا از طریق فروشگاه آنلاین شما. هر زمان که کاربری به فروشگاه شما وارد شود، به طور خودکار به عنوان مشتری ثبت خواهد شد.",
  ...
  customer_add:{
    ...
    subtitle:"برای اضافه کردن مشتری به فروشگاه خود، لطفاً آدرس ایمیل یا شماره تلفن را وارد کنید.",
    more:{
      title:'افزودن جزئیات بیشتر',
      subtitle:'تنظیم ارز، باشگاه مشتریان، بخش‌ها، آدرس و موارد دیگر.'
    },
    detail:{
      subtitle:"اطلاعات شخصی مشتری خود را ثبت کنید. لطفاً به حریم خصوصی مشتری خود احترام بگذارید."
    },
    preferences:{
      subtitle:"ارز پیش‌فرض کاربر، باشگاه مشتریان و بخش‌ها را اینجا تنظیم کنید."
    },
    address:{
      subtitle:"این آدرس می‌تواند در POS استفاده شود. کاربر نمی‌تواند این اطلاعات را ببیند."
    }
  },
  ...
  blog_category: {
    ...
    subtitle:"شما می‌توانید تعداد محدودی دسته‌بندی برای پست‌های وبلاگ خود ایجاد کنید تا آنها را به طور مؤثرتری مدیریت کنید. داشتن یک محدودیت در دسته‌بندی‌ها باعث سازماندهی بهتر در وب‌سایت شما می‌شود. به طور خاص، حتی خبرگزاری‌های برتر نیز تعداد محدودی دسته‌بندی دارند، اغلب کمتر از 100، تا مدیریت را ساده‌تر کرده و تمرکز گسترده‌تری را حفظ کنند.",
  ...
  blog_timeline:{
    ...
    subtitle:"در اینجا لیست مقالات زمان‌بندی شده برای انتشار در آینده است. شما می‌توانید پست‌های وبلاگ و حتی توضیحات محصول را برای انتشار در زمان‌های خاصی برنامه‌ریزی کنید.",
  },
  ...
  orders_bulk_export: {
    ...
    subtitle:"برچسب‌ها را برای پردازش سفارش دسته‌جمعی صادر و دانلود کنید - ایده‌آل برای مدیریت بیش از 100 سفارش در روز.",
