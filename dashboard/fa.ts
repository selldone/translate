  ...
  include_item_add: {
    ...
    mode: {
      ...
      internal_link: {
        ...
        tips: "می‌توانید یک صفحه فرود را با پروفایل لینک کنید و یک مسیر سفارشی و محتوای دینامیک برای آن تنظیم کنید. Selldone یک لینک دینامیک برای آیتم ایجاد خواهد کرد."
      }
    },
