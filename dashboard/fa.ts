...
export default {
  ...
  add_product: {
    ...
    edit_info: {
      ...
      external: {
        not_available_message: "امکان افزودن کلید خرید دوم تنها برای لایسنس شرکت و سازمانی موجود است.",
  ...
  vendor_add: {
    ...
    we_will_send_invitation_to_user_msg:
      "ما یک ایمیل دعوت به کاربر ارسال خواهیم کرد.",
  ...
  vendor_shipping_services: {
    title: "حمل‌ونقل",
    subtitle:
      "شما می‌توانید خدمات حمل‌ونقل و پیک‌ها را در اینجا اضافه کنید. خدمات حمل‌ونقل و پیک‌ها باید تحت روش‌های حمل‌ونقل از پیش تعریف‌شده‌ای که توسط بازار مشخص شده‌اند، قرار بگیرند. با افزودن خدمات حمل‌ونقل و پیک‌ها، می‌توانید به راحتی سفارشات را به آن‌ها اختصاص دهید و برچسب‌ها یا پیک‌ها را به صورت خودکار سفارش دهید.",
    action: "افزودن سرویس",
    add_dialog: {
      select_method: "انتخاب روش",
      select_method_msg:
        "لطفاً یک روش حمل‌ونقل را از لیست زیر انتخاب کنید. روش‌های حمل‌ونقل توسط بازار تعریف می‌شوند.",
      select_service_msg:
        "یک سرویس حمل‌ونقل از لیست زیر انتخاب کنید. در اینجا فقط خدمات موجودی که می‌توان به فروشگاه شما اضافه کرد نمایش داده می‌شوند.",
  ...
  affiliate_edit: {
    ...
    payment: {
      title: "اطلاعات پرداخت",
      subtitle: "ساختار کمیسیون را برای همکار تعیین کنید. می‌توانید کمیسیون ثابت و درصدی را ترکیب کنید، یا کمیسیون خاصی برای هر محصول تنظیم کنید.",
    },
    ...
    restriction: {
      ...
      subtitle: "محصولاتی که برای کمیسیون واجد شرایط هستند را تعیین کنید. می‌توانید کمیسیون‌ها را به محصولات خاصی محدود کنید.",
    },

    link_domain: {
      title: "دامنه متصل",
      subtitle: "یکی از دامنه‌های خود را به این همکار متصل کنید. بازدیدکنندگانی که از طریق این دامنه خرید می‌کنند به این همکار نسبت داده می‌شوند.",

      domain_not_approved_msg: "دامنه هنوز تأیید نشده است!",
      domain_is_not_enable_msg: "دامنه فعال نیست!",
      domain_is_linked_to_other_affiliate_msg: "این دامنه قبلاً به یک همکار دیگر متصل شده است!",
    },
    ...
    cluster: {
      title: "خوشه",
      subtitle: "این همکار را با یک خوشه مرتبط کنید تا بتوانید آن را به همراه منابع دیگر در یک مکان مدیریت کنید.",
    ...
    inputs: {
      ...
      commission: {
        ...
        true_description: "محاسبه با استفاده از کمیسیون محصولات تعیین شده در تب قیمت‌گذاری.",
      ...
      pos: {
        true_description: "همکاران می‌توانند از طریق پنل خود مستقیماً برای مشتریانشان سفارش ثبت کنند.",
        true_title: "دسترسی POS",
      },
      enable: {
        true_description: "آیا این همکار در حال حاضر فعال است؟ اگر غیر فعال باشد، برنامه همکاری آنها بر سفارش‌هایی که از طریق لینک همکاری آنها انجام می‌شود اعمال نخواهد شد.",
      },
      products: {
     ...
     */
    delete: {
      subtitle: "می‌توانید تمامی بدهی‌های معوقه خود را با همکار تسویه کرده و سپس او را از فروشگاه خود حذف کنید. اطلاعات همکار برای مدت محدودی پس از حذف در دسترس خواهد بود.",
    }
  ...
  shop_valuations: {
    ...
    subtitle: "یک ارزیابی (فرم ورودی قیمت‌گذاری) به محصول اختصاص دهید که به مشتریان امکان انتخاب بین تغییرات یا شخصی‌سازی محصولات شما را می‌دهد. سپس سیستم قیمت را بر اساس ورودی‌های سفارشی محاسبه می‌کند.",
    add_valuation_action: 'ایجاد فرم ارزیابی جدید',
    empty_message: 'به جای ایجاد چندین نوع مختلف، به توسعه یک استراتژی ارزیابی فکر کنید که می‌تواند به یک محصول ساده اعمال شود.',
    delete_dialog: {
      title: "حذف دائمی",
      message: "آیا مطمئن هستید که می‌خواهید این فرم قیمت‌گذاری را حذف کنید؟ لطفاً اطمینان حاصل کنید که این استراتژی قیمت‌گذاری سفارشی از تمامی محصولات مرتبط حذف شده باشد.",
  ...
  valuation_add: {
    ...
    config: {
      subtitle: "با استفاده از فرمول‌ها و جداول مرجع، سیستم ارزیابی خود را برای ایجاد قیمت‌گذاری انعطاف‌پذیر راه‌اندازی کنید. ابتدا یک نام منحصر به فرد برای این ارزیابی تعیین کنید.",
    },
    valuation_preview: "پیش‌نمایش فرم ارزیابی",
    load_sample: "بارگذاری نمونه",
    conditions: {
      title: "شرایط",
      subtitle: "منطق پشت تغییرات سفارشی را تعریف کنید. این تنظیمات مدیریت دسترسی به تغییرات را آسان‌تر می‌کند.",
    },
    structure: {
      title: "ساختار",
      subtitle: "فرم ورودی قیمت‌گذاری خود را با استفاده از فرمول‌ها و جداول مرجع طراحی کنید.",
      expand_action: "گسترش",
    ...
    inputs: {
      title: {
        ...
        placeholder: "یک نام برای قیمت‌گذاری وارد کنید، مثلاً 'قیمت‌گذاری ماگ‌ها'",
      },
    },
    samples: {
  ...
  importer: {
    ...
    vendor: {
      ...
      subtitle: "فایل‌های CSV فروشندگان را اینجا بارگذاری کنید. اطمینان حاصل کنید که قالب صحیح است و با مقررات حریم خصوصی مطابقت دارد.",
      checklist: {
        title: 'چک لیست مهم',
        subtitle: 'حتماً دستورالعمل‌ها را دنبال کنید.',
        sample_files: 'فایل‌های نمونه',
        valid_vendor_name_needed: "شما باید یک <b>نام معتبر</b> ارائه دهید. از <b>نام</b> برای تعیین اینکه آیا باید یک فروشنده جدید <i>(ایجاد)</i> شود یا یک فروشنده موجود <i>(به‌روزرسانی)</i> استفاده می‌شود.",
        assign_user_after_import: "پس از وارد کردن فروشندگان، می‌توانید به صورت دستی یک کاربر را برای دسترسی به پنل فروشنده اختصاص دهید.",
      },
      need_kyc_alert: 'شما باید اطلاعات شخصی خود را تأیید کنید قبل از اینکه بتوانید فروشندگان را وارد کنید.',
  ...
  marketplace_products: {
    ...
    subtitle: "این کاتالوگ فهرستی از تمام محصولاتی که توسط فروشندگان ارائه می‌شوند را نشان می‌دهد. در بازار، یک محصول می‌تواند به یک یا چند فروشنده مرتبط باشد. هر فروشنده‌ای که با یک محصول مرتبط است، یک ورودی منحصر به فرد دارد که شامل جزئیات موجودی و قیمت‌گذاری مخصوص به آن فروشنده است.",
    filter_vendor: {
  ...
  marketplace_requests: {
    ...
    subtitle: "این لیستی از درخواست‌های افرادی است که برای تبدیل شدن به فروشنده در بازار شما درخواست داده‌اند.",
  },
  ...
  marketplace_setting: {
    marketplace: {
      title: 'بازار',
      subtitle: "غیرفعال کردن بازار برخی از قابلیت‌ها را غیرفعال می‌کند. اگر می‌خواهید کل بازار خود را غیرفعال کنید، باید فروشگاه خود را در تنظیمات غیرفعال کنید.",
    },
    distribution_model: {
      title: 'مدل توزیع',
      subtitle: "بازارها می‌توانند از مدل‌های توزیع مختلفی استفاده کنند. چه ترجیح دهید که فروشندگان کالاها را مستقیماً به خریداران ارسال کنند یا سفارش‌ها را در انبار خودتان جمع‌آوری و ارسال کنید، می‌توانید مدلی را انتخاب کنید که بهترین نیازهای شما را برآورده کند.",
    },
    access: {
      title: 'دسترسی فروشندگان',
      subtitle: "به عنوان مدیر، شما می‌توانید سطح دسترسی فروشندگان به داشبورد محصولات را کنترل کنید. تنظیمات دسترسی عمومی را تنظیم کنید تا به فروشندگان اجازه دهید محصولات و دسته‌بندی‌های خود را اضافه کنند یا این دسترسی را فقط به مدیران محدود کنید.",
    },
    need_enable_shipping_for_vendors_tips: "برای هر روش به طور جداگانه، باید حمل‌ونقل برای فروشندگان را در تب Shop > Logistic فعال کنید.",
    transportation_available_tooltip: "این گزینه برای فروشندگان موجود است.",
    transportation_not_available_tooltip: "برای فروشندگان در دسترس نیست! می‌توانید آن را در تنظیمات حمل‌ونقل فعال کنید.",
    panel: {
      title: 'پنل فروشندگان',
      subtitle: "فروشندگان خود را از طریق دامنه اختصاصی خودتان به سیستم وارد کنید.",
    },
    documents: {
      title: 'اسناد',
      subtitle: "می‌توانید از فروشندگان خود بخواهید که اسناد را بارگذاری کنند یا قراردادهای مشخصی را امضا کنند. اسناد مورد نیاز را در اینجا مشخص کنید.",
      add_document_action: 'افزودن درخواست سند',
    },
    inputs: {
      enable: {
        false_description: "بازار غیرفعال است و تمامی قابلیت‌های بازار غیرفعال می‌شوند.",
      ...
      product: {
        ...
        false_description: "شما محصولات را اضافه کرده و به فروشندگان اختصاص می‌دهید. فروشندگان فقط می‌توانند قیمت و موجودی را مدیریت کنند.",
        true_description: "فروشندگان می‌توانند محصولات خود را مستقیماً در پنل فروشنده مدیریت و اضافه کنند.",
      },
      need_verify: {
        ...
        true_description: "محصولات جدید فروشنده نیاز به تأیید مدیر دارند تا در بازار نمایش داده شوند.",
        true_title: "نیاز به تأیید",
      },
      category: {
        label: 'افزودن دسته‌بندی جدید',
        true_title: "فروشندگان می‌توانند دسته‌بندی اضافه کنند",
        false_description: "شما دسته‌بندی‌ها را اضافه می‌کنید. فروشندگان فقط می‌توانند محصولات خود را در دسته‌بندی‌های موجود اضافه کنند.",
        true_description: "فروشندگان می‌توانند دسته‌بندی‌ها را مستقیماً در پنل خود اضافه و مدیریت کنند.",
      },
      shipping: {
        label: "گزینه‌های حمل‌ونقل",
        true_title: "فروشندگان دارای گزینه‌های حمل‌ونقل هستند",
        false_description: "فروشندگان نمی‌توانند روش حمل‌ونقل خود را اضافه یا سفارشی‌سازی کنند.",
        true_description: "فروشندگان می‌توانند روش‌های حمل‌ونقل خود را تنظیم کنند، پیک‌ها را اضافه کرده و آن را برای خودشان سفارشی‌سازی کنند.",
      },
      hidden_customer: {
        label: "نمایش اطلاعات تماس خریدار",
        true_description: "جزئیات تماس خریدار از فروشندگان پنهان است.",
        false_description: "جزئیات تماس خریدار، مانند شماره تلفن و ایمیل، برای فروشندگان قابل مشاهده است.",
      },
      multi: {
        false_description: "یک کاربر می‌تواند تنها یک حساب فروشنده داشته باشد. کاربران به پنل خود در /vendors هدایت می‌شوند.",
        true_description: "یک کاربر می‌تواند بیش از یک حساب فروشنده داشته باشد. این یک ویژگی بتا است؛ قبل از استفاده از آن با ما تماس بگیرید.",
    ...
    add_document_dialog: {
      ...
      type: {
        title: 'نوع سند',
        subtitle: "در اینجا می‌توانید یک درخواست سند اضافه کنید. این درخواست در پنل فروشنده نمایش داده می‌شود و او را برای بارگذاری سند مربوطه راهنمایی می‌کند.",
      },
      guide: {
        title: 'راهنما',
        subtitle: "راهنمایی کوتاهی ارائه دهید تا به فروشندگان کمک کند متوجه شوند کدام اسناد را باید بارگذاری کنند و چگونه این کار را به درستی انجام دهند.",
      },
      code: {
        title: 'کد جاسازی',
        subtitle: "کد جاسازی یک سند، فرم یا قراردادی که فروشنده باید امضا کند را اینجا وارد کنید.",
      },
      link: {
        title: 'لینک خارجی',
        subtitle: "یک لینک خارجی به سند یا قراردادی که فروشنده باید امضا کند ارائه دهید.",
      },
      inputs: {
        title: {
          label: 'عنوان',
        ...
        guide: {
          ...
          placeholder: "در صورت لزوم، یک راهنمای کوتاه یا دستورالعمل‌ها را ارائه دهید که شامل لینک به قراردادها یا اسناد دیگر باشد.",
        },
        code: {
          label: "کد جاسازی",
  ...
  VendorDocumentType: {
    Identification: {
      ...
      description: "برای تأیید هویت مالک یا مدیر ارشد کسب‌وکار، یک مدرک شناسایی صادر شده توسط دولت بارگذاری کنید.",
    },
    Business: {
      title: "اسناد کسب‌وکار",
      description: "اسناد ضروری کسب‌وکار مانند مجوزها یا گواهی‌های ثبت را برای تأیید وضعیت قانونی کسب‌وکارتان ارائه دهید.",
    },
    Address: {
      title: "تأیید آدرس",
      description: "یک سند برای تأیید آدرس کسب‌وکارتان ارسال کنید، مانند قبض خدمات عمومی، فاکتور مالیاتی، یا قرارداد اجاره.",
    },
    Contract: {
      title: "قراردادها و توافق‌نامه‌ها",
      description: "قراردادها یا توافق‌نامه‌هایی که شرایط و ضوابط روابط کسب‌وکار شما را تعیین می‌کنند، بارگذاری کنید.",
    },
    Copyright: {
      title: "اسناد حق چاپ",
      description: "اسناد ثبت حق چاپ خود را برای تأیید حقوق مالکیت معنوی خود ارائه دهید.",
    },
    Privacy: {
      title: "اسناد سیاست حفظ حریم خصوصی",
      description: "اسناد سیاست حفظ حریم خصوصی خود را برای نشان دادن تعهد کسب‌وکارتان به حفاظت از اطلاعات کاربران و مشتریان ارائه دهید.",
    },
    Embed: {
      title: "فرم جاسازی شده",
      description: "فرم جاسازی شده را کامل کنید تا اطلاعات مورد نیاز را ارائه دهید.",
    },
    Link: {
      title: "لینک خارجی",
      description: "لینک خارجی را دنبال کنید تا اطلاعات مورد نیاز را ارائه دهید.",
    },
  },
  ...
  vendor_account_transactions: {
    subtitle: "این بخش فهرستی دقیق از تمامی تراکنش‌ها برای کیف پول انتخاب‌شده ارائه می‌دهد. یک تراکنش شارژ زمانی ثبت می‌شود که مشتری با موفقیت برای یک سفارش پرداخت کند. اگر سفارشی لغو یا به‌صورت جزئی بازپرداخت شود، تراکنش بازپرداخت مربوطه نیز در اینجا ثبت خواهد شد.",
  ...
  marketplace_payouts: {
    ...
    subtitle: "این ویژگی حسابداری را برای شما و فروشندگان‌تان ساده‌تر می‌کند و با نگهداری یک سابقه دقیق از تمامی تراکنش‌ها. پرداخت‌ها می‌توانند به صورت دستی از طریق انتقال بانکی یا روش‌های دیگر انجام شوند، یا به صورت خودکار توسط ارائه‌دهندگان پرداختی که از پرداخت‌های جداگانه پشتیبانی می‌کنند، مانند Stripe، مدیریت شوند.",
  ...
  marketplace_pricings: {
    ...
    subtitle: "مدل‌های قیمت‌گذاری را برای بازار خود تنظیم کنید، مانند یک کارمزد ۵٪ برای محصولات دیجیتال. این کار مدیریت قیمت‌گذاری را سریع‌تر و کارآمدتر می‌کند.",
  ...
  vendor_pricing_add: {
    ...
    subtitle: "وقتی یک مدل قیمت‌گذاری به محصولات فروشنده اختصاص داده می‌شود، قیمت به‌طور خودکار به‌صورت قیمت فروشنده * (1 + درصد کمیسیون) محاسبه می‌شود.",
    delete: {
      subtitle: "حذف یک مدل قیمت‌گذاری بر روی تمام محصولاتی که به آن مرتبط هستند تأثیر می‌گذارد. قبل از حذف یک مدل قیمت‌گذاری، مطمئن شوید که تمام محصولات فروشنده که از آن استفاده می‌کنند را به‌روزرسانی کرده و مدل قیمت‌گذاری دیگری را به آنها اختصاص دهید.",
  ...
  vendor_payout_add: {
    vendor: {
      title: 'فروشنده',
      subtitle: "فروشنده‌ای را که می‌خواهید وجهی به او منتقل کنید انتخاب کنید. پس از انتخاب، گزینه‌های پرداخت موجود نمایش داده خواهند شد. اگر درگاه‌های پرداخت با قابلیت واریز را فعال کرده‌اید، آن گزینه‌ها نیز در اینجا نمایش داده می‌شوند.",
    },
    vendor_wallet: 'کیف پول فروشنده',
    vendor_bank_account: 'حساب بانکی فروشنده',
    with_balance_tooltip: "وقتی خدمات واریز مانند Stripe Connect را متصل می‌کنید، موجودی موجود در حساب Stripe شما بازیابی و برای مرجع شما نمایش داده می‌شود.",
    with_balance: 'با موجودی',
    without_balance: 'بدون موجودی - حالت سریع',
    bank_transfer: {
      title: 'انتقال بانکی',
      subtitle: "این فقط یک رکورد از تاریخچه پرداخت است. هیچ وجهی به‌صورت واقعی به فروشنده توسط سیستم منتقل نخواهد شد؛ شما باید به صورت دستی به فروشندگان خود پرداخت کنید.",
    },
    vendor_bank: 'بانک فروشنده',
    gateway_in_debug_mode_warning: "از آنجا که درگاه پرداخت در حالت دیباگ است، وجوه به یک حساب واقعی منتقل نخواهند شد.",
    payment: {
      title: 'پرداخت',
      subtitle: "ارز را انتخاب کرده و مبلغی را که می‌خواهید به فروشنده منتقل کنید وارد کنید. اگر مبلغ منفی وارد کنید، وجوه از کیف پول فروشنده کسر می‌شود. برای حساب‌های متصل با گزینه‌های واریز، وجوه از حساب متصل مانند حساب Stripe فروشنده کسر خواهد شد.",
    },
    history: {
      title: 'تاریخچه',
      subtitle: "بخشی از این پرداخت از طریق انتقال معکوس بازپرداخت شده است، به این معنی که موجودی از حساب فروشنده کسر شده و به حساب شما بازگردانده شده است.",
    },
    refund: {
      title: 'بازپرداخت',
      subtitle: "مبلغ بازپرداخت شده از موجودی حساب فروشنده کسر خواهد شد. تمام پرداخت‌ها (یا مبالغ باقی‌مانده) در حساب فروشنده (مانند Stripe Connect) از طریق انتقال معکوس بازپرداخت خواهند شد.",
    },
    inputs: {
      vendor: {
      ...
      note: {
        placeholder: "می‌توانید در اینجا یک یادداشت اضافه کنید... این یادداشت برای فروشنده قابل مشاهده نیست.",
      },
      accept_refund: {
    ...
    notifications: {
      reverse_fund_success: {
        title: 'بازگشت وجه',
        message: "بازگشت وجه فروشنده با موفقیت انجام شد و پول از بانک به کیف پول منتقل شده و به موجودی کیف پول اضافه شد.",
      },
      payout_success: {
        title: 'واریز وجه',
  ...
  quota_importer: {
    ...
    max_daily_limit_msg: 'حداکثر تعداد مواردی که می‌توانید در یک روز وارد کنید.',
  ...
  l_page_editor_repository: {
    ...
    add_dialog: {
      ...
      configuration: {
        title: "تنظیمات",
        subtitle: "شما می‌توانید بخش‌های سفارشی طراحی شده را برای استفاده‌های آینده در طراحی صفحات خود ذخیره کنید. این بخش‌های ذخیره شده برای تمام مدیران این فروشگاه در دسترس خواهند بود.",
      },
      image: {
        title: "تصویر",
      ...
      code: {
        title: "کد",
        subtitle: "شما می‌توانید کد المان را از بخش‌های سمت چپ در صفحه‌ساز کپی و جایگذاری کنید.",
      },
      inputs: {
        title: {
          label: "عنوان",
  ...
  marketplace_vendors: {
    ...
    subtitle: "فروشندگان را در اینجا اضافه کنید، سپس آن‌ها را به محصولات در داشبورد محصول > فروشندگان اختصاص دهید.",
    ...
    access_tooltip: {
      title: 'دسترسی به پنل',
      subtitle: 'فروشنده به پنل خود دسترسی دارد. می‌توانید این را در تب دسترسی فروشنده ویرایش کنید.',
    },
    reject_by_user_tooltip: {
      title: 'رد شده توسط کاربر',
      subtitle: "کاربر درخواست برای تبدیل شدن به فروشنده و دسترسی به این فروشنده را رد کرده است.",
    },
