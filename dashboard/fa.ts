...
export default {
    ...
    inventory: {
      ...
      variant_add_edit: {
        ...
        variables: {
          ...
          subtitle: "یک کد رنگ هگز وارد کنید، به عنوان مثال، <b>#654FFF</b>، یا دو رنگ جدا شده با یک اسلش، به عنوان مثال، <b>#764FFA/#000000</b>.",
          graphical_asset_tips: "می‌توانید هر مقداری را به متغیرها اختصاص دهید، از جمله تصاویر با استفاده از <b>آیکون های گرافیکی</b>. یک الگو آپلود کرده و کد تولید شده را برای تنوع محصول استفاده کنید.",
        ...
        price: {
          title: 'قیمت‌گذاری',
          subtitle: "قیمت اختصاصی برای تنوع محصول تنظیم کنید یا از قیمت پیش‌فرض محصول استفاده کنید."
        },
        package: {
          title: 'بسته‌بندی و حمل و نقل',
          subtitle: "وزن و ابعاد برای هر تنوع محصول را مشخص کنید تا روش‌های حمل و نقل مناسب تعیین شوند.",
          same_as_product_action:"مشابه محصول اصلی",
        },
        image: {
          title: "تصاویر تنوع محصول",
          subtitle: "تصاویر منحصربه‌فردی برای هر نوع محصول اضافه کنید. اولین تصویر آپلود شده به عنوان تصویر اصلی آن تنوع در نظر گرفته خواهد شد."
        },
        inputs: {
          sku: {
          ...
          gtin: {
            ...
            message: "فرمت‌های پشتیبانی شده: UPC (12 رقم)، EAN (13 رقم)، JAN (8 یا 13 رقم)، ISBN (13 رقم)."
          }
        }
  ...
  product_images_gallery: {
    dialog_alt: {
      ...
      success_update_notification: "متن جایگزین تصویر با موفقیت به‌روزرسانی شد."
    },
    dialog_bg_remove: {
  ...
  variant_graphical_assets: {
    ...
    tips: {
      how_it_works: "<b>چگونه کار می‌کند:</b><br />الگوها یا تصاویر آیتم‌ها را اینجا آپلود کنید. برای استفاده از این تصاویر به عنوان گزینه‌ای برای تنوع محصول، <b>{filename}</b> را در مقدار تنوع محصول وارد کنید. توجه داشته باشید که این کد نمی‌تواند در مقدار <b><s>رنگ</s></b> استفاده شود.",
      how_set_name: "<b>نکات نام‌گذاری:</b><br />اولین ۱۲ کاراکتر از نام فایل آپلود شده به عنوان نام دارایی استفاده خواهد شد. این ویژگی برای نمایش جنبه‌های قابل تنظیم یک محصول، مانند اندازه لاستیک موتورسیکلت یا الگوهای پارچه‌ای، ایده‌آل است. برای استفاده بهینه از این ویژگی، از آپلود تصاویر انواع محصول اینجا خودداری کنید مگر اینکه تعداد آیکون های گرافیکی کمتر از ۱۰۰ باشد، مانند انواع چوب برای مبلمان."
    }
  },
  /**
  ...
  product_variant_item: {
    ...
    image: {
      tooltip: "⚡ تصویر را اینجا بکشید و رها کنید تا به تنوع محصول اختصاص یابد."
    },
    enable: {
    ...
    restore_dialog: {
      ...
      message: "آیا مطمئن هستید که می‌خواهید این تنوع محصول حذف شده را بازیابی کنید؟",
  ...
  process_order_page_dashboard: {
    ...
    reject_dialog: {
      ...
      options: {
        title: "تنظیمات",
        subtitle: "اگر می‌خواهید فوراً سفارش خود را لغو کنید، می‌توانید از این گزینه استفاده کنید.",
      },
      express_input: {
        true_title: "فوری | لغو سفارش بلافاصله",
        false_title: "استاندارد | لغو سفارش پس از ۴۸ ساعت",
        true_description: "این گزینه سفارش شما را بلافاصله لغو کرده و موجودی انبار را به‌روز می‌کند.",
        false_description: "این گزینه سفارش شما را پس از ۴۸ ساعت لغو می‌کند. تا آن زمان، اقلام رزرو خواهند شد و قابل خرید توسط دیگران نخواهند بود."
      },
    ...
    notifications: {
      ...
      vendor_order_status_update_success: "وضعیت تکمیل سفارش فروشنده با موفقیت به‌روز شد.",
    },
  },
  ...
  product_variants_bulk_add: {
    ...
    variants: {
      ...
      subtitle: "تا دو گزینه نوع محصول را انتخاب کنید. پس از انتخاب، می‌توانید نوع‌های خاصی را برای ایجاد خودکار انتخاب کنید."
    },
    values: {
      title: 'مقادیر نوع محصول',
      subtitle: 'مقادیر ممکن برای هر گزینه نوع محصول را اینجا وارد کنید.',
      prevent_duplicates_tips: "<b>توجه:</b> ما به صورت خودکار نوع‌های موجود را بررسی می‌کنیم تا از ایجاد موارد تکراری جلوگیری شود."
    },
    inventory: {
      title: 'موجودی اولیه',
