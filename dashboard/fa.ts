...
export default {
  ...
  payment_refund_dialog: {
    title: "بازپرداخت پرداخت",
    message: "به دلایل امنیتی، تنها سفارشاتی که در ۷ روز گذشته پرداخت شده‌اند واجد شرایط بازپرداخت هستند.",
    ...
    verify: {
      ...
      description: "من تأیید می‌کنم که مبلغ بازپرداخت صحیح است و می‌خواهم ادامه دهم."
    },
  ...
  payment_delivery_dialog: {
    ...
    message: "برخی از خدمات پرداخت نیاز به تأیید تحویل سفارش به مشتری دارند. معمولاً این تأیید را در آخرین مرحله از تکمیل سفارش، زمانی که تأییدیه تحویل مشتری را دریافت می‌کنیم، ارسال می‌کنیم. اما اگر نیاز دارید این عمل را به صورت دستی انجام دهید، می‌توانید اینجا انجام دهید.",
    verify: {
      title: "تأیید تحویل",
  ...
  product_cross_selling: {
    ...
    dialog: {
      ...
      discount: {
        title: "تخفیف و پیام",
        subtitle: "شما می‌توانید یک پیام اضافه کنید و تخفیفی را برای ترغیب مشتریان به خرید آیتم‌های انتخابی ارائه دهید. این انگیزه‌ها می‌توانند به افزایش فروش و بهبود تجربه خرید کمک کنند.",
        amount_input: {
          message: "درصد تخفیف پس از محاسبه تمام تخفیف‌های موجود به قیمت محصول اعمال خواهد شد."
        },
        mismatch_type_warning: "تخفیف‌ها را نمی‌توان به انواع دیگری غیر از نوع محصولات اصلی اعمال کرد، زیرا آیتم‌های منبع و هدف در سبدهای جداگانه قرار نمی‌گیرند.",
        not_support_subscription_type_warning: "تنظیم تخفیف برای محصولات اشتراکی فروش مکمل ممکن نیست، زیرا برنامه‌های قیمت‌گذاری به صورت پویا قابل تنظیم نیستند.",
        message_input: {
          message: "یک عنوان جذاب و متقاعدکننده بنویسید تا توجه مشتریان را جلب کنید.",
          placeholder: "بسته بندی و صرفه جویی: با انتخاب دست‌چین شده ما ظاهر خود را تکمیل کنید!"
        }
      },
      action: {
        title: 'دکمه',
        subtitle: "در اینجا می‌توانید اقدام محصول فروش مکمل را تغییر دهید. اگر محصول شما نیاز به ورودی اطلاعات سفارشی دارد، مانند از طریق فرم ارزیابی، اقدام \"افزودن به سبد خرید\" را انتخاب نکنید زیرا ممکن است منجر به خطا شود.",
      }
    }
  },
