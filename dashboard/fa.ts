    ...
    template_edit: {
      ...
      text: {
        ...
        auto_fill: {
          ...
          subtitle:
            "شما می‌توانید هر یک از این پارامترها را در متن استفاده کنید و سلدان آنها را با مقدار متنائم جایگزین خواهد کرد.",
        },
      ...
      template: {
        ...
        auto_fill: {
          title: "پر کردن خودکار پارامترها",
          subtitle:
            "شما می‌توانید هر یک از این پارامترها را به عنوان یک مقدار تنظیم کنید و سلدان آنها را با مقدار متنائم جایگزین خواهد کرد.",
        },
        sample: {
