...
export default {
  ...
  products_select: {
    ...
    load_more_products: "محصولات بیشتری در این دسته‌بندی موجود است. برای مشاهده موارد بیشتر کلیک کنید.",
    product_menu: {
    ...
    engine: {
      ...
      subtitle: "محصولات از دسته‌بندی‌ها و برچسب‌های انتخاب‌ شده بارگذاری خواهند شد.",
  ...
  shop_email_provider: {
    ...
    subtitle: "سرویس‌دهنده ایمیل خود را برای ارسال ایمیل از طریق دامنه سفارشی خود متصل کنید.",
    provider: 'ارائه‌دهنده',
    enable_input: {
      false_description: "ایمیل‌های شما از طریق دامنه myselldone شما ارسال خواهند شد.",
      true_description: "ایمیل‌های شما از طریق دامنه ایمیل سفارشی شما ارسال خواهند شد.",
    },
    config: {
      title: 'تنظیمات',
      subtitle: 'برای پیکربندی سرویس ایمیل سفارشی برای فروشگاه خود، کلید API سرویس و دیگر تنظیمات ضروری را وارد کنید.',
    },
    sender: {
      title: 'فرستنده',
      subtitle: "شما می‌توانید نام و آدرس ایمیل فرستنده پیش‌فرض را پیکربندی کنید که برای ارسال ایمیل به مشتریان شما استفاده خواهد شد.",
    },
    inputs: {
      from: {
        label: 'ایمیل فرستنده',
    ...
    messages: {
      provider_error_limit: "اگر سرویس شما بیش از ۱۰۰ خطا داشته باشد، به صورت خودکار غیرفعال خواهد شد! برای فعال‌سازی مجدد می‌توانید خطاها را بازنشانی کنید.",
      encryption_ports_guide: "ارائه‌دهندگان ایمیل ممکن است بر اساس پورت‌های موجود اتصالات SSL، TLS، یا بدون رمزگذاری ارائه دهند. اگر اتصال به خطا برخورد کرد، تغییر حالت رمزگذاری ممکن است مشکل را حل کند. به طور استاندارد <b>TLS</b> از پورت <b>587</b> و <b>SSL</b> از پورت <b>465</b> استفاده می‌کنند.",
      enable_receive_test: "پس از ذخیره تغییرات، یک ایمیل تستی به <b>{email}</b> ارسال خواهد شد. قبل از ارسال ایمیل تستی با تنظیمات جدید، تغییرات را ذخیره کنید.",
    }
  },
  ...
  product_template:{
    ...
    subtitle:"شما می‌توانید یک صفحه را درون صفحه محصول خود قرار دهید تا ارائه بهتری داشته باشید. روش بهینه این است که صفحات را با پس‌زمینه شفاف و ۱ تا ۳ بخش مخصوص به هر دسته محصول ایجاد کنید. سپس یک صفحه را به چندین محصول اختصاص دهید تا یک نمایش منسجم و جذاب داشته باشید.",
   ...
   */
  product_embed:{
    subtitle:"شما می‌توانید به راحتی یک محصول یا لیستی از محصولات را در وبلاگ یا صفحات وب دیگر خود با کپی و چسباندن کدهایی که ما برای شما تولید می‌کنیم، درج کنید. اگرچه این ویژگی هنوز در مراحل اولیه خود است، اما ما به طور فعال در حال کار بر روی گسترش قابلیت‌های آن هستیم تا از آنچه در حال حاضر در دسترس است، فراتر برویم. در حال حاضر، این ویژگی دارای قابلیت‌های محدودی است، اما ما قصد داریم در آینده قالب‌ها و گزینه‌های سفارشی‌سازی بیشتری اضافه کنیم.",
    card:{
      title:'مینیمال',
      description:'کد HTML تولید کنید تا کارت‌های محصول را در پلتفرم‌ها و صفحات HTML دیگر اضافه کنید.',
    },
    iframe:{
      title: 'آی‌فریم',
      description:
  ...
  permission_staff_add: {
    ...
    staff: {
      ...
      subtitle: "تمام کاربرانی که دسترسی کارمند دارند می‌توانند وارد داشبورد شما شوند و اطلاعات مالی را مشاهده کنند. برای اضافه کردن کاربرانی با دسترسی محدود، نقش تعریف کنید.",
      go_to_roles: 'رفتن به نقش‌ها',
    },
    access: {
      customization_tips: "<b>سفارشی‌سازی:</b> برای سفارشی کردن دسترسی پیش‌فرض خواندن/نوشتن، روی هر آیتم کلیک کنید. هر ردیف نشان‌دهنده یک سطح دسترسی مرتبط با داشبورد اصلی فروشگاه است.",
      simplify_tips: '<b>مهم!</b> ما کنترل دسترسی را از بیش از ۳۰۰ به کمتر از ۱۰ سطح ساده کرده‌ایم. سطوح دسترسی دقیق‌تر و به‌روزتر در مستندات منتشر خواهد شد.',
      multi_permission_tips: "<b>محدودیت‌های سفارشی؟</b> شما می‌توانید دسترسی بیشتری به یک کاربر اضافه کنید، بنابراین پس از افزودن اولین دسترسی، دسترسی‌های اضافی را با همان مراحل ایجاد کنید.",
  ...
  category_engine_editor: {
    ...
    subtitle: "محصولات را از دسته‌بندی‌های مختلف نمایش دهید. شما می‌توانید چندین دسته‌بندی را برای نمایش محصولات انتخاب کنید یا محصولات را با برچسب‌ها فیلتر کنید.",
    aut_add_sub_categories_tips: "می‌توانید با کلیک روی دکمه زیر، به‌طور خودکار همه زیرمجموعه‌ها را به دسته‌بندی فعلی اضافه کنید.",
    inputs: {
      categories: {
        label: "دسته‌بندی‌ها",
      ...
      tags: {
        ...
        placeholder: "برچسب‌ها را اینجا وارد کنید و اینتر را فشار دهید. مثال: مجموعه جدید",
      }
    },
    actions: {
