...
export default {
  ...
  shop_connect:{
    ...
    service_status:{
      ...
      shipping_enable_msg:'هزینه حمل و نقل بر اساس اطلاعات ارائه شده در زمان پرداخت محاسبه خواهد شد.',
    },
    detail:{
      title:'جزئیات اتصال',
      ...
      sync:{
        ...
        subtitle:'جزئیات همگام‌سازی داخلی. این اطلاعات پس از پایان موفقیت‌آمیز دوره همگام‌سازی ذخیره می‌شود.',
    ...
    products:{
      title:'محصولات',
      subtitle:"لیست محصولات اضافه شده از {name}. مطمئن شوید که محصول شما نام و شناسه (SKU) منحصر به فرد دارد. برخی از خدمات Connect برای مهاجرت استفاده می‌شوند، بنابراین اگر محصولاتی با شناسه‌ها و نام‌های تکراری داشته باشید، آن محصولات تغییر خواهند کرد!",
    ...
    logs:{
      title:'لاگ‌ها',
      subtitle:'فهرست تمام لاگ‌ها در ۷ روز گذشته. قابلیت لاگ‌گیری فقط از ارائه‌دهندگان خدمات خارجی پشتیبانی می‌شود.'
    },
    ...
    edit:{
      ...
      service:{
        title:'سرویس',
        subtitle:"پلتفرم هدف، تأمین‌کننده دراپ‌شیپینگ، یا بازار را برای اتصال انتخاب کنید."
      },
      test:{
        ...
        true_desc:"حداکثر ۵ محصول، دسته، و مشتری دریافت کنید. می‌توانید در هر زمان به حالت کامل در اتصال > تنظیمات تغییر دهید."
      },
      overwrite:{
        false_title:"اگر موجود است تغییر ندهید",
        false_desc:"جزئیات محصولات و دسته‌های موجود را به همان شکل حفظ کنید.",
        true_title:"بازنویسی",
        true_desc:"اطلاعات محصولات، واریانت‌ها، و دسته‌های موجود را به‌روزرسانی کنید."
      },
      migration_tips:"<b>نکات: </b>اگر می‌خواهید عملکرد را تست کنید، گزینه <b>محدود</b> را انتخاب کنید. با انتخاب 'همگام‌سازی همه'، تمام داده‌ها را از خدمات متصل شما دریافت می‌کنیم و تصاویر مرتبط را دانلود می‌کنیم، بنابراین فضای ذخیره‌سازی رایگان شما کاهش می‌یابد. همچنین، حذف بسیاری از محصولات، دسته‌ها، و مشتریان دشوار خواهد بود!",
      add_action:"اتصال خودکار به",
      order:{
        title:'وضعیت سفارش',
        subtitle:"تنظیمات مدیریت سفارش سرویس متصل شده را برای فروشگاه خود پیکربندی کنید. این شامل تنظیم پذیرش سفارش، فعال کردن تأیید خودکار سفارش (اگر پشتیبانی می‌شود)، و پیکربندی محاسبات هزینه حمل و نقل می‌شود.",
      },
      enable:{
        label:'وضعیت اتصال',
      ...
      confirm:{
        ...
        true_desc:"سفارش‌های با پرداخت زنده به طور خودکار تأیید خواهند شد. سفارش‌های با پرداخت آزمایشی به طور خودکار تأیید نخواهند شد.",
      ...
      shipping:{
        ...
        false_desc:"از محاسبه هزینه حمل و نقل خودم استفاده کن، در فروشگاه > لجستیک > حمل و نقل برای تمام محصولات، شامل محصولات وارداتی.",
        true_title:"محاسبه حمل و نقل",
        true_desc:"از API محاسبه نرخ حمل و نقل ارائه شده توسط این سرویس استفاده کن.",
      },
      remove:{
    ...
    list:{
      title:'اتصال OS',
      subtitle:"سیستم‌عامل کسب‌وکار خود را به خدمات خارجی متصل کنید و تمام کانال‌ها را در یک مکان مدیریت کنید.",
      action:'اتصال سرویس جدید',
      empty_message:"برنامه‌ها و پلاگین‌های دراپ‌شیپینگ را فراموش کنید! اتصال آینده مدیریت سفارش‌های چند پلتفرمی است.",
  ...
  shop_landings:{
    ...
    subtitle:"صفحات سفارشی متمایز و پاسخگو برای برند خود با استفاده از ویرایشگر درون‌خطی قدرتمند مبتنی بر هوش مصنوعی ایجاد کنید و با وارد کردن داده‌ها به صورت خودکار محتوای پویا تولید کنید.",
  ...
  shop_staff:{
    list:{
      ...
      subtitle:'کاربرانی که به داشبورد و بخش‌های مدیریتی این فروشگاه دسترسی دارند.',
    },
    pending:{
      title:'در انتظار',
