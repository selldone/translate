...
export default {
  ...
  add_product: {
    ...
    edit_spec: {
      ...
      dialog: {
        ...
        spec_view_subtitle:"The specifications have been imported from the chosen product.",
      ...
      dialog_ai: {
        ...
        prompt: {
          ...
          subtitle: "Please provide a brief and clear description of the product, highlighting its key features and details. This information will be used to automatically generate the product specifications."
        },
        generated_spec: {
          title: "AI-Generated Specifications",
          subtitle: "These specifications were generated by artificial intelligence."
        },
        inputs: {
          prompt: {
        ...
        actions: {
          run: {
            ...
            subtitle: "Click to automatically create product specifications from the provided overview."
          },
   ...
   */
    ...
    add_custom_badge:{
      title:'Custom badge',
      subtitle:"Add a new custom badge to my shop. Keep badges count under 10. More badges would slow down your shop.",
      ...
      inputs:{
        ...
        pattern:{
          label:"Pattern",
          message:"Automatically show this badge for products has this matched value in their spec. Regex supported.",
      ...
      "notifications": {
        ...
        "item_not_found_error": "The item could not be found. Please refresh the page or contact support."
      }
    }
  },
  /**
