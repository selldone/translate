export default {
    ...
    edit: {
      ...
      edit_menu: {
        ...
        header: {
          ...
          sub_title: "منوی بالای صفحات فروشگاه.",
          message:
  ...
  selldone_applications: {
    title: "کسب و کار خود را در هر مکان و هر زمان مدیریت کنید!",
    msg: "نسخه بتا آزمایشی اپلیکیشن را می توانید از طریق لینک زیر دریافت نمایید.",
  },
