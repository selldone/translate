export default {
  ...
  admin_shop: {
    ...
    logistic: {
      ...
      warehouse_btn_error: "انبار، فروشگاه یا مبدا کسب و کار خود را تنظیم کنید. این طالاعات در محاسبه هزینه حمل و نقل و فرآیند ثبت سفارش ضروری است.",
  ...
  add_product: {
    ...
    edit_spec: {
      ...
      group_input_header: "افزودن دسته",
  ...
  accounts: {
    title: "کیف پول من",
    message:"شما می بایست حداقل یک حساب با ارز مورد مبادله خود در سلدان ایجاد نمایید. این حساب برای را برای پرداخت هزینه های سرویس بایستی شارژ نمایید.",
  ...
  user_monetize_plans: {
    ...
    sub_title: "بابت همکاری شما مبالغی به عنوان هدیه به شما داده خواهد شد. این مبالغ به عنوان شارژ در حساب شما منظور می گردد و امکان برداشت تنها برای شرکای تجاری سلدان ممکن است. شما می توانید این مبالغ را به عنوان مبالغ شارژ و خرید خدمات سایت در سلدان هزینه نمایید و یا برای دیگران ارسال کنید.",
  ...
  companies: {
    ...
    message:"حساب های تجاری، شرکت و تیم هایی که قصد توسعه محصولات و اپلیکیشن بر پایه سرویس سلدان را دارند بایستی یک پروفایل تجاری در اینجا برای خود بسازند.",
  ...
  email_builder: {
    service_unavailable:
      "سرویس ایمیل در حساب شما فعال نیست.",
  ...
  my_roles: {
    title: "نقش های من",
    message: "نقش ها دسترسی ها محدودی هستند که به کارمندان یک فروشگاه داده می شود. برای مثال مسئول ارسال سفارشات و یا بسته بندی سفارشات.",
  },
  ...
  order_delivery: {
    ...
    auto_complete_note:
      "بعد از گذشت یک بازه زمانی مشخص، سیستم سفارش را به حالت تحویل داده شد تغییر وضعیت خواهد داد. این بازه زمانی بسته به نوع سفارش متغییر بوده وتوسط سیستم تایین می گردد.",
  ...
  shops_list: {
    title:'فروشگاه های من',
    message:"لیست فروشگاه های من، فروشگاه های دارای دسترسی و فروشگاه های نمونه."
