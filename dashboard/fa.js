export default {
  ...
  admin_shop: {
    ...
    dashboard: {
      ...
      info: {
        ...
        site_map: "نقشه سایت",
        shop_domains: "دامین های فروشگاه",
      ...
      finance: {
        ...
        pay_amount_chart_title: "مقدار پرداخت بر اساس ارز",
        sell_amount_chart_title: "مقدار فروش بر اساس ارز",
        discount_amount_chart_title: "مقدار تخفیف بر اساس ارز",
    ...
    auditing: {
      ...
      gateway: {
        ...
        sub_title: "اتصال درگاه به فروشگاه و مدیریت آن",
        message:
      ...
      exchange: {
        ...
        sub_title: "ارزهای قابل انتخاب توسط خریدار",
        message:
    ...
    logistic: {
      warehouse_btn: "ویرایش انبار",
      warehouse_btn_error: "مشخصات انبار خود را وارد نمایید!",
      ...
      warehouse: {
        ...
        message: "شما قادر به تعریف یک انبار برای فروشگاه خود هستید.",
        table: {
          title: "لیست موجودی",
          sub_title:
      ...
      delivery: {
        ...
        sub_title:
          "روش های ارسال فعال، محاسبه هزینه، محدوده تحت پوشش و وضعیت پرداخت در محل",
        message:
        ...
        delivery_form: {
          ...
          currency_input_message: "هزینه ها بر اساس این ارز محسابه می گردد",
          ...
          sod_input: "آیا پرداخت هزینه حمل و نقل در محل (پس کرایه) صورت گیرد؟",
          sod_input_message:
    ...
    users: {
      ...
      report: {
        ...
        sub_title: "مشاهده اطلاعات زنده، عضویت و فعالیت کاربران",
        message:
          "وضعیت فروشگاه خود را به صورت زنده در این بخش مشاهده می نمایید. برای دریافت اطلاعات بیشتر از افزونه های بررسی رفتار کاربران و خریداران می توانید استفاده نمایید.",
      ...
      club: {
        ...
        sub_title: "دسته بندی مشتریان بر اساس میزان خرید",
        message:
      ...
      faq: {
        ...
        message:
          "برای ثبت سوال جدید به بخش پرسش و پاسخ در فروشگاه مراجعه نمایید.",
      },
    }, // End of users
    ...
    apps: {
      ...
      my_apps: {
        ...
        sub_title: "اپ های کاربران و مدیریت فروشگاه",
        message: "اپلیکیشن های سایت خود را در این بخش مدیریت نمایید.",
        all: "همه",
      },
    ...
    permissions: {
      ...
      shop_api: {
        ...
        sub_title: "اپلیکیشن های متصل به فروشگاه",
        message:
    ...
    edit: {
      ...
      info: {
        ...
        sub_title: "نام،تصویر، توضیحات، آدرس و اطلاعات تماس فروشگاه",
        message:
          "اطلاعات عمومی فروشگاه خود را در این بخش مشاهده و ویرایش نمایید.",
      },
      ...
      edit_menu: {
        ...
        sub_title: "منوی 4 ستونی پایین فروشگاه.",
        message:
  ...
  add_product: {
    ...
    edit_info: {
      ...
      condition_message:
        "شما بایتسی یکی از شرایط را برای محصول خود انتخاب نمایید.",
    ...
    edit_spec: {
      title: "مشخصات",
      sub_title: "مشخصات محصول را وارد نمایید.",
      message:
        "به کمک این گزینه می توانید مشخصات کالای دیگر را برای این کالا وارد نمایید.",
      import_action: "وارد کردن",
      group_input_header: "افزودن تیتر / دسته بندی مشخصات محصول.",
      item_title_header: "افزودن مشخصه جدید برای محصول.",
    ...
    edit_images: {
      title: "تصویر اصلی",
      sub_title: "تصویر اصلی محصول در بخش لیست محصولات",
      message: "یک تصویر به عنوان تصویر اصلی محصول انتخاب نمایید.",
      main_image_input: "تصویراصلی محصول",
      ...
      background_is_white: "آیا تصویر با پس زمینه سفید است؟",
      images: {
        title: "گالری تصاویر محصول",
        sub_title: "تصاویر محصول",
        message:
    ...
    pricing: {
      ...
      commission_input: "کمیسیون / مالیات",
      ...
      independent_price: "قیمت گذاری مستقل",
      same_price: "قیمت مشابه محصول",
    ...
    inputs_edit: {
      ...
      sub_title: "دریافت اطلاعات از خریدار",
      message:
    ...
    extra_edit: {
      physical: {
        ...
        sub_title: "ابعاد و زمان آماده سازی",
        message:
  ...
  product_admin: {
    ...
    inventory: {
      ...
      variants: {
        ...
        title: "لیست موجودی کالا",
        sub_title: "تعداد موجودی کالا / لیست تنوع کالا",
        message:
  ...
  inventory_list: {
    ...
    bulk_price: "تغییر قیمت همه محصولات",
    table: {
  ...
  campaign: {
    ...
    landing: {
      ...
      add_landing: "افزودن صفحه لندینگ",
    },
    ...
    setting: {
      ...
      general_setting: {
        ...
        message:
          "صفحه لندینگ و کد تخفیف مربوط به این کمپین را در این بخش انتخاب نمایید. کد تخفیف به صورت خودکار برای خریداران در طی زمان کمپین اعمال خواهد شد.",
      ...
      time_setting: {
        ...
        message: "زمان شروع و پایان کمپین را انتخاب نمایید.",
        start_input: "شروع",
      ...
      banner_setting: {
        ...
        sub_title: "محل نمایش: بالای صفحه فروشگاه (در بخش دسته بندی محصولات)",
        message:
          "متن پیام کوتاه و جذابی برای بنر اطلاع رسانی کمپین انتخاب کنید. می توانید این بنر را شخصی سازی نموده یا به آن انیمیشن اضافه نمایید.",
      ...
      notifications: {
        title: "نوتیفیکیشن",
        sub_title: "نمایش نوتیفیکیشن کاربر",
        message: "نوتیفیکیشن ایجاد کنید و آن را به کمپین خود پیوند دهید.",
  ...
  process_center: {
    ...
    payment_widget: {
      ...
      samin: {
        ...
        tooltip: "محسابه با توجه به روش پرداخت",
        percent: "درصد",
      },
      affiliate: {
  ...
  physical_order_inputs: {
    title: "اطلاعات وارد شده برای سفارش",
  },
  ...
  user_gifts: {
    ...
    send_gifts: {
      ...
      sub_title: "هدایای ارسالی توسط شما برای دیگران.",
      message:
    ...
    received_gifts: {
      ...
      sub_title: "تمامی هدایای دریافتی توسط سلدان و دیگر افراد به شما.",
      message:
        "سلدان بابت فعالیت شما در شبکه های اجتماعی، مشارکت در توسعه سلدان، معرفی به دوستان و غیره به حساب شما مبالغی را واریز می نماید. همچنین دیگران می توانند برای شما مبالغ هدیه ای ارسال نمایند.",
      table: {
        amount: "مبلغ",
        currency: "ارز",
  ...
  user_monetize_plans: {
    ...
    sub_title: "بابت همکاری شما مبالغی به عنوان هدیه به شما داده خواهد شد.",
    message:
      "این مبالغ به عنوان شارژ در حساب شما منظور می گردد و امکان برداشت تنها برای شرکای تجاری سلدان ممکن است. شما می توانید این مبالغ را به عنوان مبالغ شارژ و خرید خدمات سایت در سلدان هزینه نمایید و یا برای دیگران ارسال کنید.",
    discount: "تخفیف",
  ...
  account_page: {
    ...
    transfer: {
      title: "انتقال وجه به دیگر حساب های سلدان",
      form: {
    ...
    deposit: {
      ...
      form: {
        title: "واریز وجه",
        sub_title:
          "کلیه هزینه های استفاده از سرویس از حساب متصل سلدان شما برداشت می گردد.",
        message:
  ...
  transaction_form: {
    ...
    to: "حساب مقصد",
    amount: "مبلغ",
    receipt_title: "پرداخت برای رسید <small>اختیاری</small>",
    ...
    confirmation: {
      ...
      amount: "مبلغ واریزی",
      fee: "هزینه تراکنش",
      total_pay: "مبلغ برداشت شده از حساب کاربر",
      receipt: "رسید",
      description: "توضیحات",
  ...
  shop_locations: {
    ...
    message:
      "برای محدودتر کردن منطقه تحت پوشش، برای کسب و کارهای محلی، می توانید محدوده خدمات خود را در بخش مدیریت حمل و نقل تنظیم کنید.",
  ...
  gift_card_orders: {
    ...
    table: {
      ...
      payed_by_card: "پرداخت شده با کارت",
      payment_status: "وضعیت پرداخت",
      date: "تاریخ",
    },
  },
  ...
  discount_codes: {
    ...
    message: "برای ایجاد کد تخفیف جدید بر روی کلید زیر کلیک کلیک نمایید.",
  ...
  gift_cards: {
    ...
    message:
      "برای صدور کارت های هدیه (شارژ) بایستی ابتدا یک دسته کارت ایجاد نمایید، سپس شما قادر به ایجاد هر تعداد کارت هدیه برای آن نوع (دسته) کارت خواهید بود.",
  ...
  coupons: {
    title: "کوپن",
    sub_title: "کوپن های تخفیف درصدی و با شارژ",
    message:
    ...
    for_order_more_than: "حداقل تعداد آیتم های در سبد",
  ...
  coupon_edit: {
    ...
    active_clubs: "سطح های باشگاه مشتریان واجد شرایط",
    notifications: {
  ...
  offers: {
    title: "پیشنهاد ویژه",
    sub_title: "پیشنهاد های ویژه بر اساس خرید مشتری",
    message:
  ...
  affiliate_dashboard: {
    ...
    i_payed: "اینجانب مبلغ {amount} {currency} به {name} پرداخت کردم.",
    pay_now: "تسویه حساب",
  },
  ...
  /** {@see Affiliate**/
  user_affiliates: {
    title: "مدیریت مشارکت های تجاری من",
  },

  /** {@see AdminShopLottery**/
  shop_lotteries: {
    title: "بازی",
    sub_title: "گردونه شانس",
    message:
  ...
  email_builder: {
    service_unavailable:
      "سرویس ایمیل در حال حاضر فعال نمی باشد. این ویژگی به زودی فعال می گردد.",
  ...
  inline_help: {
    ...
    blogs_title: "مطالب مرتبط در آکادمی سلدان",
  },
  ...
  delivery_dashboard: {
    select_destinations: " انتخاب آدرس مبدا و مقصد",
  ...
  pos: {
    ...
    payment_cod: {
      title: "تایید روش پرداخت در محل برای سفارش",
      message:
  ...
  shop_theme: {
    ...
    color_info: "لینک ها",
    light_checkout: "تم روشن تایید سفارش",
    light_header: "تم روشن منوی بالا",
    light_footer: "تم روشن منوی پایین",
  },
  ...
  shop_home_edit: {
    ...
    message:
      "شما می توانید صفحه اصلی سایت خود را تغییر دهید. توجه داشته باشید در صفحه لندینگ، لینک دسترسی به فروشگاه را برای مشتریانتان قرار دهید.",
  ...
  shop_emails: {
    ...
    sub_title: "ایمیل های ارسالی فروشگاه",
    message:
  ...
  product_outputs: {
    ...
    virtual: {
      ...
      sub_title: "نمایش اطلاعات به خریدار پس از خرید",
      message:
    ...
    service: {
      title: "طراحی خدمت",
      sub_title: "انتخاب نوع و مشخصات سرویس",
      message:
  ...
  notification_top_bar: {
    free_charge:
      "🎊 سیستم عامل کسب و کارها  (Business Operating System) | با {amount} هزار تومان اعتبار رایگان. به کارت اعتباری نیاز نیست. تنها کافیست حساب خود را {amount} شارژ کنید تا علاوه بر آن {amount} هزار تومان هدیه دریافت نمایید.",
