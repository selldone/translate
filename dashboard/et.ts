export default {
  ...
  "cautions": {
    "title": "Juhtige oma ettevõtet professionaalselt, järgides järgmisi näpunäiteid. Jätkake lugemist, et saada näpunäiteid kasumimarginaali suurendamise ja muu kohta. Oleme teiega teel.",
    "no_payment_method": {
      "title": "Makseviis",
      "message": "Peate oma poele lisama makseviisi.",
      "action": "Poeväravad"
    },
    "link_account": {
      "title": "Linkige konto",
      "message": "Peate linkima konto ({currency}) oma poega.",
      "action": "Poe kontod"
    },
    "no_domain": {
      "title": "Lisa domeen",
      "message": "Saate oma poega ühendada ühe või mitu isiklikku domeeni. Teie veebisait installitakse teie domeeni. See protsess on kiire ja lihtne."
    },
    "domain_not_approved": {
      "title": "Domeeni kinnitamine",
      "message": "Teie domeen {domain} ei ole kinnitatud. Kontrollige DNS-i sätteid ja kinnitage domeen."
    },
    "no_currency": {
      "title": "Lisa valuuta",
      "message": "Peate oma poe jaoks määrama vähemalt ühe valuuta.",
      "action": "Valuuta haldamine"
    },
    "no_primary_domain": {
      "title": "Peamine domeen",
      "message": "Palun valige oma esmaseks domeeniks domeen. Klõpsates domeeninime kõrval tärninupul, saad valida domeeni oma poe esmaseks domeeniks. See on otsingumootorite jaoks kriitiline. Pange tähele, et teie pood on endiselt saadaval kõigi aktiivsete domeenide kaudu."
    },
    "shop_complete": {
      "title": "Täielik teave",
      "action": "Poe seaded",
  ...
  "support": {
    ...
    "category": "Kategooria",
    "title": "Toetus",
    "message": "Esitage mis tahes taotlusi või küsimusi. Meie tugimeeskond juhendab teid. Soovitame teil esitada oma küsimuse teie taotlusega seotud lehel. Näiteks kui teil on küsimus domeeni seadistuse kohta, saatke see oma poe domeeniseadete lehele.",
  ...
  "helps": {
    ...
    "subtitle": "Tere tulemast Selldone'i. Kui ehitate ettevõtte operatsioonisüsteemile uut veebipoodi, leiate lisateavet siit.",
  ...
  "blogs": {
    "title": "Blogi",
    "subtitle": "Õppetunnid ettevõtlusele, enesekindlus ja eduka ettevõtte loomiseks vajalikud teadmised.",
  ...
  "user_dashboard": {
    ...
    "shops": {
      ...
      "create_new_sub": "Tasuta",
      "create_new_sub_need_initial_charge": "Esimese poe ehitamine on tasuta. Tõenäoliselt piisab teie ettevõtte jaoks ühest kauplusest, kuid kui teil on vaja poode juurde ehitada, on uue poe ehitamise maksumus 25 dollarit. Võtame summa teie rahakoti kontolt välja.",
      "menu": {
        "title": "Minu poed",
        "shops": "Kauplused",
        "new": "Uus"
  ...
  "admin_shop": {
    ...
    "dashboard": {
      ...
      "info": {
        ...
        "home_msg": "Määrake oma veebisaidi vaikeavaleht. Seda saab muuta iga kohandatud domeeni jaoks.",
        ...
        "wage": "Tasu",
        "cpu_message": "Ostetud plaanile kohandatud ressursside arv ja teenusele lisatud ressursid.",
        ...
        "add_dialog": {
          ...
          "step1": "Saate määratleda DNS-domeeni või alamdomeeni kirje A IP-piirangu järgmiste väärtuste abil.",
          "step2": "Lisage DNS-i TXT-kirje:",
          "set_ip_alert": "Määrake kirje A IP väärtus <b>{ip}</b> .",
          ...
          "ssl_message": "Ärge muretsege oma veebisaidi SSL-sertifikaadi pärast. Selldone (beeta) väljastab selle sertifikaadi teie domeeni jaoks automaatselt.",
          "active": "Domeen on aktiivne",
          "inactive": "Domeen on keelatud",
          "success_message": "Õnnitleme, teie sait on domeenis {domain} lubatud. Selle domeeni kaudu saate oma ettevõtet ja kaubamärki maailmale tutvustada.",
        ...
        "alert": {
          ...
          "message": "Kas soovite selle domeeni kustutada? Teiste pettuste vältimiseks lähtestage kindlasti oma domeeni DNS-kirje väärtused."
        }
      },
      "active_orders": {
        "title": "Tellimused",
        "title_small": "Füüsilised, faili-, virtuaal- ja teenindustellimused",
    ...
    "products": {
      ...
      "process_que": "Imporditud toodete töötlemine",
      "view_que_list": "Vaadake järjekordade loendit",
      "menu_products_list": "Toodete loend",
      "menu_export": "Ekspordi tooteid",
      "menu_import": "Import tooteid",
      "menu_show_deletes": "Kuva kustutatud tooted",
      "drop_import_message": "Pukseerige toodete loendi fail (CSV-, XLS-, XLSX-vormingus) siia, et alustada hulgitoodete lisamist. Veenduge, et failil oleks Müüdud toodete loendi vorming.",
      "product_widget": {
    ...
    "auditing": {
      ...
      "invoice": {
        ...
        "subtitle": "Tasud, komisjonitasud ja poekulud arvatakse nendelt rahakotikontodelt maha.",
        "title_add": "Ühendage uus rahakoti konto",
        "subtitle_add": "Peaksite looma iga valuuta jaoks uue rahakoti ja ühendama selle oma poega. Teenustasu võetakse sellelt rahakotilt välja.",
        ...
        "add_account_dialog": {
          ...
          "subtitle": "Kui avate Selldone'is rahakotikonto, anname teile virtuaalse krediitkaardi ja konto nagu igale teisele krediitkaardile. Selldone müügitasu arvatakse sellelt kontolt maha, kuid kui teie kontojäägist ei piisa, jääb see summa võlgu. Saate kasutada Selldone'i teenuseid nii palju kui vaja.",
          "account_number": "Konto number",
          "account_number_input_message": "Pood lingitakse selle kontoga. Seda kontot kasutatakse tasude ja kulude katmiseks.",
          "balance": "Kontojääk",
          "connect_account_to_shop": "Ühendage konto poega"
        },
        "notifications": {
          "connect_account_success": "Konto lisamine õnnestus.",
          "delete_account_success": "Konto eemaldati poest edukalt."
        },
        "alert": {
          "delete_account": "Katkesta konto ühendus",
          "delete_account_message": "Kas soovite selle konto poekontode loendist eemaldada?",
          "delete_account_action": "Kustuta konto"
        },
        "inform_charge_account": "Võtke oma kontolt tasu!",
        "inform_charge_account_critical": "Teenuse peatamise vältimiseks võtke oma kontolt tasu!"
      },
      "gateway": {
        "title": "Makseviisid",
        "sub_title": "Aktiivsete makseviiside loend. Kui soovite oma poodi lisada uue meetodi, vajutage järgmist nuppu. Soovitame tungivalt mitte rohkem kui 10 lisatud makselüüsi.",
        "add_gateway": "Uus makseviis",
        "add_gateway_dialog": {
          "title": "Valige Valuuta",
          "country_currencies": "Kohalikud valuutad",
          "crypto_currencies": "Krüptovaluutad",
          "active_gateways": "Aktiivsed makseviisid",
          "confirm": "Lisa makseviis"
        }
      },
      "exchange": {
        "title": "Salvestage aktiivsed valuutad",
        "subtitle": "Kasutajad saavad valida ühe aktiivsetest valuutadest ning toodete hinnad arvutatakse ja kuvatakse. Vahetuskursi sisestamine on müüja enda teha.",
        ...
        "rates": {
          ...
          "sub_title": "Saate sisestada toodete hinnad mis tahes allpool toodud valuutade alusel ja toodete hinnad arvutatakse automaatselt teie valuutade vaheliste ümberarvestuskursside alusel.",
          "message": "Sisestades valuutadevahelised vahetuskursid, arvutatakse ja uuendatakse teie toodete hindu automaatselt.",
        ...
        "add_rate_dialog": {
          ...
          "message": "Olge teabe sisestamisel ettevaatlik. Teie toodete hinnad arvutatakse siin sisestatud hindade alusel.",
    ...
    "logistic": {
      ...
      "warehouse_btn_error": "Määrake oma ladu, pood või ettevõtte asukoht. See on oluline, et oleksite saatekulu arvutamise ja kassasse viimise protsessis.",
      "size_unit": {
        "title": "Suuruse ühik",
      ...
      "warehouse": {
        ...
        "table": {
          ...
          "sub_title": "Kõigi poetoodete loend, sealhulgas füüsilised, virtuaalsed, failid ja teenused"
        }
      },
      "delivery": {
        "title": "Saatmisviisid",
        "sub_title": "Selle jaotise väärtuste määramisega aktiveeritakse teie poes mitmesugused saatmisviisid. Selles jaotises saab aktiveerida ka sularaha meetodi.",
        ...
        "delivery_form": {
          ...
          "cod_input_message": "Veenduge, et teie saatmisteenus aktsepteeriks järelmaksu.",
          "sod_input": "Kas toetate COD-i?",
          "sod_input_message": "Veenduge, et teie saatmisteenus aktsepteeriks järelmaksu.",
          ...
          "price_cof_input_message": "Sisaldab kindlustuskulusid ja muid teenuseid, näiteks järelmaksuga seotud kulusid.",
    ...
    "users": {
      ...
      "report": {
        ...
        "report_30days_by_time": "Kasutajate tegevus viimase 30 päeva kuupäeva ja kellaaja alusel",
        "report_30days_by_location": "Geolokatsiooni kasutajate tegevus viimase 30 päeva jooksul"
      },
      "club": {
        "title": "Klientide klubi",
        "sub_title": "Iga taseme aktiveerimiseks sisestage igakuine ja aastane ostusumma ning valuuta. Teie kliendid logitakse teie kliendiklubisse, kui nad vastavad igakuise või aasta ostu nõuetele.",
        "item": {
        ...
        "edit_dialog": {
          ...
          "currency_input_message": "Ostude kogusumma on arvestatud selles valuutas.",
          "free_shipping_input": "Tasuta saatmine",
    ...
    "marketing": {
      ...
      "campaign": {
        ...
        "name_input_message": "Sisestage oma kampaania pealkiri.",
    ...
    "categories": {
      ...
      "subtitle": "Kategooriad on teie veebipoe põhifunktsioon. Soovitame teil kasutada neid võimsaid kategoriseerimise tööriistu, et luua kaasaegne kauplus ja muuta klientidel õigete toodete leidmine lihtsaks.",
      "menu": {
      ...
      "graph": {
        ...
        "subtitle": "Teil on täielik ülevaade oma poe kategooriatest ja sellest, kuidas kasutajad nendes navigeerivad. Kategooriate õige paigutusega leiavad teie kliendid tooted kiiresti ja konversioonimäär tõuseb.",
      ...
      "category_widget": {
        "parent": "Lapsevanem",
        "not_exist": "Ei eksisteeri",
        "children": "Alamkategooriad",
        "delete_alert": {
          "title": "Eemalda lapsekategooria",
          "message": "Kas soovite eemaldada kasutaja {title} loendist {parent_title}?",
          "action": "Kustuta"
        },
        "notifications": {
    ...
    "apps": {
      ...
      "my_apps": {
        ...
        "subtitle": "Hallake oma ärirakendusi.",
        "all": "kõik"
      },
      "store": {
        "title": "Rakenduste pood",
        "subtitle": "Ühendage oma lemmikteenused turvaliselt oma ettevõttega. Lisame pistikprogramme ja rakendusi vastavalt klientide soovidele.",
    ...
    "permissions": {
      ...
      "shop_permissions": {
        "menu": {
          ...
          "new_user_message": "Kasutajad, kellel on juurdepääs selle poe armatuurlauale ja haldusjaotistele.",
          "email_input_placeholder": "Meil",
          "email_input": "Kasutaja e-posti aadress",
          "level_input": "Juurdepääsutase",
          "add_user_action": "Lisa töötajaid"
        },
        "delete_alert": {
      ...
      "shop_api": {
        ...
        "message": "Neid võtmeid kasutab teie server juurdepääsulubade loomiseks. Pange tähele, et võtmed on konfidentsiaalsed ja asuvad ainult serveris viisil, mis pole teistele nähtav."
      }
    },
    "applications": {
      "pwa": {
        ...
        "message": "Märkus. Saate iOS-i rakenduses muuta oma veebisaidi tervituslehte iPhone'is ja iPadis",
        "ios_app": "iOS-i rakendus"
      },
      "ios": {
        "title": "iOS-i rakendus",
        "sub_title": "Peagi saate oma poe jaoks luua iOS-i rakenduse.",
        "message": "Maksimaalne failisuurus: 512 KB, saate üles laadida kuni 1 MB suuruseid faile, eeldusel, et meie tihendussüsteem suudab faili suurust vähendada 512 KB-ni. Üleslaaditud pildi suurust muudetakse nutikalt."
      },
      "android": {
        "title": "Androidi rakendus",
        "sub_title": "Looge oma Androidi rakendus",
        "message": "Täitke see vorm ja vajutage ehitusklahvi. Midagi muud pole vaja. Kõik teie rakenduse loomise ja allkirjastamise protsessi etapid viiakse läbi pilveserverites. Lõplik rakendus laaditakse üles kõikidesse AppStore'idesse.",
        "server_un_available": "Katseliselt pole rakendusserver praegu ühendatud.",
        ...
        "package_name_input_alert": "Kui muudate seda nime, ei saa te enam oma eelmisi rakendusi AppStore'is värskendada ega uut installida. Pange tähele, et rakenduste vanemate versioonide kasutajad ei saa ka oma kontodele sisse logida.",
        "version_input": "Versioon",
        "version_input_message": "See arv peab alati olema suurem kui selle eelmine väärtus.",
        "version_name_input": "versiooni nimi",
        "version_name_input_message": "Sisestage selle rakenduse versiooni jaoks kordumatu nimi.",
        "use_selldone_key": "Müüdud vaikevõtmed",
        ...
        "splash_title_input_message": "See pealkiri kuvatakse suures kirjasuuruses.",
        "splash_message_input": "Käivituskuva teade",
        "splash_message_input_placeholder": "Sõnum...",
        "splash_message_input_message": "See teade kuvatakse allpool pisipildina.",
        "dark_theme": "Tume teema",
        "light_theme": "kerge teema",
        "build": "Ehitada",
        "building_info": "Rakenduse loomine pilveserveris võtab aega 10 sekundit kuni mitu minutit. Palun ole kannatlik. Allalaadimisfaili link kuvatakse siin, kui rakendus on valmis.",
        ...
        "notifications": {
          ...
          "start_building_message": "Taotlus Androidi rakenduse loomiseks on esitatud.",
          "build_success_title": "Palju õnne",
          "build_success": "Teie Androidi rakendus on valmis ja saate selle kohe alla laadida."
        }
      }
    },
    "automation": {
    ...
    "edit": {
      ...
      "info": {
        ...
        "description_tab": {
          "title": "Sinu ärilugu",
          "subtitle": "Kirjutage oma ettevõttest ja selle ainulaadsest väärtuspakkumisest."
        },
        "contact_tab": {
          "title": "Kontakt ja kohalik äri",
          "subtitle": "Avalik kontaktteave ja Google'i kohaliku ettevõtte seadistamine."
        },
        "image_tab": {
          "title": "Logo",
      ...
      "badge": {
        ...
        "external_message": "Siin saate sisestada märgi pildi aadressi ja selle lingi. URL-id peavad pärinema kinnitatud veebisaidilt."
      },
      "edit_menu": {
        "title": "Menüüd",
        "footer": {
          "title": "Jaluse menüü",
          "sub_title": "Siin saate seadistada oma poe lehe alumise menüü. Need menüüd võivad olla kodulehed, kujundatud lehed või välislingid."
        },
        "header": {
          "title": "Päise menüü",
          "sub_title": "Seda menüüd kuvatakse ainult mobiiliekraanidest suurematel ekraanidel ning avalehe, tootekategooriate, maandumiste ja tootelehtede ülaosas."
        },
      ...
      "social": {
        ...
        "message": "Sisestage sellesse jaotisesse oma ametlik sotsiaalmeedia link. Aadresside kinnitamiseks järgige iga üksuse juhiseid."
      },
      "time": {
        "title": "Tööpäevad",
  ...
  "add_product": {
    ...
    "edit_info": {
      ...
      "sku": "SKU",
      "sku_message": "Laoseisu üksus",
      "mpn": "MPN",
      "mpn_message": "Tootja osa number",
      "status": "Olek",
      ...
      "is_original_message": "Kui te oma toodet originaali ei määra, kuvatakse selle toote puhul võltsmärk.",
      "return_warranty": "Mitu päeva on sellel tootel tagastusgarantii?",
      ...
      "condition": "Toote seisukord teie kaupluses",
      "condition_message": "Peate valima sellel väljal ühe väärtustest.",
      ...
      "marketplace": {
        "vendor_panel_message": "<b>{vendor_name}</b> on toote omanik.",
        "subscription_message": "Tellimustoodetel võib olla üks tarnija, nii et saate luua need hankija paneelil või määrata neile loomise etapis hankija. Valitud müüja on toote omanik.",
        "default_message": "Saate määrata, kas see toode kuulub ühele müüjale ja seetõttu saab seda müüa ainult üks müüja või kuulub see toode Marketplace'i ja rohkem kui üks müüja võib seda müüa.",
        "single_vendor_title": "Üksik müüja",
        "single_vendor_desc": "See toode kuulub tarnijale ja valitud tarnija saab seda hallata.",
        "multi_vendors_title": "Mitu müüjat",
        "multi_vendors_desc": "See toode kuulub turule ja seda saab muuta ainult turu paneelil."
      }
    },
    "rating_pros_cons": {
      "title": "Küsitlus",
      "message": "Sisestage oma klientidele toote spetsifikatsioonide loend, et teie toodet hinnata. (Kuni 5 eset)",
      ...
      "pros_group_messages": "Toote peamised omadused",
      "cons_title": "Miinused",
      ...
      "cons_group_messages": "Toote peamised nõrkused",
      ...
      "rating_input_placeholder": "Kirjutage siia oma kohandatud küsitluse küsimus... ja vajutage sisestusklahvi!"
    },
    "edit_spec": {
      "title": "Tehnilised kirjeldused",
      "sub_title": "Saate importida sarnaste toodete tehnilisi kirjeldusi.",
      ...
      "notifications": {
        ...
        "enter_item_title_and_value_error": "Sisestage funktsiooni pealkiri ja väärtus",
    ...
    "edit_images": {
      ...
      "images": {
        ...
        "sub_title": "Laadige selles jaotises üles kõikide tootevariantide jaoks ühised tootepildid."
      },
      "video": {
        "title": "Video",
        "sub_title": "Esmalt laadige oma tootevideo Youtube'i üles ja seejärel sisestage video URL siia."
      }
    },
    "pricing": {
      ...
      "commission_message": "See valik on kasulik ainult teatud tüüpi kaupmeestele, näiteks hulgimüüjatele. Kui te ei ole hulgimüüja, jätke see valik tühjaks. Hind, mida ostjad näevad, on hinna ja komisjonitasu summa. Maksu lisamiseks klõpsake Raamatupidamine > Maks.",
    ...
    "inputs_edit": {
      ...
      "sub_title": "Saate luua iga toote jaoks andmesisestusvormi, nii et ostjad saadavad teile toote ostmisel teavet. Näiteks võib see teave olla kivile graveeringu nimi.",
      "message_input": "Sõnum kasutajale",
      "message_input_message": "Seda teadet näidatakse kliendile toodete ostmisel.",
      "inputs_form": "Teabe struktuur (sisend)"
    },
    "extra_edit": {
      "physical": {
        "title": "saadetise info",
        "sub_title": "Maksumus ja valmistamise aeg arvutatakse selles jaotises oleva teabe põhjal. Info sisestage kindlasti poes valitud ühikute järgi (kaal, mõõdud, vahemaa)."
      },
      "notifications": {
    ...
    "variants": {
      "not_available": "Seda tüüpi toote jaoks ei ole praegu võimalik varianti valida."
    },
    "delete_product": {
  ...
  "product_admin": {
    ...
    "dashboard": {
      ...
      "orders": {
        ...
        "send_30days_title": "Tellimused tarnitud viimase 30 päeva jooksul",
        "downloads_30days_title": "Viimase 30 päeva jooksul allalaaditud faili number",
        "virtual_orders_title": "Selle toote tellimused ootavad täitmist"
      },
      "inventory": {
        "title": "Inventuur",
        "title_small": "Ladu",
        ...
        "total_sell_30days": "Viimase 4 päeva müük",
        "chart": {
          "labels": [
            "Inventuur",
            "Soodustus"
      ...
      "finance": {
        "title": "Rahaline",
        "title_small": "Viimase 6 kuu ostuaruanne",
      ...
      "inform": {
        ...
        "message": "Teavitage kliente, kui tooted müügile jõuavad või saadavale tulevad",
    ...
    "inventory": {
      "variants": {
        ...
        "sub_title": "Kui sellel tootel on rohkem kui üks variant, sisestage need sellesse jaotisesse. Iga variandi puhul saate eraldi määratleda summa, hinna ja allahindluse; vastasel juhul rakendatakse hinnakujunduses toote vaikeväärtusi.",
      ...
      "variant_add_edit": {
        "title": "Tootevariandi määratlemine",
        ...
        "variant_variable": "Variantmuutujad",
        "pricing": "Hinnakujundus",
        "has_pricing_input": "Kas hind erineb põhitoote hinnast?",
        "inventory": "Inventuur",
        "inventory_unit": "Üksused",
        "delivery_info": "Pakendamine ja saatmine",
        "images": "Variandi pildid",
        "images_message": "Pärast selle variandi salvestamist saate siia pildi lisada."
      }
    },
    "edit_article": {
      "menu": {
  ...
  "product_extra_physical": {
    ...
    "bulk_action_msg": "Määra kõikidele variantidele toote pakendamise ja valmistamise aeg."
  },
  "product_images_list": {
  ...
  "shop_warehouse_edit": {
    "title": "Lisa ladu",
    "message": "Saatekulu arvutamiseks sisestage oma lao aadress ja profiil.",
    "name_input": "Lao nimi",
    "address": "aadress",
  ...
  "inventory_list": {
    ...
    "bulk_price_dialog": {
      "title": "Hulgitoimingud > Hind",
      "message": "Märkus. Järgmine summa rakendub protsendina kõigi teie poe toodete hinnale. Samuti teisendatakse arvutatud hinnaväärtused arukalt lähimaks vooru numbriks valitud valuuta alusel. Olge väärtuste sisestamisel ettevaatlik.",
      "check": "Kiidan hinnamuudatused heaks.",
      "add_percent_tab": "Lisa protsent",
      "add_constant_tab": "Lisa konstant",
      "ending_tab": "Lõpetamisstrateegia"
    },
    "bulk_discount_dialog": {
      "title": "Hulgitoimingud > Allahindlus",
      "message": "Märkus. Järgmine summa arvestatakse protsendina kõigi teie poe toodete allahindlusest. Samuti teisendatakse arvutatud allahindlusväärtused arukalt lähimaks vooru numbriks valitud valuuta alusel. Olge väärtuste sisestamisel ettevaatlik.",
  ...
  "contact_messages_list": {
    ...
    "dialog": {
      ...
      "mail_input_message": "Kui lubate selle, saadetakse teie vastus kasutaja meilile."
    },
    "delete_alert": {
      "title": "Kustuta sõnum",
  ...
  "campaign": {
    ...
    "dashboard": {
      ...
      "no_links": "Andmed puuduvad! Looge link oma kampaaniale.",
    ...
    "finance": {
      ...
      "total_revenue": "Kogutulu kampaaniate kaupa",
    ...
    "setting": {
      ...
      "general_setting": {
        ...
        "auto": "Vaikekampaania",
        "auto_message": "Vaikekampaania on teie poes aktiveeritud"
      },
      "time_setting": {
        "title": "Ajavahemik",
        "sub_title": "Alguskuupäev ja kellaaeg / Lõppkuupäev ja kellaaeg",
        "start_input": "Alusta",
      ...
      "banner_setting": {
        "title": "Poe bänner",
        "sub_title": "Kuva poe lehe ülaosas",
        ...
        "icon_input": "Ikoon",
        "icon_input_hint": "Materjalikujunduse ikooni nimi või Fontawsom: fas fa-staar",
      ...
      "notifications": {
        ...
        "persistence": "Püsivus",
        "persistence_message": "Kas soovite näidata iga kord, kui teie kasutaja veebisaiti külastab",
        "radius": "Raadius",
  ...
  "add_category": {
    ...
    "filter": {
      ...
      "message": "Sisestage ja salvestage allolevasse kasti selle kategooria ühise tehnilise funktsiooni pealkiri. Pärast loendi salvestamist kuvatakse filtrikategooriad koos iga kategooria sisuga. Tootevariandist ekstraheeritakse automaatselt värv, kaal, suurus, kaubamärk jne."
    },
    "delete_alert": {
    ...
    "edit_filter": {
      ...
      "spec_input_message": "Funktsioonide loend, mida soovite filtri jaotises kuvada",
      "price": "hind",
      "min": "Min",
      "max": "Max",
      "suggested_list": {
  ...
  "add_shop": {
    ...
    "name_input_tips": "Ärge kasutage mitte-ingliskeelseid tähemärke, tühikuid ega tähti, kui kasutate, ei pruugita poe nime õigesti kuvada.",
    ...
    "phone_input_tips": "Sisestage kontaktnumber koos riigikoodiga. Seda numbrit kasutatakse ka teabe kuvamiseks Google'i otsingus.",
    "email_input": "Meil",
  ...
  "virtual_items_list": {
    ...
    "add_virtual_item_desc": "Virtuaalsete toodete müümiseks peate need sellesse jaotisesse lisama. Virtuaalsete üksuste arv on võrdne selles jaotises olevate tasuta üksuste arvuga. Kui kliendid virtuaalse üksuse ostavad, saadetakse neile link.",
  ...
  "add_virtual_item": {
    ...
    "message": "Kaupluse juhataja saab pärast makse sooritamist ostjale väärtust näidata. Need väärtused tuleb sisestada allolevale vormile. Selle vormi struktuur määratakse jaotises Redigeeri üksust > Redigeeri väljundteavet.",
  ...
  "virtual_process_center": {
    ...
    "list_widget": {
      "title": "Tellimuse spetsifikatsioonid",
      "product_name": "tootenimi"
    },
    "inputs_widget": {
      "title": "Sisestusvorm",
      ...
      "change_inputs_action": "Redigeeri sisestusvormi"
    },
    "outputs_widget": {
      "title": "Väljundvorm",
      "table": {
  ...
  "process_order_page_dashboard": {
    ...
    "open_basket_cation": "See ostukorv on avatud, see tähendab, et klient on ostlemas ega ole veel tellimust tasunud.",
    "reject_dialog": {
      "title": "Tellimuse tagasilükkamise põhjus",
      "message": "Valige allolevast loendist selle tellimuse tagasilükkamise põhjus. Teavitage klienti kindlasti tühistamise ja raha tagastamise protsessist. Tagasimaksed tuleb teha 12 tunni jooksul.",
      "confirm_action": "Tühista tellimus",
    ...
    "notifications": {
      ...
      "dismiss_reject_success": "Tellimus naasis tavapärase protsessi juurde.",
  ...
  "process_center": {
    ...
    "payment_widget": {
      ...
      "payment_receipt_not_uploaded_error": "Maksekviitungit pole veel üles laaditud!",
      "waiting_for_pay": "Ootel makse",
      "processing_payment": "Makse töötlemine",
      "processing_cancel": "Makse tühistatud",
      "paid": "Tasuline",
      "cod_pay_info": "Kui olete kliendilt tellimuse kätte saanud, saate makse kinnitada ja tellimuse vormistada.",
      "dir_pay_info": "Üleval kuvatakse maksekviitung. Enne makse kinnitamist kontrollige oma pangast sissemakse summat ja kviitungiteavet.",
      ...
      "add_transactions_message": "Selle tellimuse jaoks peate looma vähemalt ühe tehingu. Mõnel juhul tuleb tasuda mitmes etapis. Milliste tehingute eest peab kasutaja tasuma, määrate ise töö käigus.",
      "add_bill_dialog": {
        "title": "Lisa arve",
        "message": "Sellele tellimusele saate lisada ühe või mitu uut arvet. Klient näeb neid arveid ja maksab igaüks vastavalt töö edenemisele.",
      ...
      "bill_cash_payment_dialog": {
        ...
        "message": "Kui ostja on käesoleva arve summa tasunud sularahas või muul viisil kui veebimaksega, registreerige selles jaotises suvandit valides ja kinnitage oma makse. Selles jaotises näete ainult oma poe sularahamaksete lüüsi.Kui te sellist valikut ei näe, peate oma poes aktiveerima sularahamaksete lüüsi valitud valuutas.",
      ...
      "samin": {
        "title": "Teenustasu",
        "description": "See summa on teie Selldone'i rahakoti kontolt maha arvatud.",
        "tooltip": "Arvutage makseviisi järgi",
        "percent": "protsenti"
      },
      "affiliate": {
        "title": "Sidusettevõtte komisjon",
        "affiliate_message": "Peaksite selle vahendustasu maksma oma sidusettevõttele. Seda protsessi tehakse ise."
      },
      ...
      "pay_cod_dialog": {
        ...
        "message": "Kinnitage see valik sularahas kohaletoimetamise makseviisis pärast kliendi poolt täieliku tasumise tagamist.",
        "confirm_action": "Kinnitage kliendi makse"
      },
      "pay_dir_dialog": {
        "title": "Kas saite tellimusraha?",
        "message": "Kinnitage see valik pärast üleslaaditud maksekviitungi kinnitamist oma pangaga. Kontrollige makset kindlasti oma pangast.",
        "confirm_action": "Kinnitage kliendi makse"
      },
      "notifications": {
        "pay_confirm_message": "Makse on kinnitatud.<br> Port: {gateway_name}<br> Kuupäev: {payment_at}",
    ...
    "basket_list": {
      ...
      "message": "Kui mõni toode pole saadaval või seda ei saa müüa, tühjendage selle kõrval olev ruut ja klõpsake nuppu <b>Kinnita tellimus</b> .",
      ...
      "lottery_prize_inform": "Teie klient võidab seda toodet 1x. Saada kingitus selle tellimusega."
    },
    "preparing": {
      "title": "Ettevalmistus",
      ...
      "message": "Kui tellimus on saatmiseks valmis, klõpsake nuppu <b>Tellimus</b> on valmis.",
    ...
    "return_delivery_dialog": {
      ...
      "message": "Kinnitage saadetise tagastamise võimalus, kui tellimus tagastatakse mingil põhjusel pärast saatmist ja tekib vajadus saadetis uuesti saata.",
    ...
    "notifications": {
      ...
      "pay_dir_success": "Makse kinnitati kaardimaksega või rahaülekandega.",
      "set_tracking_success": "Tellimuse raja ID salvestamine õnnestus.",
  ...
  "shop_gateway": {
    ...
    "dashboard": {
      ...
      "gateway_info_widget": {
        ...
        "title_small": "Värav",
        "status": "Olek",
        "cod_transportation": "Saatmisviisid thst toetavad järelmaksu",
        "cod_transportations_error": "Lubage sularahamakse vähemalt ühe tarneviisi puhul!",
        "payment_type": "Makse tüüp",
        "cod": "Kohaletoimetamise sularaha",
        "online": "Online makse",
        "wage_percent": "Tasu protsent",
        "min_wage": "Minimaalne tasu",
        "max_wage": "Maksimaalne tasu",
        "min_amount": "Minimaalne tehing",
        "max_amount": "Maksimaalne tehing",
        "timeout": "Makseperiood",
        "timeout_unit": "Sekundid",
        "link": "Lüüsi link",
        "your_gateway_status": "Teie lüüsi olek",
        "config_extra_info": "Makseteenuse konfiguratsioon",
        "oauth2_button": "Automaatne ühendumine võrguga {gateway}",
        "fee_payment_message": "Kogu kliendi poolt tasutud summa kantakse Sinu kontole. Teenustasu arvatakse Selldone'is teie rahakotist maha."
      }
    },
    "edit": {
      "title": "Muuda lüüsi",
  ...
  "edit_gateway": {
    ...
    "link": "Veebileht",
    "state_title": "Aktiivne/mitteaktiivne makseviis",
    "gateway_status": "Olek",
    "wallet": "Blockchaini rahakott",
    "developer_title": "Arendaja režiim",
    "developer_message": "Saate töödelda võltsitud tehinguid, kui lüüs toetab silumisrežiimi.",
    "notifications": {
  ...
  "timeline": {
    ...
    "buy": "Kassasse",
    "payment": "Makse",
    "confirm": "Tellimuse kinnitus, <b>{success}</b> kinnitatud ja <b>{fail}</b> tagasi lükatud.",
    ...
    "delivery-returned": "Tellimust klient ei saanud ja see tagastati. On vaja uuesti saata.",
  ...
  "accounts": {
    "title": "Minu rahakott",
    "message": "Peate looma vähemalt ühe konto selle valuutaga, mida Selldone'is kasutate. Teenustasu maksmiseks peate seda kontot täiendama.",
    ...
    "new_account_dialog": {
      ...
      "currency_input_message": "Loodud kontole jäävad ainult selle valuuta väärtused.",
  ...
  "user_gifts": {
    ...
    "send_gifts": {
      ...
      "sub_title": "Saate saata kingitusi oma sõpradele või klientidele. Kingituse saaja võib teie kingituse vastu võtta või tagasi lükata. Summa lukustatakse teie kontol ja võetakse välja, kui saaja nõustub. Vastasel juhul kantakse see summa teie kontole.",
      "table": {
        "user": "Kasutaja",
        "amount": "Summa",
        "currency": "Valuuta",
    ...
    "received_gifts": {
      ...
      "sub_title": "Teie saadud kingitused Selldone'ilt või teistelt",
      "table": {
        "amount": "Summa",
        "currency": "Valuuta",
        "account_from": "Alates",
  ...
  "get_gift_dialog": {
    ...
    "notifications": {
      ...
      "received_success": "Kingituse summa {amount} {currency} on teie kontole kantud."
    }
  },
  "send_gift_dialog": {
  ...
  "user_monetize_accounts": {
    ...
    "notifications": {
      ...
      "delete_success": "Konto on edukalt eemaldatud kingituste vastuvõtmise vaikekontode loendist."
    },
    "delete_alert": {
      "title": "Kustuta konto",
      "message": "Kas soovite selle konto kingituskontode loendist eemaldada?",
      "action": "Kustuta"
    }
  },
  "user_monetize": {
  ...
  "user_monetize_plans": {
    ...
    "sub_title": "Saate soovituskingituste eest kontokrediiti. Need summad kantakse teie kontolt ja neid saab välja võtta ainult Selldone'i äripartneritelt (mitte kõigilt). Võite kulutada raha Selldone'i teenustasule.",
    "discount": "Allahindlus",
    ...
    "link_tip": "Saate lisada fraasi ?ref={link_code} iga jagatud aadressi lõppu.",
    "table": {
      "currency": "Valuuta",
      "amount": "Tasakaal",
      "total": "Kogu makse",
    ...
    "notifications": {
      "get_credit_success": "Soovitud summa on teie kontole kantud."
    }
  },
  "basic_information": {
    ...
    "main_profile_subtitle": "See teave on kõigile avalikult kättesaadav.",
    "kyc_waiting_info": "Kontrollime teie sisestatud teabe õigsust. See protsess on KYC reeglite kohaselt kohustuslik ja vähendab finantstehingute riski. Saate kasutada selle teenuse praegusi ja tulevasi eeliseid.",
    "personal_info_dialog": {
      ...
      "passport_image_input_message": "Laadige üles oma passipildi skanneering.",
      "personal_image_input": "Valige oma pilt",
      "personal_image_input_message": "Laadige skannitud pilt oma rahvuskaardile pildile edasi-tagasi."
    },
    "profile_dialog": {
      ...
      "image_input_message": "Laadige oma pilt üles. Seda pilti kasutatakse teie profiilipildina.",
      "notifications": {
        "update_profile_success": "Teie profiili on värskendatud.",
        "update_personal_info_success": "Teie andmed registreeriti edukalt"
      }
    },
    "charge_account_approve_message": "Pangatehingu kinnitamiseks võtke oma kontolt tasu.",
    "payment_approval": "Makse kinnitamine",
    "residential_address_checking": "Teie elukoha aadressi dokumendid on kontrolljärjekorras.",
    "add_residential_address": "Lisage oma asukoht ja elukoha aadressi tõendavad dokumendid."
  },
  "phone_verify": {
    "title": "Mobiili number",
    "step1_title": "Sisesta oma mobiilinumber.",
    ...
    "notifications": {
      ...
      "send_activation_code_success": "Kinnituskood saadeti numbrile {phone_number}.",
      "verify_success": "Teie mobiilinumber on kinnitatud"
    }
  },
  "companies": {
    "title": "Minu ettevõtte kontod",
    "message": "Ettevõtted, ettevõtjad ja professionaalsed meeskonnad saavad arendada tooteid ja rakendusi, mis põhinevad Selldone'il. Ettevõtteprofiili loomine on kohustuslik.",
  ...
  "user_access_control": {
    ...
    "connected_apps_message": "Näete kõigi teie domeenikontoga ühendatud poodide ja rakenduste loendit. Saate juurdepääsu mõnele neist kustutada.",
  ...
  "user_security_control": {
    ...
    "delete": {
      "title": "Kustuta konto",
      "subtitle": "Enne konto kustutamist veenduge, et olete kõik poed kustutanud.",
      "action": "Olen kindel, kustutage mu konto",
      "agreement": "Nõustun, et kogu minu teave kustutatakse teie serverist. Teie teave kustutatakse vastavalt meie määratud ajakavale, et vältida pettusi või väärkasutust."
    },
    "list": {
      "password": {
        "title": "Parool",
      ...
      "phone": {
        "title": "Mobiili number",
        "sub_title": "Kinnitage oma mobiiltelefoni number. Selle numbri kaudu saate sisse logida.",
      ...
      "email": {
        ...
        "sub_title": "Teil on võimalus värskendada selle kontoga seotud peamist e-posti aadressi.",
    ...
    "two_step_auth": {
      ...
      "step_2": {
        ...
        "message": "6-kohaline kood genereeritakse teie mobiiltelefoni algoritmi abil. Rakenduse saate alla laadida järgmiselt lingilt. Parooli sisaldava QR-koodi loomiseks vajutage koodigeneraatori klahvi.",
        "qr_code_info": "Kui skannimine pole võimalik, saate koodi käsitsi kopeerida ja rakendusse kleepida.",
        "create_new_code": "Loo uus kood",
        "qr_code_scanning": "Skannige Google Authenticator Mobile Appi loodud QR-kood ja sisestage selle lehe kasti kinnitamiseks genereeritud kood.",
        "qr_code_regenerate_info": "Märkus. Ülaltoodud klahvi vajutamisel luuakse uus võti ja eelmine klahv muutub kasutuskõlbmatuks. Sisestage oma telefonirakendusse uus võti."
      },
      "step_3": {
        "title": "Sisestage loodud kood",
        "message": "Sisestage allolevale väljale rakenduses loodud pääsukood.",
        "activation_key_input": "Juurdepääsukood"
      },
      "activated_alert": "Kaheastmeline sisselogimine on lubatud.",
      "activated_message": "Teie kontole on lubatud kaheastmeline sisselogimine. Nüüdsest peate oma kontole juurdepääsuks sisestama teise koodi, mis muutub iga 30 sekundi järel. Kaheastmelise sisselogimise keelamiseks topeltklõpsake nuppu Vajutage sammu ja minge läbi.",
      "cancel_two_step_login_action": "Kaheastmelise sisselogimise tühistamine",
      "cancel_two_step_login_info": "Kui soovite kaheastmelise kinnitamise keelata, sisestage oma parool ja klõpsake kaheastmelisel sisselogimisklahvil.",
  ...
  "authorized_clients": {
    ...
    "delete_alert": {
      "title": "Kustuta",
      "message": "Kas soovite selle juurdepääsu tühistada? Pange tähele, et sellel rakendusel ei ole enam juurdepääsu teie kontole.",
  ...
  "personal_access_tokens": {
    ...
    "access_token_dialog": {
      ...
      "message": "Siin on teie isikliku juurdepääsumärgi tunnus. See on ainus kord, kui seda märki näidatakse, nii et ärge jätke seda ilma! Nüüd saate seda luba kasutada API taotlemiseks."
    },
    "delete_alert": {
      "title": "Kustuta",
  ...
  "scopes": {
    "profile": {
      "name": "profiil",
      "description": "Lugege profiiliteavet, sealhulgas nime, e-posti aadressi, pilti ja autentimise olekut."
    },
    "phone": {
      "name": "telefoninumber",
    ...
    "notifications": {
      "name": "Saatke ja võtke vastu teateid",
      "description": "Saatke ja võtke vastu teateid."
    },
    "read-shops": {
      "name": "Kaupluse ist",
      "description": "Lugege poe nimekirja."
    },
    "shop-edit": {
      "name": "Kaupluse juhtimine",
      "description": "Muutke poe juurdepääsu"
    },
    "shop-contacts": {
      "name": "Kontaktvormi haldus",
      "description": "Võtke vastu ja muutke kontaktivorme."
    },
    "shop-gift-cards": {
      "name": "Kinkekaartide haldamine",
      "description": "Looge, muutke ja hallake kinkekaarte."
    },
    "shop-faqs": {
      "name": "Küsimuste ja vastuste haldamine",
      "description": "Looge, redigeerige ja hallake korduma kippuvaid küsimusi."
    },
    "shop-categories": {
      "name": "Kategooriate haldamine",
      "description": "Looge, muutke ja hallake kategooriaid."
    },
    "shop-products": {
      "name": "Tootehaldus",
      "description": "Lisage, muutke ja hallake tooteid."
    },
    "shop-read-reports": {
      "name": "Lugege aruandeid",
      "description": "Lugege teavet ja aruandeid."
    },
    "shop-socials": {
      "name": "Hallake sotsiaalmeediat",
      "description": "Muutke poe sotsiaalmeediat"
    },
    "shop-accounts": {
      "name": "Hallake finantskontosid",
      "description": "Muutke ja kustutage poega lingitud finantskontosid."
    },
    "shop-menus": {
      "name": "Menüüde haldamine",
      "description": "Muutke poe menüüsid."
    },
    "shop-pages": {
      "name": "Lehtede haldamine",
      "description": "Redigeeri poe lehti."
    },
    "shop-warehouse": {
      "name": "Laohaldus",
      "description": "Redigeeri poe ladu"
    },
    "shop-permissions": {
      "name": "Juurdepääsu haldamine",
      "description": "Poe juurdepääsu vaatamine ja muutmine."
    },
    "shop-process-center": {
      "name": "Tellimuste haldamine",
  ...
  "shop_permissions": {
    "ADMIN": {
      "text": "Omanik",
      "description": "Täielik juurdepääs kõikidele vitriinidele."
    },
    "PRODUCT": {
      "text": "Tootejuht",
    ...
    "MARKETING": {
      "text": "Turundus",
      "description": "Juurdepääs seadetele ja kampaaniate loomine, meiliturundus ja muud turundusega seotud jaotised."
    },
    "VIEWER": {
      "text": "Vaataja",
      "description": "Võimalus vaadata poe teavet, ilma et oleks võimalik seda redigeerida või muuta."
    }
  },
  "shop_roles": {
  ...
  "account_status": {
    ...
    "Banned": "Keelatud",
    "Payment": "Makse",
    "SelldoneSprite": "Müüdud rahakoti konto",
    "SelldoneStorage": "Müüdud hoiuruum"
  },
  "account_page": {
    "title": "Konto",
    "menu": {
    ...
    "transfer": {
      ...
      "form": {
        ...
        "sub_title": "Deposiit enda või teiste kontodele",
        "message": "Olge raha ülekandmisel ettevaatlik, ülekande sooritamisel ei saa te tagastada."
      }
    },
    "deposit": {
      "form": {
        "title": "Arvelduskonto",
        "sub_title": "Litsentside ostmiseks, konto uuendamiseks ja süsteemikviitungite maksmiseks peate oma konto saldot võtma.",
        "amount_input": "Summa",
  ...
  "transaction_form": {
    ...
    "confirmation": {
      ...
      "message": "Kui järgmine teave on õige, vajutage tehingu tegemiseks tehingu kinnitusklahvi.",
      "from": "Kontolt",
      "to": "Kontole",
      "amount": "Summa",
      "fee": "Ülekandetasu",
    ...
    "currency_not_match": "Sihtkonto valuuta ei ole sama mis lähtevaluuta",
  ...
  "login": {
    ...
    "register_subtitle": "Registreeruge täna tasuta. Selldone'i armastavad idufirmad, ettevõtted, ostjad ja müüjad.",
    "password_recovery_title": "Parooli taastamine",
    "password_recovery_message": "Kui unustasite parooli, sisestage oma konto e-posti aadress ja vajutage kinnitusklahvi. Saadame teile parooli lähtestamise lingiga meili.",
    ...
    "privacy_agreement": "Registreerudes nõustute Selldone'i <a href='/terms' target='_blank'>kasutustingimuste</a> ja <a href='/privacy' target='_blank'>privaatsuspoliitikaga</a> .",
  ...
  "page_builder": {
    ...
    "seo": {
      "message": "SEO sätteid reguleerib Selldone SEO mootor automaatselt."
    }
  },
  "verify_email_caution": {
    "title": "Kinnita oma E-maili aadress",
    "message": "Uus aktiveerimislink on saadetud teie e-posti aadressile {email}. Enne mis tahes toimingu tegemist kontrollige oma e-posti.",
    "resend_message": "Kui te pole oma meilis aktiveerimislinki saanud, klõpsake uuesti saatmiseks allolevat nuppu.",
  ...
  "shop_license": {
    ...
    "price": "hind",
    "terms": "Lugesin Selldone'i kasutustingimusi ja nõustun nendega",
    "need_charge": "Tasu vaja",
    "buy_now": "Osta kohe",
    "auto_renewal": "Automaatne uuendamine",
    "plan_placeholder": "Valige oma liitumisplaan",
    "plan": "Litsentsi plaan",
    "use_date": "Aktiveerimise kuupäev",
    "active_license": {
      "title": "Aktiivne litsents",
      "subtitle": "Teie aktiivse litsentsi teave.",
      "subtitle_partner": "Teie aktiivse {name} litsentsi teave."
    },
    "licenses_table": {
      "title": "Ostetud ajalugu",
      "subtitle": "Aktiivsed ja ootel litsentsid."
    },
    "license_detail": {
      "title": "Üksikasjad",
      "subtitle": "Teie praeguse plaani piirangud."
    },
    "table": {
      "plan": "Plaan",
  ...
  "shop_locations": {
    ...
    "sub_title": "Valige allolevast loendist riigid, kus soovite oma toodet müüa.",
  ...
  "product_studio": {
    ...
    "add_by_sku": "Lisa SKU järgi",
    "auto_category": "Automaatselt määratud kategooria",
    "add_in_current_category": "Lisa praegusesse kategooriasse",
    "category_mode_message": "Kui see on lubatud, lisatakse toode vaikekategooriasse või alamkategooriasse.",
    "sku_name_input": "SKU / nimi"
  },
  "my_affiliate": {
    "title": "Minu sidusettevõtte lepingud",
    "message": "Teiste kauplustega sõlmitud sidusettevõtete lepingute loend."
  },
  "affiliates": {
    "title": "Siduspartnerid",
    "subtitle": "Looge sidusettevõtteid, jälgige nende toimivust aja jooksul ja tehke ühes kohas täpse teabe põhjal toiminguid. Aitame teil ja teie partneritel luua tugeva suhte.",
    ...
    "link_domain": {
      "title": "Lingitud domeen",
      "subtitle": "Saate ühe oma domeenidest selle siduspartneriga ühendada. Seda partnerit tuntakse kõigi teie poodi külastavate ja selle domeeni kaudu ostvate inimeste esindajana."
    },
    "dialog": {
      "new": "Uus siduspartner",
      "edit": "Muuda siduspartnerit",
      "user": "Kasutaja (valikuline)",
      "bank_info": "Pangainfo",
      "restriction": "Piirang",
      "select_products": "Valige tooted",
      "select_products_message": "Siduspartner saab nende toodete eest komisjonitasu",
      "edit_action": "Värskenda sidusettevõtet",
      "add_action": "Lisa siduspartner",
      "affiliate_name": "Siduspartneri nimi",
      "payment_info": "Makseinfo",
      "enable_switch": "Kas see on aktiivne?",
      "affiliate_info": "Siduspartnerite teave"
    },
    "link_factory": {
  ...
  "discount_codes": {
    "title": "Sooduskoodid",
    "sub_title": "Selles jaotises saate kujundada oma vajadustele vastavaid sooduskuponge. Need allahindlused on toote allahindlustest eraldiseisvad ja kehtivad kasutaja tellimuse lõppsummale.",
    ...
    "dialog": {
      ...
      "limit_input_message": "Allahindluslimiidi väärtus 0 tähendab, et diskontomääral ei ole piirangut.",
      "title_input": "Pealkiri",
      "title_input_hint": "Sellele sooduskoodile saate sisestada pealkirja",
      "description_input": "Kirjeldus",
      "description_input_hint": "Selle sooduskoodi jaoks saate sisestada kirjelduse",
  ...
  "gift_cards": {
    "title": "Kinkekaart",
    "sub_title": "Looge kinkekaart ja seejärel tehke nii palju kui vaja. Sellel kaardil on tasu ja seda saab kasutada ainult teie poes ostmiseks.",
  ...
  "coupons": {
    "title": "Kupongid",
    "sub_title": "Kui soovite teha oma klientidele allahindlust, mida saab kasutada konkreetsete tingimustega, saate luua kuponge. Kupongid võivad sisaldada protsentuaalset allahindlust limiidiga või fikseeritud summaga või mõlema kombinatsiooni.",
  ...
  "coupon_edit": {
    ...
    "min_purchase_amount_hint": "Ostusumma peab olema sellest väärtusest suurem või sellega võrdne.",
    "should_exist_product": "Vähemalt üks neist toodetest peab olema ostukorvis",
    "apply_for_first_order": "Ainult esimesel ostul",
    "apply_for_first_order_on": "Seda kupongi saab kasutada ainult kliendi esimesel ostul!",
    "apply_for_first_order_off": "Kupongi kasutuskordade arvu ostja kohta saab reguleerida allpool.",
    "has_qualify_constraints": "Kas soovite määratleda rohkem piiranguid?",
    "has_qualify_constraints_message": "Määrake rohkem tingimusi, et kvalifitseerida klient seda kupongi kasutama.",
    "one_time_use": "Ühekordne kasutus",
  ...
  "offers": {
    "title": "Pakkumised",
    "sub_title": "Saate luua oma klientidele eripakkumisi, et pärast ühe kauba ostmist saaksid nad teise kauba allahindlusega või isegi tasuta.",
    "create_new": "Lisa uus pakkumine",
    "qualified_products": "Abikõlblikud tooted",
    "min_quantity": "Minimaalne kogus",
    "min_purchase": "Minimaalne ost",
    "discounted_products": "Allahinnatud tooted",
    "amount_usage": "Kasutatud kogus",
    "delete_alert": {
  ...
  "offer_edit": {
    ...
    "qualified_products": "Abikõlblikud tooted",
    "qualified_products_message": "Et tooted oleksid abikõlblikud, peab ostukorvis olevate kaupade koguarv olema võrdne miinimumkogusega või sellest suurem.",
    ...
    "per_order_message": "Maksimaalne kordade arv, mille jooksul saab pakkumist tellimusele rakendada",
    "count_input": "Summa",
    "count_input_hint": "Selle pakkumise maksimaalne kasutamine",
    "min_purchase": "Minimaalne ostusumma",
    "min_purchase_hint": "Ostuhind peab olema sellest väärtusest suurem või sellega võrdne",
    "limitation": "Piirang",
    "date_start_input": "Alusta",
    "date_start_input_placeholder": "Valige kupongi käivitamise aeg",
    "date_end_input": "Lõpp",
  ...
  "emails": {
    "title": "Meiliturundus",
    "subtitle": "Kujundage e-kirju pukseerides, ajastage ja käivitage kampaaniaid, et suurendada säilitamist ning näha ühes kohas usaldusväärset ja täpset teavet.",
    "cation_message": "⚠ Piiratud kinnitamata kaupmeestele. (beeta)",
    "subject": "Teema",
    "from": "Alates",
    "in_que": "Ootab",
  ...
  "email_dashboard": {
    ...
    "not_submitted_send_request": "Te pole veel selle meili saatmise taotlust esitanud.",
  ...
  "shop_lotteries": {
    "title": "Loterii",
    "sub_title": "Teie kliendid saavad mängida ja võita. Teie poe kliendid peavad iga mängu jaoks tarbima 10 žetooni. Näiteks kui soovite, et teie klientidel oleks võimalus võita 1000 USD, peate määrama iga kiibi hinnaks 100 USD. Iga kiibi väärtus 0 tähendab, et ostja saab iga ostu eest ühe kiibi.",
  ...
  "lottery_edit": {
    ...
    "currency_message": "Selle üksuse valuuta. Muud valuutad konverteeritakse vahetuskursi alusel.",
    "discount": "Allahindlus",
  ...
  "shop_tax": {
    ...
    "calculate_tax_message": "Selle valiku aktiveerimisel arvutatakse ja rakendatakse teie tellimustele käibemaks.",
    "tax_number": "Maksumaksu number",
    "tax_number_message": "Sisestage oma maksunumber. See registreerimisnumber kajastub ostja arvele.",
    "tax_included_in_price_input": "Toodete hinna sees käibemaks",
    "tax_included_in_price_message": "Valige see valik, kui lisate oma toote hinnale maksusumma. Maksusumma arvutatakse järgmise valemiga:",
    "tax_included_in_price_formula": "Maks = (hind * KM) / (1 + KM), näiteks 100$ hinna ja 10% lisandväärtuse määraga toote maksusummaks saab 9,09$.",
    "tax_on_shipping_input": "Kohaldage saatmisel maksud",
    "tax_on_shipping_message": "Selle valiku valimisel rakendub maks kohaletoimetamisele.",
    "fixed_tax_rate": "Fikseeritud maksumäär",
    "dynamic_tax_rate": "Maks piirkondadepõhiselt",
    "locations_tip": "Ülaltoodud loend näitab müüdavate riikidena ainult neid riike, mille olete valinud jaotises Poe seaded > Asukohad.",
  ...
  "delivery_person": {
    ...
    "pickup_dialog": {
      ...
      "message": "Kui vastutate selle paki vedamise eest, valige Jah, muul juhul valige Ei."
    },
    "status_dialog": {
    ...
    "cod_dialog": {
      "title": "COD makse",
      "message": "Kas kinnitate, et olete ostjalt tellimuse summa kätte saanud?",
  ...
  "pos_devices": {
    ...
    "Scanner_desc": "Vöötkoodiskanneri kasutamiseks tuleb sisestada toote SKU kood õigesti toote seadetesse.",
    "Printer": "Printer",
    "Printer_desc": "Printige oma klientide kviitung, ühendades kviitungi printeriga.",
    "CustomerView": "Kliendivaade",
    "CustomerView_desc": "Sellel lehel saate oma klientidele tellimuse üksikasju kuvada.",
  ...
  "exporter": {
    ...
    "subtitle": "Teie andmed kuuluvad teile! Saate oma ettevõtteteabe standardvormingus igal ajal alla laadida. Siiski austage oma klientide privaatsust, ärge saatke neile rämpsposti ega jagage kunagi nende teavet kolmandate osapooltega.",
    "excel": "Saate kõigi poes olevate {type} loendi koos täieliku teabega Exceli vormingus.",
  ...
  "importer": {
    "category": {
      ...
      "subtitle": "Laadige siia üles kategooriate CSV-fail. Veenduge, et järgite standardvormingut."
    },
    "product": {
      "title": "Import tooteid",
      "subtitle": "Laadige siia üles toodete CSV-fail. Veenduge, et järgite standardvormingut."
    },
    "product_images": {
      "title": "Impordi pilte",
      "subtitle": "Pildiinfo vastuvõtmine on aeganõudev. Piltide importimisel austage kindlasti autoriõigusi."
    },
    "inventory": {
      "title": "Varude hulgivärskendus",
      "subtitle": "Laadige siia üles varude CSV-fail. Veenduge, et järgiksite standardvormingut, eksportides esmalt CSV-faili ja seejärel seda faili redigeerides."
    },
  ...
  "campaigns": {
    "title": "Kampaaniad",
    "subtitle": "Looge kampaaniaid, jälgitavaid linke ning vaadake usaldusväärset ja täpset teavet ühes kohas. Aitame teil teha paremaid andmepõhiseid otsuseid.",
  ...
  "shop_theme": {
    ...
    "products_view_mode_desc": "Saate kohandada oma poes olevate toodete kuvamisrežiimi vastavalt ekraani suurusele. Seda režiimi võetakse vaikimisi arvesse ja seda ei rakendata, kui kasutaja muudab kuvarežiimi.",
  ...
  "my_roles": {
    "title": "Minu rollid",
    "message": "Rollid on poe töötajatele antud juurdepääsu tüüp. Näiteks tellimuste saatmise või pakkimise eest vastutavad töötajad."
  },
  "role_card": {
  ...
  "referral_widget": {
    "apply_now": "Kandideeri kohe sellesse programmi!",
    "no_bonus": "Saate esimese auhinna, kutsudes sõbra.",
    "your_gift": "Sinu kingitus",
    "invited_gift": "Kutsutud kingitus",
    "percent_bonus": "Protsentuaalne boonus",
    "discount_bonus": "Soodusboonus",
    "registered": "Uus kasutaja",
    "accepted": "Aktsepteeritud kasutaja"
  },
  "app_config": {
    "reviews": "Arvustused",
    "rate_now": "Hinda kohe",
  ...
  "shop_bots": {
    ...
    "dialog": {
      ...
      "message": "Põhjalik robotite raamistik ettevõttetasemel ostukogemuste loomiseks."
    }
  },
  "shop_customers": {
  ...
  "app_loader_page": {
    ...
    "no_ui_desc": "Mõned rakendused ei vaja oma administraatorialas kasutajaliidest. See rakendus võib koodi lisada ainult teie poe veebisaidi päise jaotisesse.",
    "header": "Päise kood"
  },
  "finance_report": {
    "export_title": "Ekspordi finantsandmeid",
    "export_sub_title": "Laadige finantsandmed alla ühes failis.",
  ...
  "shop_notifications": {
    ...
    "dialog": {
      ...
      "message": "Põhjalik teavitusraamistik ettevõttetasemel e-kaubanduse kogemuste loomiseks.",
      "action": "Kliki siia!",
  ...
  "order_delivery": {
    ...
    "message": "Pärast paki saatmiskulerile üleandmist klõpsake nuppu <b>Kinnita kohaletoimetamine</b> .",
    "message_add_to_service": "Kui soovite selle paki <b>kohaletoimetamise teenusega</b> saata, klõpsake allolevat nuppu.",
    "action": "Kohaletoimetamise kinnitus",
    "checklist": [
    ...
    "manual": {
      ...
      "message": "Märkus. Kui klient saab tellimuse kätte, saate täitmise lõpetamiseks kasutada järgmisi võimalusi. Mõned süsteemis olevad saatmisteenused kinnitavad kohaletoimetamise automaatselt."
    },
    "auto_complete_note": "Teatud aja möödudes muudetakse tellimuse olek tarnituks. See periood erineb olenevalt tellimuse tüübist ja selle määrab süsteem.",
    "received": {
    ...
    "tracking": {
      ...
      "code": "Jälgimiskood",
      "url": "Jälgimise URL",
      "message": "Kui olete tarninud teenuse kaudu, mis pakub sellele tellimusele jälgimiskoodi, saate sellesse jaotisesse sisestada koodi ja asjakohase jälgimislingi. Seda teavet näidatakse kliendile."
    },
  ...
  "widget_shop_gateway": {
    "link_account_caution": "Linkige konto ({currency}) oma poega! Kliki siia.."
  },
  "product_sell_widget": {
  ...
  "fulfilment_order_widget": {
    ...
    "message": "Pärast tarnijale tellimistasu tasumist vaadake selles jaotises tellimuse saatmise edenemist."
  },
  "drop_shipping": {
    "menu": {
      "dashboard": "Armatuurlaud",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Teie tellimus on registreeritud otsemaksena, palun viige makse lõpule ja laadige kviitung üles oma tellimuse lehele.",
      "pay_title": "Makse",
  ...
  "dropship_checkout": {
    ...
    "notifications": {
      "success_pay": "Teie makse nende tellimuste eest on kinnitatud ja edukalt lõpule viidud."
    }
  },
  "dropship_accounts": {
    "charge_account": "Tasu konto",
  ...
  "dropshipping_products": {
    "no_shops": "Kahjuks poodi ei leitud. Tulevikus on poode rohkem, et saaksite nende tooteid oma poodi panna.",
  ...
  "product_dropshipping": {
    ...
    "changed_value": "Seda toodet on redigeerinud esialgne müüja. Kontrollige muudatusi ja kui nõustute muudatuste rakendamisega oma tootele, klõpsake allolevat nuppu.",
    "changed_value_action": "Nõus, tee muudatusi",
    "parent_deleted": "Algne müüja eemaldas selle kauba.",
    "parent_closed": "Algne müüja on selle toote keelanud! Te ei saa seda toodet oma poes müüa, kuid kui algne müüja toote uuesti aktiveerib, saate selle toote oma poes uuesti aktiveerida.",
    "notifications": {
      "re_enable_success": "See toode on uuesti aktiveeritud.",
      "update_success": "Seda tooteteavet värskendati algse tooteteabega."
    }
  },
  "product_dropshipping_admin": {
    "title": "Dropshipping",
    "save_alert": "Selle toote dropshipping seaded on muutunud. Kas soovite muudatused salvestada?",
    "reselling_message": "Selle valiku aktiveerides saavad teised müüjad teie toote oma poodi lisada.",
  ...
  "product_info": {
    ...
    "notifications": {
      ...
      "waiting_list_add_success": "Anname teile teada, kui see toode oksjonile läheb.",
  ...
  "shop_contacts": {
    ...
    "popup_message": "Selle valiku aktiveerimisel kuvatakse tugivõti teie poe paremas alanurgas."
  },
  "popup_page": {
  ...
  "popup_appearance": {
    "position": "positsioon",
    "position_desc": "Määrake selle teatise kuvamiskoht lehel.",
    "width": "Laius",
    "width_desc": "Saate määrata lehe maksimaalse laiuse.",
    "height": "Kõrgus",
    "height_desc": "Saate määrata lehe maksimaalse kõrguse.",
    "radius": "Nurga raadius",
    "radius_desc": "Selles jaotises saate määrata teatise nurkade kõverusraadiuse.",
    "shadow": "Vari",
    "shadow_desc": "Kas soovite, et hüpikaken oleks varjutatud?",
    "delay": "Näita viivitust",
    "delay_desc": "Kui kasutaja teie poodi siseneb, kuvatakse pärast selle aja möödumist kasutajale teatis.",
    "hide": "Peida viivitus",
    "hide_desc": "Saate määrata, et märguanne sulguks automaatselt mõni sekund pärast etendust. Väärtus 0 tähendab, et teade ei sulgu automaatselt.",
    "transition": "Hüpikanimatsioon"
  },
  "popup_filter": {
    "registered": "Liikmeks ja sisselogimise nõue",
    "registered_desc": "Saate valida selle märguande kuvamise ainult poe kasutajatele või külalistele.",
    "only_guests": "Ainult külalised",
    "only_users": "Ainult sisse loginud kasutajad",
    "purchased": "Ostude ajalugu",
    "purchased_desc": "Saate valida selle teatise kuvamise ainult kasutajatele, kes on juba ostnud või kes pole veel ostnud.",
    "no_purchase": "Ostu veel pole",
    "yes_purchase": "Ostetud enne",
    "sex": "Sugu",
    "sex_desc": "Kas soovite, et seda teatist näidataks ainult kindlast soost kasutajatele?",
    "age": "Minimaalne vanus",
    "age_desc": "Kui sisestatakse mõni väärtus, mis on suurem kui 6, peab kasutaja olema sisse logitud ja sisestanud oma sünnikuupäeva.",
    "levels": "Kliendiklubi tasemed",
    "levels_desc": "Kui kasutajal on üks allpool valitud tasemetest, kuvatakse talle see märguanne.",
    "countries": "Asukohapiirangud",
    "countries_desc": "Kas soovite, et seda teatist kuvataks ainult konkreetsest riigist pärit kasutajatele?"
  },
  "popup_setting": {
    "published": "Avaldatud olek",
    "repeat": "Korda",
    "repeat_msg": "Kas soovite, et seda teatist kuvataks kasutajale rohkem kui üks kord?",
    "intervals": "Hüpikakna kuvamise kestus",
    "intervals_msg": "Minimaalne ajavahemik kasutajale märguannete kuvamise vahel peab olema möödunud.",
    ...
    "delete": {
      "title": "Kustuta",
      "sub_title": "Kui olete hüpikakna kustutanud, pole tagasipöördumist. Palun olge kindel.",
  ...
  "shop_sms": {
    "title": "Hallake SMS-i",
    "sub_title": "Klientidele saadetud SMS-mallid",
    "message": "Oma poe saadetud tekstisõnumite sisu näed siit. Sõnumiteenuses valideerimismustrite registreerimise piirangu tõttu ei ole hetkel võimalik tekstsõnumeid isikupärastada."
  },
  "shop_emails": {
    "title": "Hallake e-kirju",
    "sub_title": "Selles jaotises näete kaupluse poolt klientidele ja juhtidele saadetud meilide loendit. Meilid kujundatakse ja luuakse automaatselt teie poe jaoks sisestatud teabe põhjal. Samuti saab tulevikus avalikkusele kättesaadavaks sõnumite ja piltide isikupärastamise võimalus."
  },
  "instagram": {
    "title": "Müük Instagramis",
    "message": "Selle tööriista abil saate muuta oma Instagrami poeks. Lihtsalt lisa ja kinnita oma Instagrami konto siin, siis saad igast postitusest või oma loosse postitada ühe või mitu toodet, lisada ja sildistada oma toodete nimekirja või muuta postituse uueks tooteks!",
    "add_product": "Lisa uus toode",
    "create_product": "Loo toode",
    "link_box_msg": "Pange see link oma biograafiasse Instagrami, Telegrami või muusse sotsiaalmeediasse, et teie publik saaks kiiremini, lihtsamalt, rohkem ja lõpuks rohkem osta.",
    "remove_account": "Muutke / eemaldage Instagrami link",
    "sync": "Sünkrooni konto andmed (iga 60 minuti järel)"
  },
  "service_bill": {
    "task": {
      "title": "Nimekiri",
      "message": "Kirjutage tööde pealkirjad, mida soovite teha, ja andke ostjale teada, kui kaugele see on edenenud."
    },
    "booking": {
      "title": "Broneerimine / Broneerimine",
      "message": "Seda tellimust töödeldakse kindlaksmääratud ajal, klient on valinud soovitud perioodi, kui soovite valitud perioodil muudatusi teha, andke sellest kliendile teada.",
      "selected_checkin": "Valitud kliendi sisselogimiskuupäev",
      "selected_checkout": "Valitud kliendi lahkumise kuupäev",
      "change_days_question": "Kas peate vahetama kliendi valitud päevadel?",
    ...
    "subscription": {
      "title": "Tellimus",
      "message": "Tellimisperioodi saate valida, ostes seda teenust igapäevaselt. Andke ostjale teada, kui soovite juba sisestatud vaikeväärtusi muuta.",
  ...
  "service_tasks": {
    "notification_finish": {
      "title": "Teenuse lõpp",
      "message": "Kui see on tehtud, vajutage tellimuse täitmiseks ja sulgemiseks kinnitusklahvi.",
  ...
  "product_outputs": {
    ...
    "virtual": {
      ...
      "sub_title": "Teave, mida soovite kasutajale pärast ostmist näidata. See vorm on eriti kasutatav virtuaalsete toodete (nt kinkekaardi) müügi puhul."
    },
    "service": {
      "title": "Teenuse disain",
      "sub_title": "Esmalt valige oma teenuse tüüp ja sisestage nõutav teave. Näiteks saate koostada ülesannete nimekirja või küsida kliendilt broneerimisaega või kohtumise."
    }
  },
  "service_design": {
    "type": "Teenuse tüüp",
    "type_message": "Valige selle toote jaoks pakutava teenuse tüüp. Iga üksuse valimisel kuvatakse vastav vorm. Olenevalt valitud teenuse tüübist võidakse tellijalt saada lisateavet tellimuse vormistamisel."
  },
  "ServiceTypes": {
    "DEMAND": {
      "title": "Nõudlusel",
      "desc": "nagu kodu remont, värvimine, auto remont jne."
    },
    "BOOKING": {
      "title": "Broneerimine",
      "desc": "Nagu hotellitoa või villa broneerimine."
    },
    "APPOINTMENT": {
      "title": "Kohtumine",
      "desc": "Nagu lemmikloomahoolduse kohtumine või isiklik koolitus."
    },
    "RENTAL": {
      "title": "Laenutus",
      "desc": "Nagu näiteks koha või auto rentimine."
    },
    "SUBSCRIPTION": {
      "title": "Tellimus",
      "desc": "Nagu klubi liikmelisus või veebipõhine juhendamine."
    },
    "CHARGE": {
      "title": "Lae",
      "desc": "Näiteks kontolt tasu võtmine või rakenduse kasutamise eest tasu võtmine."
    },
    "CUSTOM": {
      "title": "Kohandatud",
      "desc": "Valige see suvand, kui teie pakutav teenus ei ole ükski ülalmainitutest."
    }
  },
  "avocado": {
    "title": "Kiire, täpne ja nauditav müük kõigis sotsiaalmeedias",
    "message": "Üks summa ja üks tiitel on kõik, mida vajate, et klientidelt raha saada! Raha kantakse otse teie kontole ja teie kliendid saavad ainulaadse ostukogemuse.",
    "new_order": "Uus arve",
    "create_by_seller_title": "Loo arve",
    "create_by_seller_message": "Kui soovid koostada kindla summaga arve ja saata selle kellelegi, siis vajuta allolevale nupule, et kuvada arve vorm. Andke genereeritud link ostjale tasumiseks ja selle kaudu tellimuse jälgimiseks.",
    "create_by_buyer_title": "Avokaado vorm",
    "create_by_buyer_message": "Selle jaotise aktiveerimisel kuvatakse teile link, edastage see link oma ostjatele, et nad saaksid oma tellimuse esitada.",
    "orders_list": "Tellimuste loend",
    "active_mode": "Tellimuse kviitung aktiivne",
    "inactive_mode": "mitteaktiivne",
    "active_message": "Selle allika aktiveerimisel saavad teie kliendid esitada toote tellimuse alloleva taotlusvormi kaudu.",
    "avocado_form_link_message": "Lisage see link oma biograafiasse Instagrami, Telegrami või muusse sotsiaalmeediasse, et teie publik saaks kiiremini, lihtsamalt ja lõpuks rohkem osta",
    "need_address": "Hangi aadress",
    "need_address_msg": "Kui soovite hankida ostja asukoha ja aadressi, valige see valik.",
    "avocado_link_message": "Tellimuse tasumiseks piisab ülaltoodud lingi andmisest kliendile. Selle lingi kaudu saab klient tellimust jälgida.",
    "edit_order": "Muuda tellimust",
    "progress": "Edenemismäär",
    "buyer_link": "Ostja link",
    "buyer_link_message": "Esitage see link oma ostjale. Ostja saab selle lingi kaudu maksta ja oma tellimust jälgida. See link on kodeeritud, kui kellelegi link antakse, saab ta maksta ja infot näha. See link on aktiivne 60 päeva. Kopeerimiseks klõpsake alloleval lingil.",
    "OrderConfirm_done": "Tellimus kinnitatud.",
    "OrderConfirm_message": "Kui kinnitate makse ja tellimus on õige, klõpsake allolevat nuppu.",
    "OrderConfirm_action": "Tellimuse kinnitus",
    "PreparingOrder_message": "Kui kliendi tellimus on saatmiseks valmis, klõpsake alloleval nupul OK.",
    "PreparingOrder_action": "Tellimus on saatmiseks valmis",
    "finish_message": "Kui see tellimus on lõpetatud, vajutage selle tellimuse sulgemiseks nuppu Lõpeta.",
  ...
  "avocado_process": {
    "step1": "Hinnakujundus",
    "step1_msg": "Sisestage iga kauba hind ja märkige roheline ruut. Kui kaupa ei ole võimalik müüa, muutke selle olek tagasi lükatud.",
    "step2": "Kinnitage arve",
    "step2_msg": "Koostage selle tellimuse jaoks arve. Saate sisestada arvele pealkirja ja kirjelduse. Tellimuse summa arvutatakse kaupade koguhinna alusel automaatselt.",
    "title_input": "Arve pealkiri *",
    "show_to_customer": "Seda teavet näidatakse ostjale.",
    "description_msg": "Kas soovite selle tellimuse kohta märkuse kirjutada? Seda teavet näidatakse ostjale.",
  ...
  "hyper": {
    "print_label": "Printige järgmine etikett ja asetage see toote ette",
    "hyper_form_link_product_message": "Teie kliendid saavad selle lingi kaudu kiiresti osta toodet {product}. Nad sisestavad sama lingi ka QR-koodi skannides.",
    "title": "Hüperkiirmüük",
    "message": "Hyper Selldone müügikanali abil saavad teie kliendid QR-koodi skaneerides tooteid osta, ilma et teil oleks vaja midagi teha. Kasutage seda võimalust mõne eseme kiireks müümiseks suurel hulgal festivalidel, näitustel või tihedatel tseremooniatel. Pärast selles jaotises Hyperi aktiveerimist saate jaotises Tootehaldus luua füüsiliste toodete jaoks hüper QR-koodi.",
  ...
  "notification_top_bar": {
    ...
    "claim_charge_caution": "Märkus. Rahakoti kontode vahel ei ole valuutat võimalik konverteerida. Seetõttu valige konto, mis sobib teie poes vahetatava valuuta jaoks.",
  ...
  "shop_languages": {
    ...
    "message": "Saate oma poodi installida kuni 10 keelepaketti. Kui teil on vaja installida rohkem pakette, võtke meiega ühendust."
  },
  "invite_friends": {
    ...
    "invite": {
      ...
      "description": "Kutsun teid Selldone'i, et alustada oma äri veebis suurepärase tööriistaga.",
  ...
  "shops_list": {
    "title": "Minu poed",
    "message": "Minu enda poodide, lubatud ja näidispoodide nimekiri."
  },
  "shipping": {
    "warehouse_error": "Seadke esmalt oma ladu! Seda aadressi kasutatakse saatmise lähtekohana.",
    "errors": {
  ...
  "about_us": {
    "title": "Meie leht",
    "subtitle": "Kirjutage oma ettevõtte kohta artikkel, mida kuvada lehel Meist. See leht aitab teie vaatajaskonnal teie brändi ja missiooni tundma õppida."
  },
  "terms": {
    "title": "Kasutustingimuste leht",
    "subtitle": "Selgitage oma klientidele oma teenuste ostmise ja kasutamise tingimusi."
  },
  "privacy": {
    "title": "Privaatsuspoliitika leht",
    "subtitle": "Privaatsuspoliitika on avaldus või juriidiline dokument, mis avalikustab mõned või kõik viisid, kuidas osapool kliendi või kliendi andmeid kogub, kasutab, avalikustab ja haldab."
  },
  "contact_us": {
    "title": "Võtke meiega ühendust lehel",
    "subtitle": "Kirjutage oma kontaktteave, aadress ja telefoninumber, mida näidatakse teie klientidele kontakti lehel."
  },
  "metaverse": {
    "title": "Metaverse sild",
    "subtitle": "Selldone pakub kaubandusruumis %100 API-põhist teenust. Mängude, plokiahela ja metaversumi arendajad saavad kasutada neid võimsaid API-sid, et ühendada ettevõtted, kliendid ja teenused tulevikus töö-, elu- ja kaubandusmaailmas.",
  ...
  "orders_bulk_export": {
    ...
    "tasks": {
      ...
      "subtitle": "Laadige alla ülesannete loend tellimuste hulgi töötlemiseks. Tulemus sisaldab ainult tasulisi ja järelmaksuga tellimusi.",
      "export_title": "Ülesannete loetelu"
    },
    "labels": {
      "title": "Pakendid Sildid",
      "subtitle": "Laadige alla kõigi valitud ajaperioodi ja oleku tellimuste siltide loend. Tulemus sisaldab ainult tasulisi ja järelmaksuga tellimusi.",
  ...
  "theme": {
    ...
    "dark_mode_description": "Valige see valik, kui soovite tumedat tausta valge tekstivärviga.",
    "light_mode": "Valgusrežiim",
    "light_mode_description": "Valige see valik, kui soovite, et taust oleks hele ja tekst musta värvi."
  },
  "shop_quota": {
    "title": "Kasutuskvoot",
    "sub_title": "See on teie poe kasutuskvootide loend. Saate neid limiite suurendada, kui uuendate oma poe litsentsi. Kui ületate piirmäärasid, saate meilt taotleda täiendavaid päevarahasid. Kogu kasutus lähtestatakse iga päev."
  },
  "app_card": {
    "category": "Kategooria",
    "installs": "Installige",
  ...
  "suggestions": {
    ...
    "shop_email": {
      ...
      "subject": [
        ...
        "🍹 Aeg end hellitada – nädalavahetuse välkmüük!",
    ...
    "coupon": {
      ...
      "description": [
        ...
        "Täname oma püsikliente eksklusiivse allahindlusega.",
        ...
        "Hellitage end väikese millegi lisaga – erisoodustusega.",
