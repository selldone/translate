...
export default {
  ...
  suggestions: {
    ...
    subscription_price: {
      ...
      description: [
        "Ideaalne inimestele, kes uurivad põhitõdesid.",
        "Juurdepääs kõigile esmaklassilistele funktsioonidele ja sisule.",
        "Eksklusiivsed eelised ja eelistoetus.",
        "Tasakaalustatud pakett tavakasutajatele.",
        "Ülim juurdepääs kõrgetasemeliste hüvedega.",
        "Kohandatud lahendused suurtele organisatsioonidele.",
        "Soodne algtaseme valik.",
        "Energiakasutajale pole kasutuspiiranguid.",
        "Eriplaan peredele, kuni 4 liiget.",
        "Mõeldud professionaalidele, kes otsivad täiustatud tööriistu.",
      ],
    },
    ...
    spec: {
      group: [
        ...
        "Ühenduvusvalikud",
        "Nõuded võimsusele",
        "Materjali- ja ehituskvaliteet",
        "Värvi- ja viimistlusvalikud",
        "Salvestus ja mälu",
        ...
        "Kasutajate hinnangud ja ülevaated",
    ...
    avocado: {
      ...
      message: [
        ...
        "Hindame teie ettevõtet.",
        "Teie tellimus on teel!",
        "Täname, et ostsite meiega.",
        "Ootan teid uuesti teenima.",
        "Teie rahulolu on meie prioriteet.",
        "Ärge unustage oma kogemust hinnata.",
        "Täname teid meie kaupluse toetamise eest.",
        "Loodame, et teile meeldib oma uus ost!",
        "Salvestage oma arve edaspidiseks kasutamiseks.",
        "Suuremate toodete saamiseks külastage meid uuesti.",
        "Püsige ühenduses eksklusiivsete pakkumiste saamiseks.",
        "Täname, et olete hinnatud klient.",
        "Oleme siin, et aidata, kui vajate abi.",
        "Teie tagasiside aitab meil täiustada.",
        "Nautige oma järgmisel ostul erisoodustust.",
        "Olete teinud suurepärase valiku!",
        "Täname teid meie vastu usaldamise eest.",
        "Ootan teie tagasisidet.",
        "Südamlik tänu meie meeskonna poolt.",
      ],
    },
    ...
    expert_contract: {
      title: [
        "Marketplace'i häälestusteenuste leping",
        "Poe seadistamise leping",
        "Nõudmisel printimise teenuste leping",
        "Digitaalse turunduse teenuse leping",
        "E-kaubanduse platvormi seadistamise leping",
        "Ekspertkonsultatsioonileping ettevõtete omanikele",
        "Marketplace'i konfigureerimise teenuseleping",
        "Poe seadistus- ja konfigureerimisteenuste leping",
        "POD-i teenuse osutamise leping",
        "Turundusstrateegia rakendamise leping",
        "Ettevõtluse arendamise teenuseleping",
        "E-kaubanduse poe seadistamise leping",
        "Ekspertteenuse osutamise leping",
        "Ärilahenduste ja seadistusleping",
        "Kohandatud poe seadistamise teenuste leping",
        "Turu optimeerimise teenuseleping",
        "Nõustamis- ja häälestusteenuste leping",
        "POD-i integratsiooniteenuste leping",
        "Turundus- ja müügiedendusteenuste leping",
        "Äritegevuse laiendamise teenuseleping",
      ],
    },
    ...
    cashback: {
      ...
      description: [
        "Teenige igalt ostult raha tagasi!",
        "Saate oma lojaalsuse eest tasu.",
        "Eksklusiivsed rahatagastuspakkumised just teile.",
        "Nautige rahatagastuspreemiatega suurt kokkuhoidu.",
        "Kiire raha tagasi kõikidelt teie lemmikkaupadelt.",
        "Hooajaliste rahatagastuspakkumiste abil säästke rohkem.",
        "Kahekordistage oma raha tagasi erilistel päevadel!",
        "Teenige raha tagasi iga kord, kui ostlete.",
        "Liituge rahatagastushullusega juba täna!",
        "VIP-liikmed naudivad eksklusiivset cashbacki.",
        "Kiirusta! Piiratud aja jooksul rahatagastuspakkumised.",
        "Liituge meie Cashback Rewards Clubiga kohe.",
        "Mida rohkem ostate, seda rohkem säästate.",
        "Avage ülim rahatagastuspreemia.",
        "Kogege parimaid raha tagasi pakkumisi.",
      ],
    },
    ...
    page: {
      prompts: [
        "Tere tulemast {shop}-sse – tutvuge meie erilise kaubavalikuga",
        "{shop} – teie parim kvaliteetsete kaupade ja suurepärase teeninduse allikas",
        "Ainult {shop} eksklusiivsed pakkumised ja säästud – kasutage võimalust!",
        "Tutvuge {shop} pühendumusega keskkonnasõbralikkusele ja eetilistele tavadele",
        "Saage osaks {shop} perekonnast – tellige värskenduste saamiseks meie uudiskiri",
        "Sukelduge {shop} parimate valikute ja kõrgelt hinnatud kaupade hulka",
        "Esitage ideid ja loomingulisi soovitusi kõikide sündmuste jaoks saidil {shop}",
        "Võrreldamatud pakkumised ja ajatundlikud eripakkumised saidil {shop} – tegutsege kiiresti!",
        "{shop} põhjalikud ostunõuanded ja tootehinnangud – ostke enesekindlalt",
        "Võtke ühendust {shop}-ga – püüame pakkuda võrratut ostukogemust",
      ],
    },
    ...
    cross_selling: {
      message: [
        "Täiendage oma välimust, haarake komplekt!",
        "Säästke meie komplektpakkumistega palju!",
        "Ärge jätke ilma meie täiuslikest paaridest!",
        "Täiustage oma ostu, lisandmoodulid ootavad!",
        "Avage eksklusiivsed säästud, ostke koos!",
        "Täiendavad kaubad, erisoodustused!",
        "Hankige rohkem, kulutage vähem – komplekteerige!",
        "Piiratud ajaga pakkumine: sobivad tooted!",
        "Täiendage oma kogemust, kombineeritud pakkumised!",
        "Avastage meie kureeritud kombinatsioonid, salvestage kohe!",
        "Ühendage see ülima kombinatsiooni saamiseks!",
        "Ostke nutikalt, komplekteerige ja säästke!",
        "Kahekordne väärtus, topelt lõbus!",
        "Teie täiuslik vaste on siin – ostke kohe!",
        "Eksklusiivne komplekti hind just teile!",
        "Maksimeerige oma kokkuhoid meie kombinatsioonidega!",
        "Täiustage oma kollektsiooni nende valikutega!",
        "Teie jaoks kureeritud: sobitage ja salvestage!",
        "Ideaalne paar täiuslikuks päevaks!",
        "Pane oma lemmikud kokku, et säästa rohkem!",
      ],
    },
    ...
    template_message: {
      ...
      body: [
        "Tere, {buyer_name}, teie tellimus #{order_id} on kinnitatud! Töötleme seda ja anname teile teada, kui see on saatmiseks valmis.",

        "Hea uudis, {buyer_name}! Teie tellimus #{order_id} on teele saadetud. Saate seda jälgida oma konto kaudu. Täname, et ostsite meiega!",

        "Tere, {buyer_name}, teie tellimus #{order_id} on edukalt kohale toimetatud. Loodame, et teile meeldib ost. Aitäh!",

        "Tere, {buyer_name}, oleme saanud tellimuse #{order_id} makse. Teie tellimust praegu töödeldakse ja see saadetakse peagi teele.",

        "Lugupeetud {buyer_name}, meil on kahju teatada, et teie tellimus #{order_id} on tühistatud. Kui teil on küsimusi, võtke ühendust klienditoega.",

        "Lugupeetud {buyer_name}! Teie tellimus #{order_id} viibib. Vabandame ebamugavuste pärast ja püüame probleemi võimalikult kiiresti lahendada.",

        "Tere, {buyer_name}! Teie tellimus #{order_id} on praegu ootel. Lisateabe saamiseks kontrollige oma kontot või võtke ühendust klienditoega.",

        "Tere, {buyer_name}! Teie tellimus #{order_id} on tarnitud ja peaks varsti teieni jõudma. Täname teid kannatlikkuse eest!",

        "Lugupeetud {buyer_name}, oleme teie tellimuse #{order_id} tagastamise menetlenud. Kui teil on küsimusi, võtke ühendust klienditoega.",

        "Tere, {buyer_name}! Teie tellimuse #{order_id} raha tagasimakse on välja antud. Peaksite raha oma kontol varsti nägema.",

        "Tere, {buyer_name}, teie tellimuse #{order_id} toode on tagasi laos! Kui olete endiselt huvitatud, saate kohe uue tellimuse esitada.",
      ],
    },
    ...
    property_set: {
      ...
      description: [
        "Rõivaste atribuudid, nagu suurus, värv ja kangas.",
        "Tehnilised vidinad, nagu kaubamärk, mudel ja funktsioonid.",
        "Maitsed, suurused ja jookide liigid.",
        "Üksikasjad toitude, suupistete ja toiduainete kohta.",
        "Materjal, mõõtmed ja kujundusstiilid.",
        "Autor, žanr ja ilmumisaasta.",
        "Nahatüüp, koostisained ja pakendi üksikasjad.",
        "Vanuserühm, materjal ja ohutusstandardid.",
        "Tüüp, suurus ja jõudlusfunktsioonid.",
        "Stiilid, materjalid ja kaubamärgi üksikasjad.",
      ],
    },
