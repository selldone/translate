export default {
  ...
  "cautions": {
    "title": "Gestisci la tua attività in modo professionale seguendo i seguenti suggerimenti. Continua a leggere per suggerimenti su come aumentare il margine di profitto e altro ancora. Siamo con te lungo la strada.",
    "no_payment_method": {
      "title": "Metodo di pagamento",
      "message": "Devi aggiungere un metodo di pagamento al tuo negozio.",
      "action": "Gateway di negozi"
    },
    "link_account": {
      "title": "Collega l'account",
      "message": "Devi collegare un account ({currency}) al tuo negozio.",
      "action": "Conti del negozio"
    },
    "no_domain": {
      "title": "Aggiungi dominio",
      "message": "Puoi collegare uno o più domini personali al tuo negozio. Il tuo sito web verrà installato sul tuo dominio. Questo processo è facile e veloce."
    },
    "domain_not_approved": {
      "title": "Verifica del dominio",
      "message": "Il tuo dominio {domain} non è stato verificato. Verifica le impostazioni DNS e conferma il dominio."
    },
    "no_currency": {
    ...
    "no_primary_domain": {
      ...
      "message": "Seleziona un dominio come dominio principale. Cliccando sul pulsante asterisco accanto al nome di dominio, puoi selezionare il dominio come dominio principale del tuo negozio. Questo è fondamentale per i motori di ricerca. Tieni presente che il tuo negozio sarà ancora disponibile attraverso tutti i domini attivi."
    },
    "shop_complete": {
  ...
  "support": {
    ...
    "category": "Categoria",
    "title": "Supporto",
    "message": "Fai qualsiasi richiesta o domanda. Il nostro team di supporto ti guiderà. Ti consigliamo di porre la tua domanda nella pagina relativa alla tua richiesta. Ad esempio, se hai una domanda sull'impostazione del dominio, inviala nella pagina delle impostazioni del dominio del tuo negozio.",
  ...
  "helps": {
    ...
    "subtitle": "Benvenuto in Selldone. Se stai costruendo un nuovo negozio online su un sistema operativo aziendale, puoi trovare maggiori informazioni qui.",
  ...
  "blogs": {
    "title": "Blog",
    "subtitle": "Lezioni per gli affari, la fiducia e le conoscenze necessarie per creare un business fiorente.",
  ...
  "user_dashboard": {
    ...
    "shops": {
      ...
      "create_new_sub": "Libero",
      "create_new_sub_need_initial_charge": "Costruire il primo negozio è gratuito. Probabilmente un negozio è sufficiente per la tua attività, ma se hai bisogno di costruire più negozi, il costo per costruirne uno nuovo è di 25$. Preleviamo l'importo dal tuo conto portafoglio.",
      "menu": {
        "title": "I miei negozi",
        "shops": "Negozi",
        "new": "Nuovo"
  ...
  "widgets": {
    "overview": {
      ...
      "report_last7days": "Report degli ultimi 7 giorni",
      "report_last30days": "Report degli ultimi 30 giorni"
    }
  },
  "admin_shop": {
    "title": "negozio",
    ...
    "dashboard": {
      ...
      "info": {
        ...
        "home_msg": "Imposta la home page predefinita del tuo sito web. Può essere modificato per ogni dominio personalizzato.",
        ...
        "wage": "Tassa",
        "cpu_message": "Il numero di risorse che hai adattato al piano acquistato e le risorse che aggiungi al tuo servizio.",
        ...
        "add_dialog": {
          ...
          "step1": "È possibile definire il limite IP del record A per un dominio o sottodominio DNS dai seguenti valori:",
          "step2": "Aggiungi un record DNS TXT:",
          "set_ip_alert": "Imposta il valore IP del record A <b>{ip}</b> .",
          ...
          "ssl_message": "Non preoccuparti del certificato SSL per il tuo sito web. Questa certificazione verrà rilasciata automaticamente per il tuo dominio da Selldone (beta).",
          "active": "Il dominio è attivo",
          "inactive": "Il dominio è disabilitato",
          "success_message": "Congratulazioni, il tuo sito è abilitato su {domain}. Puoi presentare la tua attività e il tuo marchio al mondo attraverso questo dominio.",
        ...
        "alert": {
          ...
          "message": "Vuoi eliminare questo dominio? Assicurati di reimpostare i valori dei record DNS del tuo dominio per prevenire frodi ad altri."
        }
      },
      "active_orders": {
        "title": "Ordini",
        "title_small": "Ordini fisici, file, virtuali e di servizio",
    ...
    "products": {
      ...
      "process_que": "Elaborazione di prodotti importati",
      ...
      "menu_show_deletes": "Mostra prodotti eliminati",
      "drop_import_message": "Trascina qui il file dell'elenco dei prodotti (formato CSV, XLS, XLSX) per iniziare ad aggiungere prodotti in blocco. Assicurati che il file abbia il formato dell'elenco dei prodotti Selldone.",
      "product_widget": {
    ...
    "blogs": {
      ...
      "list": {
        ...
        "subtitle": "Scrivi articoli con un moderno editor inline per presentare te stesso e la tua attività. Il contenuto originale è la prima cosa su cui devi concentrarti quando scrivi un post di blog SEO-friendly di alta qualità."
      }
    },
    "orders": {
      "physical": {
    ...
    "auditing": {
      ...
      "invoice": {
        ...
        "subtitle": "Addebiti, commissioni e costi del negozio vengono detratti da questi conti portafoglio.",
        "title_add": "Collega il nuovo account del portafoglio",
        "subtitle_add": "Dovresti creare un nuovo portafoglio per ogni valuta e collegarlo al tuo negozio. La commissione di servizio verrà prelevata da questo portafoglio.",
        ...
        "add_account_dialog": {
          ...
          "subtitle": "Quando apri un conto portafoglio con Selldone, ti forniremo una carta di credito virtuale e un conto come qualsiasi altra carta di credito. La commissione di vendita di Selldone verrà detratta da questo account, ma se il saldo del tuo account non è sufficiente, questo importo sarà dovuto. Puoi utilizzare i servizi Selldone quanto vuoi.",
          "account_number": "Numero di conto",
          "account_number_input_message": "Il negozio sarà collegato a questo account. Questo account verrà utilizzato per commissioni e costi.",
        ...
        "notifications": {
          ...
          "delete_account_success": "Account rimosso dal negozio con successo."
        },
        "alert": {
          "delete_account": "Disconnetti l'account",
          "delete_account_message": "Vuoi rimuovere questo account dall'elenco degli account del negozio?",
          "delete_account_action": "Eliminare l'account"
        },
        "inform_charge_account": "Carica il tuo account!",
        "inform_charge_account_critical": "Addebita il tuo account per evitare la sospensione del servizio!"
      },
      "gateway": {
        "title": "Modalità di pagamento",
        "sub_title": "Elenco dei metodi di pagamento attivi. Se vuoi aggiungere un nuovo metodo al tuo negozio, premi il seguente pulsante. Consigliamo vivamente di non superare i 10 gateway di pagamento aggiunti.",
        ...
        "add_gateway_dialog": {
          ...
          "active_gateways": "Metodi di pagamento attivi",
          "confirm": "Aggiungi metodo di pagamento"
        }
      },
      "exchange": {
        "title": "Memorizza valute attive",
        "subtitle": "Gli utenti potranno selezionare una delle valute attive e i prezzi dei prodotti verranno calcolati e visualizzati. Spetta al venditore inserire il tasso di cambio.",
        ...
        "rates": {
          ...
          "sub_title": "Puoi inserire i prezzi dei prodotti in base a una qualsiasi delle valute seguenti e i prezzi dei prodotti verranno calcolati automaticamente ai tassi di conversione tra le tue valute.",
          "message": "Inserendo i tassi di cambio tra le valute, i prezzi dei tuoi prodotti verranno automaticamente calcolati e aggiornati.",
        ...
        "add_rate_dialog": {
          ...
          "message": "Fare attenzione nell'inserimento delle informazioni. I prezzi dei tuoi prodotti verranno calcolati in base alle tariffe inserite qui.",
    ...
    "logistic": {
      ...
      "warehouse_btn_error": "Imposta il tuo magazzino, negozio o origine della tua attività. È fondamentale avere nel calcolo dei costi di spedizione e nel processo di checkout.",
      "size_unit": {
      ...
      "warehouse": {
        ...
        "table": {
          "title": "Inventario",
          "sub_title": "Elenco di tutti i prodotti del negozio inclusi fisici, virtuali, file e servizi"
        }
      },
      "delivery": {
        "title": "Metodi di spedizione",
        "sub_title": "Impostando i valori in questa sezione, nel tuo negozio vengono attivate diverse modalità di invio. In questa sezione è possibile attivare anche la modalità Contrassegno.",
        ...
        "delivery_form": {
          ...
          "cod_input_message": "Assicurati che il tuo servizio di spedizione accetti il contrassegno.",
          "sod_input": "Supportate il COD?",
          "sod_input_message": "Assicurati che il tuo servizio di spedizione accetti il contrassegno.",
          ...
          "price_cof_input_message": "Include i costi assicurativi e altri servizi come i costi del contrassegno.",
          ...
          "sod_true_message": "Assicurati che il tuo servizio di spedizione accetti i costi di spedizione a destinazione.",
    ...
    "users": {
      ...
      "report": {
        ...
        "report_30days_by_time": "Attività dell'utente basata su data e ora negli ultimi 30 giorni",
        "report_30days_by_location": "Attività degli utenti di geolocalizzazione negli ultimi 30 giorni"
      },
      "club": {
        "title": "Club dei clienti",
        "sub_title": "Inserisci l'importo di acquisto mensile e annuale e la valuta per attivare ogni livello. I tuoi clienti verranno registrati nel tuo club clienti poiché soddisfano i requisiti di acquisto mensile o annuale.",
        "item": {
        ...
        "edit_dialog": {
          ...
          "currency_input_message": "Gli acquisti totali sono calcolati in questa valuta.",
          "free_shipping_input": "Spedizione gratuita",
    ...
    "marketing": {
      ...
      "campaign": {
        ...
        "name_input_message": "Inserisci il titolo della tua campagna.",
    ...
    "categories": {
      ...
      "subtitle": "Le categorie sono la caratteristica chiave del tuo negozio online. Ti invitiamo a utilizzare questi potenti strumenti di categorizzazione per creare una vetrina moderna e consentire ai tuoi clienti di trovare facilmente i prodotti giusti.",
      "menu": {
      ...
      "graph": {
        ...
        "subtitle": "Puoi avere una panoramica completa delle categorie del tuo negozio e di come gli utenti le navigano. Con la giusta disposizione delle categorie, i tuoi clienti possono trovare rapidamente i prodotti e il tasso di conversione aumenterà.",
        "visits_count": "Visita",
        "normal": "Semplice",
      ...
      "category_widget": {
        ...
        "delete_alert": {
          "title": "Rimuovi la categoria figlio",
          "message": "Vuoi rimuovere {title} dall'elenco di {parent_title}?",
          "action": "Eliminare"
        },
        "notifications": {
    ...
    "apps": {
      ...
      "my_apps": {
        ...
        "subtitle": "Gestisci le tue applicazioni aziendali.",
        "all": "Tutto"
      },
      "store": {
        "title": "App Store",
        "subtitle": "Collega i tuoi servizi preferiti alla tua attività in modo sicuro. Aggiungiamo plugin e app in base alle richieste dei nostri clienti.",
    ...
    "permissions": {
      ...
      "shop_permissions": {
        "menu": {
          ...
          "new_user_message": "Utenti che avranno accesso alla dashboard e alle sezioni di gestione di questo negozio.",
          "email_input_placeholder": "E-mail",
          "email_input": "Indirizzo e-mail dell'utente",
          "level_input": "Livello di accesso",
          "add_user_action": "Aggiungi personale"
        },
        "delete_alert": {
      ...
      "shop_api": {
        ...
        "message": "Queste chiavi vengono utilizzate per creare token di accesso dal server. Si noti che le chiavi sono riservate e solo sul server in un modo che non è visibile ad altri."
      }
    },
    "applications": {
      "pwa": {
        ...
        "message": "Nota: puoi modificare la pagina di benvenuto del tuo sito Web sul tuo iPhone e iPad nell'app iOS",
        "ios_app": "app per iOS"
      },
      "ios": {
        "title": "app per iOS",
        "sub_title": "Presto sarai in grado di creare un'app iOS per il tuo negozio.",
        "message": "Dimensione massima del file: 512 KB, puoi caricare file di dimensioni fino a 1 MB, a condizione che il nostro sistema di compressione sia in grado di ridurre le dimensioni a 512 KB. L'immagine caricata verrà ridimensionata in modo intelligente."
      },
      "android": {
        "title": "Applicazione Android",
        "sub_title": "Crea la tua app per Android",
        "message": "Compila questo modulo e premi il tasto build. Non ci sarà bisogno di nient'altro. Tutti i passaggi del processo di creazione e firma dell'app vengono eseguiti sui server cloud. L'app finale verrà caricata su tutti gli AppStore.",
        "server_un_available": "Sperimentalmente, il server delle applicazioni non è connesso in questo momento.",
        ...
        "package_name_input_alert": "Se modifichi questo nome, non potrai più aggiornare le tue app precedenti in AppStore e installarne una nuova. Tieni presente che anche gli utenti delle versioni precedenti dell'app non saranno in grado di accedere ai propri account.",
        "version_input": "Versione",
        "version_input_message": "Questo numero deve essere sempre maggiore del suo valore precedente.",
        "version_name_input": "nome della versione",
        "version_name_input_message": "Inserisci un nome univoco per questa versione dell'app.",
        ...
        "splash_title_input_message": "Questo titolo verrà visualizzato con caratteri di grandi dimensioni.",
        "splash_message_input": "Messaggio schermata iniziale",
        "splash_message_input_placeholder": "Messaggio ...",
        "splash_message_input_message": "Questo messaggio verrà visualizzato come miniatura di seguito.",
        "dark_theme": "Tema scuro",
        "light_theme": "tema leggero",
        "build": "Costruire",
        "building_info": "La creazione di un'applicazione su un server cloud richiede da 10 secondi a diversi minuti. Per favore sii paziente. Il collegamento al file di download apparirà qui una volta che l'applicazione è pronta.",
        ...
        "notifications": {
          ...
          "start_building_message": "Richiesta per la creazione di un'applicazione Android inviata.",
          "build_success_title": "Congratulazioni",
          "build_success": "La tua app per Android è pronta e puoi scaricarla ora."
        }
      }
    },
    "automation": {
    ...
    "edit": {
      ...
      "info": {
        ...
        "description_tab": {
          ...
          "subtitle": "Scrivi della tua attività e della sua proposta di valore unica."
        },
        "contact_tab": {
          "title": "Contatto e attività locali",
          "subtitle": "Informazioni di contatto pubbliche e configurazione dell'attività locale di Google."
        },
        "image_tab": {
          "title": "Logo",
      ...
      "badge": {
        ...
        "external_message": "Qui puoi inserire l'indirizzo dell'immagine del badge e il link ad essa. Gli URL devono provenire da un sito Web approvato."
      },
      "edit_menu": {
        "title": "Menù",
        "footer": {
          "title": "Menù a piè di pagina",
          "sub_title": "Puoi configurare il menu in basso della pagina del tuo negozio qui. Questi menu possono essere home page, pagine progettate o collegamenti esterni."
        },
        "header": {
          "title": "Menu di intestazione",
          "sub_title": "Questo menu viene visualizzato solo su schermi più grandi dei dispositivi mobili e nella parte superiore della home page, delle categorie di prodotti, degli arrivi e delle pagine dei prodotti."
        },
      ...
      "social": {
        "title": "Social media",
        "message": "Inserisci il tuo link ufficiale ai social media in questa sezione. Segui le istruzioni per ogni articolo per confermare gli indirizzi."
      },
      "time": {
  ...
  "add_product": {
    ...
    "edit_info": {
      ...
      "sku": "SKU",
      "sku_message": "Unità di conservazione delle scorte",
      "mpn": "MPN",
      "mpn_message": "codice articolo del costruttore",
      "status": "Stato",
      ...
      "is_original_message": "Se non imposti il tuo prodotto originale, verrà mostrato il badge falso per questo prodotto.",
      "return_warranty": "Per quanti giorni questo prodotto ha una garanzia di restituzione?",
      "warehouse_section": "Magazzino e produzione",
      "conditions_section": "Condizioni del prodotto",
      "warranty_section": "Garanzia e consegna",
      "unit": "Unità di prodotto",
      "unit_message": "Immettere l'unità se necessario. Es: kg, metro, ...",
      "condition": "Condizioni del prodotto nel tuo negozio",
      "condition_message": "Devi scegliere uno dei valori in questo campo.",
      "unit_section": "Unità di prodotto",
      "unit_float": "Unità galleggiante (presto)",
      "unit_float_hint": "Ad esempio, il cliente può ordinare 3 kg di frutta, ma l'importo inviato al cliente è leggermente diverso dall'importo ordinato.",
      ...
      "marketplace": {
        "vendor_panel_message": "Il <b>{vendor_name}</b> è il proprietario del prodotto.",
        "subscription_message": "I prodotti in abbonamento possono avere un fornitore, quindi puoi crearli nel pannello del fornitore o assegnare loro un fornitore nella fase di creazione. Il venditore selezionato sarà il proprietario del prodotto.",
        "default_message": "Puoi specificare se questo prodotto appartiene a un fornitore e quindi solo un venditore può venderlo, oppure questo prodotto appartiene al Marketplace e più di un fornitore può venderlo.",
        "single_vendor_title": "Fornitore unico",
        "single_vendor_desc": "Questo prodotto appartiene a un fornitore e il fornitore selezionato può gestirlo.",
        "multi_vendors_title": "Più fornitori",
        "multi_vendors_desc": "Questo prodotto appartiene al marketplace e può essere modificato solo nel pannello del marketplace."
      }
    },
    "rating_pros_cons": {
      "title": "Sondaggio",
      "message": "Inserisci un elenco di specifiche del prodotto per consentire ai tuoi clienti di valutare il tuo prodotto. (Fino a 5 articoli)",
      ...
      "pros_group_messages": "Le caratteristiche principali del prodotto",
      "cons_title": "contro",
      ...
      "cons_group_messages": "I principali punti deboli del prodotto",
      ...
      "rating_input_placeholder": "Scrivi qui la domanda del tuo sondaggio personalizzato... e premi Invio!"
    },
    "edit_spec": {
      "title": "Specifiche tecniche",
      "sub_title": "È possibile importare le specifiche tecniche di prodotti simili.",
      ...
      "notifications": {
        ...
        "enter_item_title_and_value_error": "Immettere il titolo e il valore della funzione",
    ...
    "edit_images": {
      ...
      "images": {
        ...
        "sub_title": "Carica le immagini dei prodotti, comuni a tutte le varianti di prodotto, in questa sezione."
      },
      "video": {
        "title": "video",
        "sub_title": "Innanzitutto, carica il video del tuo prodotto su Youtube, quindi inserisci l'URL del video qui."
      }
    },
    "pricing": {
      "edit_price": "Prezzo",
      ...
      "commission_message": "Questa opzione è utile solo per particolari tipi di commercianti come i grossisti. Se non sei un grossista, lascia vuota questa opzione. Il prezzo che gli acquirenti vedono è la somma del prezzo e della commissione. Per aggiungere le tasse fare clic su Contabilità > Tasse.",
      ...
      "variant_pricing_message": "Selezionando questa opzione è possibile impostare il prezzo di questa variante indipendentemente dal prodotto principale.",
      "price_label_input": "Etichetta prezzo",
      "price_label_message": "Aggiungi informazioni extra sul prezzo come ($ 1,5/Fl Oz). Casi d'uso: alimentari, FMCG.",
      "add_price_label_action": "Aggiungi l'etichetta del prezzo"
    },
    "inputs_edit": {
      "title": "Modulo di immissione delle informazioni sull'acquirente",
      "sub_title": "Puoi creare un modulo di inserimento dati per ogni prodotto, in modo che gli acquirenti ti inviino informazioni quando acquistano un prodotto. Ad esempio, questa informazione potrebbe essere un nome per un'incisione su una pietra.",
      "message_input": "Messaggio all'utente",
      "message_input_message": "Questo messaggio verrà mostrato al cliente al momento dell'acquisto dei prodotti.",
      "inputs_form": "Struttura delle informazioni (input)"
    },
    "extra_edit": {
      "physical": {
        "title": "Informazioni sulla spedizione",
        "sub_title": "Il costo e il tempo di preparazione sono calcolati sulla base delle informazioni in questa sezione. Assicurati di inserire le informazioni in base alle unità selezionate nel negozio (peso, dimensioni, distanza)."
      },
      "notifications": {
    ...
    "variants": {
      "not_available": "Al momento non è possibile selezionare una variante per questo tipo di prodotto."
    },
    "delete_product": {
  ...
  "product_admin": {
    ...
    "dashboard": {
      ...
      "orders": {
        ...
        "send_30days_title": "Ordini spediti negli ultimi 30 giorni",
        "downloads_30days_title": "Numero di file scaricati negli ultimi 30 giorni",
        "virtual_orders_title": "Ordini di questo prodotto in attesa di completamento"
      },
      "inventory": {
        "title": "Inventario",
        ...
        "total_sell_30days": "Saldi degli ultimi 4 giorni",
        "chart": {
          "labels": [
            "Inventario",
            "Vendita"
      ...
      "finance": {
        "title": "Finanziario",
        "title_small": "Rapporto sugli acquisti degli ultimi 6 mesi",
      ...
      "inform": {
        ...
        "message": "Avvisa i clienti quando i prodotti sono in vendita o diventano disponibili",
    ...
    "inventory": {
      "variants": {
        ...
        "sub_title": "Se questo prodotto ha più di una variante, inseriscile in questa sezione. Puoi definire separatamente l'importo, il prezzo e lo sconto di ciascuna variante; in caso contrario verranno applicati i valori di default del prodotto per il prezzo.",
      ...
      "variant_add_edit": {
        "title": "Definizione della variante di prodotto",
        ...
        "delivery_info": "Imballaggio e spedizione",
        "images": "Immagini della variante",
        "images_message": "Dopo aver salvato questa variante potrai aggiungere un'immagine qui."
      }
    },
    "edit_article": {
      "menu": {
  ...
  "product_extra_physical": {
    ...
    "bulk_action_msg": "Imposta la confezione del prodotto e il tempo di preparazione per tutte le varianti."
  },
  "product_images_list": {
  ...
  "shop_warehouse_edit": {
    ...
    "message": "Inserisci il tuo indirizzo di magazzino e il profilo per calcolare il costo di spedizione.",
  ...
  "inventory_list": {
    ...
    "bulk_price_dialog": {
      "title": "Azioni collettive > Prezzo",
      "message": "Nota: il seguente importo verrà applicato in percentuale al prezzo di tutti i prodotti nel tuo negozio. Inoltre, i valori dei prezzi calcolati verranno convertiti in modo intelligente nel numero tondo più vicino in base alla valuta selezionata. Prestare attenzione nell'inserimento dei valori.",
      "check": "Approvo le modifiche ai prezzi.",
      "add_percent_tab": "Aggiungi percentuale",
      "add_constant_tab": "Aggiungi costante",
      "ending_tab": "Strategia finale"
    },
    "bulk_discount_dialog": {
      "title": "Azioni collettive > Sconto",
      "message": "Nota: il seguente importo sarà una percentuale sullo sconto di tutti i prodotti nel tuo negozio. Inoltre, i valori di sconto calcolati verranno convertiti in modo intelligente nel numero tondo più vicino in base alla valuta selezionata. Prestare attenzione nell'inserimento dei valori.",
  ...
  "contact_messages_list": {
    ...
    "dialog": {
      ...
      "mail_input_message": "Se lo abiliti, la tua risposta verrà inviata all'e-mail dell'utente."
    },
    "delete_alert": {
  ...
  "campaign": {
    ...
    "dashboard": {
      ...
      "no_links": "Non ci sono dati disponibili! Crea un link alla tua campagna.",
    ...
    "finance": {
      ...
      "total_revenue": "Entrate totali per campagna",
    ...
    "setting": {
      ...
      "general_setting": {
        ...
        "auto_message": "Campagna predefinita attivata nel tuo negozio"
      },
      "time_setting": {
        "title": "Periodo di tempo",
        "sub_title": "Data e ora di inizio / Data e ora di fine",
        "start_input": "Inizio",
      ...
      "banner_setting": {
        ...
        "sub_title": "Visualizza nella parte superiore della pagina del negozio",
        ...
        "icon_input": "Icona",
        "icon_input_hint": "Nome icona design materiale o Fontawsom: fa:fas fa-star",
      ...
      "notifications": {
        ...
        "persistence_message": "Vuoi mostrare ogni volta che il tuo utente visita il sito web",
        "radius": "Raggio",
  ...
  "add_category": {
    ...
    "edit_filter": {
      ...
      "spec_input_message": "Elenco delle funzionalità che desideri vengano visualizzate nella sezione dei filtri",
      "price": "prezzo",
      "min": "min",
      "max": "Massimo",
      "suggested_list": {
  ...
  "add_shop": {
    ...
    "name_input_tips": "Non utilizzare caratteri, spazi o lettere non inglesi, se utilizzati, il nome del negozio potrebbe non essere visualizzato correttamente.",
    ...
    "phone_input_tips": "Inserisci il numero di contatto con il prefisso internazionale. Questo numero viene utilizzato anche per visualizzare le informazioni nella ricerca di Google.",
    "email_input": "E-mail",
  ...
  "virtual_items_list": {
    ...
    "add_virtual_item_desc": "Per vendere prodotti virtuali, devi aggiungerli in questa sezione. Il numero di oggetti virtuali è uguale al numero di oggetti gratuiti in questa sezione. Una volta che i clienti acquistano l'oggetto virtuale, il link verrà loro inviato.",
  ...
  "add_virtual_item": {
    ...
    "message": "Il gestore del negozio può mostrare all'acquirente il valore dopo il pagamento. Questi valori devono essere inseriti nel modulo sottostante. La struttura di questo modulo è impostata nella sezione Modifica elemento > Modifica informazioni di output.",
  ...
  "virtual_process_center": {
    ...
    "list_widget": {
      "title": "Specifiche dell'ordine",
      "product_name": "nome del prodotto"
    },
    "inputs_widget": {
      "title": "Modulo di input",
      "table": {
        "title": "Titolo",
        "value": "Valore"
      },
      "change_inputs_action": "Modifica modulo di immissione"
    },
    "outputs_widget": {
  ...
  "process_order_page_dashboard": {
    ...
    "open_basket_cation": "Questo carrello è aperto, il che significa che il cliente sta facendo acquisti e non ha ancora pagato l'ordine.",
    "reject_dialog": {
      "title": "Motivo per rifiutare l'ordine",
      "message": "Seleziona il motivo del rifiuto di questo ordine dall'elenco sottostante. Assicurati di informare il cliente della procedura di cancellazione e rimborso. I rimborsi devono essere effettuati entro 12 ore.",
      "confirm_action": "Annulla Ordine",
    ...
    "notifications": {
      ...
      "dismiss_reject_success": "L'ordine è tornato al normale processo.",
      "set_tracking_success": "Order Track ID salvato correttamente."
    }
  },
  "process_center": {
    "title": "Centro di elaborazione",
    ...
    "payment_widget": {
      ...
      "payment_receipt_not_uploaded_error": "La ricevuta di pagamento non è stata ancora caricata!",
      "waiting_for_pay": "In attesa di Pagamento",
      "processing_payment": "Pagamento in elaborazione",
      "processing_cancel": "Pagamento annullato",
      "paid": "Pagato",
      "cod_pay_info": "Quando hai ricevuto l'ordine dal cliente puoi confermare il pagamento e completare l'ordine.",
      "dir_pay_info": "La ricevuta del pagamento apparirà sopra. Prima di confermare il pagamento, verifica l'importo del deposito e le informazioni sulla ricevuta con la tua banca.",
      ...
      "add_transactions_message": "Devi creare almeno una transazione per questo ordine. In alcuni casi, il pagamento è richiesto in più passaggi. Le transazioni per le quali l'utente deve pagare saranno determinate da te, durante il lavoro.",
      "add_bill_dialog": {
        "title": "Aggiungi fattura",
        "message": "Puoi aggiungere una o più nuove fatture per questo ordine. Il cliente vedrà queste fatture e pagherà ciascuna in base allo stato di avanzamento dei lavori.",
      ...
      "samin": {
        ...
        "description": "Questo importo è stato detratto dal tuo conto portafoglio Selldone.",
        "tooltip": "Calcola per metodo di pagamento",
        "percent": "per cento"
      },
      "affiliate": {
        "title": "Commissione di affiliazione",
        "affiliate_message": "Dovresti pagare questa commissione al tuo affiliato. Questo processo è fatto da te."
      },
      ...
      "pay_cod_dialog": {
        ...
        "message": "Conferma questa opzione nel metodo di pagamento in contrassegno, dopo aver assicurato il pagamento completo da parte del cliente.",
        "confirm_action": "Conferma il pagamento del cliente"
      },
      "pay_dir_dialog": {
        "title": "Hai ricevuto il denaro dell'ordine?",
        "message": "Conferma questa opzione dopo aver approvato la ricevuta di pagamento caricata con la tua banca. Assicurati di controllare il pagamento con la tua banca.",
        "confirm_action": "Conferma il pagamento del cliente"
      },
      "notifications": {
        "pay_confirm_message": "Il pagamento è confermato.<br> Porta: {gateway_name}<br> Data: {payment_at}",
    ...
    "basket_list": {
      ...
      "message": "Se uno qualsiasi degli articoli non è disponibile o non può essere venduto, deseleziona la casella accanto ad esso e fai clic sul pulsante <b>Conferma ordine</b> .",
      ...
      "lottery_prize_inform": "Il tuo cliente vince 1 volta di questo prodotto. Invia un regalo con questo ordine."
    },
    "preparing": {
      "title": "Preparazione",
      ...
      "message": "Fare clic sul seguente pulsante <b>Ordine pronto</b> se l'ordine è pronto per la spedizione.",
    ...
    "return_delivery_dialog": {
      ...
      "message": "Conferma l'opzione per restituire la spedizione se l'ordine viene restituito dopo l'invio per qualche motivo ed è necessario inviare nuovamente la spedizione.",
    ...
    "notifications": {
      ...
      "pay_dir_success": "Il pagamento è stato confermato tramite pagamento da carta a carta o trasferimento di denaro.",
      "set_tracking_success": "Order Track ID salvato correttamente.",
  ...
  "shop_gateway": {
    ...
    "dashboard": {
      ...
      "gateway_info_widget": {
        ...
        "title_small": "Gateway",
        "status": "Stato",
        "cod_transportation": "Metodi di spedizione che supportano COD",
        "cod_transportations_error": "Abilita il pagamento in contrassegno per almeno un metodo di spedizione!",
        "payment_type": "Modalità di pagamento",
        "cod": "Pagamento alla consegna",
        "online": "Pagamento online",
        "wage_percent": "Commissione Percentuale",
        "min_wage": "Tariffa minima",
        "max_wage": "Tariffa massima",
        "min_amount": "Transazione minima",
        "max_amount": "Massima transazione",
        "timeout": "Periodo di pagamento",
        "timeout_unit": "Secondi",
        "link": "Collegamento del gateway",
        "your_gateway_status": "Lo stato del tuo gateway",
        "config_extra_info": "Configurazione del servizio di pagamento",
        "oauth2_button": "Connessione automatica a {gateway}",
        "fee_payment_message": "L'intero importo pagato dal cliente verrà trasferito sul tuo conto. La commissione del servizio verrà detratta dal tuo portafoglio in Selldone."
      }
    },
    "edit": {
  ...
  "edit_gateway": {
    ...
    "link": "Sito web",
    "state_title": "Metodo di pagamento attivo/inattivo",
    "gateway_status": "Stato",
    "wallet": "Portafoglio blockchain",
    "developer_title": "modalità sviluppatore",
    "developer_message": "Puoi elaborare transazioni false se il gateway supporta la modalità di debug.",
    "notifications": {
      "edit_success": "Gateway {gateway_name} modificato."
    },
    "developer_setting": "Sviluppa e prova",
  ...
  "gift_card": {
    ...
    "dashboard": {
      "title": "Dashboard di gestione delle carte regalo",
      "amount_widget": {
  ...
  "shop_discount": {
    ...
    "dashboard": {
      "title": "Dashboard per la gestione del codice sconto",
      "chart_amount_buy": {
  ...
  "shop_offer": {
    ...
    "dashboard": {
      "title": "Dashboard di gestione dell'offerta",
      "chart_amount_buy": {
        "y": "Importo dell'acquisto {currency}",
        "label": "Acquistare"
      },
  ...
  "timeline": {
    ...
    "buy": "Guardare",
    "payment": "Pagamento",
    "confirm": "Conferma dell'ordine, <b>{success}</b> confermato e <b>{fail}</b> rifiutato.",
    ...
    "delivery-returned": "L'ordine non è stato ricevuto dal cliente ed è stato restituito. È necessario spedire di nuovo.",
    ...
    "payment-cash-confirm": "Il pagamento di {amount} {currency} in contanti per il conto è stato confermato.",
  ...
  "accounts": {
    ...
    "message": "Devi creare almeno un account con la valuta che stai utilizzando in Selldone. È necessario ricaricare questo account per pagare la tariffa del servizio.",
    ...
    "new_account_dialog": {
      ...
      "currency_input_message": "L'account creato conterrà solo i valori di questa valuta.",
  ...
  "user_gifts": {
    ...
    "send_gifts": {
      ...
      "sub_title": "Puoi inviare un regalo ai tuoi amici o clienti. Il destinatario può accettare o rifiutare il tuo regalo. L'importo viene bloccato nel tuo account e ritirato se il destinatario accetta. In caso contrario, questo importo verrà trasferito sul tuo account.",
      "table": {
        "user": "utente",
        "amount": "Importo",
        "currency": "Moneta",
    ...
    "received_gifts": {
      ...
      "sub_title": "I tuoi regali ricevuti da Selldone o altri",
      "table": {
        "amount": "Importo",
        "currency": "Moneta",
  ...
  "get_gift_dialog": {
    ...
    "notifications": {
      ...
      "received_success": "L'importo del regalo {amount} {currency} è stato depositato sul tuo account."
    }
  },
  "send_gift_dialog": {
    "title": "Invia REGALO",
  ...
  "user_monetize_accounts": {
    ...
    "notifications": {
      ...
      "delete_success": "Account rimosso con successo dall'elenco degli account predefiniti per la ricezione di regali."
    },
    "delete_alert": {
      "title": "Eliminare l'account",
      "message": "Vuoi rimuovere questo account dall'elenco Account regalo?",
      "action": "Eliminare"
    }
  },
  "user_monetize": {
  ...
  "user_monetize_plans": {
    ...
    "sub_title": "Riceverai un credito sul conto per i regali di riferimento. Questi importi verranno addebitati sul tuo conto e possono essere prelevati solo ai partner commerciali di Selldone (non tutti). Puoi spendere i soldi per la commissione dei servizi di Selldone.",
    "discount": "Sconto",
    ...
    "link_tip": "Puoi aggiungere la frase ?ref={link_code} alla fine di ogni indirizzo che condividi.",
    "table": {
      "currency": "Moneta",
      "amount": "Bilancia",
    ...
    "notifications": {
      "get_credit_success": "L'importo richiesto è stato depositato sul tuo conto."
    }
  },
  "basic_information": {
    ...
    "main_profile_subtitle": "Queste informazioni sono pubblicamente disponibili a tutti.",
    "kyc_waiting_info": "Stiamo verificando l'accuratezza delle informazioni che inserisci. Questo processo è obbligatorio in conformità con le regole KYC e ridurrà il rischio di transazioni finanziarie. Puoi sfruttare i vantaggi presenti e futuri di questo servizio.",
    "personal_info_dialog": {
      ...
      "passport_image_input_message": "Carica una scansione dell'immagine del tuo passaporto.",
      "personal_image_input": "Scegli la tua immagine",
      "personal_image_input_message": "Carica un'immagine di scansione avanti e indietro sulla tua carta nazionale su un'immagine."
    },
    "profile_dialog": {
      ...
      "image_input_message": "Carica la tua immagine. Questa immagine verrà utilizzata come immagine del tuo profilo.",
      "notifications": {
        "update_profile_success": "Il tuo profilo è stato aggiornato.",
        "update_personal_info_success": "Le tue informazioni sono state registrate con successo"
      }
    },
    "charge_account_approve_message": "Addebita sul tuo conto per approvare la tua transazione bancaria.",
    "payment_approval": "Approvazione del pagamento",
    "residential_address_checking": "I documenti dell'indirizzo di residenza in coda di controllo.",
    "add_residential_address": "Aggiungi la tua posizione e la prova dei documenti dell'indirizzo di residenza."
  },
  "phone_verify": {
    "title": "Numero di cellulare",
    "step1_title": "Inserisci il tuo numero di telefono.",
    ...
    "notifications": {
      ...
      "send_activation_code_success": "Il codice di verifica è stato inviato a {phone_number}.",
      "verify_success": "Il tuo numero di cellulare è stato verificato"
    }
  },
  "companies": {
    "title": "I miei conti aziendali",
    "message": "Aziende, imprenditori e team di professionisti possono sviluppare prodotti e applicazioni basati su Selldone. È un requisito per creare un profilo aziendale.",
  ...
  "user_access_control": {
    ...
    "connected_apps_message": "Vedrai un elenco di tutti gli store e le app collegati al tuo account di dominio. È possibile eliminare l'accesso a uno qualsiasi di essi.",
    "shop_keys_title": "Memorizza le chiavi di accesso",
    "shop_keys_message": "Queste chiavi vengono utilizzate per creare token di accesso dal server. Si noti che le chiavi sono riservate e posizionate sul server solo in modo che non siano visibili ad altri.",
    "personal_keys_title": "Chiavi di accesso personali",
    "personal_keys_message": "Puoi creare le chiavi del tuo account qui. Tieni presente che queste chiavi potranno accedere al tuo account. Crea e usa queste chiavi solo se sai esattamente cosa stai facendo.",
    "clients_title": "Clienti",
    "clients_message": "Queste chiavi vengono utilizzate per creare token di accesso dal server. Si noti che le chiavi sono riservate e posizionate sul server solo in modo che non siano visibili ad altri."
  },
  "user_security_control": {
    ...
    "delete": {
      "title": "Eliminare l'account",
      "subtitle": "Prima di eliminare il tuo account, assicurati di aver eliminato tutti i negozi.",
      "action": "Sono sicuro, elimina il mio account",
      "agreement": "Accetto che tutte le mie informazioni vengano cancellate dal tuo server. Le tue informazioni saranno cancellate secondo un programma da noi stabilito per prevenire frodi o usi impropri."
    },
    "list": {
      "password": {
      ...
      "phone": {
        "title": "Numero di cellulare",
        "sub_title": "Conferma il tuo numero di cellulare. Potrai accedere tramite questo numero.",
      ...
      "email": {
        ...
        "sub_title": "Hai la possibilità di aggiornare l'e-mail principale associata a questo account.",
    ...
    "two_step_auth": {
      ...
      "step_2": {
        ...
        "message": "Il codice a 6 cifre è generato da un algoritmo nel tuo cellulare. È possibile scaricare l'app dal seguente link. Premere il tasto generatore di codice per creare un codice QR contenente la password.",
        "qr_code_info": "Se non è possibile eseguire la scansione, è possibile copiare e incollare manualmente il codice nell'app:",
        "create_new_code": "Crea nuovo codice",
        "qr_code_scanning": "Scansiona il codice QR creato da Google Authenticator Mobile App e inserisci il codice generato per conferma nel box in questa pagina.",
        "qr_code_regenerate_info": "Nota: Premendo il tasto sopra verrà creata una nuova chiave e la chiave precedente sarà inutilizzabile. Immettere la nuova chiave nell'app del telefono."
      },
      "step_3": {
        "title": "Inserisci il codice creato",
        "message": "Inserisci nel campo sottostante il codice di accesso creato nell'applicazione.",
        "activation_key_input": "Codice d'accesso"
      },
      "activated_alert": "L'accesso in 2 passaggi è abilitato.",
      "activated_message": "L'accesso in due passaggi è abilitato per il tuo account. D'ora in poi dovrai inserire un secondo codice che cambia ogni 30 secondi per accedere al tuo account. Per disabilitare l'accesso in due passaggi, fai doppio clic su Premi un passaggio e segui i passaggi.",
      "cancel_two_step_login_action": "Annulla l'accesso in due passaggi",
      "cancel_two_step_login_info": "Se desideri disabilitare la verifica in due passaggi, inserisci la tua password e fai clic sulla chiave di accesso in due passaggi.",
  ...
  "authorized_clients": {
    ...
    "delete_alert": {
      "title": "Eliminare",
      "message": "Vuoi revocare questo accesso? Tieni presente che questa app non avrà più accesso al tuo account.",
  ...
  "personal_access_tokens": {
    ...
    "access_token_dialog": {
      ...
      "message": "Ecco il token del tuo token di accesso personale. Questa è l'unica volta che questo token verrà visualizzato, quindi non perderlo! Ora puoi utilizzare questo token per richiedere un'API."
    },
    "delete_alert": {
      "title": "Eliminare",
  ...
  "scopes": {
    "profile": {
      "name": "profilo",
      "description": "Leggi le informazioni sul profilo tra cui nome, indirizzo e-mail, immagine e stato di autenticazione."
    },
    "phone": {
    ...
    "notifications": {
      "name": "Invia e ricevi notifica",
      "description": "Invia e ricevi notifica."
    },
    "read-shops": {
      "name": "Ist. negozio",
      "description": "Leggi l'elenco dei negozi."
    },
    "shop-edit": {
      "name": "Gestione del negozio",
      "description": "Modifica l'accesso al negozio"
    },
    "shop-contacts": {
      "name": "Gestione del modulo di contatto",
      "description": "Ricevi e modifica i moduli di contatto."
    },
    "shop-gift-cards": {
      "name": "Gestisci le carte regalo",
      "description": "Crea, modifica e gestisci carte regalo."
    },
    "shop-faqs": {
      "name": "Gestione di domande e risposte",
      "description": "Crea, modifica e gestisci le domande frequenti."
    },
    "shop-categories": {
      "name": "Gestisci categorie",
      "description": "Crea, modifica e gestisci le categorie."
    },
    "shop-products": {
      "name": "Gestione del prodotto",
      "description": "Aggiungi, modifica e gestisci i prodotti."
    },
    "shop-read-reports": {
      "name": "Leggi i rapporti",
      "description": "Leggi informazioni e rapporti."
    },
    "shop-socials": {
      "name": "Gestisci i social media",
      "description": "Modifica i social media del negozio"
    },
    "shop-accounts": {
      "name": "Gestire i conti finanziari",
      "description": "Modifica ed elimina gli account finanziari collegati al negozio."
    },
    "shop-menus": {
      "name": "Gestisci menu",
      "description": "Modifica i menu del negozio."
    },
    "shop-pages": {
      "name": "Gestisci pagine",
      "description": "Modifica le pagine del negozio."
    },
    "shop-warehouse": {
      "name": "Gestione del magazzino",
      "description": "Modifica Magazzino negozio"
    },
    "shop-permissions": {
      "name": "Gestisci l'accesso",
      "description": "Visualizza e modifica l'accesso al negozio."
    },
    "shop-process-center": {
    ...
    "shop-profile": {
      ...
      "description": "Gestisci i profili del negozio."
    },
    "shop-discount-code": {
      "name": "Gestione codici sconto",
      "description": "Gestisci, modifica e aggiungi codici sconto del negozio."
    }
  },
  "company_page": {
    "title": "Azienda",
  ...
  "shop_permissions": {
    "ADMIN": {
      "text": "Proprietario",
      "description": "Accesso completo a tutte le vetrine."
    },
    "PRODUCT": {
    ...
    "MARKETING": {
      "text": "Marketing",
      "description": "Accesso alle impostazioni e creazione di campagne, email marketing e altre sezioni relative al marketing."
    },
    "VIEWER": {
      "text": "Spettatore",
      "description": "La possibilità di visualizzare le informazioni del negozio senza poterle modificare o cambiare."
    }
  },
  "shop_roles": {
  ...
  "account_page": {
    ...
    "transfer": {
      ...
      "form": {
        ...
        "sub_title": "Deposita sul tuo conto o su altri",
        "message": "Fai attenzione nel trasferire denaro, non potrai restituire se completi il trasferimento."
      }
    },
    "deposit": {
      "form": {
        "title": "Conto di addebito",
        "sub_title": "Devi addebitare il saldo del tuo account per acquistare licenze, aggiornare il tuo account e pagare le ricevute di sistema.",
        "amount_input": "Importo",
  ...
  "transaction_form": {
    ...
    "confirmation": {
      ...
      "message": "Se le seguenti informazioni sono corrette, premi il tasto di conferma della transazione per effettuare la transazione.",
      "from": "Dal conto",
      "to": "Per conto",
      "amount": "Importo",
    ...
    "currency_not_match": "La valuta del conto di destinazione non è la stessa di origine",
  ...
  "login": {
    ...
    "register_subtitle": "Registrati oggi gratis. Selldone è amato da startup, imprese, acquirenti e venditori.",
    "password_recovery_title": "Recupero della password",
    "password_recovery_message": "Se hai dimenticato la password, inserisci l'indirizzo email del tuo account e premi il tasto di conferma. Ti invieremo un'e-mail con un link per reimpostare la tua password.",
    ...
    "privacy_agreement": "Iscrivendoti, accetti i <a href='/terms' target='_blank'>Termini di utilizzo</a> e <a href='/privacy' target='_blank'>l'Informativa sulla privacy</a> di Selldone.",
  ...
  "page_builder": {
    ...
    "seo": {
      "message": "Le impostazioni SEO sono regolate automaticamente dal motore SEO Selldone."
    }
  },
  "verify_email_caution": {
    "title": "conferma il tuo indirizzo email",
    "message": "Il nuovo link di attivazione è stato inviato al tuo indirizzo email {email}. Si prega di controllare la posta elettronica prima di intraprendere qualsiasi azione.",
    "resend_message": "Se non hai ricevuto il link di attivazione nella tua e-mail, fai clic sul pulsante in basso per inviare nuovamente.",
  ...
  "shop_license": {
    ...
    "price": "prezzo",
    "terms": "Ho letto e accetto i termini di utilizzo di Selldone",
    ...
    "active_license": {
      ...
      "subtitle": "Le tue informazioni sulla licenza attiva.",
      "subtitle_partner": "Informazioni sulla licenza di {name} attiva."
    },
    "licenses_table": {
      "title": "Storia degli acquisti",
      "subtitle": "Licenze attive e in sospeso."
    },
    "license_detail": {
      "title": "Dettagli",
      "subtitle": "Limiti del tuo piano attuale."
    },
    "table": {
      "plan": "Piano",
    ...
    "validity_duration_hint": "Acquistando una licenza di 12 mesi, riceverai uno sconto del 30%."
  },
  "admin_shop_layout": {
  ...
  "user_preferences": {
    ...
    "samples_message": "Se abilitato, alcuni negozi campione verranno visualizzati nel tuo pannello.",
    "automation": "Automazione",
    "automation_message": "Mostra la scheda di automazione sulla dashboard del negozio. (Webhook, Programmazione visiva, ...)"
  },
  "shop_locations": {
    "title": "Paesi in cui viene fornito il servizio",
    "sub_title": "Seleziona i paesi in cui desideri vendere il tuo prodotto dall'elenco sottostante.",
  ...
  "product_studio": {
    ...
    "add_by_sku": "Aggiungi per SKU",
    "auto_category": "Categoria di impostazione automatica",
    "add_in_current_category": "Aggiungi alla categoria corrente",
    "category_mode_message": "Se abilitato, il prodotto verrà aggiunto alla categoria o sottocategoria predefinita.",
    "sku_name_input": "SKU / Nome"
  },
  "my_affiliate": {
    "title": "I miei contratti di affiliazione",
    "message": "Elenco degli accordi di affiliazione con altri negozi."
  },
  "affiliates": {
    "title": "Partner affiliati",
    "subtitle": "Crea affiliati, monitora le loro prestazioni nel tempo e intraprendi azioni sulla base di informazioni accurate in un unico posto. Aiutiamo te e i tuoi partner a costruire una relazione forte.",
    ...
    "link_domain": {
      "title": "Dominio collegato",
      "subtitle": "Puoi collegare uno dei tuoi domini a questo partner affiliato. Questo partner sarà conosciuto come il rappresentante di ogni persona che visita il tuo negozio e acquista tramite questo dominio."
    },
    "dialog": {
      "new": "Nuovo partner affiliato",
      "edit": "Modifica partner affiliato",
      "user": "Utente (opzionale)",
      "bank_info": "Informazioni bancarie",
      "restriction": "Restrizione",
      "select_products": "Seleziona i prodotti",
      "select_products_message": "Il partner affiliato riceve una commissione per questi prodotti",
      "edit_action": "Aggiorna affiliato",
      "add_action": "Aggiungi partner affiliato",
      "affiliate_name": "Nome del partner affiliato",
      "payment_info": "Informazioni di pagamento",
      "enable_switch": "È attivo?",
      "affiliate_info": "Informazioni sul partner affiliato"
    },
    "link_factory": {
  ...
  "discount_codes": {
    "title": "Codici Sconto",
    "sub_title": "In questa sezione potrai progettare buoni sconto in base alle tue esigenze. Questi sconti sono separati da qualsiasi sconto sul prodotto e si applicheranno all'importo finale dell'ordine dell'utente.",
    ...
    "dialog": {
      ...
      "limit_input_message": "Il valore 0 per il limite di sconto significa che non c'è limite per il tasso di sconto.",
      "title_input": "Titolo",
      "title_input_hint": "Puoi inserire un titolo per questo codice sconto",
      "description_input": "Descrizione",
      "description_input_hint": "Puoi inserire una descrizione per questo codice sconto",
  ...
  "gift_cards": {
    "title": "Carta regalo",
    "sub_title": "Crea una carta regalo e poi creane quanti ne hai bisogno. Questa carta ha un addebito e può essere utilizzata solo per acquisti nel tuo negozio.",
  ...
  "coupons": {
    "title": "Buoni",
    "sub_title": "Se vuoi offrire ai tuoi clienti uno sconto che può essere utilizzato con condizioni specifiche, puoi creare dei coupon. I coupon possono includere uno sconto percentuale con un limite o un importo fisso o una combinazione di entrambi.",
  ...
  "coupon_edit": {
    ...
    "min_purchase_amount_hint": "L'importo dell'acquisto deve essere maggiore o uguale a questo valore.",
    ...
    "apply_for_first_order_on": "Questo coupon può essere utilizzato solo per il primo acquisto del cliente!",
    "apply_for_first_order_off": "Il numero di utilizzi dei coupon per acquirente può essere modificato di seguito.",
    "has_qualify_constraints": "Vuoi definire più limiti?",
    "has_qualify_constraints_message": "Imposta più condizioni per qualificare il cliente a utilizzare questo coupon.",
    "one_time_use": "Monouso",
  ...
  "offers": {
    "title": "Offerte",
    "sub_title": "Puoi creare offerte speciali per i tuoi clienti in modo che, dopo aver acquistato un articolo, ne ricevano un altro con uno sconto o addirittura gratis.",
  ...
  "offer_edit": {
    ...
    "qualified_products": "Prodotti idonei",
    "qualified_products_message": "Affinché i prodotti siano idonei, il totale degli articoli nel carrello deve essere uguale o superiore alla quantità minima.",
    ...
    "per_order_message": "Il numero massimo di volte in cui l'offerta può essere applicata a un ordine",
    "count_input": "Importo",
    "count_input_hint": "Massimo utilizzo di questa offerta",
    "min_purchase": "Importo minimo di acquisto",
    "min_purchase_hint": "Il prezzo di acquisto deve essere maggiore o uguale a questo valore",
  ...
  "emails": {
    ...
    "subtitle": "Progetta le email trascinandole, pianifica e avvia campagne per aumentare la fidelizzazione e visualizza informazioni affidabili e accurate in un unico posto.",
    "cation_message": "⚠ Limitato ai commercianti non verificati. (Beta)",
    "subject": "Soggetto",
    "from": "A partire dal",
    "in_que": "In attesa",
  ...
  "email_dashboard": {
    ...
    "not_submitted_send_request": "Non hai ancora inviato una richiesta per inviare questa email.",
  ...
  "affiliate_dashboard": {
    "link": "Collegamento partner di affiliazione",
    "fix_commission": "Commissione fissa",
  ...
  "shop_lotteries": {
    "title": "Lotteria",
    "sub_title": "I tuoi clienti possono giocare e vincere. I clienti del tuo negozio devono consumare 10 gettoni per ogni gioco. Ad esempio, se vuoi che i tuoi clienti abbiano la possibilità di vincere 1000 USD, devi impostare l'importo del prezzo di ogni chip a 100 USD. Un valore di 0 per ogni chip significa che l'acquirente riceverà un chip per ogni acquisto.",
  ...
  "lottery_edit": {
    ...
    "currency_message": "Valuta per questo articolo. Le altre valute vengono convertite in base al tasso di cambio.",
    "discount": "Sconto",
  ...
  "shop_tax": {
    ...
    "calculate_tax_message": "Attivando questa opzione, l'IVA verrà calcolata e applicata ai tuoi ordini.",
    "tax_number": "Codice Fiscale",
    "tax_number_message": "Inserisci il tuo codice fiscale. Questo numero di registrazione sarà registrato nella fattura dell'acquirente.",
    "tax_included_in_price_input": "Tasse incluse nel prezzo dei prodotti",
    "tax_included_in_price_message": "Seleziona questa opzione se includi l'importo dell'imposta nel prezzo del tuo prodotto. L'importo dell'imposta sarà calcolato con la seguente formula:",
    "tax_included_in_price_formula": "Imposta = (prezzo * IVA) / (1 + IVA), ad esempio, l'importo dell'imposta per un prodotto al prezzo di 100 $ con un'aliquota sul valore aggiunto del 10% diventa 9,09 $.",
    "tax_on_shipping_input": "Applicare le tasse alla spedizione",
    "tax_on_shipping_message": "Selezionando questa opzione verrà applicata l'imposta sulla spedizione.",
    "fixed_tax_rate": "Aliquota d'imposta fissa",
    "dynamic_tax_rate": "Tasse in base alle regioni",
    "locations_tip": "L'elenco sopra mostra solo i paesi che hai selezionato nelle impostazioni del negozio > Località come paesi che vendi.",
  ...
  "delivery_person": {
    ...
    "pickup_dialog": {
      ...
      "message": "Se sei responsabile del trasporto di questo pacco, seleziona Sì, altrimenti seleziona il No."
    },
    "status_dialog": {
    ...
    "cod_dialog": {
      ...
      "message": "Confermi di aver ricevuto l'importo dell'ordine dall'acquirente?",
  ...
  "pos_devices": {
    ...
    "Scanner_desc": "Per utilizzare lo scanner di codici a barre, è necessario inserire correttamente il codice SKU del prodotto nelle impostazioni del prodotto.",
    "Printer": "Stampante",
    "Printer_desc": "Stampa la ricevuta dei tuoi clienti collegandoti a una stampante per ricevute.",
    "CustomerView": "Vista del cliente",
    "CustomerView_desc": "Questa pagina ti consente di mostrare i dettagli dell'ordine ai tuoi clienti.",
  ...
  "pos": {
    ...
    "payment_dialog": {
      ...
      "paid_by_gift_card_msg": "L'importo totale dell'ordine è stato prelevato dalle carte regalo! L'acquirente non deve pagare di più.",
    ...
    "name": "POS",
    "message": "Avere il tuo punto vendita online a costo zero, eseguirlo su qualsiasi smartphone, tablet e PC o creare ordini manualmente."
  },
  "exporter": {
    "title": "Esporta dati",
    "subtitle": "I tuoi dati ti appartengono! Puoi scaricare le informazioni sulla tua attività nel formato standard in qualsiasi momento. Tuttavia, rispetta la privacy dei tuoi clienti, non inviarli spam e non condividere mai le loro informazioni con terzi.",
    "excel": "Riceverai un elenco di tutti i {type} presenti nel negozio insieme a informazioni complete in formato Excel.",
  ...
  "importer": {
    "category": {
      ...
      "subtitle": "Carica qui il file CSV delle categorie. Assicurati di seguire il formato standard."
    },
    "product": {
      "title": "Importa prodotti",
      "subtitle": "Carica qui il file CSV dei prodotti. Assicurati di seguire il formato standard."
    },
    "product_images": {
      "title": "Importa immagini",
      "subtitle": "La ricezione di informazioni sull'immagine richiede tempo. Assicurati di rispettare il copyright durante l'importazione delle immagini."
    },
    "inventory": {
      "title": "Inventario di aggiornamento collettivo",
      "subtitle": "Carica qui il file CSV dell'inventario. Assicurati di seguire il formato standard esportando prima il file CSV, quindi modificando quel file."
    },
    ...
    "customer": {
      ...
      "subtitle": "Carica qui i file CSV dei clienti. Assicurati di seguire il formato standard e, inoltre, devi seguire le regole sulla privacy."
    }
  },
  "campaigns": {
    "title": "Campagne",
    "subtitle": "Crea campagne, link tracciabili e visualizza informazioni affidabili e accurate in un unico posto. Ti aiutiamo a prendere decisioni migliori basate sui dati.",
  ...
  "shop_theme": {
    ...
    "products_view_mode_desc": "Puoi regolare la modalità di visualizzazione dei prodotti nel tuo negozio in base alle dimensioni dello schermo. Questa modalità sarà considerata di default e non verrà applicata se l'utente cambia la modalità di visualizzazione.",
  ...
  "my_roles": {
    "title": "I miei ruoli",
    "message": "I ruoli sono il tipo di accesso concesso ai dipendenti di un negozio. Ad esempio, il personale responsabile dell'invio o dell'imballaggio degli ordini."
  },
  "role_card": {
  ...
  "referral_widget": {
    "apply_now": "Candidati ora per questo programma!",
    "no_bonus": "Ricevi il primo premio invitando un amico.",
    "your_gift": "Il tuo regalo",
    "invited_gift": "Regalo invitato",
    "percent_bonus": "Bonus percentuale",
    "discount_bonus": "Bonus sconto",
    "registered": "Nuovo utente",
    "accepted": "Utente accettato"
  },
  "app_config": {
    "reviews": "Recensioni",
  ...
  "shop_bots": {
    ...
    "dialog": {
      ...
      "message": "Un framework bot completo per la creazione di esperienze di acquisto di livello aziendale."
    }
  },
  "shop_customers": {
  ...
  "app_loader_page": {
    ...
    "no_ui_desc": "Alcune applicazioni non richiedono un'interfaccia utente nella loro area di amministrazione. Questa applicazione può aggiungere codice solo alla sezione dell'intestazione del sito Web del tuo negozio.",
    "header": "Codice intestazione"
  },
  "finance_report": {
    "export_title": "Esporta dati finanziari",
    "export_sub_title": "Scarica i dettagli finanziari in un unico file.",
  ...
  "shop_notifications": {
    ...
    "dialog": {
      ...
      "message": "Un framework di notifica completo per creare esperienze di e-commerce di livello aziendale.",
      "action": "Clicca qui!",
  ...
  "order_delivery": {
    ...
    "message": "Dopo aver consegnato il pacco al corriere di spedizione, clicca sul pulsante <b>Conferma Consegna</b> .",
    "message_add_to_service": "Fare clic sul pulsante seguente se si desidera inviare questo pacco tramite un <b>servizio di consegna</b> .",
    "action": "Conferma di consegna",
    "checklist": [
    ...
    "manual": {
      ...
      "message": "Nota: se il cliente riceve l'ordine, puoi utilizzare le seguenti opzioni per completare l'evasione. Alcuni servizi di spedizione nel sistema confermeranno automaticamente la consegna."
    },
    "auto_complete_note": "Dopo un certo periodo, lo stato dell'ordine verrà modificato in consegnato. Questo periodo varia a seconda del tipo di ordine ed è determinato dal sistema.",
    "received": {
    ...
    "tracking": {
      ...
      "message": "Se hai spedito tramite un servizio che fornisce un codice di tracciamento per questo ordine, puoi inserire il codice e il relativo link di tracciamento in questa sezione. Queste informazioni verranno mostrate al cliente."
    },
    ...
    "option_add_to_que": "Opzione 2: aggiungi alla coda da elaborare nella pagina del servizio di spedizione.",
    "option_instant_shipping": "Opzione 3: spedizione immediata.",
    "pickup_action": "Conferma del ritiro"
  },
  "shop_home_edit": {
    "title": "Impostazione della pagina iniziale",
    "sub_title": "Imposta la pagina predefinita del tuo sito web",
  ...
  "selldone_referral_page": {
    "title": "Dashboard di riferimento",
  ...
  "widget_shop_gateway": {
    "link_account_caution": "Collega un account ({currency}) al tuo negozio! Clicca qui.."
  },
  "product_sell_widget": {
  ...
  "fulfilment_order_widget": {
    ...
    "message": "Dopo aver pagato la commissione dell'ordine al fornitore, vedere lo stato di avanzamento dell'invio dell'ordine in questa sezione."
  },
  "drop_shipping": {
    "menu": {
      "dashboard": "Pannello",
  ...
  "dropshipping_reseller_dashboard": {
    "title": "Dashboard del rivenditore"
  },
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Il tuo ordine è stato registrato come pagamento diretto, completa il pagamento e carica la ricevuta nella pagina dell'ordine.",
      "pay_title": "Pagamento",
  ...
  "dropship_checkout": {
    ...
    "notifications": {
      "success_pay": "Il pagamento per questi ordini è stato confermato e completato con successo."
    }
  },
  "dropship_accounts": {
    "charge_account": "Conto di addebito",
  ...
  "dropshipping_products": {
    "no_shops": "Siamo spiacenti, nessun negozio trovato. Ci saranno più negozi in futuro in modo da poter mettere i loro prodotti nel tuo negozio.",
    ...
    "notifications": {
      ...
      "request_access": "Abbiamo inviato con successo la tua richiesta di accesso al grossista."
    },
    "show_eligible_shops_message": "Mostra i negozi idonei"
  },
  "product_dropshipping": {
    "need_re_enable": "Questo prodotto è stato modificato dal venditore originale, queste variazioni di prezzo hanno disabilitato il prodotto nel tuo negozio. Verifica le modifiche e se accetti di riattivare il prodotto, premi il pulsante qui sotto.",
    "need_re_enable_action": "Accetto, applica le modifiche e l'attivazione",
    "changed_value": "Questo prodotto è stato modificato dal venditore originale. Controlla le modifiche e se accetti di applicare le modifiche al tuo prodotto, fai clic sul pulsante in basso.",
    "changed_value_action": "D'accordo, apporta modifiche",
    "parent_deleted": "Questo articolo è stato rimosso dal venditore originale.",
    "parent_closed": "Questo prodotto è stato disabilitato dal venditore originale! Non potrai vendere questo prodotto nel tuo negozio, ma se il venditore originale riattiva il prodotto potrai riattivarlo nel tuo negozio.",
    "notifications": {
      "re_enable_success": "Questo prodotto è stato riattivato.",
      "update_success": "Queste informazioni sul prodotto sono state aggiornate con le informazioni sul prodotto originale."
    }
  },
  "product_dropshipping_admin": {
    "title": "Scaricare la consegna",
    "save_alert": "Le impostazioni di dropshipping di questo prodotto sono cambiate. Vuoi salvare le modifiche?",
    "reselling_message": "Attivando questa opzione, gli altri venditori potranno aggiungere il tuo prodotto al loro negozio.",
  ...
  "styler": {
    ...
    "products": {
      ...
      "categories_limit_msg": "Inserisci il numero massimo di categorie. Imposta zero per nessun limite."
    }
  },
  "shop_contacts": {
    "popup": "Abilita il supporto dei popup",
    "popup_message": "Attivando questa opzione, la chiave di supporto verrà visualizzata in basso a destra del tuo negozio."
  },
  "popup_page": {
  ...
  "popup_appearance": {
    "position": "Posizione",
    "position_desc": "Specificare la posizione di visualizzazione di questa notifica nella pagina.",
    "width": "Larghezza",
    ...
    "radius_desc": "In questa sezione puoi impostare il raggio di curvatura degli angoli della notifica.",
    "shadow": "Ombra",
    "shadow_desc": "Vuoi che la finestra pop-up sia ombreggiata?",
    "delay": "Mostra ritardo",
    "delay_desc": "Una volta che l'utente è entrato nel tuo negozio, trascorso questo periodo di tempo, verrà visualizzata una notifica all'utente.",
    "hide": "Nascondi ritardo",
    "hide_desc": "Puoi impostare che la notifica si chiuda automaticamente pochi secondi dopo lo spettacolo. Un valore di 0 significa che la notifica non si chiuderà automaticamente.",
    "transition": "Animazione popup"
  },
  "popup_filter": {
    "registered": "Requisiti di iscrizione e di accesso",
    "registered_desc": "Puoi scegliere di mostrare questa notifica solo agli utenti o agli ospiti del negozio.",
    "only_guests": "Solo ospiti",
    "only_users": "Solo utenti registrati",
    "purchased": "Cronologia degli acquisti",
    "purchased_desc": "Puoi scegliere di mostrare questa notifica solo agli utenti che hanno già acquistato oa coloro che non hanno ancora acquistato.",
    "no_purchase": "Nessun acquisto ancora",
    "yes_purchase": "Acquistato prima",
    "sex": "Genere",
    "sex_desc": "Vuoi che questa notifica venga mostrata solo agli utenti di un sesso specifico?",
    "age": "Età minima",
    "age_desc": "Se viene inserito un valore maggiore di 6, l'utente deve essere loggato e deve aver inserito la sua data di nascita.",
    "levels": "Livelli del club dei clienti",
    "levels_desc": "Se l'utente ha uno dei livelli selezionati di seguito, questa notifica gli verrà mostrata.",
    "countries": "Restrizioni di posizione",
    "countries_desc": "Vuoi che questa notifica venga mostrata solo agli utenti provenienti da un paese specifico?"
  },
  "popup_setting": {
    "published": "Stato pubblicato",
    "repeat": "Ripetere",
    "repeat_msg": "Vuoi che questa notifica venga mostrata all'utente più di una volta?",
    "intervals": "Durata della visualizzazione popup",
    "intervals_msg": "Deve essere trascorso il tempo minimo tra la visualizzazione delle notifiche a un utente.",
    ...
    "delete": {
      "title": "Eliminare",
      "sub_title": "Una volta eliminato un popup, non c'è ritorno. Si prega di essere certi.",
  ...
  "shop_sms": {
    "title": "Gestisci SMS",
    "sub_title": "Modelli SMS inviati ai clienti",
    "message": "Puoi vedere il contenuto degli SMS inviati dal tuo negozio qui. A causa della limitazione nella registrazione dei modelli di convalida nel servizio di messaggistica, al momento non è possibile personalizzare i messaggi di testo."
  },
  "shop_emails": {
    "title": "Gestisci le email",
    "sub_title": "In questa sezione vedrai l'elenco delle email inviate dal negozio a clienti e gestori. Le e-mail vengono progettate e create automaticamente in base alle informazioni che hai inserito per il tuo negozio. Inoltre, in futuro sarà disponibile al pubblico la possibilità di personalizzare messaggi e immagini."
  },
  "instagram": {
    "title": "Vendite su Instagram",
    "message": "Con l'aiuto di questo strumento, puoi trasformare il tuo Instagram in un negozio. Basta aggiungere e confermare qui il tuo account Instagram, quindi potrai pubblicare uno o più prodotti da ogni post o nella tua storia, aggiungere e taggare la tua lista di prodotti o trasformare un post in un nuovo prodotto!",
    "add_product": "Aggiungi nuovo prodotto",
    "create_product": "Crea prodotto",
    "link_box_msg": "Inserisci questo link nella tua biografia su Instagram, Telegram o altri social media in modo che il tuo pubblico possa acquistare più velocemente, più facilmente, di più e infine di più.",
    "remove_account": "Cambia/Rimuovi link Instagram",
    "sync": "Sincronizza i dati dell'account (ogni 60 minuti)"
  },
  "service_bill": {
    "task": {
      "title": "Lista di cose da fare",
      "message": "Scrivi i titoli del lavoro che vuoi fare e fai sapere all'acquirente fino a che punto è progredito."
    },
    "booking": {
      "title": "Prenotazione / Prenotazione",
      "message": "Questo ordine verrà elaborato a un'ora specifica, il cliente ha selezionato il periodo desiderato, se desideri apportare modifiche nel periodo selezionato, informa il cliente.",
      "selected_checkin": "Data di accesso cliente selezionata",
      "selected_checkout": "Data di uscita del cliente selezionata",
      "change_days_question": "Hai bisogno di cambiare durante i giorni selezionati dal cliente?",
  ...
  "service_tasks": {
    "notification_finish": {
      ...
      "message": "In tal caso, premere il tasto di conferma per completare e chiudere l'ordine.",
  ...
  "product_outputs": {
    ...
    "virtual": {
      ...
      "sub_title": "Le informazioni che vuoi mostrare all'utente dopo l'acquisto. Questo modulo è particolarmente applicabile per la vendita di prodotti virtuali come la carta regalo."
    },
    "service": {
      "title": "Progettazione di servizi",
      "sub_title": "Per prima cosa seleziona il tipo di servizio e inserisci le informazioni richieste. Ad esempio, puoi definire una lista di cose da fare o chiedere al cliente un orario di prenotazione o un appuntamento."
    }
  },
  "service_design": {
    "type": "Tipo di servizio",
    "type_message": "Seleziona il tipo di servizio che offri per questo prodotto. Selezionando ogni voce verrà visualizzato il relativo form. A seconda del tipo di servizio scelto, maggiori informazioni potrebbero essere ricevute dal cliente al momento dell'ordine."
  },
  "ServiceTypes": {
    "DEMAND": {
      "title": "Su richiesta",
      "desc": "come riparazioni domestiche, pittura, riparazione auto, ecc."
    },
    "BOOKING": {
      "title": "Prenotazione",
      "desc": "Come prenotare una camera d'albergo o una villa."
    },
    "APPOINTMENT": {
      "title": "Appuntamento",
      "desc": "Come un appuntamento per la cura degli animali domestici o un addestramento di persona."
    },
    "RENTAL": {
      "title": "Noleggio",
      "desc": "Come affittare un posto o un'auto."
    },
    "SUBSCRIPTION": {
      "title": "Sottoscrizione",
      "desc": "Come l'appartenenza a un club o il Coaching online."
    },
    "CHARGE": {
      "title": "Caricare",
      "desc": "Come l'addebito di un account o l'addebito per l'utilizzo di un'applicazione."
    },
    "CUSTOM": {
      "title": "Costume",
      "desc": "Seleziona questa opzione se il servizio che fornisci non è uno dei precedenti."
    }
  },
  "avocado": {
    "title": "Vendite veloci, accurate e divertenti su tutti i social media",
    "message": "Un importo e un titolo sono tutto ciò di cui hai bisogno per ottenere denaro dai tuoi clienti! Il denaro verrà accreditato direttamente sul tuo account e i tuoi clienti avranno un'esperienza di acquisto unica.",
    "new_order": "Nuova fattura",
    "create_by_seller_title": "Crea fattura",
    "create_by_seller_message": "Se vuoi creare una fattura con un determinato importo e inviarla a qualcuno, puoi premere il pulsante qui sotto per mostrare il modulo fattura. Fornisci il link generato all'acquirente per pagare e traccia il suo ordine attraverso di esso.",
    "create_by_buyer_title": "Forma di avocado",
    "create_by_buyer_message": "Attivando questa sezione, ti verrà mostrato un link, fornisci questo link ai tuoi acquirenti in modo che possano effettuare il loro ordine.",
    "orders_list": "Elenco ordini",
    "active_mode": "Ricevuta ordine attiva",
    "inactive_mode": "inattivo",
    "active_message": "Attivando questa fonte, i tuoi clienti potranno effettuare un ordine per il prodotto attraverso il modulo di richiesta che vedi sotto.",
    "avocado_form_link_message": "Inserisci questo link nella tua biografia su Instagram, Telegram o altri social media in modo che il tuo pubblico possa acquistare più velocemente, più facilmente e infine di più",
    "need_address": "Ottieni indirizzo",
    "need_address_msg": "Se hai bisogno di ottenere la posizione e l'indirizzo dell'acquirente, seleziona questa opzione.",
    "avocado_link_message": "È sufficiente fornire il link sopra al cliente per pagare l'ordine. Il cliente potrà seguire l'ordine attraverso questo link.",
    "edit_order": "Modifica ordine",
    "progress": "Tasso di avanzamento",
    "buyer_link": "Collegamento acquirente",
    "buyer_link_message": "Fornisci questo link al tuo acquirente. L'acquirente potrà pagare e tracciare il suo ordine tramite questo link. Questo collegamento è codificato, se il collegamento viene fornito a qualcuno, sarà in grado di pagare e vedere le informazioni. Questo link sarà attivo per 60 giorni. Clicca sul link qui sotto per copiare.",
    "OrderConfirm_done": "Ordine confermato.",
    "OrderConfirm_message": "Se confermi il pagamento e l'ordine è corretto, fai clic sul pulsante in basso.",
    "OrderConfirm_action": "Conferma dell'ordine",
    "PreparingOrder_message": "Se l'ordine del cliente è pronto per la spedizione, fai clic sul pulsante OK in basso.",
    "PreparingOrder_action": "L'ordine è pronto per la spedizione",
    "finish_message": "Se questo ordine è completato, premi il pulsante di fine per chiudere questo ordine.",
  ...
  "avocado_process": {
    "step1": "Prezzo",
    "step1_msg": "Inserisci il prezzo di ogni articolo e spunta la casella verde. Se non è possibile vendere un articolo, cambia il suo stato in rifiutato.",
    "step2": "Conferma fattura",
    "step2_msg": "Crea una fattura per questo ordine. È possibile inserire un titolo e una descrizione per la fattura. L'importo dell'ordine viene calcolato automaticamente in base al prezzo totale degli articoli.",
    "title_input": "Titolo fattura *",
    "show_to_customer": "Questa informazione viene mostrata all'acquirente.",
    "description_msg": "Vuoi scrivere una nota per questo ordine? Queste informazioni verranno mostrate all'acquirente.",
  ...
  "hyper": {
    "print_label": "Stampa la seguente etichetta e posizionala davanti al prodotto",
    "hyper_form_link_product_message": "I tuoi clienti potranno acquistare rapidamente {product} tramite questo link. Inoltre, inseriranno lo stesso link scansionando il codice QR.",
    "title": "Vendita iperveloce",
    "message": "Con l'aiuto del canale di vendita Hyper Selldone, i tuoi clienti potranno acquistare i prodotti scansionando un codice QR senza che sia necessaria alcuna azione da parte tua. Usa questo modo per vendere rapidamente alcuni oggetti in occasione di festival, mostre o cerimonie indaffarate in gran numero. Dopo aver attivato Hyper in questa sezione, puoi creare un codice QR hyper per i prodotti fisici nella sezione Product Management.",
    "orders_list": "Elenco ordini iper",
    "active_mode": "Canale di vendita iper attivato",
    "inactive_mode": "inattivo",
    "active_message": "Se si abilita questa opzione, nella sezione di gestione di ogni prodotto verrà visualizzata la possibilità di creare i codici di vendita rapida.",
  ...
  "notification_top_bar": {
    ...
    "claim_charge_caution": "Nota: non è possibile convertire valute tra i conti del tuo portafoglio. Pertanto, seleziona un account appropriato per la valuta cambiata nel tuo negozio.",
  ...
  "shop_languages": {
    ...
    "message": "Puoi installare fino a 10 Language Pack nel tuo negozio. Contattaci se hai bisogno di installare più pacchetti."
  },
  "invite_friends": {
    ...
    "invite": {
      ...
      "description": "Ti invito a Selldone per avviare la tua attività online con uno strumento fantastico.",
  ...
  "shops_list": {
    "title": "I miei negozi",
    "message": "Elenco dei miei negozi, negozi autorizzati e campioni."
  },
  "shipping": {
    "warehouse_error": "Imposta prima il tuo magazzino! Questo indirizzo verrà utilizzato come origine della spedizione.",
    "errors": {
  ...
  "about_us": {
    ...
    "subtitle": "Scrivi un articolo sulla tua attività da mostrare nella pagina Chi siamo. Questa pagina aiuterà il tuo pubblico a conoscere il tuo marchio e la tua missione."
  },
  "terms": {
    "title": "Pagina dei termini di servizio",
    "subtitle": "Spiega ai tuoi clienti le condizioni di acquisto e di utilizzo dei tuoi servizi."
  },
  "privacy": {
    "title": "Pagina informativa sulla privacy",
    "subtitle": "Un'informativa sulla privacy è una dichiarazione o un documento legale che rivela alcuni o tutti i modi in cui una parte raccoglie, utilizza, divulga e gestisce i dati di un cliente o cliente."
  },
  "contact_us": {
    "title": "Pagina Contattaci",
    "subtitle": "Scrivi le tue informazioni di contatto, indirizzo e numero di telefono da mostrare ai tuoi clienti nella pagina dei contatti."
  },
  "metaverse": {
    "title": "Ponte Metaverso",
    "subtitle": "Selldone fornisce %100 servizi basati su API nello spazio commerciale. Gli sviluppatori di giochi, blockchain e metaverse possono utilizzare queste potenti API per connettere aziende, clienti e servizi nel futuro del mondo del lavoro, della vita e del commercio.",
  ...
  "orders_bulk_export": {
    ...
    "tasks": {
      ...
      "subtitle": "Scarica l'elenco delle attività per l'elaborazione degli ordini in blocco. Il risultato contiene solo ordini pagati e in contrassegno.",
      "export_title": "Elenco delle attività"
    },
    "labels": {
      "title": "Etichette dei pacchi",
      "subtitle": "Scarica l'elenco di tutte le etichette degli ordini nel periodo e nello stato selezionati. Il risultato contiene solo ordini pagati e in contrassegno.",
      "export_title": "Etichette per scatole"
    }
  },
  "customers_funnel": {
    "title": "Demografia dei clienti",
    "subtitle": "Filtra ed esporta i dati dei tuoi clienti per prendere decisioni migliori per offrire più valore con meno marketing! Rispetta la privacy dei tuoi clienti e non inviare mai loro e-mail di massa! Non condividere mai le informazioni dei tuoi clienti con servizi di terze parti senza ottenere il permesso da ognuno di loro."
  },
  "transportation_pickups": {
    "addresses": {
      "title": "Indirizzi di ritiro",
      "subtitle": "Aggiungi e modifica gli indirizzi di ritiro qui. Gli utenti potranno selezionare l'indirizzo di ritiro nella pagina di pagamento.",
  ...
  "affiliate_pos": {
    ...
    "description": "Questa opzione è adatta per gli amministratori di pagine Instagram e altri social network. Utilizza Affiliate POS per ricevere e aggiungere manualmente gli ordini dei clienti. I tuoi affiliati (o franchising) possono aggiungere nuovi ordini nel POS di affiliazione e caricare la ricevuta di deposito."
  },
  "shop_configuration": {
    "login": {
    ...
    "checkout": {
      ...
      "subtitle": "Personalizza il percorso del cliente e il flusso di acquisto nel tuo e-commerce.",
      "map": {
        "title": "Carta geografica",
        "subtitle": "Gli utenti devono selezionare il luogo di consegna sulla mappa (come Uber).",
        "subtitle_no_map": "La distanza nel calcolo della spedizione considera zero se la posizione non esiste nell'indirizzo fornito dal cliente."
      },
      "mode": {
  ...
  "business_model": {
    ...
    "subtitle": "Imposta il tuo modello di business e configureremo il tuo sistema operativo dietro le quinte."
  },
  "business_type": {
    "title": "Tipi di merce",
    "subtitle": "Imposta il tipo di prodotti che vuoi vendere nel tuo negozio. I tipi di prodotto in Selldone sono più di un semplice tipo di prodotti; è più sulla procedura di adempimento.",
    "send_activation_request_to_support": "Invia una richiesta di attivazione in un ticket di supporto.",
    "require_kyc": "Titolare dell'azienda KYC.",
    "needs_enterprise_license": "Devi avere una licenza Enterprise.",
    "marketplace_caution_message": "Imposta Marketplace poiché il tuo modello influisce profondamente sulla configurazione del tuo sistema operativo aziendale. Ad esempio, è necessario definire almeno un fornitore per ogni prodotto con prezzi e inventario indipendenti. I clienti non possono acquistare prodotti che non hanno un fornitore."
  },
  "business_model_view": {
    "normal": {
  ...
  "vendors_list": {
    ...
    "message": "Elenco dei miei fornitori."
  },
  "vendor_page": {},
  "domains": {
    "message": "Collega più domini al tuo sistema operativo aziendale e gestiscili tutti in un unico posto. Puoi utilizzare la funzione domini multipli per creare domini dedicati per ogni parte del tuo sito web, come blog e community, oppure utilizzare domini diversi per i tuoi affiliati."
  },
  "notes": {
  ...
  "external_services": {
    ...
    "subtitle": "Monitora l'ultimo stato dei servizi esterni come SMS ed e-mail qui."
  },
  "theme": {
    "dark_mode": "Modalità oscura",
    "dark_mode_description": "Scegli questa opzione se desideri uno sfondo scuro con il colore del testo bianco.",
    "light_mode": "Modalità luce",
    "light_mode_description": "Scegli questa opzione se desideri che lo sfondo sia chiaro e il testo sia di colore nero."
  },
  "shop_quota": {
    "title": "Quota di utilizzo",
    "sub_title": "Questo è l'elenco delle quote di utilizzo per il tuo negozio. Puoi aumentare questi limiti aggiornando la licenza del tuo negozio. Se superi i limiti, puoi richiederci quote giornaliere aggiuntive. Tutto l'utilizzo verrà ripristinato quotidianamente."
  },
  "app_card": {
    "category": "Categoria",
    "installs": "Installare",
