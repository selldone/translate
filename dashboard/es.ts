export default {
  ...
  "cautions": {
    "title": "Administre su negocio profesionalmente siguiendo los siguientes consejos. Siga leyendo para obtener consejos sobre cómo aumentar el margen de beneficio y más. Estamos contigo en el camino.",
    "no_payment_method": {
      "title": "Método de pago",
      "message": "Debes añadir un método de pago a tu tienda.",
      "action": "Pasarelas de compras"
    },
    "link_account": {
      "title": "Vincular cuenta",
      "message": "Debe vincular una cuenta ({currency}) a su tienda.",
      "action": "Comprar cuentas"
    },
    "no_domain": {
      "title": "Agregar dominio",
      "message": "Puede conectar uno o más dominios personales a su tienda. Su sitio web se instalará en su dominio. Este proceso es rápido y fácil."
    },
    "domain_not_approved": {
      "title": "Verificación de dominio",
      "message": "Su dominio {domain} no ha sido verificado. Verifique la configuración de DNS y confirme el dominio."
    },
    "no_currency": {
      "title": "Agregar moneda",
      "message": "Debe definir al menos una moneda para su tienda.",
      "action": "Gestión de divisas"
    },
    "no_primary_domain": {
      "title": "el dominio principal",
      "message": "Seleccione un dominio como su dominio principal. Al hacer clic en el botón de estrella junto al nombre de dominio, puede seleccionar el dominio como el dominio principal de su tienda. Esto es fundamental para los motores de búsqueda. Tenga en cuenta que su tienda seguirá estando disponible a través de todos los dominios activos."
    },
    "shop_complete": {
  ...
  "support": {
    ...
    "category": "Categoría",
    "title": "Apoyo",
    "message": "Haga cualquier solicitud o pregunta. Nuestro equipo de soporte lo guiará. Le sugerimos que haga su pregunta en la página relacionada con su solicitud. Por ejemplo, si tiene una pregunta sobre la configuración del dominio, envíela a la página de configuración del dominio de su tienda.",
  ...
  "helps": {
    ...
    "subtitle": "Bienvenido a Selldone. Si está creando una nueva tienda en línea en un sistema operativo comercial, puede encontrar más información aquí.",
  ...
  "blogs": {
    "title": "Blog",
    "subtitle": "Lecciones para los negocios, la confianza y el conocimiento que necesita para crear un negocio próspero.",
  ...
  "user_dashboard": {
    ...
    "shops": {
      ...
      "create_new_sub_need_initial_charge": "Construir la primera tienda es gratis. Probablemente una tienda sea suficiente para su negocio, pero si necesita construir más tiendas, el costo de construir una nueva tienda es de 25 $. Retiramos el monto de su cuenta de billetera.",
      "menu": {
        "title": "Mis tiendas",
        "shops": "tiendas",
        "new": "Nuevo"
  ...
  "admin_shop": {
    ...
    "dashboard": {
      ...
      "info": {
        ...
        "home_msg": "Establezca la página de inicio predeterminada de su sitio web. Se puede cambiar para cada dominio personalizado.",
        ...
        "wage": "Tarifa",
        "cpu_message": "La cantidad de recursos que ha adaptado al plan adquirido y los recursos que agrega a su servicio.",
        ...
        "add_dialog": {
          ...
          "step1": "Puede definir el límite de IP del registro A para un dominio o subdominio DNS a partir de los siguientes valores:",
          "step2": "Agregue un registro DNS TXT:",
          "set_ip_alert": "Establezca el valor de IP del registro A <b>{ip}</b> .",
          ...
          "ssl_message": "No se preocupe por el certificado SSL para su sitio web. Selldone (beta) emitirá automáticamente esta certificación para su dominio.",
          "active": "El dominio está activo",
          "inactive": "El dominio está deshabilitado",
          "success_message": "Felicitaciones, su sitio está habilitado en {domain}. Puede presentar su negocio y marca al mundo a través de este dominio.",
        ...
        "alert": {
          ...
          "message": "¿Quieres eliminar este dominio? Asegúrese de restablecer los valores de registro DNS de su dominio para evitar que otros cometan fraude."
        }
      },
      "active_orders": {
        "title": "Pedidos",
        "title_small": "Órdenes Físicas, de Archivo, Virtuales y de Servicio",
    ...
    "products": {
      ...
      "process_que": "Procesamiento de productos importados",
      ...
      "menu_show_deletes": "Mostrar productos eliminados",
      "drop_import_message": "Suelte el archivo de lista de productos (formato CSV, XLS, XLSX) aquí para comenzar a agregar productos a granel. Asegúrese de que el archivo tenga el formato de lista de productos de Selldone.",
      "product_widget": {
    ...
    "auditing": {
      ...
      "invoice": {
        ...
        "subtitle": "Los cargos, comisiones y costos de tienda se deducen de estas cuentas de billetera.",
        "title_add": "Conectar nueva cuenta de billetera",
        "subtitle_add": "Debe crear una nueva billetera para cada moneda y conectarla a su tienda. La tarifa de servicio se retirará de esta billetera.",
        ...
        "add_account_dialog": {
          ...
          "subtitle": "Cuando abra una cuenta de billetera con Selldone, le daremos una tarjeta de crédito virtual y una cuenta como cualquier otra tarjeta de crédito. La tarifa de venta de Selldone se deducirá de esta cuenta, pero si el saldo de su cuenta no es suficiente, se adeudará esta cantidad. Puede utilizar los servicios de Selldone tanto como necesite.",
          "account_number": "Número de cuenta",
          "account_number_input_message": "La tienda se vinculará a esta cuenta. Esta cuenta se utilizará para honorarios y costos.",
          "balance": "Saldo de la cuenta",
          "connect_account_to_shop": "Conectar cuenta a la tienda"
        },
        "notifications": {
          "connect_account_success": "Cuenta añadida con éxito.",
          "delete_account_success": "Cuenta eliminada de la tienda con éxito."
        },
        "alert": {
          "delete_account": "Desconectar cuenta",
          "delete_account_message": "¿Quieres eliminar esta cuenta de la lista de cuentas de la tienda?",
          "delete_account_action": "Borrar cuenta"
        },
        "inform_charge_account": "¡Carga tu cuenta!",
        "inform_charge_account_critical": "¡Cargue su cuenta para evitar la suspensión del servicio!"
      },
      "gateway": {
        "title": "Métodos de pago",
        "sub_title": "Lista de métodos de pago activos. Si desea agregar un nuevo método a su tienda, presione el siguiente botón. Recomendamos enfáticamente no exceder las 10 pasarelas de pago agregadas.",
      ...
      "exchange": {
        ...
        "subtitle": "Los usuarios podrán seleccionar una de las monedas activas y se calcularán y mostrarán los precios de los productos. Corresponde al vendedor introducir el tipo de cambio.",
        ...
        "rates": {
          ...
          "sub_title": "Puede ingresar precios de productos basados en cualquiera de las monedas a continuación y los precios de los productos se calcularán automáticamente según las tasas de conversión entre sus monedas.",
          "message": "Al ingresar los tipos de cambio entre monedas, los precios de sus productos se calcularán y actualizarán automáticamente.",
        ...
        "add_rate_dialog": {
          ...
          "message": "Tenga cuidado al ingresar la información. Los precios de sus productos se calcularán en base a las tarifas ingresadas aquí.",
    ...
    "logistic": {
      ...
      "warehouse_btn_error": "Establece tu almacén, tienda u origen de tu negocio. Es vital tenerlo en el cálculo del costo de envío y en el proceso de pago.",
      "size_unit": {
      ...
      "warehouse": {
        ...
        "table": {
          ...
          "sub_title": "Lista de todos los productos de la tienda, incluidos los físicos, virtuales, archivos y servicios"
        }
      },
      "delivery": {
        "title": "Métodos de envío",
        "sub_title": "Al establecer los valores en esta sección, se activan una variedad de métodos de envío en su tienda. En esta sección también se puede activar el método Contra Reembolso.",
        ...
        "delivery_form": {
          ...
          "cod_input_message": "Asegúrese de que su servicio de envío acepte COD.",
          "sod_input": "¿Apoyas COD?",
          "sod_input_message": "Asegúrese de que su servicio de envío acepte COD.",
          ...
          "price_cof_input_message": "Incluye costos de seguros y otros servicios como costos COD.",
    ...
    "users": {
      ...
      "report": {
        ...
        "report_30days_by_time": "Actividad del usuario basada en fecha y hora en los últimos 30 días",
        "report_30days_by_location": "Actividad de usuarios de geolocalización en los últimos 30 días"
      },
      "club": {
        "title": "club de clientes",
        "sub_title": "Ingrese el monto de la compra mensual y anual y la moneda para activar cada nivel. Sus clientes iniciarán sesión en su club de clientes a medida que cumplan con los requisitos de compra mensual o anual.",
        "item": {
        ...
        "edit_dialog": {
          ...
          "currency_input_message": "Las compras totales se calculan en esta moneda.",
          "free_shipping_input": "Envío gratis",
    ...
    "marketing": {
      ...
      "campaign": {
        ...
        "name_input_message": "Introduce el título de tu campaña.",
    ...
    "categories": {
      ...
      "subtitle": "Las categorías son la característica clave de su tienda en línea. Lo alentamos a utilizar estas poderosas herramientas de categorización para crear una tienda moderna y facilitar que sus clientes encuentren los productos correctos.",
      "menu": {
      ...
      "graph": {
        ...
        "subtitle": "Puede tener una descripción completa de las categorías de su tienda y cómo los usuarios las navegan. Con la disposición correcta de categorías, sus clientes pueden encontrar productos rápidamente y la tasa de conversión aumentará.",
      ...
      "category_widget": {
        ...
        "delete_alert": {
          "title": "Eliminar categoría infantil",
          "message": "¿Desea eliminar {title} de la lista {parent_title}?",
          "action": "Borrar"
        },
        "notifications": {
    ...
    "apps": {
      ...
      "my_apps": {
        ...
        "subtitle": "Administre sus aplicaciones comerciales.",
        "all": "todos"
      },
      "store": {
        "title": "Tienda de aplicaciones",
        "subtitle": "Conecta tus servicios favoritos a tu negocio de forma segura. Agregamos complementos y aplicaciones según las solicitudes de nuestros clientes.",
    ...
    "permissions": {
      ...
      "shop_permissions": {
        "menu": {
          ...
          "new_user_message": "Usuarios que tendrán acceso al panel de control y secciones de administración de esta tienda.",
          "email_input_placeholder": "Correo electrónico",
          "email_input": "Dirección de correo electrónico del usuario",
          "level_input": "Nivel de acceso",
          "add_user_action": "Agregar personal"
        },
        "delete_alert": {
      ...
      "shop_api": {
        ...
        "message": "Estas claves se utilizan para crear tokens de acceso por parte de su servidor. Tenga en cuenta que las claves son confidenciales y solo en el servidor de una manera que no es visible para otros."
      }
    },
    "applications": {
      "pwa": {
        ...
        "message": "Nota: Puede editar la página de bienvenida de su sitio web en su iPhone y iPad en la aplicación iOS",
        "ios_app": "aplicación para iOS"
      },
      "ios": {
        "title": "aplicación para iOS",
        "sub_title": "Pronto podrá crear una aplicación de iOS para su tienda.",
        "message": "Tamaño máximo de archivo: 512 KB, puede cargar archivos de hasta 1 MB de tamaño, siempre que nuestro sistema de compresión sea capaz de reducir el tamaño a 512 KB. La imagen cargada cambiará de tamaño de forma inteligente."
      },
      "android": {
        "title": "Aplicación Android",
        "sub_title": "Cree su propia aplicación para Android",
        "message": "Complete este formulario y presione la tecla de compilación. No habrá necesidad de nada más. Todos los pasos del proceso de creación y firma de su aplicación se realizan en los servidores de la nube. La aplicación final se cargará en todas las tiendas de aplicaciones.",
        "server_un_available": "Experimentalmente, el servidor de aplicaciones no está conectado en este momento.",
        ...
        "package_name_input_alert": "Si cambia este nombre, ya no podrá actualizar sus aplicaciones anteriores en AppStore e instalar una nueva. Tenga en cuenta que los usuarios de versiones anteriores de la aplicación tampoco podrán iniciar sesión en sus cuentas.",
        "version_input": "Versión",
        "version_input_message": "Este número siempre debe ser mayor que su valor anterior.",
        "version_name_input": "nombre de la versión",
        "version_name_input_message": "Ingrese un nombre único para esta versión de la aplicación.",
        ...
        "splash_title_input_message": "Este título se mostrará en tamaño de fuente grande.",
        "splash_message_input": "Mensaje de la pantalla de bienvenida",
        "splash_message_input_placeholder": "Mensaje ...",
        "splash_message_input_message": "Este mensaje se mostrará como una miniatura a continuación.",
        "dark_theme": "tema oscuro",
        "light_theme": "tema ligero",
        "build": "Construir",
        "building_info": "La creación de una aplicación en un servidor en la nube lleva de 10 segundos a varios minutos. Por favor sea paciente. El enlace del archivo de descarga aparecerá aquí una vez que la aplicación esté lista.",
        ...
        "notifications": {
          ...
          "start_building_message": "Se envió la solicitud para crear una aplicación de Android.",
          "build_success_title": "Felicidades",
          "build_success": "Su aplicación de Android está lista y puede descargarla ahora."
        }
      }
    },
    "automation": {
    ...
    "edit": {
      ...
      "info": {
        ...
        "description_tab": {
          ...
          "subtitle": "Escriba sobre su negocio y su propuesta de valor única."
        },
        "contact_tab": {
          "title": "Contacto y negocio local",
          "subtitle": "Información de contacto pública y configuración de empresas locales de Google."
        },
        "image_tab": {
          "title": "Logo",
      ...
      "badge": {
        ...
        "external_message": "Aquí, puede ingresar la dirección de la imagen de la insignia y el enlace a ella. Las URL deben ser de un sitio web aprobado."
      },
      "edit_menu": {
        "title": "Menús",
        "footer": {
          "title": "Menú de pie de página",
          "sub_title": "Puedes configurar el menú inferior de la página de tu tienda aquí. Estos menús pueden ser páginas de inicio, páginas diseñadas o enlaces externos."
        },
        "header": {
          "title": "menú de encabezado",
          "sub_title": "Este menú solo se muestra en pantallas más grandes que las de los dispositivos móviles y en la parte superior de la página de inicio, las categorías de productos, los aterrizajes y las páginas de productos."
        },
      ...
      "social": {
        ...
        "message": "Ingrese su enlace oficial de redes sociales en esta sección. Siga las instrucciones de cada elemento para confirmar las direcciones."
      },
      "time": {
  ...
  "add_product": {
    ...
    "edit_info": {
      ...
      "sku": "SKU",
      "sku_message": "Unidad de mantenimiento de stock",
      "mpn": "MPN",
      "mpn_message": "Número de pieza del fabricante",
      "status": "Estado",
      ...
      "is_original_message": "Si no configura su producto original, se mostrará la insignia falsa para este producto.",
      "return_warranty": "¿Cuántos días tiene garantía de devolución este producto?",
      ...
      "condition": "Estado del producto en tu tienda",
      "condition_message": "Debe elegir uno de los valores de este campo.",
      ...
      "marketplace": {
        "vendor_panel_message": "El <b>{vendor_name}</b> es el propietario del producto.",
        "subscription_message": "Los productos de suscripción pueden tener un proveedor, por lo que puede crearlos en el panel de proveedores o asignarles un proveedor en el paso de creación. El proveedor seleccionado será el propietario del producto.",
        "default_message": "Puede especificar si este producto pertenece a un proveedor y, por lo tanto, solo un proveedor puede venderlo, o si este producto pertenece a Marketplace y más de un proveedor puede venderlo.",
        "single_vendor_title": "Proveedor único",
        "single_vendor_desc": "Este producto pertenece a un proveedor y el proveedor seleccionado puede gestionarlo.",
        "multi_vendors_title": "Múltiples proveedores",
        "multi_vendors_desc": "Este producto pertenece al mercado y solo se puede editar en el panel del mercado."
      }
    },
    "rating_pros_cons": {
      "title": "Encuesta",
      "message": "Ingrese una lista de especificaciones del producto para que sus clientes califiquen su producto. (Hasta 5 artículos)",
      "rating_input": "Centro",
      ...
      "pros_group_messages": "Las principales características del producto.",
      "cons_title": "Contras",
      ...
      "cons_group_messages": "Las principales debilidades del producto.",
      ...
      "rating_input_placeholder": "Escribe aquí tu pregunta de encuesta personalizada... ¡y presiona Enter!"
    },
    "edit_spec": {
      "title": "Especificaciones técnicas",
      "sub_title": "Puede importar especificaciones técnicas de productos similares.",
      ...
      "notifications": {
        ...
        "enter_item_title_and_value_error": "Ingrese el título y el valor de la característica",
    ...
    "edit_images": {
      ...
      "images": {
        ...
        "sub_title": "Cargue imágenes de productos, comunes a todas las variantes de productos, en esta sección."
      },
      "video": {
        "title": "Video",
        "sub_title": "Primero, cargue el video de su producto en Youtube y luego coloque la URL del video aquí."
      }
    },
    "pricing": {
      "edit_price": "Precios",
      ...
      "commission_message": "Esta opción es útil solo para determinados tipos de comerciantes, como los mayoristas. Si no es mayorista, deje esta opción en blanco. El precio que ven los compradores es la suma del precio y la comisión. Para agregar impuestos, haga clic en Contabilidad > Impuestos.",
    ...
    "inputs_edit": {
      ...
      "sub_title": "Puede crear un formulario de entrada de datos para cada producto, de modo que los compradores le envíen información al comprar un producto. Por ejemplo, esta información podría ser un nombre para un grabado en una piedra.",
      "message_input": "Mensaje al usuario",
      "message_input_message": "Este mensaje se le mostrará al cliente al comprar productos.",
      "inputs_form": "Estructura de la información (entrada)"
    },
    "extra_edit": {
      "physical": {
        "title": "Información de envío",
        "sub_title": "El costo y el tiempo de preparación se calculan con base en la información de esta sección. Asegúrese de ingresar la información según las unidades seleccionadas en la tienda (peso, dimensiones, distancia)."
      },
      "notifications": {
    ...
    "variants": {
      "not_available": "Actualmente no es posible seleccionar una variante para este tipo de producto."
    },
    "delete_product": {
  ...
  "product_admin": {
    ...
    "dashboard": {
      ...
      "orders": {
        ...
        "send_30days_title": "Pedidos enviados en los últimos 30 días",
        "downloads_30days_title": "Archivo descargado número en los últimos 30 días",
        "virtual_orders_title": "Pedidos de este producto pendientes de finalización"
      },
      "inventory": {
        "title": "Inventario",
        ...
        "total_sell_30days": "Ventas de los últimos 4 días",
        "chart": {
          "labels": [
            "Inventario",
            "Rebaja"
      ...
      "finance": {
        "title": "Financiero",
        "title_small": "Informe de compras de los últimos 6 meses",
      ...
      "inform": {
        ...
        "message": "Notificar a los clientes cuando los productos salgan a la venta o estén disponibles",
    ...
    "inventory": {
      "variants": {
        ...
        "sub_title": "Si este producto tiene más de una variante, introdúzcalas en esta sección. Puedes definir por separado el monto, precio y descuento de cada variante; de lo contrario, se aplicarán los valores predeterminados del producto para la fijación de precios.",
      ...
      "variant_add_edit": {
        "title": "Definición de variante de producto",
        ...
        "delivery_info": "Embalaje y envío",
        "images": "imágenes de la variante",
        "images_message": "Después de guardar esta variante, podrá agregar una imagen aquí."
      }
    },
    "edit_article": {
      "menu": {
  ...
  "product_extra_physical": {
    ...
    "bulk_action_msg": "Establezca el empaque del producto y el tiempo de preparación para todas las variantes."
  },
  "product_images_list": {
  ...
  "shop_warehouse_edit": {
    ...
    "message": "Ingrese su dirección de almacén y perfil para calcular el costo de envío.",
  ...
  "inventory_list": {
    ...
    "bulk_price_dialog": {
      ...
      "message": "Nota: La siguiente cantidad se aplicará como un porcentaje al precio de todos los productos en tu tienda. Además, los valores de precio calculados se convertirán de forma inteligente al número redondo más cercano según la moneda seleccionada. Tenga cuidado al ingresar los valores.",
    ...
    "bulk_discount_dialog": {
      ...
      "message": "Nota: La siguiente cantidad será como un porcentaje del descuento de todos los productos en su tienda. Además, los valores de descuento calculados se convertirán de forma inteligente al número redondo más cercano según la moneda seleccionada. Tenga cuidado al ingresar los valores.",
  ...
  "contact_messages_list": {
    ...
    "dialog": {
      ...
      "mail_input_message": "Si habilita esto, su respuesta se enviará al correo electrónico del usuario."
    },
    "delete_alert": {
  ...
  "campaign": {
    ...
    "dashboard": {
      ...
      "no_links": "¡No hay datos disponibles! Crea un enlace a tu campaña.",
    ...
    "finance": {
      ...
      "total_revenue": "Ingresos totales por campaña",
    ...
    "setting": {
      ...
      "general_setting": {
        ...
        "auto_message": "Campaña por defecto activada en tu tienda"
      },
      "time_setting": {
        "title": "Periodo de tiempo",
        "sub_title": "Fecha y hora de inicio / Fecha y hora de finalización",
        "start_input": "Comienzo",
      ...
      "banner_setting": {
        ...
        "sub_title": "Mostrar en la parte superior de la página de la tienda",
      ...
      "notifications": {
        ...
        "persistence_message": "¿Quieres mostrar cada vez que tu usuario visita el sitio web?",
        "radius": "Radio",
  ...
  "add_category": {
    ...
    "edit_filter": {
      ...
      "spec_input_message": "Lista de características que desea que se muestren en la sección de filtro",
      "price": "precio",
      "min": "mínimo",
      "max": "máx.",
      "suggested_list": {
  ...
  "add_shop": {
    ...
    "name_input_tips": "No utilice caracteres, espacios o letras que no sean ingleses; si se utilizan, es posible que el nombre de la tienda no se muestre correctamente.",
    ...
    "phone_input_tips": "Ingrese el número de contacto con el código del país. Este número también se utiliza para mostrar información en la búsqueda de Google.",
  ...
  "virtual_items_list": {
    "add_virtual_item": "Agregar elemento virtual",
    "add_virtual_item_desc": "Para vender productos virtuales, debe agregarlos en esta sección. El número de artículos virtuales es igual al número de artículos gratuitos en esta sección. Una vez que los clientes compren el artículo virtual, se les enviará el enlace.",
  ...
  "add_virtual_item": {
    ...
    "message": "El gerente de la tienda puede mostrar al comprador el valor después del pago. Estos valores deben ser ingresados en el siguiente formulario. La estructura de este formulario se establece en la sección Editar elemento> Editar información de salida.",
  ...
  "process_order_page_dashboard": {
    ...
    "open_basket_cation": "Este carrito de compras está abierto, lo que significa que el cliente está comprando y aún no ha pagado el pedido.",
    "reject_dialog": {
      "title": "Motivo para rechazar el pedido",
      "message": "Seleccione el motivo del rechazo de este pedido de la lista a continuación. Asegúrese de informar al cliente del proceso de cancelación y reembolso. Los reembolsos deben hacerse dentro de las 12 horas.",
      "confirm_action": "Cancelar orden",
    ...
    "notifications": {
      ...
      "dismiss_reject_success": "El pedido volvió al proceso normal.",
  ...
  "process_center": {
    ...
    "payment_widget": {
      ...
      "payment_receipt_not_uploaded_error": "¡Aún no se ha subido el recibo de pago!",
      "waiting_for_pay": "Pago pendiente",
      "processing_payment": "Procesando el pago",
      "processing_cancel": "Pago cancelado",
      "paid": "Pagado",
      "cod_pay_info": "Cuando haya recibido el pedido del cliente, puede confirmar el pago y completar el pedido.",
      "dir_pay_info": "El recibo de pago aparecerá arriba. Antes de confirmar el pago, verifique el monto del depósito y la información del recibo con su banco.",
      ...
      "add_transactions_message": "Debe crear al menos una transacción para este pedido. En algunos casos, el pago se requiere en varios pasos. Usted determinará qué transacciones debe pagar el usuario durante el trabajo.",
      "add_bill_dialog": {
        "title": "Agregar factura",
        "message": "Puede agregar una o más facturas nuevas para este pedido. El cliente verá estas facturas y pagará cada una de ellas según el avance de la obra.",
      ...
      "samin": {
        ...
        "description": "Esta cantidad se ha deducido de su cuenta de billetera Selldone.",
        "tooltip": "Calcular por método de pago",
        "percent": "Por ciento"
      },
      "affiliate": {
        "title": "comisión de afiliados",
        "affiliate_message": "Debes pagar esta comisión a tu afiliado. Este proceso lo hace usted mismo."
      },
      ...
      "samin_wage": "Tarifa de venta hecha",
      "pay_cod_dialog": {
        "title": "¿Recibió el dinero del pedido?",
        "message": "Confirme esta opción en el método de pago contra reembolso, después de asegurar el pago completo por parte del cliente.",
        "confirm_action": "Confirmar pago del cliente"
      },
      "pay_dir_dialog": {
        "title": "¿Recibió el dinero del pedido?",
        "message": "Confirme esta opción después de aprobar el recibo de pago cargado con su banco. Asegúrese de verificar el pago con su banco.",
        "confirm_action": "Confirmar pago del cliente"
      },
      "notifications": {
        "pay_confirm_message": "Se confirma el pago.<br> Puerto: {gateway_name}<br> Fecha: {payment_at}",
    ...
    "basket_list": {
      ...
      "message": "Si alguno de los artículos no está disponible o no se puede vender, desmarque la casilla junto a él y haga clic en el botón <b>Confirmar pedido</b> .",
      ...
      "lottery_prize_inform": "Su cliente gana 1x de este producto. Enviar regalo con este pedido."
    },
    "preparing": {
      "title": "Preparación",
      ...
      "message": "Haga clic en el siguiente botón <b>Pedido listo</b> si el pedido está listo para enviarse.",
    ...
    "return_delivery_dialog": {
      ...
      "message": "Confirme la opción de devolución del envío si el pedido se devuelve después del envío por algún motivo y existe la necesidad de volver a enviar el envío.",
    ...
    "notifications": {
      ...
      "pay_dir_success": "El pago se confirmó mediante pago de tarjeta a tarjeta o transferencia de dinero.",
      "set_tracking_success": "El ID de seguimiento del pedido se guardó correctamente.",
  ...
  "shop_gateway": {
    ...
    "dashboard": {
      ...
      "gateway_info_widget": {
        ...
        "title_small": "Puerta",
        "status": "Estado",
        "cod_transportation": "Métodos de envío que admiten COD",
        "cod_transportations_error": "¡Habilite el pago contra reembolso para al menos un método de envío!",
        ...
        "timeout": "Periodo de pago",
        "timeout_unit": "Segundos",
        "link": "Enlace de puerta de enlace",
        "your_gateway_status": "El estado de su puerta de enlace",
        "config_extra_info": "Configuración del servicio de pago",
        "oauth2_button": "Conexión automática a {gateway}",
        "fee_payment_message": "La totalidad del importe pagado por el cliente se transferirá a su cuenta. La tarifa del servicio se deducirá de su billetera en Selldone."
      }
    },
    "edit": {
  ...
  "edit_gateway": {
    ...
    "developer_message": "Puede procesar transacciones falsas si la puerta de enlace admite el modo de depuración.",
    "notifications": {
  ...
  "timeline": {
    ...
    "buy": "Verificar",
    "payment": "Pago",
    "confirm": "Confirmación de pedido, <b>{success}</b> confirmado y <b>{fail}</b> rechazado.",
    ...
    "delivery-returned": "El pedido no fue recibido por el cliente y fue devuelto. Es necesario enviar de nuevo.",
  ...
  "accounts": {
    "title": "Mi billetera",
    "message": "Debe crear al menos una cuenta con la moneda que está utilizando en Selldone. Debe recargar esta cuenta para pagar la tarifa de servicio.",
    ...
    "new_account_dialog": {
      ...
      "currency_input_message": "La cuenta creada solo tendrá los valores de esta moneda.",
  ...
  "user_gifts": {
    ...
    "send_gifts": {
      ...
      "sub_title": "Puedes enviar un regalo a tus amigos o clientes. El destinatario puede aceptar o rechazar su regalo. El monto se bloquea en su cuenta y se retira si el destinatario acepta. De lo contrario, esta cantidad será transferida a su cuenta.",
      "table": {
        "user": "Usuario",
        "amount": "Monto",
        "currency": "Divisa",
    ...
    "received_gifts": {
      ...
      "sub_title": "Sus regalos recibidos de Selldone u otros",
      "table": {
        "amount": "Monto",
        "currency": "Divisa",
        "account_from": "Desde",
  ...
  "get_gift_dialog": {
    ...
    "notifications": {
      ...
      "received_success": "El monto del regalo {amount} {currency} se ha depositado en su cuenta."
    }
  },
  "send_gift_dialog": {
    "title": "Enviar regalo",
  ...
  "account_list": {
    ...
    "account_input_message": "Los importes de los regalos por esta moneda se depositarán en esta cuenta.",
    "free_balance": "Saldo libre",
    "account_name": "Nombre de la cuenta"
  },
  "user_monetize_accounts": {
    "title": "Cuentas de depósito",
    "sub_title": "Los montos de los obsequios se depositarán automáticamente en estas cuentas.",
    "message": "Selldone deposita fondos para su actividad en las redes sociales, participar en el desarrollo de Selldone, presentar amigos, etc. Al elegir una cuenta de depósito para cada moneda, los montos de los obsequios se depositarán en esa cuenta en su dominio automáticamente. Estas cantidades se pueden acreditar a Selldone. Los retiros solo serán posibles para los socios comerciales.",
    ...
    "notifications": {
      ...
      "delete_success": "Cuenta eliminada con éxito de la lista de cuentas predeterminadas para recibir regalos."
    },
    "delete_alert": {
      "title": "Borrar cuenta",
      "message": "¿Desea eliminar esta cuenta de la lista de Cuentas de regalos?",
      "action": "Borrar"
    }
  },
  "user_monetize": {
  ...
  "user_monetize_plans": {
    ...
    "sub_title": "Recibirá un crédito en la cuenta por los regalos de referencia. Estos montos se cargarán a su cuenta y solo se pueden retirar a los socios comerciales de Selldone (no a todos). Puede gastar el dinero en la tarifa de servicios de Selldone.",
    "discount": "Descuento",
    ...
    "link_tip": "Puede agregar la frase ?ref={link_code} al final de cada dirección que comparta.",
    "table": {
      "currency": "Divisa",
      "amount": "Equilibrio",
      "total": "Pago total",
    ...
    "notifications": {
      "get_credit_success": "La cantidad solicitada ha sido depositada en su cuenta."
    }
  },
  "basic_information": {
    ...
    "main_profile_subtitle": "Esta información está disponible públicamente para todos.",
    "kyc_waiting_info": "Estamos verificando la exactitud de la información que ingresa. Este proceso es obligatorio de acuerdo con las reglas KYC y reducirá el riesgo de las transacciones financieras. Puede aprovechar los beneficios presentes y futuros de este servicio.",
    "personal_info_dialog": {
      ...
      "passport_image_input_message": "Cargue un escaneo de la imagen de su pasaporte.",
      "personal_image_input": "Elige tu propia imagen",
      "personal_image_input_message": "Cargue una imagen escaneada de ida y vuelta en su tarjeta nacional a una imagen."
    },
    "profile_dialog": {
      ...
      "image_input_message": "Sube tu imagen. Esta imagen se usará como tu foto de perfil.",
      "notifications": {
        "update_profile_success": "Tu perfil ha sido actualizado.",
        "update_personal_info_success": "Su información fue registrada con éxito"
      }
    },
    "charge_account_approve_message": "Cargue su cuenta para aprobar su transacción bancaria.",
    "payment_approval": "Aprobación de pago",
    "residential_address_checking": "Los documentos de su dirección residencial en la cola de comprobación.",
    "add_residential_address": "Agregue su ubicación y documentos de prueba de dirección residencial."
  },
  "phone_verify": {
    "title": "Número de teléfono móvil",
    "step1_title": "Ingrese su numero celular.",
    ...
    "notifications": {
      ...
      "send_activation_code_success": "El código de verificación se envió a {phone_number}.",
      "verify_success": "Su número de móvil ha sido verificado"
    }
  },
  "companies": {
    "title": "Mis cuentas comerciales",
    "message": "Empresas, emprendedores y equipos profesionales pueden desarrollar productos y aplicaciones basados en Selldone. Es un requisito para crear un perfil comercial.",
  ...
  "user_access_control": {
    ...
    "connected_apps_message": "Verá una lista de todas las tiendas y aplicaciones que están conectadas a su cuenta de dominio. Puede eliminar el acceso a cualquiera de ellos.",
  ...
  "user_security_control": {
    ...
    "delete": {
      "title": "Borrar cuenta",
      "subtitle": "Antes de eliminar su cuenta, asegúrese de haber eliminado todas las tiendas.",
      "action": "Estoy seguro, borre mi cuenta",
      "agreement": "Acepto que toda mi información será eliminada de su servidor. Su información se eliminará de acuerdo con un cronograma determinado por nosotros para evitar fraudes o usos indebidos."
    },
    "list": {
      "password": {
        "title": "Clave",
      ...
      "phone": {
        "title": "Número de teléfono móvil",
        "sub_title": "Confirma tu número de móvil. Podrá iniciar sesión a través de este número.",
      ...
      "email": {
        ...
        "sub_title": "Tiene la opción de actualizar el correo electrónico principal asociado con esta cuenta.",
    ...
    "two_step_auth": {
      ...
      "step_2": {
        ...
        "message": "El código de 6 dígitos es generado por un algoritmo en su teléfono móvil. Puedes descargar la aplicación desde el siguiente enlace. Presione la tecla del generador de códigos para crear un código QR que contenga la contraseña.",
        "qr_code_info": "Si no es posible escanear, puede copiar y pegar manualmente el código en la aplicación:",
        "create_new_code": "Crear nuevo código",
        "qr_code_scanning": "Escanee el código QR creado por la aplicación móvil Google Authenticator e ingrese el código generado para confirmación en el cuadro de esta página.",
        "qr_code_regenerate_info": "Nota: Al presionar la tecla anterior, se creará una nueva clave y la tecla anterior quedará inutilizable. Introduce la nueva clave en la aplicación de tu teléfono."
      },
      "step_3": {
        "title": "Introduce el código creado",
        "message": "Ingrese el código de acceso creado en la aplicación en el campo a continuación.",
        "activation_key_input": "Código de acceso"
      },
      "activated_alert": "El inicio de sesión en 2 pasos está habilitado.",
      "activated_message": "El inicio de sesión en dos pasos está habilitado para su cuenta. A partir de ahora necesitarás ingresar un segundo código que cambia cada 30 segundos para acceder a tu cuenta. Para deshabilitar el inicio de sesión en dos pasos, simplemente haga doble clic en Presione un paso y siga los pasos.",
      "cancel_two_step_login_action": "Cancelar inicio de sesión en dos pasos",
      "cancel_two_step_login_info": "Si desea deshabilitar la verificación en dos pasos, ingrese su contraseña y haga clic en la clave de inicio de sesión en dos pasos.",
  ...
  "authorized_clients": {
    ...
    "delete_alert": {
      "title": "Borrar",
      "message": "¿Quiere revocar este acceso? Tenga en cuenta que esta aplicación ya no tendrá acceso a su cuenta.",
  ...
  "personal_access_tokens": {
    ...
    "access_token_dialog": {
      ...
      "message": "Aquí está el token de su token de acceso personal. Esta es la única vez que se mostrará este token, ¡así que no te lo pierdas! Ahora puede usar este token para solicitar una API."
    },
    "delete_alert": {
      "title": "Borrar",
  ...
  "scopes": {
    "profile": {
      "name": "Perfil",
      "description": "Lea la información del perfil, incluido el nombre, la dirección de correo electrónico, la imagen y el estado de autenticación."
    },
    "phone": {
    ...
    "notifications": {
      "name": "Enviar y recibir notificaciones",
      "description": "Enviar y recibir notificaciones."
    },
    "read-shops": {
      "name": "Lista de tiendas",
      "description": "Lee la lista de tiendas."
    },
    "shop-edit": {
      "name": "Administración de la tienda",
      "description": "Editar el acceso a la tienda"
    },
    "shop-contacts": {
      "name": "Gestión de formularios de contacto",
      "description": "Recibir y editar formularios de contacto."
    },
    "shop-gift-cards": {
      "name": "Administrar tarjetas de regalo",
      "description": "Crea, edita y administra tarjetas de regalo."
    },
    "shop-faqs": {
      "name": "Gestión de preguntas y respuestas",
      "description": "Cree, edite y administre las preguntas frecuentes."
    },
    "shop-categories": {
      "name": "Gestionar categorías",
      "description": "Crear, editar y administrar las categorías."
    },
    "shop-products": {
      "name": "Gestión de productos",
      "description": "Agregue, edite y administre los productos."
    },
    "shop-read-reports": {
      "name": "Leer informes",
      "description": "Leer información e informes."
    },
    "shop-socials": {
      "name": "Administrar redes sociales",
      "description": "Editar las redes sociales de la tienda"
    },
    "shop-accounts": {
      "name": "Administrar cuentas financieras",
      "description": "Edite y elimine cuentas financieras vinculadas a la tienda."
    },
    "shop-menus": {
      "name": "Administrar Menús",
      "description": "Editar menús de tiendas."
    },
    "shop-pages": {
    ...
    "shop-warehouse": {
      "name": "Gestion de almacenes",
      "description": "Editar almacén de la tienda"
    },
    "shop-permissions": {
      "name": "Administrar acceso",
      "description": "Ver y editar el acceso a la tienda."
    },
    "shop-process-center": {
  ...
  "shop_permissions": {
    ...
    "MARKETING": {
      "text": "Márketing",
      "description": "Accede a la configuración y crea campañas, email marketing y otras secciones relacionadas con el marketing."
    },
    "VIEWER": {
      "text": "Espectador",
      "description": "La capacidad de ver la información de la tienda sin poder editarla o cambiarla."
    }
  },
  "shop_roles": {
  ...
  "account_status": {
    ...
    "SelldoneStorage": "Almacenamiento vendido"
  },
  "account_page": {
    "title": "Cuenta",
    "menu": {
    ...
    "transfer": {
      ...
      "form": {
        ...
        "sub_title": "Depósito a cuentas propias o de terceros",
        "message": "Tenga cuidado al transferir dinero, no podrá regresar si completa la transferencia."
      }
    },
    "deposit": {
      "form": {
        "title": "Cuenta de cargo",
        "sub_title": "Debe cargar el saldo de su cuenta para comprar licencias, actualizar su cuenta y pagar los recibos del sistema.",
        "amount_input": "Monto",
  ...
  "transaction_form": {
    ...
    "confirmation": {
      ...
      "message": "Si la siguiente información es correcta, presione la tecla de confirmación de transacción para realizar la transacción.",
      "from": "De la cuenta",
      "to": "A la cuenta",
      "amount": "Monto",
    ...
    "currency_not_match": "La divisa de la cuenta de destino no es la misma que la de origen",
  ...
  "login": {
    ...
    "register_subtitle": "Inscríbete hoy gratis. Selldone es amado por nuevas empresas, empresas, compradores y vendedores.",
    "password_recovery_title": "Recuperación de contraseña",
    "password_recovery_message": "En caso de que haya olvidado su contraseña, ingrese la dirección de correo electrónico de su cuenta y presione la tecla de confirmación. Le enviaremos un correo electrónico con un enlace para restablecer su contraseña.",
    ...
    "privacy_agreement": "Al registrarse, acepta los <a href='/terms' target='_blank'>Términos de uso</a> y la Política de <a href='/privacy' target='_blank'>privacidad</a> de Selldone.",
  ...
  "page_builder": {
    ...
    "seo": {
      "message": "La configuración de SEO se ajusta automáticamente por el motor SEO de Selldone."
    }
  },
  "verify_email_caution": {
    "title": "confirme su dirección de correo electrónico",
    "message": "El nuevo enlace de activación ha sido enviado a su dirección de correo electrónico {email}. Por favor revise su correo electrónico antes de tomar cualquier acción.",
    "resend_message": "Si no ha recibido el enlace de activación en su correo electrónico, haga clic en el botón de abajo para volver a enviar.",
  ...
  "shop_license": {
    ...
    "price": "precio",
    "terms": "He leído y acepto los términos de uso de Selldone",
    ...
    "active_license": {
      ...
      "subtitle": "La información de su licencia activa.",
      "subtitle_partner": "La información de su licencia activa de {name}."
    },
    "licenses_table": {
      "title": "Historial comprado",
      "subtitle": "Licencias activas y pendientes."
    },
    "license_detail": {
      "title": "Detalles",
      "subtitle": "Límites en su plan actual."
    },
    "table": {
      "plan": "Plan",
  ...
  "shop_locations": {
    ...
    "sub_title": "Seleccione los países en los que desea vender su producto de la lista a continuación.",
  ...
  "product_studio": {
    ...
    "add_by_sku": "Agregar por SKU",
    "auto_category": "Categoría de configuración automática",
    "add_in_current_category": "Añadir a la categoría actual",
    "category_mode_message": "Si está habilitado, el producto se agregará a la categoría o subcategoría predeterminada.",
    "sku_name_input": "SKU / Nombre"
  },
  "my_affiliate": {
    "title": "Mis contratos de afiliados",
    "message": "Lista de acuerdos de afiliación con otras tiendas."
  },
  "affiliates": {
    "title": "socios afiliados",
    "subtitle": "Cree afiliados, realice un seguimiento de su rendimiento a lo largo del tiempo y tome medidas basadas en información precisa en un solo lugar. Te ayudamos a ti y a tus socios a construir una relación sólida.",
    ...
    "link_domain": {
      ...
      "subtitle": "Puede conectar uno de sus dominios a este socio afiliado. Este socio será conocido como el representante de cada persona que visite su tienda y compre a través de este dominio."
    },
    "dialog": {
      ...
      "select_products_message": "El socio afiliado recibe una comisión por estos productos",
      "edit_action": "Actualizar afiliado",
      "add_action": "Agregar socio afiliado",
      "affiliate_name": "Nombre del socio afiliado",
      "payment_info": "información de pago",
      "enable_switch": "¿Está activo?",
      "affiliate_info": "Información de socios afiliados"
    },
    "link_factory": {
  ...
  "discount_codes": {
    ...
    "sub_title": "En esta sección podrás diseñar cupones de descuento a la medida de tus necesidades. Estos descuentos son independientes de cualquier descuento de producto y se aplicarán al importe final del pedido del usuario.",
    ...
    "dialog": {
      ...
      "limit_input_message": "El valor de 0 para el límite de descuento significa que no hay límite para la tasa de descuento.",
      "title_input": "Título",
      "title_input_hint": "Puede ingresar un título para este código de descuento",
      "description_input": "Descripción",
      "description_input_hint": "Puede introducir una descripción para este código de descuento",
  ...
  "gift_cards": {
    ...
    "sub_title": "Cree una tarjeta de regalo y luego haga tantas como necesite. Esta tarjeta tiene un cargo y solo se puede usar para compras en su tienda.",
  ...
  "coupons": {
    "title": "cupones",
    "sub_title": "Si desea dar a sus clientes un descuento que se puede utilizar con condiciones específicas, puede crear cupones. Los cupones pueden incluir un porcentaje de descuento con un límite o una cantidad fija o una combinación de ambos.",
  ...
  "coupon_edit": {
    ...
    "min_purchase_amount_hint": "El monto de la compra debe ser mayor o igual a este valor.",
    ...
    "apply_for_first_order_on": "¡Este cupón solo se puede usar para la primera compra del cliente!",
    "apply_for_first_order_off": "El número de usos de cupones por comprador se puede ajustar a continuación.",
    "has_qualify_constraints": "¿Quieres definir más límites?",
    "has_qualify_constraints_message": "Establezca más condiciones para calificar al cliente para usar este cupón.",
    "one_time_use": "De un solo uso",
  ...
  "offers": {
    "title": "ofertas",
    "sub_title": "Puedes crear ofertas especiales para tus clientes para que, tras comprar un artículo, reciban otro artículo con descuento o incluso gratis.",
  ...
  "offer_edit": {
    ...
    "qualified_products": "Productos elegibles",
    "qualified_products_message": "Para que los productos sean elegibles, el total de artículos en el carrito debe ser igual o mayor que la cantidad mínima.",
    ...
    "per_order_message": "El número máximo de veces que se puede aplicar la oferta a un pedido",
    "count_input": "Monto",
    "count_input_hint": "Uso máximo de esta oferta",
    "min_purchase": "Importe mínimo de compra",
    "min_purchase_hint": "El precio de compra debe ser mayor o igual a este valor",
  ...
  "emails": {
    ...
    "subtitle": "Diseñe correos electrónicos arrastrando y soltando, programe y lance campañas para aumentar la retención y vea información confiable y precisa en un solo lugar.",
    "cation_message": "⚠ Restringido para comerciantes no verificados. (Beta)",
    "subject": "Asunto",
    "from": "Desde",
    "in_que": "esperando",
  ...
  "email_dashboard": {
    ...
    "not_submitted_send_request": "Todavía no ha enviado una solicitud para enviar este correo electrónico.",
  ...
  "lottery_edit": {
    ...
    "currency_message": "Moneda para este artículo. Otras monedas se convierten por tipo de cambio.",
    "discount": "Descuento",
  ...
  "shop_tax": {
    ...
    "calculate_tax_message": "Al activar esta opción, se calculará y aplicará el IVA para sus pedidos.",
    "tax_number": "Número de impuesto",
    "tax_number_message": "Ingrese su número de identificación fiscal. Este número de registro se hará constar en la factura del comprador.",
    "tax_included_in_price_input": "Impuesto incluido en el precio de los productos",
    "tax_included_in_price_message": "Seleccione esta opción si incluye el monto del impuesto en el precio de su producto. El importe del impuesto se calculará con la siguiente fórmula:",
    "tax_included_in_price_formula": "Impuesto = (precio * IVA) / (1 + IVA), por ejemplo, el monto del impuesto por un producto a un precio de 100 $ con una tasa de valor agregado del 10 % se convierte en 9,09 $.",
    "tax_on_shipping_input": "Aplicar impuestos al envío",
    "tax_on_shipping_message": "Al seleccionar esta opción se aplicará el impuesto al envío.",
    "fixed_tax_rate": "Tasa fija de impuestos",
    "dynamic_tax_rate": "Impuesto basado en regiones",
    "locations_tip": "La lista anterior solo muestra los países que ha seleccionado en Configuración de la tienda > Ubicaciones como los países que vende.",
  ...
  "delivery_person": {
    ...
    "pickup_dialog": {
      ...
      "message": "Si usted es responsable de llevar este paquete, seleccione Sí, de lo contrario, seleccione No."
    },
    "status_dialog": {
    ...
    "cod_dialog": {
      ...
      "message": "¿Confirmas que has recibido el importe del pedido del comprador?",
  ...
  "pos_devices": {
    ...
    "Scanner_desc": "Para usar el escáner de código de barras, debe ingresar el código SKU del producto correctamente en la configuración del producto.",
    "Printer": "Impresora",
    "Printer_desc": "Imprima el recibo de sus clientes conectándose a una impresora de recibos.",
    "CustomerView": "Vista del cliente",
    "CustomerView_desc": "Esta página le permite mostrar los detalles del pedido a sus clientes.",
  ...
  "pos": {
    ...
    "payment_cod": {
      "title": "Pago contra reembolso",
      "message": "El importe de este pedido se abonará en el momento de la entrega. Después de recibir el importe por parte del comprador, debe confirmar el pago para completar el pedido en el sistema."
    },
    "payment_online": {
      "title": "Seleccione el método de pago en línea",
      "message": "Al seleccionar las siguientes opciones, se creará un enlace de pago y se enviará al comprador. Al pagar este enlace, el estado del pedido cambiará al modo pago. El enlace de pago se generará escaneando el código QR en la pantalla del cliente, SMS o correo electrónico. Para activar cualquier canal para enviar un enlace, haga clic en esa opción y luego presione el botón para enviar un recibo al comprador."
    },
    "notifications": {
      "success_pay": "Pago del pedido completado.",
      "success_order": "Pedido creado con éxito y esperando que el cliente lo pague."
    },
    "payment_dialog": {
  ...
  "exporter": {
    ...
    "subtitle": "¡Tus datos te pertenecen! Puede descargar la información de su empresa en el formato estándar en cualquier momento. Sin embargo, respete la privacidad de sus clientes, no les envíe spam y nunca comparta su información con terceros.",
    "excel": "Recibirás una lista de todos los {type} en la tienda junto con información completa en formato Excel.",
    "csv": "Recibirás una lista de todos los {type} en la tienda junto con información completa en formato CSV. Este formato está de acuerdo con el formato estándar de Selldone para importar {tipo} a la tienda."
  },
  "importer": {
    "category": {
      "title": "Importar categorías",
      "subtitle": "Cargue el archivo CSV de las categorías aquí. Asegúrese de seguir el formato estándar."
    },
    "product": {
      "title": "Importar productos",
      "subtitle": "Cargue el archivo CSV de productos aquí. Asegúrese de seguir el formato estándar."
    },
    "product_images": {
      "title": "Importar imágenes",
      "subtitle": "Recibir información de la imagen lleva mucho tiempo. Asegúrese de respetar los derechos de autor al importar imágenes."
    },
    "inventory": {
      "title": "Inventario de actualización masiva",
      "subtitle": "Cargue el archivo CSV del inventario aquí. Asegúrese de seguir el formato estándar exportando primero el archivo CSV y luego editándolo."
    },
  ...
  "campaigns": {
    "title": "Campañas",
    "subtitle": "Cree campañas, enlaces rastreables y vea información confiable y precisa en un solo lugar. Te ayudamos a tomar mejores decisiones basadas en datos.",
  ...
  "shop_theme": {
    ...
    "products_view_mode_desc": "Puede ajustar el modo de visualización de los productos en su tienda según el tamaño de la pantalla. Este modo se considerará por defecto y no se aplicará si el usuario cambia el modo de visualización.",
  ...
  "my_roles": {
    "title": "mis roles",
    "message": "Los roles son un tipo de acceso otorgado a los empleados de una tienda. Por ejemplo, personal encargado de enviar o empacar pedidos."
  },
  "role_card": {
  ...
  "referral_widget": {
    "apply_now": "¡Solicite ahora este programa!",
    "no_bonus": "Recibe el primer premio invitando a un amigo.",
    "your_gift": "Tu regalo",
    "invited_gift": "regalo invitado",
    "percent_bonus": "bonificación porcentual",
    "discount_bonus": "bono de descuento",
    "registered": "Nuevo Usuario",
  ...
  "shop_bots": {
    ...
    "dialog": {
      ...
      "message": "Un marco integral de bots para crear experiencias de compra de nivel empresarial."
    }
  },
  "shop_customers": {
  ...
  "app_loader_page": {
    ...
    "no_ui_desc": "Algunas aplicaciones no requieren una interfaz de usuario en su área de administración. Esta aplicación solo puede agregar código a la sección de encabezado del sitio web de su tienda.",
    "header": "código de encabezado"
  },
  "finance_report": {
    "export_title": "Exportar datos financieros",
    "export_sub_title": "Descarga los detalles financieros en un solo archivo.",
  ...
  "shop_notifications": {
    ...
    "dialog": {
      ...
      "message": "Un marco de notificación integral para crear experiencias de comercio electrónico de nivel empresarial.",
  ...
  "order_delivery": {
    ...
    "message": "Después de entregar el paquete al servicio de mensajería, haga clic en el botón <b>Confirmar entrega</b> .",
    "message_add_to_service": "Haga clic en el siguiente botón si desea enviar este paquete por un <b>servicio de entrega</b> .",
    "action": "Confirmacion de envio",
    "checklist": [
    ...
    "manual": {
      ...
      "message": "Nota: Si el cliente recibe el pedido, puede usar las siguientes opciones para completar el cumplimiento. Algunos servicios de envío en el sistema confirmarán la entrega automáticamente."
    },
    "auto_complete_note": "Después de un cierto período, el estado del pedido cambiará a entregado. Este plazo varía según el tipo de pedido y lo determina el sistema.",
    "received": {
    ...
    "tracking": {
      ...
      "message": "Si realizó el envío a través de un servicio que proporciona un código de seguimiento para este pedido, puede ingresar el código y el enlace de seguimiento correspondiente en esta sección. Esta información se le mostrará al cliente."
    },
  ...
  "shop_home_edit": {
    ...
    "sub_title": "Establezca la página predeterminada de su sitio web",
  ...
  "widget_shop_gateway": {
    "link_account_caution": "¡Vincule una cuenta ({currency}) a su tienda! Haga clic aquí.."
  },
  "product_sell_widget": {
  ...
  "fulfilment_order_widget": {
    ...
    "message": "Después de pagar la tarifa del pedido al proveedor, vea el progreso del envío del pedido en esta sección."
  },
  "drop_shipping": {
    "menu": {
      "dashboard": "Panel",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Su pedido ha sido registrado como pago directo, complete el pago y cargue el recibo en la página de su pedido.",
      "pay_title": "Pago",
  ...
  "dropship_checkout": {
    ...
    "notifications": {
      "success_pay": "Su pago para estos pedidos confirmado y completado con éxito."
    }
  },
  "dropship_accounts": {
    "charge_account": "Cuenta de cargo",
  ...
  "dropshipping_products": {
    "no_shops": "Lo sentimos, no se encontró ninguna tienda. Habrá más tiendas en el futuro para que puedas poner sus productos en tu tienda.",
  ...
  "product_dropshipping": {
    ...
    "changed_value": "Este producto ha sido editado por el vendedor original. Verifique los cambios y si acepta aplicar los cambios a su producto, haga clic en el botón a continuación.",
    "changed_value_action": "Aceptar, hacer cambios",
    "parent_deleted": "Este artículo ha sido eliminado por el vendedor original.",
    "parent_closed": "¡Este producto ha sido deshabilitado por el vendedor original! No podrá vender este producto en su tienda, pero si el vendedor original reactiva el producto, podrá reactivar este producto en su tienda.",
    "notifications": {
      "re_enable_success": "Este producto ha sido reactivado.",
      "update_success": "La información de este producto se actualizó con la información del producto original."
    }
  },
  "product_dropshipping_admin": {
    "title": "Envío directo",
    "save_alert": "La configuración de dropshipping de este producto ha cambiado. ¿Quieres guardar los cambios?",
    "reselling_message": "Al activar esta opción, otros vendedores podrán agregar su producto a su tienda.",
  ...
  "product_info": {
    ...
    "notifications": {
      ...
      "waiting_list_add_success": "Te avisaremos cuando este producto sea subastado.",
  ...
  "shop_contacts": {
    ...
    "popup_message": "Al activar esta opción, la clave de soporte se verá en la parte inferior derecha de tu tienda."
  },
  "popup_page": {
  ...
  "popup_appearance": {
    "position": "Posición",
    "position_desc": "Especifique la ubicación de visualización de esta notificación en la página.",
    "width": "Ancho",
    ...
    "radius_desc": "En esta sección puede establecer el radio de curvatura de las esquinas de la notificación.",
    "shadow": "Sombra",
    "shadow_desc": "¿Quieres que la ventana emergente esté sombreada?",
    "delay": "Mostrar retraso",
    "delay_desc": "Una vez que el usuario ingrese a su tienda, luego de transcurrido este tiempo, se le mostrará una notificación al usuario.",
    "hide": "Ocultar retraso",
    "hide_desc": "Puedes configurar que la notificación se cierre automáticamente unos segundos después del espectáculo. Un valor de 0 significa que la notificación no se cerrará automáticamente.",
    "transition": "Animación emergente"
  },
  "popup_filter": {
    "registered": "Requisito de membresía e inicio de sesión",
    "registered_desc": "Puede optar por mostrar esta notificación solo a los usuarios o invitados de la tienda.",
    "only_guests": "solo invitados",
    "only_users": "Solo usuarios registrados",
    "purchased": "Historial de compras",
    "purchased_desc": "Puede optar por mostrar esta notificación solo a los usuarios que ya han comprado o a los que aún no han comprado.",
    "no_purchase": "No hay compra todavía",
    "yes_purchase": "Comprado antes",
    "sex": "Género",
    "sex_desc": "¿Quieres que esta notificación se muestre solo a usuarios de un género específico?",
    "age": "Edad mínima",
    "age_desc": "Si se ingresa algún valor mayor a 6, el usuario debe estar logueado y debe haber ingresado su fecha de nacimiento.",
    "levels": "Niveles del club de clientes",
    "levels_desc": "Si el usuario tiene uno de los niveles seleccionados a continuación, se le mostrará esta notificación.",
    "countries": "Restricciones de ubicación",
    "countries_desc": "¿Quieres que esta notificación se muestre solo a los usuarios que vienen de un país específico?"
  },
  "popup_setting": {
    "published": "Estado publicado",
    "repeat": "Repetir",
    "repeat_msg": "¿Desea que esta notificación se muestre al usuario más de una vez?",
    "intervals": "Tiempo de duración de la pantalla emergente",
    "intervals_msg": "Debe haber transcurrido el tiempo mínimo entre la visualización de notificaciones a un usuario.",
    ...
    "delete": {
      "title": "Borrar",
      "sub_title": "Una vez que eliminas una ventana emergente, no hay retorno. Por favor, esté seguro.",
  ...
  "shop_sms": {
    ...
    "sub_title": "Plantillas de SMS enviadas a los clientes",
    "message": "Puedes ver el contenido de los mensajes de texto enviados por tu tienda aquí. Debido a la limitación en el registro de los patrones de validación en el servicio de mensajería, por el momento no es posible personalizar los mensajes de texto."
  },
  "shop_emails": {
    "title": "Administrar correos electrónicos",
    "sub_title": "Verá la lista de correos electrónicos enviados por la tienda a clientes y gerentes en esta sección. Los correos electrónicos se diseñan y crean automáticamente en función de la información que ingresó para su tienda. Asimismo, en el futuro estará disponible para el público la posibilidad de personalizar mensajes e imágenes."
  },
  "instagram": {
    "title": "Ventas en Instagram",
    "message": "Con la ayuda de esta herramienta, puedes convertir tu Instagram en una tienda. Simplemente agregue y confirme su cuenta de Instagram aquí, luego podrá publicar uno o más productos de cada publicación o en su historia, agregar y etiquetar su lista de productos o convertir una publicación en un nuevo producto.",
    "add_product": "Agregar nuevo producto",
    "create_product": "Crear producto",
    "link_box_msg": "Pon este enlace en tu biografía en Instagram, Telegram u otras redes sociales para que tu audiencia pueda comprar más rápido, más fácil, más y finalmente más.",
    "remove_account": "Cambiar / Eliminar enlace de Instagram",
    "sync": "Sincronizar datos de cuenta (cada 60 minutos)"
  },
  "service_bill": {
    "task": {
      "title": "Lista de quehaceres",
      "message": "Escribe los títulos del trabajo que quieres hacer y hazle saber al comprador cuánto ha progresado."
    },
    "booking": {
      ...
      "change_days_question": "¿Necesita cambiar durante los días seleccionados por el cliente?",
    ...
    "subscription": {
      "title": "Suscripción",
      "message": "Puede elegir el período de suscripción comprando este servicio diariamente. Informe al comprador si desea cambiar los valores predeterminados que ya ingresó.",
      "duration": "Periodo de suscripción"
    },
    "charge": {
      "title": "Cargo",
      "message": "Ha especificado un cargo por este artículo. Puede cambiar el monto del cargo por el artículo comprado por el cliente.",
      "charge": "Cargo"
    },
  ...
  "service_tasks": {
    "notification_finish": {
      ...
      "message": "Si se hace esto, presione la tecla de confirmación para completar y cerrar el pedido.",
  ...
  "product_outputs": {
    ...
    "virtual": {
      ...
      "sub_title": "La información que desea mostrar al usuario después de la compra. Este formulario es especialmente aplicable para la venta de productos virtuales como la tarjeta regalo."
    },
    "service": {
      "title": "Diseño de servicio",
      "sub_title": "Primero seleccione su tipo de servicio e ingrese la información requerida. Por ejemplo, puede definir una lista de tareas pendientes o pedirle al cliente una hora de reserva o una cita."
    }
  },
  "service_design": {
    "type": "Tipo de servicio",
    "type_message": "Seleccione el tipo de servicio que proporciona para este producto. Al seleccionar cada elemento, se mostrará el formulario correspondiente. Dependiendo del tipo de servicio que elija, es posible que se reciba más información del cliente al realizar el pedido."
  },
  "ServiceTypes": {
    "DEMAND": {
      "title": "Bajo demanda",
  ...
  "avocado": {
    ...
    "message": "¡Una cantidad y un título es todo lo que necesita para obtener dinero de sus clientes! El dinero se acreditará directamente en su cuenta y sus clientes tendrán una experiencia de compra única.",
    "new_order": "nueva factura",
    "create_by_seller_title": "Crear factura",
    "create_by_seller_message": "Si desea crear una factura con un monto determinado y enviársela a alguien, puede presionar el botón a continuación para mostrar el formulario de factura. Proporcione el enlace generado al comprador para que pague y rastree su pedido a través de él.",
    "create_by_buyer_title": "forma de aguacate",
    "create_by_buyer_message": "Al activar esta sección, se le mostrará un enlace, proporcione este enlace a sus compradores para que puedan realizar su pedido.",
    "orders_list": "Lista de pedidos",
    "active_mode": "Recibo de pedido activo",
    "inactive_mode": "inactivo",
    "active_message": "Al activar esta fuente, sus clientes podrán realizar un pedido del producto a través del formulario de solicitud que ve a continuación.",
    "avocado_form_link_message": "Pon este enlace en tu biografía en Instagram, Telegram u otras redes sociales para que tu audiencia pueda comprar más rápido, más fácil y finalmente más.",
    "need_address": "Obtener dirección",
    "need_address_msg": "Si necesita obtener la ubicación y la dirección del comprador, seleccione esta opción.",
    "avocado_link_message": "Basta con proporcionar el enlace anterior al cliente para pagar el pedido. El cliente podrá seguir el pedido a través de este enlace.",
    "edit_order": "Editar orden",
    "progress": "Tasa de progreso",
    "buyer_link": "Enlace del comprador",
    "buyer_link_message": "Proporcione este enlace a su comprador. El comprador podrá realizar el pago y seguimiento de su pedido a través de este enlace. Este enlace está codificado, si el enlace se proporciona a cualquier persona, podrá pagar y ver la información. Este enlace estará activo durante 60 días. Haga clic en el enlace de abajo para copiar.",
    "OrderConfirm_done": "Orden confirmada.",
    "OrderConfirm_message": "Si confirma el pago y el pedido es correcto, haga clic en el botón a continuación.",
    "OrderConfirm_action": "Confirmación del pedido",
    "PreparingOrder_message": "Si el pedido del cliente está listo para enviarse, haga clic en el botón Aceptar a continuación.",
    "PreparingOrder_action": "El pedido está listo para enviar",
    "finish_message": "Si se completa este pedido, presione el botón Finalizar para cerrar este pedido.",
  ...
  "avocado_process": {
    "step1": "Precios",
    "step1_msg": "Introduce el precio de cada artículo y marca la casilla verde. Si no es posible vender un artículo, cambie su estado a rechazado.",
    "step2": "Confirmar factura",
    "step2_msg": "Cree una factura para este pedido. Puede ingresar un título y una descripción para la factura. El importe del pedido se calcula en función del precio total de los artículos de forma automática.",
    "title_input": "Título de la factura *",
    "show_to_customer": "Esta información se muestra al comprador.",
    "description_msg": "¿Quieres escribir una nota para este pedido? Esta información se mostrará al comprador.",
  ...
  "notification_top_bar": {
    ...
    "claim_charge_caution": "Nota: No es posible convertir monedas entre sus cuentas de billetera. Por lo tanto, seleccione una cuenta que sea apropiada para la moneda cambiada en su tienda.",
  ...
  "shop_languages": {
    ...
    "message": "Puedes instalar hasta 10 paquetes de idiomas en tu tienda. Contáctenos si necesita instalar más paquetes."
  },
  "invite_friends": {
    ...
    "invite": {
      ...
      "description": "Te invito a Selldone para que inicies tu negocio en línea con una herramienta fantástica.",
  ...
  "shops_list": {
    "title": "Mis tiendas",
    "message": "Listado de tiendas propias, tiendas permitidas y de muestra."
  },
  "shipping": {
    "warehouse_error": "¡Configura tu almacén primero! Esta dirección se utilizará como origen del envío.",
    "errors": {
  ...
  "about_us": {
    ...
    "subtitle": "Escriba un artículo sobre su empresa para mostrarlo en la página Acerca de nosotros. Esta página ayudará a tu audiencia a conocer tu marca y misión."
  },
  "terms": {
    "title": "Página de términos de servicio",
    "subtitle": "Explique las condiciones de compra y uso de sus servicios para sus clientes."
  },
  "privacy": {
    "title": "Página de política de privacidad",
    "subtitle": "Una política de privacidad es una declaración o documento legal que revela algunas o todas las formas en que una parte recopila, usa, divulga y administra un cliente o los datos de un cliente."
  },
  "contact_us": {
    "title": "Contáctenos página",
    "subtitle": "Escriba su información de contacto, dirección y número de teléfono para mostrar a sus clientes en la página de contacto."
  },
  "metaverse": {
    "title": "Puente Metaverso",
    "subtitle": "Selldone proporciona %100 servicios basados en API en el espacio comercial. Los desarrolladores de juegos, cadenas de bloques y metaversos pueden usar estas potentes API para conectar empresas, clientes y servicios en el futuro del mundo del trabajo, la vida y el comercio.",
  ...
  "orders_bulk_export": {
    ...
    "tasks": {
      ...
      "subtitle": "Descargue la lista de tareas para el procesamiento de pedidos en bloque. El resultado solo contiene pedidos pagados y COD.",
      "export_title": "Lista de tareas"
    },
    "labels": {
      "title": "Etiquetas de paquetes",
      "subtitle": "Descargue la lista de todas las etiquetas de pedidos en el período de tiempo y el estado seleccionados. El resultado solo contiene pedidos pagados y COD.",
  ...
  "theme": {
    ...
    "dark_mode_description": "Elija esta opción si desea un fondo oscuro con color de texto blanco.",
    "light_mode": "Modo de luz",
    "light_mode_description": "Elija esta opción si desea que el fondo sea claro y el texto en color negro."
  },
  "shop_quota": {
    "title": "Cuota de uso",
    "sub_title": "Esta es la lista de cuotas de uso para su tienda. Puede aumentar estos límites actualizando la licencia de su tienda. Si excede los límites, puede solicitarnos asignaciones de cuota diaria adicionales. Todo el uso se restablecerá diariamente."
  },
  "app_card": {
    "category": "Categoría",
    "installs": "Instalar",
