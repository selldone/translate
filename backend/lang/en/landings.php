...
return [
  ...
  */
    'instagram' => [
        ...
        'header_msg' => 'Imagine customers opening a store-like page from Instagram, choosing products from photos they like, adding them to an order, and paying directly to your account online. The solution is right in front of you.',
        ...
        'title1' => 'Turn your Instagram into a <span class="ulb">full-featured</span> store!',
        ...
        'sub1' => 'Product management works like this...',
        'sub1msg' => "The first step is to add products. With Selldone, you can import products from Instagram, upload an Excel file, or use other simple methods in just a few clicks.",
        ...
        'title4s' => 'Auto SEO',
        'title4' => 'Designing an SEO-friendly site that follows SEO best practices helps make your online business more visible to potential customers. Selldone provides the infrastructure you need for an SEO-oriented store, so you do not have to worry about being discovered on Google.',
        ...
        'title6' => 'Much more than an Instagram store...',
        ...
        'import_title' => "Ask Selldone users; their feedback on <span class='ulr'>simplicity and speed</span> will surprise you!",
