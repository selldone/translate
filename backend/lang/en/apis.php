    ...
    */
    ...
    'Product' => [
        ...
        'Get products list' => [
            ...
            'description' => 'Get the shop\'s product list.',
            ...
            'parameters' => [
                ...
                'with_parent' => ['title' => 'Get the parent category hierarchy. Can be true or false.', 'type' => 'boolean', 'default' => false],
                'offset' => ['title' => 'Offset of the product list (for pagination).', 'type' => 'int', 'default' => 0],
                'limit' => ['title' => 'Number of products in the list (for pagination).', 'type' => 'int', 'default' => 20],
                'sort' => ['title' => 'List sort type', 'type' => 'enum', 'default' => null, 'values' => [null, 'related', 'most_visited', 'most_popular', 'newest', 'bestselling', 'cheapest', 'most_expensive', 'random', 'related', 'favorite', 'random']],
                'product_id' => ['title' => 'Product ID used to return related products (sort = related).', 'type' => 'int', 'default' => null],
                'set' => ['title' => 'Product data set. Can be null or spec (null: default, spec: optimized for retrieving specifications).', 'type' => 'enum', 'default' => null, 'values' => [null, 'spec']],
                ...
                'dir' => ['title' => 'Category ID or name. Gets products in this category when set.', 'type' => 'any', 'default' => null],
                'products_only' => ['title' => 'Get only products (categories not included).', 'type' => 'boolean', 'default' => false],
                'categories_only' => ['title' => 'Get only categories (products not included).', 'type' => 'boolean', 'default' => false],
                'need_full_variants' => ['title' => 'Get full variant information.', 'type' => 'boolean', 'default' => false],
                'optimized' => ['title' => '(Only when getting products as an admin) Get the product list without price, rate, or statistics.', 'type' => 'boolean', 'default' => false],
        ...
        'Get product info' => [
            ...
            'scope' => ProductController::GET_MY_PRODUCTS_SCOPE,
            'permissions' => ProductController::GET_MY_PRODUCTS_PERMISSION,
            'description' => 'Get product information and statistics.',
