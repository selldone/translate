...
return [
    ...
    JobTopic::PAYMENT => [
        ...
        'desc' => 'Añade una pasarela de pago online a tu tienda.',
    ],
    ...
    JobTopic::TAX => [
        ...
        'desc' => 'Recibe asesoramiento sobre tus temas financieros y fiscales.',
    ],
    ...
    JobTopic::ANALYZE => [
        ...
        'desc' => 'Revisa el comportamiento de tus usuarios en la tienda online e incluso en las sucursales físicas de tu tienda para brindarles una mejor experiencia de usuario.',
    ],
    ...
    JobTopic::APP_INSTALL => [
        ...
        'desc' => 'Instala y configura la aplicación que necesitas en la tienda.',
    ],
    ...
    JobTopic::PRODUCT_DESCRIPTION => [
        ...
        'desc' => 'Escribe descripciones atractivas de tus productos para que tus clientes puedan conocer tus productos más fácilmente.',
    ],
