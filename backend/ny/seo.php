<?php 
 ...
 return [
     ...
     "author" => "Wolemba",
     "others-title" => "Dziwani zambiri za :mutu",
],
     "page" => [
     "login" => [
     ...
     "shuttle-shop" => [
     "title" => "Selldone | Gulani Dashboard",
     ...
     "guild" => [
     "title" => "Gulu - Collective Sales Channel",
