<?php 
 ...
 return [
     ...
     "body" => "Yako :param2 kubhadhara kwagadziriswa. Order: :param1 Thanks, :param3. Selldone",
     ...
     "body" => "Nyowani :param2 kubhadhara kwakagadziriswa. Order: :param1 Thanks, :param3. Selldone",
     "description" => "Tumira meseji kumuridzi wechitoro uvazivise nezvekubhadhara kwakabudirira.",
],
     "vendor-new-order" => [
     "title" => "Mutengesi New Order",
     "sample" => "Wagamuchira odha itsva ye$200.<br> Order: SM-870 kubva kune <b>zita reMutengesi</b> .",
     "body" => "Wagamuchira itsva :param2 odha. Order: :param1 ye:param3.",
     ...
     "body" => "Kodhi yako yekupinda ndeiyi: :param1 :param2 Selldone",
     ...
     "body" => "Wadiwa :param1, Wapinda muakaundi yako ne:param2 pa:param3. Selldone",
     ...
     "body" => ":param3 Wadiwa :param1, Tagamuchira odha yako uye tiri kuiongorora. Order #: :param2 Selldone",
     ...
     "body" => "Wagamuchira order yeavocado: Chitoro: :param1 Mutengi: :param2 Order: :param3 Selldone",
     ...
     "body" => ":param3 Odha yako yakasimbiswa uye inogona kubhadharwa kuburikidza neinotevera link. Order #: :param2 Link: :param1 Selldone",
