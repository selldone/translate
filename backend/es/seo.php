<?php 
 ...
 return [
     ...
     "author" => "Autor",
     "others-title" => "Más información sobre :título",
],
     "page" => [
     "login" => [
     ...
     "description" => "Preguntas y respuestas sobre Selldone.",
],
     "price" => [
     ...
     "shuttle-shop" => [
     "title" => "Selldone | Tablero de la tienda",
     ...
     "guild" => [
     "title" => "Gremio — Canal de ventas colectivas",
