<?php 
 ...
 return [
     ...
     "body" => "U vostru pagamentu :param2 hè stallatu bè. Ordine: :param1 Grazie, :param3. Selldone",
],
     "shop-order-payment-admin" => [
     "title" => "Accetta pagamentu",
     "sample" => "U novu pagamentu di 267 $ hè stallatu bè.<br> Ordine: SM-425<br> Grazie, u <b>vostru nome di a tenda</b> .<br> Selldone",
     "body" => "Novu: pagamentu param2 risoltu cù successu. Ordine: :param1 Grazie, :param3. Selldone",
],
     "shop-login" => [
     ...
     "body" => "U vostru codice di login hè: :param1 :param2 Selldone",
],
     "user-login" => [
     ...
     "body" => "Caru :param1, Avete logatu à u vostru contu da :param2 à :param3. Selldone",
],
     ...
     "body" => ":param3 Caru :param1, Avemu ricevutu u vostru ordine è l'avemu esaminatu. Order #: :param2 Selldone",
],
     ...
     "body" => "Avete ricevutu un ordine di avocado: Store: :param1 Cumpratore: :param2 Order: :param3 Selldone",
],
     ...
     "body" => ":param3 U vostru ordine hè statu cunfirmatu è pò esse pagatu attraversu u ligame seguente. Order #: :param2 Link: :param1 Selldone",
],
];