<?php 
 ...
 return [
     ...
     "body" => "Yakho :param2 intlawulo ilungiswe ngempumelelo. Umyalelo: :param1 Enkosi, :param3. Selldone",
],
     ...
     "body" => "Entsha :intlawulo yeparam2 ilungiswe ngempumelelo. Umyalelo: :param1 Enkosi, :param3. Selldone",
],
     "shop-login" => [
     ...
     "body" => "Ikhowudi yakho yokungena ngu: :param1 :param2 Selldone",
],
     "user-login" => [
     ...
     "body" => "Othandekayo :param1, Ungene kwiakhawunti yakho nge :param2 apha :param3. Selldone",
],
     ...
     "body" => ":param3 Othandekayo :param1, Siyifumene iodolo yakho kwaye siyayiphonononga. Umyalelo #: :param2 Selldone",
],
     ...
     "body" => "Ufumene iodolo yeeavokhado: IVenkile: :param1 Umthengi: :param2 Iodolo: :param3 Selldone",
],
     ...
     "body" => ":param3 Umyalelo wakho uqinisekisiwe kwaye unokuhlawulwa ngekhonkco elilandelayo. Umyalelo #: :param2 Ikhonkco: :param1 Selldone",
],
];