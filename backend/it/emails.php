<?php 
 ...
 return [
     ...
     "title" => "ordine",
     "message" => "Il tuo ordine conferma,<br> Abbiamo il tuo ordine. Ti invieremo un'altra email quando il tuo ordine sarà spedito.",
     "payments" => "Pagamenti",
],
     "order-payment" => [
     "subject" => "🛍 Conferma pagamento | :ID ordine",
     "title" => "Ordine di pagamento",
     "message" => "Il tuo pagamento completato,<br> Abbiamo il tuo ordine. Ti invieremo un'altra email quando il tuo ordine sarà spedito.",
     "payments" => "Pagamenti",
],
     "get-voucher" => [
     "subject" => "Congratulazioni :nome | Nuovo buono: :titolo",
     "category" => "CONGRATULAZIONI, NUOVO VOUCHER",
     ...
     "received-gift" => [
     "subject" => "Congratulazioni, caro :nome | Hai ricevuto un regalo",
