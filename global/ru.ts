export default {
  ...
  "commons": {
    ...
    "shop_button": "Кнопка магазина",
    "embed": "Встроить",
    "over": "Над",
    "tax_vary_by_location": "отличаться. расположение",
    "product_type": "Тип продукта",
    "tax_id": "ИНН",
    "business_name": "Наименование фирмы",
    "invoice": "Счет",
    "included_in_the_product": "Входит в состав продукта",
    "included_in_the_product_description": "В состав продукта входят следующие компоненты",
    ...
    "bank_routing_number": "Банковский номер маршрута",
    "bank_branch_address": "Адрес отделения банка",
    "bank_account_name": "Полное имя владельца аккаунта",
    "valuation": "Оценка",
    "cluster": "Кластер",
    "clusters": "Кластеры",
  ...
  "actions": {
    ...
    "transfer_fund": "Перевести фонд",
    "reverse_fund": "Обратный фонд",
    "settlement": "Урегулирование",
    "refund": "Возвращать деньги",
    "partial_refund": "Частичное возмещение",
