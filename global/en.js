...
export default {
  ...
  transportation_type: {
    motorbike: "Motorbike",
    motorbike_description: "Medium freight within a few kilometers.",
    cargo_small: "Small cargo",
    cargo_small_description: "Multi-kilometer light cargo.",
    cargo: "Cargo",
    cargo_description: "Medium freight within a few kilometers.",
    truck: "Truck",
  ...
  article: {
    ...
    schedule_action: "Do you want schedule publish?",
  ...
  basket_order_info_summery: {
    ...
    phone: "Caller ID",
    reserved_date: "Registration Date",
    total_price: "Total price",
    discount: "Discount",
    final_price: "Final price",
    address: "Consignee Delivery Address",
    payment_status: "Payment Status",
  },
  ...
  basket_delivery_state: {
    ...
    step_1: "Awaiting review",
    step_2: "Order confirmation",
    step_3: "Preparation",
    step_4: "To Delivery agent",
    step_5: "Delivery to customer",
  },
