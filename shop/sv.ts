...
export default {
  ...
  surveys: ["Väldigt fattig", "Fattig", "Vanligt", "Bra", "Utmärkt"],
  ...
  footer: {
    ...
    copyright:
      "Användning av innehåll endast för icke-kommersiella ändamål och med hänvisning till källan (länk med {shop_title}). Alla rättigheter reserverade till {shop_title}.",
    powered_by: "Drivs av",
    ...
    dialog_setting: {
      title: "Inställningar för butiksappar",
  ...
  shop: {
    ...
    native: {
      ...
      message:
        "Den här appen kräver åtkomst till din butikskontoinformation. Detta inkluderar tillgång till namn, kontaktnummer, adress, e-post, beställningshistorik, beställning och att lägga upp kommentarer i denna butik.",
      message_bold:
  ...
  product_info: {
    ...
    waiting_for_auction: "Väntar du på auktionen?",
  ...
  layout_shop: {
    shop_menu: {
      orders_history: "Orderhistorik",
      profile: "Min profil",
      favorites: "Favoritartiklar",
      gift_cards: "Presentkort",
      return_requests: "Returnerade beställningar",
      basket: "Kundvagn",
    },
    user_menu: {
    ...
    login_to_shop: "Logga in i butiken",
  ...
  user_wallets: {
    ...
    subtitle: "Om du är berättigad och ett cashback-program är aktivt krediteras en del av din beställning till din plånbok. Du kan använda dessa medel vid ditt nästa köp."
  },
  /**
   * @see SWalletInput
   */
  wallet_input:{
    my_wallet_balance:"Mitt plånbokssaldo",
  },
  ...
  order_page: {
    ...
    payment: {
      title: "Betalning",
      payment_waiting: "Väntar på utbetalning",
      ...
      payment_is_in_require_capture_message:
        "Vi har tagit emot din betalning, men den har inte registrerats ännu.",
    ...
    delivery: {
      ...
      notifications: {
        confirm_delivery: "Din beställning är bekräftad.",
      },
    },
  ...
  return_request: {
    ...
    count_input_message: "Hur många varor returnerar du?",
    reason_input: "anledning att återvända",
    reason_input_message: "Välj skälet till att returnera denna vara.",
    note_input: "Beskrivning",
    note_input_hint: "Beskriv orsaken till returen..",
    note_input_message:
      "Beskriv anledningen till att returnera denna vara om det behövs.",
    media_message:
    ...
    notifications: "Din returförfrågan har registrerats.",
  },
  ...
  user_profile: {
    ...
    edit_personal_info: "Redigera personlig information",
    leave_dialog: {
      title: "Lämna butiken",
      message:
    ...
    my_profile: {
      title: "Min profil",
      subtitle: "Det här är min kundprofilinformation för butiken.",
      edit_action: "Redigera profil"
    },
    subscribe_status: {
      subscribed: "Jag prenumererar på de senaste nyheterna och kampanjerna via e-post.",
      unsubscribed: "Jag prenumererar inte på nyheter eller kampanjer via e-post."
    },
    my_club: {
      subtitle: "Min klubbnivå och dess förmåner."
    },
    kyc: {
      subtitle: "Det här är min globala identifieringsinformation."
    }
  ...
  basket_page: {
    ...
    receive_time: "Önskad leveranstid",
    select_time: "Välj Leveranstid",
    no_select_time: "Så snart som möjligt",
    transportation_type: "Frakttyp",
    ...
    same_billing_address: "Faktureringsinformation samma som mottagarens information",
    same_billing_address_desc:
      "Faktureringsadressen är densamma som leveransadressen.",
    custom_billing_info: "Olika faktureringsuppgifter",
    custom_billing_info_desc:
      "Du kan ange ditt skattenummer och ange en annan adress för fakturering.",
    ...
    can_pay_cod_message:"Du kan betala den här ordern kontant vid leverans.",
  },
  ...
  addresses_page: {
    title: "Mina adresser",
    subtitle:"Visa dina sparade adresser här och lägg enkelt till en ny.",
  ...
  return_requests: {
    ...
    subtitle:"Visa dina returförfrågningar här. För artiklar med returpolicy kan du skicka en returförfrågan på ordersidan.",
  },
  ...
  user_gift_cards: {
    ...
    add_card_dialog: {
      ...
      info: "Obs: När du köper från butiken visas möjligheten att betala med presentkort. Genom att välja det här alternativet kommer beloppet för ditt omladdningssaldo att dras från beställningsbeloppet.",
  ...
  product_comparison: {
    ...
    list: {
      ...
      brand: "varumärke",
      warranty: "Garanti",
      variants_comparison: "Jämför produktvarianter",
  ...
  product_rating_view: {
    message:
      "Bästa {user}, Du har köpt den här produkten. Vad tycker du om denna produkt?",
    notification: {
      title: "Grattis",
  ...
  contact_us_form: {
    ...
    submitted_title: "Tack för att du kontaktar oss!",
    submitted_message:
      "Vi uppskattar att du tar dig tid att kontakta oss. Ditt meddelande har tagits emot och vårt team granskar det för närvarande. Vi kommer att svara så snart som möjligt och vi tackar dig för ditt tålamod under denna tid. Ditt intresse och din feedback är viktigt för oss, och vi är angelägna om att ge dig bästa möjliga stöd.",
  },
  ...
  master_payment: {
    notifications: {
      ...
      connecting_to_online_gateway: "Ansluter till onlinebetalningsporten.",
    },
  },

  /** {@see TimeProgressBar} **/
  time_progress_bar: {
    title_before_start: "Kvar till början",
  ...
  avocado: {
    ...
    step1:
      "1. Ange namn och detaljer för den produkt du vill beställa och klicka på knappen Lägg till.",
    title_plc: "Ange namnet på produkten.",
    description_plc: "Har du fler produktbeskrivningar?",
    link_plc: "Har du en länk till produkten?",
    image: "Produktbild",
    image_msg: "Du kan skicka produktbilden vid behov.",
    ...
    check_now: "Kontrollera ordning",
    add_new_order: "Gör ny beställning",
    ...
    select_address_message:
      "Ange din adress så kan du skicka beställningen.",

    delete_item_dialog: {
      title: "Ta bort varan från varukorgen",
      message: "Vill du ta bort denna artikel från kundvagnen?",
      action: "Ja, radera",
    },
  ...
  hyper: {
    ...
    add_new_order: "Ny beställning",
    continue_order: "Fortsätt beställa",
  ...
  pending_payment: {
    upload_payment_receipt: "Ladda upp bild på betalningskvittot.",
    ...
    public_form_title: "Kontoinformation för överföring av pengar",
  },
  ...
  service_bill: {
    task: {
      ...
      message: "Ange titlarna på det arbete du vill göra och låt köparen veta hur långt det har kommit.",
    },
    booking: {
      ...
      selected_checkin: "Vald incheckning av kund",
      selected_checkout: "Vald utcheckning av kund",
  ...
  check_access: {
    ...
    no_access_message:
      "Tyvärr har du inte tillgång till vår butik.<br/> Vänligen kontakta oss.",
  },

  /** @see SShopShareOrderButton **/
  share_order: {
    action: "Dela beställning",
    title: "Dela denna beställning med andra.",
    message:
      "Det är en säker länk, dela den bara med dem du känner. Alla med denna länk kan duplicera din beställning och se den valda adressen. Den kommer att innehålla information om din nuvarande varukorg.",
    valid_period: "Denna länk upphör att gälla efter 48 timmar.",
    import_order_action: "Importorder",
    retrieve_dialog_title: "Hämta extern beställning",
  ...
  rating: {
    product_rating_message:
      "Den här produkten har fått betyget {rate} av 5 stjärnor och betygsatt av {rate_count} personer.",
  },
