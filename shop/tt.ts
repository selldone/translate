export default {
  ...
  "footer": {
    ...
    "phone": "Телефон",
    "address": "Адрес",
    "copyright": "Эчтәлекне коммерция булмаган максатларда һәм чыганакка сылтама белән куллану ({shop_title with белән сылтама). Барлык хокуклар {shop_title to өчен сакланган.",
    "powered_by": "Туклана",
  ...
  "shop": {
    ...
    "native": {
      "title": "Кушымта кертү",
      "message": "Бу кушымта сезнең кибет счеты мәгълүматына рөхсәт сорый. Бу исемгә, контакт номерына, адреска, электрон почтага, заказ тарихына, заказ бирү һәм бу кибеткә аңлатмалар урнаштыруны үз эченә ала.",
      "message_bold": "Бу кибеткә керү өчен рәсми кибет кушымтасын кулланыгыз."
    }
  },
  "sort": {
    "title": "Карата төрлә",
  ...
  "layout_shop": {
    ...
    "user_menu": {
      ...
      "exit_from": "Чыгу {shop_name}",
      "chips": "{chips} Чипс"
    },
    "login_to_shop": "Кибеткә керегез",
    "login_to_shop_short": "керергә",
    "item_in_basket_message": "{count} Бу әйбер сезнең арбада.",
    "search_title": "Кибеттә эзләү {shop_name}"
  },
  "basket_top_menu": {
    "basket": "Арба",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Заказны алсагыз, раслау төймәсенә басыгыз. Кирәк булса, раслауны алсагыз, юллама җибәрә аласыз.",
      "Recipient": "Алучы",
      "bill": "Фактура",
      "name": "Исем",
      "tel": "Телефон",
  ...
  "return_request": {
    ...
    "note_input_message": "Кирәк булса, бу әйберне кире кайтаруның сәбәбен сурәтләгез.",
    "media_message": "Продукциянең статусы турында яхшырак ярдәм алыр өчен, продуктның рәсемен, аудио яки видеосын монда урнаштыра аласыз. Файлны сайлау автоматик рәвештә җибәреләчәк һәм расланачак.",
    "video": "Видео",
    "voice": "Тавыш",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Кибеттән китү",
      "message": "Бу кибеткә язылу сезнең заказ мәгълүматларын һәм язмаларны бетермәячәк.",
      "action": "Кит"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "not_support_cod": "Locallyирле түләп булмый!",
  ...
  "basket_items": {
    ...
    "offer": "{count} х пунктын {percent} процентка алыгыз",
    "offer_free": "{count} х бушлай алыгыз"
  },
  "addresses_page": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Карта номерын һәм куркынычсызлык кодын кертегез. Сезнең хисапка бүләк картасы өстәләчәк.",
  ...
  "product_rating_view": {
    "message": "Хөрмәтле {user}, Сез бу продуктны сатып алдыгыз. Бу продукт турында нәрсә уйлыйсыз?",
    "notification": {
      "title": "Котлыйбыз",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Сезнең заказ уңышлы өстәлде. Хәзер сез турыдан-туры акча күчереп түли аласыз, аннары түләү квитанциясен заказ битенә урнаштыра аласыз.",
      "pay_title": "Түләү",
  ...
  "avocado": {
    ...
    "step1": "1. Сез заказ бирергә теләгән продуктның исемен һәм детальләрен кертегез һәм Кушу төймәсенә басыгыз.",
    ...
    "step2": "2. Барлык кирәкле әйберләрне өстәгәннән соң, заказны карау соравы төймәсенә басыгыз. Бу этапта без заказны карап чыгарбыз һәм бәясе турында сезгә хәбәр итәрбез. Бу сылтамага басып, сез бәяне һәм түләү сылтамасын күрә аласыз.",
    ...
    "pricing_not_completed_message": "Сезнең заказ карала. Тиздән сезнең заказ каралачак һәм бәяләнәчәк һәм сез заказны түли аласыз.",
    "delete_item_dialog": {
    ...
    "select_address_message": "Зинһар, адресыгызны кертегез, аннары сез заказны җибәрә аласыз."
  },
  "hyper": {
    "title": "Заказ булдыру",
    "message": "Продукция кодын сканерлап сатып алырга теләгән продуктлар исемлеген төзегез.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Сез квитанция рәсемен йөкләдегез, безнең рөхсәтне көтегез. Әгәр дә сез үзгәрергә тиеш булсагыз, алдагы рәсемне яңасына алыштыра аласыз.",
  ...
  "check_access": {
    ...
    "no_access_message": "Кызганычка каршы, безнең кибеткә керү мөмкинлеге юк.<br/> Зинһар, безнең белән элемтәгә керегез."
  },
  "share_order": {
    "action": "Заказны бүлешү",
    "title": "Бу заказны башкалар белән бүлешегез.",
    "message": "Бу куркынычсыз сылтама, аны белгәннәр белән бүлешегез. Бу сылтама булган һәркем сезнең заказны кабатлый һәм сайланган адресны күрә ала. Анда сезнең хәзерге арба турында мәгълүмат булачак.",
