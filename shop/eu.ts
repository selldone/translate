export default {
  ...
  "footer": {
    ...
    "phone": "Mugikorra",
    "address": "Helbidea",
    "copyright": "Edukia helburu ez-komertzialetarako eta iturriari erreferentzia eginez soilik erabiltzea (esteka {shop_title}-rekin). Eskubide guztiak {shop_title}rentzat gordeta.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Aplikazio honek zure dendako kontuaren informaziorako sarbidea behar du. Honek izena, kontaktu-zenbakia, helbidea, posta elektronikoa, eskaera-historia, eskaerak eta denda honetan iruzkinak argitaratzea barne hartzen ditu.",
      "message_bold": "Ziurtatu denda-aplikazio ofiziala erabiltzen duzula denda honetara sartzeko."
    }
  },
  "sort": {
    "title": "Ordenatu",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Egin klik berrespen botoian eskaera jaso baduzu. Behar izanez gero, erreferentzia bat bidali ahal izango duzu berrespena jasotzen baduzu.",
  ...
  "return_request": {
    ...
    "note_input_message": "Deskribatu elementu hau itzultzeko arrazoia behar izanez gero.",
    "media_message": "Produktuaren irudia, audioa edo bideoa karga dezakezu hemen produktuaren egoerari buruzko informaziorako laguntza hobea lortzeko. Fitxategia hautatzean automatikoki bidaliko da eta berretsiko da.",
    "video": "Bideoa",
    "voice": "Ahotsa",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Utzi denda",
      "message": "Denda honetara harpidetza kentzeak ez ditu zure eskaeraren informazioa eta erregistroak ezabatuko.",
      "action": "Utzi"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Sartu txartelaren zenbakia eta segurtasun kodea. Opari-txartel bat gehituko da zure kontuan.",
  ...
  "product_rating_view": {
    "message": "{erabiltzaile agurgarria: Produktu hau erosi duzu. Zer iruditzen zaizu produktu honi buruz?",
    "notification": {
      "title": "Zorionak",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Eskertzen dugu gurekin harremanetan jartzean izan duzun denbora. Zure mezua jaso da eta gure taldea berrikusten ari da. Ahalik eta azkarren erantzungo dugu, eta eskertzen dizugu denbora honetan izan duzun pazientziagatik. Zure interesa eta iritzia garrantzitsuak dira guretzat, eta ahalik eta laguntza onena eskaintzeko konpromisoa hartzen dugu."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Zure eskaera behar bezala gehitu da. Orain zuzeneko diru-transferentzia bidez ordaindu dezakezu eta, ondoren, ordainketa-agiria igo dezakezu eskaera orrian.",
  ...
  "avocado": {
    ...
    "step1": "1. Sartu eskatu nahi duzun produktuaren izena eta xehetasunak eta egin klik Gehitu botoian.",
    ...
    "step2": "2. Nahi dituzun elementu guztiak gehitu ondoren, egin klik eskaera berrikusteko eskaera botoian. Fase honetan, eskaera berrikusiko dugu eta prezioaren berri emango dizugu. Esteka honetan klik eginez, prezioa eta ordainketa esteka ikusteko aukera izango duzu.",
    ...
    "pricing_not_completed_message": "Zure eskaera berrikusten ari da. Zure eskaera berrikusi eta prezioa laster egingo da eta eskaera ordaindu ahal izango duzu.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Sortu erosi nahi dituzun produktuen zerrenda produktuaren kodea eskaneatuz.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Ordainagiriaren irudia dagoeneko igo duzu, itxaron gure onespena. Aldatu behar baduzu, aurreko irudia berri batekin ordez dezakezu.",
