export default {
  ...
  "avocado": {
    ...
    "step1": "1. Introduceți numele și detaliile produsului pe care doriți să îl comandați și faceți clic pe butonul Adaugă.",
  ...
  "hyper": {
    ...
    "message": "Creați lista de produse pe care doriți să le cumpărați scanând codul produsului.",
