export default {
  ...
  "footer": {
    ...
    "phone": "Foni",
    "address": "Adilesi",
    "copyright": "Kugwiritsa ntchito zinthu pazinthu zomwe si zamalonda komanso zokhudzana ndi gwero (ulalo ndi {shop_title}). Ufulu wonse ndi {shop_title}.",
    ...
    "dialog_setting": {
      "title": "Gulani Ma Applications Setting",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Pulogalamuyi ikufuna kupeza zambiri za akaunti yanu yasitolo. Izi zikuphatikiza mwayi wopeza dzina, nambala yolumikizirana, adilesi, imelo, mbiri yamaoda, kuyitanitsa ndi kutumiza ndemanga pasitolo iyi.",
      "message_bold": "Onetsetsani kuti mukugwiritsa ntchito pulogalamu yovomerezeka ya sitolo kulowa musitoloyi."
    }
  },
  "sort": {
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Dinani batani lotsimikizira ngati mwalandira dongosolo. Ngati pakufunika, mudzatha kutumiza zotumizira ngati mutalandira chitsimikiziro.",
      "Recipient": "Wolandira",
      "bill": "Invoice",
      "name": "Dzina",
      "tel": "Foni",
  ...
  "return_request": {
    ...
    "note_input_message": "Longosolani chifukwa chobwezera chinthuchi ngati chikufunika.",
    "media_message": "Mutha kukweza chithunzi, zomvera kapena kanema wazogulitsa pano kuti muthandizidwe bwino pazambiri zamalonda. Kusankha wapamwamba adzatumiza basi ndi kutsimikizira.",
    "video": "Kanema",
    "voice": "Mawu",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Chokani shopu",
      "message": "Kusiya kulembetsa ku sitoloyi sikuchotsa zomwe mwaitanitsa komanso zolemba zanu.",
      "action": "Chokani"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Lowetsani nambala yakhadi ndi nambala yachitetezo. Khadi lamphatso liwonjezedwa ku akaunti yanu.",
  ...
  "product_rating_view": {
    "message": "Wokondedwa {user}, Mwagula izi. Mukuganiza bwanji za mankhwalawa?",
    "notification": {
      "title": "Zabwino zonse",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Oda yanu yawonjezedwa bwino. Tsopano mutha kulipira mwachindunji kutengerapo ndalama ndikukweza chiphaso chamalipiro patsamba la dongosolo.",
      "pay_title": "Malipiro",
  ...
  "avocado": {
    ...
    "step1": "1. Lowetsani dzina ndi tsatanetsatane wa chinthu chomwe mukufuna kuyitanitsa ndikudina batani la Add.",
    ...
    "step2": "2. Mukawonjezera zinthu zonse zomwe mukufuna, dinani batani la pempho la oda. Pakadali pano, tiwonanso dongosolo ndikudziwitsani za mtengo wake. Podina ulalo uwu, mudzatha kuwona mtengo ndi ulalo wolipira.",
    ...
    "pricing_not_completed_message": "Zogula zanu zikuwunikidwa. Oda yanu idzawunikidwanso ndikuyika mtengo posachedwa ndipo mudzatha kulipira.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Pangani mndandanda wazinthu zomwe mukufuna kugula posanthula kachidindo.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Mwakweza kale chithunzi cha risiti, dikirani kuti tivomereze. Ngati mukufuna kusintha, mutha kusintha chithunzi choyambirira ndi chatsopano.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Kulembetsa",
      "message": "Mukhoza kusankha nthawi yolembetsa pogula ntchitoyi tsiku ndi tsiku. Mudziwitse wogula ngati mukufuna kusintha zikhalidwe zomwe mwalowa kale.",
