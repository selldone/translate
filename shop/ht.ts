export default {
  ...
  "footer": {
    ...
    "phone": "Telefòn",
    "address": "Adrès",
    "copyright": "Itilizasyon kontni sèlman pou rezon ki pa komèsyal ak referans ak sous la (lyen ak {shop_title}). Tout dwa rezève pou {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      "title": "Aplikasyon Login",
      "message": "Aplikasyon sa a mande aksè a enfòmasyon sou kont magazen ou. Sa gen ladann aksè a non, nimewo kontak, adrès, imèl, istwa lòd, kòmantè ak afiche kòmantè sou magazen sa a.",
      "message_bold": "Asire w ou itilize aplikasyon magazen ofisyèl la pou antre nan magazen sa a."
    }
  },
  "sort": {
    "title": "Triye pa",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Klike sou bouton konfimasyon an si ou te resevwa lòd la. Si sa nesesè, w ap kapab soumèt yon referans si w resevwa konfimasyon.",
  ...
  "return_request": {
    ...
    "note_input_message": "Dekri rezon pou retounen atik sa a si sa nesesè.",
    "media_message": "Ou ka telechaje imaj, odyo oswa videyo pwodwi a isit la pou jwenn pi bon sipò pou enfòmasyon sou estati pwodwi a. Chwazi fichye a pral otomatikman voye ak konfime.",
    "video": "Videyo",
    "voice": "Vwa",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Kite boutik",
      "message": "Dezabònman nan magazen sa a pa pral efase enfòmasyon ak dosye sou lòd ou yo.",
      "action": "Kite"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Antre nimewo kat la ak kòd sekirite. Y ap ajoute yon kat kado sou kont ou.",
  ...
  "product_filter_menu": {
    ...
    "brands": "Mak",
    "main_shop_page": "Sere paj prensipal la",
    "home": "Lakay"
  },
  "product_rating_view": {
    "message": "Chè {user}, Ou te achte pwodui sa a. Kisa ou panse de pwodui sa a?",
    "notification": {
      "title": "Felisitasyon",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Nou apresye tan ou nan kontakte nou. Nou resevwa mesaj ou a epi ekip nou an ap revize li. Nou pral reponn pi vit posib, epi nou remèsye ou pou pasyans ou pandan tan sa a. Enterè ou ak fidbak yo enpòtan pou nou, epi nou pran angajman pou ba ou pi bon sipò posib."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Yo te ajoute lòd ou a avèk siksè. Koulye a, ou ka peye pa transfè lajan dirèk ak Lè sa a, telechaje resi peman an sou paj lòd la.",
      "pay_title": "Peman",
  ...
  "avocado": {
    ...
    "step1": "1. Antre non an ak detay sou pwodwi a ou vle kòmande epi klike sou bouton an Add.",
    ...
    "step2": "2. Apre ou fin ajoute tout atik yo vle, klike sou bouton demann revizyon lòd la. Nan etap sa a, nou pral revize lòd la epi fè w konnen sou pri a. Lè w klike sou lyen sa a, w ap kapab wè pri ak lyen peman an.",
    ...
    "pricing_not_completed_message": "Yo revize lòd ou a. Kòmand ou a pral revize ak pri byento epi ou pral kapab peye lòd la.",
    "delete_item_dialog": {
  ...
  "hyper": {
    "title": "Kreyasyon lòd",
    "message": "Kreye lis pwodwi ou vle achte pa eskane kòd pwodwi a.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Ou deja telechaje imaj resi a, tann apwobasyon nou an. Si ou bezwen chanje, ou ka ranplase imaj anvan an ak yon nouvo.",
