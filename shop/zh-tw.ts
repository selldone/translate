export default {
  ...
  "footer": {
    ...
    "phone": "電話",
    "address": "地址",
    "copyright": "僅出於非商業目的使用內容並參考來源（與 {shop_title} 的鏈接）。 {shop_title} 保留所有權利。",
    "powered_by": "供電",
    "privacy": "隱私政策",
    "term_of_use": "使用條款",
  ...
  "shop": {
    ...
    "native": {
      "title": "應用程序登錄",
      "message": "此應用程序需要訪問您的商店帳戶信息。這包括訪問姓名、聯繫電話、地址、電子郵件、訂單歷史記錄、訂購和在該商店發表評論。",
      "message_bold": "請務必使用官方商店應用程序進入該商店。"
    }
  },
  "sort": {
    "title": "排序方式",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "如果您收到訂單，請單擊確認按鈕。如果需要，如果您收到確認，您將能夠提交推薦。",
      "Recipient": "接受者",
      "bill": "發票",
      "name": "姓名",
      "tel": "電話",
  ...
  "return_request": {
    ...
    "note_input_message": "如有需要，請說明退回此商品的原因。",
    "media_message": "您可以在這裡上傳產品的圖片、音頻或視頻，以獲得更好的產品狀態信息支持。選擇文件將自動發送並確認。",
    "video": "視頻",
    "voice": "嗓音",
    "add_action": "發送退貨請求",
  ...
  "basket_items": {
    ...
    "offer": "以 {percent}% 折扣購買 {count}x 件商品",
  ...
  "product_rating_view": {
    "message": "尊敬的 {user}，您已購買此產品。你覺得這個產品怎麼樣？",
    "notification": {
      "title": "祝賀",
      "message": "您的評論已被記錄。"
    }
  ...
  "contact_us_form": {
    ...
    "submitted_message": "感謝您抽空與我們聯繫。您的訊息已收到，我們的團隊目前正在審核。我們將盡快回复，感謝您在此期間的耐心等待。您的興趣和回饋對我們很重要，我們致力於為您提供最好的支援。"
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "您的訂單已成功添加。現在您可以通過直接匯款支付，然後在訂單頁面上傳付款收據。",
      "pay_title": "支付",
  ...
  "avocado": {
    "not_enable": "鱷梨表格未啟用！",
    "last_update": "最後更新：",
    "step1": "1. 輸入您要訂購的產品名稱和詳細信息，然後單擊添加按鈕。",
    "title_plc": "輸入產品名稱。",
    ...
    "step2": "2. 添加所有需要的項目後，單擊訂單審核請求按鈕。在此階段，我們將審核訂單並告知您價格。通過單擊此鏈接，您將能夠看到價格和付款鏈接。",
    "order_action": "訂單登記",
    "show_all": "顯示所有",
    ...
    "add_new_order": "下新訂單",
    "pay_online": "在線支付",
    "pricing_not_completed_message": "您的訂單正在審核中。您的訂單將很快得到審核和定價，您將能夠支付訂單。",
    "delete_item_dialog": {
      "title": "從購物車中刪除商品",
    ...
    "select_address_message": "請輸入您的地址，然後您就可以提交訂單了。"
  },
  "hyper": {
    "title": "訂單創建",
    "message": "通過掃描產品代碼創建您要購買的產品列表。",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ 您已經上傳收據圖片，等待我們的批准。如果需要更改，可以將之前的圖像替換為新圖像。",
  ...
  "check_access": {
    ...
    "no_access_message": "很遺憾，您無權訪問我們的商店。<br/>請聯繫我們。"
  },
  "share_order": {
    "action": "分享訂單",
    "title": "與他人共享此訂單。",
    "message": "這是一個安全鏈接，只與您認識的人分享。擁有此鏈接的每個人都可以復制您的訂單並查看所選地址。它將包含有關您當前購物車的信息。",
