export default {
  ...
  "footer": {
    ...
    "phone": "Foonu",
    "address": "Adirẹsi",
    "copyright": "Lilo akoonu nikan fun awọn idi ti kii ṣe ti owo ati pẹlu itọkasi orisun (ọna asopọ pẹlu {shop_title}). Gbogbo ẹtọ wa ni ipamọ si {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ìfilọlẹ yii nilo iraye si alaye akọọlẹ ile itaja rẹ. Eyi pẹlu iraye si orukọ, nọmba olubasọrọ, adirẹsi, imeeli, itan ibere, pipaṣẹ ati fifiranṣẹ awọn asọye lori ile itaja yii.",
      "message_bold": "Rii daju lati lo ohun elo itaja itaja lati tẹ ile itaja yii sii."
    }
  },
  "sort": {
    "title": "Sa pelu",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Tẹ bọtini idaniloju ti o ba gba aṣẹ naa. Ti o ba nilo, iwọ yoo ni anfani lati fi ifọrọranṣẹ silẹ ti o ba gba ijẹrisi.",
      "Recipient": "olugba",
      "bill": "risiti",
      "name": "Oruko",
      "tel": "Foonu",
  ...
  "return_request": {
    ...
    "note_input_message": "Ṣe apejuwe idi fun ipadabọ nkan yii ti o ba nilo.",
    "media_message": "O le gbe aworan, ohun afetigbọ tabi fidio ọja si ibi lati gba atilẹyin to dara julọ fun alaye ipo ọja. Yiyan faili yoo firanṣẹ laifọwọyi ati jẹrisi.",
    "video": "Fidio",
    "voice": "Ohùn",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Yiyọkuro si ile itaja yii kii yoo pa alaye aṣẹ rẹ ati awọn igbasilẹ rẹ rẹ.",
      "action": "Fi silẹ"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "customer_club": "Onibara Club Egbe",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      "title": "Fi ebun Kaadi",
      "message": "Tẹ nọmba kaadi sii ati koodu aabo. Kaadi ebun kan yoo wa ni afikun si akọọlẹ rẹ.",
  ...
  "product_rating_view": {
    "message": "Eyin {user}, o ti ra ọja yi. Kini o ro nipa ọja yii?",
    "notification": {
      "title": "Oriire",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "A dupẹ lọwọ akoko rẹ lati kan si wa. Ifiranṣẹ rẹ ti gba ati pe ẹgbẹ wa n ṣe atunyẹwo lọwọlọwọ. A yoo dahun ni kete bi o ti ṣee, ati pe a dupẹ lọwọ rẹ fun sũru rẹ ni akoko yii. Ifẹ rẹ ati esi ṣe pataki si wa, ati pe a pinnu lati pese atilẹyin ti o dara julọ ti o ṣeeṣe."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "A ti fi aṣẹ rẹ kun ni aṣeyọri. Bayi o le sanwo nipasẹ gbigbe owo taara ati lẹhinna gbe iwe-ẹri isanwo sori oju-iwe aṣẹ.",
      "pay_title": "Isanwo",
  ...
  "avocado": {
    ...
    "step1": "1. Tẹ orukọ sii ati awọn alaye ọja ti o fẹ paṣẹ ki o tẹ bọtini Fikun-un.",
    ...
    "step2": "2. Lẹhin fifi gbogbo awọn ti o fẹ awọn ohun kan, tẹ lori awọn ibere awotẹlẹ ìbéèrè bọtini. Ni ipele yii, a yoo ṣe atunyẹwo aṣẹ naa ki o jẹ ki o mọ nipa idiyele naa. Nipa tite lori ọna asopọ yii, iwọ yoo ni anfani lati wo idiyele ati ọna asopọ isanwo.",
    ...
    "pay_online": "San online",
    "pricing_not_completed_message": "Ibere re ti wa ni atunwo. Ilana rẹ yoo jẹ atunyẹwo ati idiyele laipẹ ati pe iwọ yoo ni anfani lati san aṣẹ naa.",
    "delete_item_dialog": {
  ...
  "hyper": {
    "title": "Bere fun ẹda",
    "message": "Ṣẹda atokọ ti awọn ọja ti o fẹ ra nipa yiwo koodu ọja naa.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ O ti gbe aworan gbigba silẹ tẹlẹ, duro fun ifọwọsi wa. Ti o ba nilo lati yipada, o le rọpo aworan ti tẹlẹ pẹlu ọkan tuntun.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Ṣiṣe alabapin",
      "message": "O le yan akoko ṣiṣe alabapin nipa rira iṣẹ yii lojoojumọ. Jẹ ki oluraja mọ ti o ba fẹ yi awọn iye aiyipada ti o ti tẹ tẹlẹ pada.",
