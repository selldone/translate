export default {
  ...
  "footer": {
    ...
    "phone": "Simu",
    "address": "Anwani",
    "copyright": "Matumizi ya maudhui kwa madhumuni yasiyo ya kibiashara pekee na kwa kurejelea chanzo (kiungo na {shop_title}). Haki zote zimehifadhiwa kwa {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Programu hii inahitaji ufikiaji wa maelezo ya akaunti yako ya duka. Hii inajumuisha ufikiaji wa jina, nambari ya mawasiliano, anwani, barua pepe, historia ya agizo, kuagiza na kuchapisha maoni kwenye duka hili.",
      "message_bold": "Hakikisha unatumia programu rasmi ya duka kuingia kwenye duka hili."
    }
  },
  "sort": {
    "title": "Panga kwa",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Bonyeza kitufe cha uthibitisho ikiwa umepokea agizo. Ikihitajika, utaweza kuwasilisha rufaa ukipokea uthibitisho.",
      "Recipient": "Mpokeaji",
      "bill": "ankara",
      "name": "Jina",
      "tel": "Simu",
  ...
  "return_request": {
    ...
    "note_input_message": "Eleza sababu ya kurejesha bidhaa hii ikiwa inahitajika.",
    "media_message": "Unaweza kupakia picha, sauti au video ya bidhaa hapa ili kupata usaidizi bora kwa maelezo ya hali ya bidhaa. Kuchagua faili itatuma na kuthibitisha kiotomatiki.",
    "video": "Video",
    "voice": "Sauti",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Ondoka dukani",
      "message": "Kujiondoa kwenye duka hili hakutafuta maelezo na rekodi za agizo lako.",
      "action": "Ondoka"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Weka nambari ya kadi na msimbo wa usalama. Kadi ya zawadi itaongezwa kwenye akaunti yako.",
  ...
  "product_rating_view": {
    "message": "Mpendwa {user}, Umenunua bidhaa hii. Una maoni gani kuhusu bidhaa hii?",
    "notification": {
      "title": "Hongera",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Tunashukuru kwa muda wako wa kuwasiliana nasi. Ujumbe wako umepokelewa na timu yetu inaukagua kwa sasa. Tutajibu haraka iwezekanavyo, na tunakushukuru kwa uvumilivu wako wakati huu. Nia yako na maoni ni muhimu kwetu, na tumejitolea kukupa usaidizi bora zaidi."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Agizo lako limeongezwa. Sasa unaweza kulipa kwa uhamishaji wa pesa moja kwa moja na kisha upakie risiti ya malipo kwenye ukurasa wa agizo.",
      "pay_title": "Malipo",
  ...
  "avocado": {
    ...
    "step1": "1. Weka jina na maelezo ya bidhaa unayotaka kuagiza na ubofye kitufe cha Ongeza.",
    ...
    "step2": "2. Baada ya kuongeza vitu vyote vinavyohitajika, bofya kwenye kifungo cha ombi la ukaguzi wa utaratibu. Katika hatua hii, tutapitia agizo na kukufahamisha kuhusu bei. Kwa kubofya kiungo hiki, utaweza kuona kiungo cha bei na malipo.",
    ...
    "pricing_not_completed_message": "Agizo lako linakaguliwa. Agizo lako litakaguliwa na kuwekewa bei hivi karibuni na utaweza kulipa agizo hilo.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Unda orodha ya bidhaa unazotaka kununua kwa kuchanganua msimbo wa bidhaa.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Tayari umepakia picha ya risiti, subiri idhini yetu. Ikiwa unahitaji kubadilisha, unaweza kubadilisha picha ya awali na mpya.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Usajili",
      "message": "Unaweza kuchagua kipindi cha usajili kwa kununua huduma hii kila siku. Mjulishe mnunuzi ikiwa ungependa kubadilisha thamani chaguomsingi ambazo tayari umeweka.",
