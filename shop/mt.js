export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Indirizz",
    "copyright": "L-użu tal-kontenut għal skopijiet mhux kummerċjali biss u b'referenza għas-sors (link ma' {shop_title}). Id-drittijiet kollha riżervati għal {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      "title": "Applikazzjoni Login",
      "message": "Din l-app teħtieġ aċċess għall-informazzjoni tal-kont tal-maħżen tiegħek. Dan jinkludi aċċess għall-isem, in-numru tal-kuntatt, l-indirizz, l-email, l-istorja tal-ordnijiet, l-ordnijiet u l-istazzjonar ta’ kummenti fuq dan il-maħżen.",
      "message_bold": "Kun żgur li tuża l-app tal-maħżen uffiċjali biex tidħol f'dan il-maħżen."
    }
  },
  "sort": {
    "title": "Irranġa skond",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Ikklikkja l-buttuna ta 'konferma jekk irċevejt l-ordni. Jekk meħtieġ, tkun tista' tissottometti referenza jekk tirċievi konferma.",
      "Recipient": "Riċevitur",
      "bill": "Fattura",
      "name": "Isem",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Iddeskrivi r-raġuni għar-ritorn ta 'dan l-oġġett jekk meħtieġ.",
    "media_message": "Tista 'ttella' immaġni, awdjo jew vidjo tal-prodott hawn biex tikseb appoġġ aħjar għall-informazzjoni dwar l-istatus tal-prodott. L-għażla tal-fajl se tibgħat u tikkonferma awtomatikament.",
    "video": "Video",
    "voice": "Leħen",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Ħalli l-ħanut",
      "message": "Jekk tneħħi l-abbonament għal dan il-maħżen mhux se tħassar l-informazzjoni u r-rekords tal-ordni tiegħek.",
      "action": "Ħalli"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      "title": "Żid Gift Card",
      "message": "Daħħal in-numru tal-karta u l-kodiċi tas-sigurtà. Se tiġi miżjuda karta rigal mal-kont tiegħek.",
  ...
  "product_rating_view": {
    "message": "Għażiż {user}, Int xtrajt dan il-prodott. X'taħseb dwar dan il-prodott?",
    "notification": {
      "title": "Prosit",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "L-ordni tiegħek ġiet miżjuda b'suċċess. Issa tista 'tħallas permezz ta' trasferiment ta 'flus dirett u mbagħad ittella' l-irċevuta tal-ħlas fuq il-paġna tal-ordni.",
      "pay_title": "Ħlas",
  ...
  "avocado": {
    ...
    "step1": "1. Daħħal l-isem u d-dettalji tal-prodott li trid tordna u kklikkja l-buttuna Żid.",
    ...
    "step2": "2. Wara li żżid l-oġġetti kollha mixtieqa, ikklikkja fuq il-buttuna tat-talba għal reviżjoni tal-ordni. F'dan l-istadju, aħna se nirrevedu l-ordni u tavżak dwar il-prezz. Billi tikklikkja fuq din il-link, tkun tista' tara l-prezz u l-link tal-ħlas.",
    ...
    "pricing_not_completed_message": "L-ordni tiegħek qed tiġi riveduta. L-ordni tiegħek ser tiġi riveduta u pprezzata dalwaqt u tkun tista' tħallas l-ordni.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Oħloq il-lista tal-prodotti li trid tixtri billi tiskennja l-kodiċi tal-prodott.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Diġà tellajt l-immaġni tal-irċevuta, stenna l-approvazzjoni tagħna. Jekk għandek bżonn tibdel, tista 'tissostitwixxi l-immaġni preċedenti b'waħda ġdida.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Abbonament",
      "message": "Tista' tagħżel il-perjodu ta' abbonament billi tixtri dan is-servizz kuljum. Ħalli lix-xerrej jekk tridx tibdel il-valuri awtomatiċi li diġà daħħalt.",
