export default {
  ...
  "footer": {
    ...
    "phone": "Téléphoner",
    "address": "Adresse",
    "copyright": "L'utilisation du contenu uniquement à des fins non commerciales et avec référence à la source (lien avec {shop_title}). Tous droits réservés à {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Cette application nécessite l'accès aux informations de votre compte de magasin. Cela inclut l'accès au nom, au numéro de téléphone, à l'adresse, à l'e-mail, à l'historique des commandes, à la commande et à la publication de commentaires sur ce magasin.",
      "message_bold": "Assurez-vous d'utiliser l'application officielle de la boutique pour entrer dans cette boutique."
    }
  },
  "sort": {
    "title": "Trier par",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Cliquez sur le bouton de confirmation si vous avez reçu la commande. Si nécessaire, vous pourrez soumettre une référence si vous recevez une confirmation.",
  ...
  "return_request": {
    ...
    "note_input_message": "Décrivez la raison du retour de cet article si nécessaire.",
    "media_message": "Vous pouvez télécharger une image, un son ou une vidéo du produit ici pour obtenir une meilleure prise en charge des informations sur l'état du produit. La sélection du fichier sera automatiquement envoyée et confirmée.",
    "video": "Vidéo",
    "voice": "Voix",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "La désinscription à cette boutique ne supprimera pas les informations et les enregistrements de votre commande.",
      "action": "Quitter"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "select_location_error": "Trouvez le lieu de réception de l'envoi sur la carte et cliquez sur l'indicateur au milieu de la carte pour déterminer l'adresse exacte du destinataire.",
    "same_billing_address_desc": "L'adresse de facturation est la même que l'adresse de livraison.",
    "custom_billing_info_desc": "Vous pouvez entrer votre numéro de taxe et définir une adresse différente pour la facturation.",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Entrez le numéro de carte et le code de sécurité. Une carte-cadeau sera ajoutée à votre compte.",
  ...
  "product_rating_view": {
    "message": "Cher {utilisateur}, Vous avez acheté ce produit. Que pensez-vous de ce produit?",
    "notification": {
      "title": "Félicitation",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Votre commande a été ajoutée avec succès. Vous pouvez maintenant payer par virement direct, puis télécharger le reçu de paiement sur la page de commande.",
      "pay_title": "Paiement",
  ...
  "avocado": {
    ...
    "step1": "1. Entrez le nom et les détails du produit que vous souhaitez commander et cliquez sur le bouton Ajouter.",
    ...
    "step2": "2. Après avoir ajouté tous les articles souhaités, cliquez sur le bouton de demande de révision de la commande. À ce stade, nous examinerons la commande et vous informerons du prix. En cliquant sur ce lien, vous pourrez voir le prix et le lien de paiement.",
    ...
    "pricing_not_completed_message": "Votre commande est en cours d'examen. Votre commande sera examinée et tarifée bientôt et vous pourrez payer la commande.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Créez la liste des produits que vous souhaitez acheter en scannant le code du produit.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Vous avez déjà téléchargé l'image du reçu, attendez notre approbation. Si vous avez besoin de changer, vous pouvez remplacer l'image précédente par une nouvelle.",
  ...
  "rating": {
    "product_rating_message": "Ce produit a reçu une note de {rate} sur 5 étoiles et évalué par {rate_count} personnes."
  },
  "related_products": {
    "card": {
      "title": "Explorer!",
