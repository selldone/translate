export default {
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Fai clic sul pulsante di conferma se hai ricevuto l'ordine. Se necessario, sarai in grado di inviare un referral se ricevi una conferma.",
  ...
  "basket_page": {
    ...
    "same_billing_address_desc": "L'indirizzo di fatturazione è lo stesso dell'indirizzo di spedizione.",
    "custom_billing_info_desc": "Puoi inserire il tuo codice fiscale e impostare un indirizzo diverso per la fatturazione.",
  ...
  "avocado": {
    ...
    "step2": "2. Dopo aver aggiunto tutti gli articoli desiderati, fare clic sul pulsante di richiesta di revisione dell'ordine. A questo punto, esamineremo l'ordine e ti faremo sapere il prezzo. Cliccando su questo link, potrai vedere il link del prezzo e del pagamento.",
    ...
    "pricing_not_completed_message": "Il tuo ordine è in fase di revisione. Il tuo ordine verrà esaminato e valutato a breve e sarai in grado di pagare l'ordine.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Crea l'elenco dei prodotti che desideri acquistare scansionando il codice prodotto.",
  ...
  "service_bill": {
    ...
    "booking": {
      ...
      "selected_checkout": "Check-out selezionato dal cliente",
  ...
  "rating": {
    "product_rating_message": "Questo prodotto ha ricevuto una valutazione di {rate} stelle su 5 ed è stato valutato da {rate_count} persone."
  },
  "related_products": {
    "card": {
      "title": "Esplorare!",
