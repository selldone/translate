export default {
  ...
  "footer": {
    ...
    "phone": "Tillefoan",
    "address": "Adres",
    "copyright": "It gebrûk fan ynhâld allinich foar net-kommersjele doelen en mei ferwizing nei de boarne (keppeling mei {shop_title}). Alle rjochten foarbehâlden oan {shop_title}.",
    ...
    "dialog_setting": {
      "title": "Winkel Applications Setting",
      "app_list": "List fan applikaasjes"
    }
  },
  "product_card": {
    "sold_out": "Útferkocht",
  ...
  "shop": {
    ...
    "native": {
      "title": "Applikaasje Login",
      "message": "Dizze app fereasket tagong ta jo winkelkontoynformaasje. Dit omfettet tagong ta namme, kontaktnûmer, adres, e-post, bestelskiednis, bestelle en pleatse opmerkings op dizze winkel.",
      "message_bold": "Wês wis dat jo de offisjele winkel-app brûke om dizze winkel yn te gean."
    }
  },
  "sort": {
    "title": "Sortearje op",
  ...
  "buy_button": {
    ...
    "count_unit": "x",
    "remove": "Weinimme",
    "add_to_basket": "Taheakje oan cart",
    "buy": "Keapje",
    "notifications": {
  ...
  "layout_shop": {
    "shop_menu": {
      "orders_history": "Orders Skiednis",
      "profile": "Myn profyl",
    ...
    "login_to_shop": "Oanmelde by Store",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_action": "Befêstigje Product Receipt",
      "confirm_received_info": "Klikje op de befêstigingsknop as jo de bestelling hawwe ûntfongen. As it nedich is, kinne jo in ferwizing yntsjinje as jo befêstiging krije.",
      "Recipient": "Ûntfanger",
      "bill": "Invoice",
      "name": "Namme",
      "tel": "Tillefoan",
  ...
  "return_request": {
    "title": "Weromkomme",
    "count_input": "Oantal werom items",
    "count_input_message": "Hoefolle items jouwe jo werom?",
    "reason_input": "Reden foar werom",
    "reason_input_message": "Selektearje de reden foar it werombringen fan dit item.",
    "note_input": "Beskriuwing",
    "note_input_hint": "Beskriuw de reden foar it weromkommen ..",
    "note_input_message": "Beskriuw de reden foar it werombringen fan dit item as it nedich is.",
    "media_message": "Jo kinne hjir ôfbylding, audio of fideo fan it produkt uploade om bettere stipe te krijen foar ynformaasje oer produktstatus. It selektearjen fan it bestân sil automatysk ferstjoere en befêstigje.",
    "video": "Video",
    "voice": "Lûd",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "It útskriuwen fan dizze winkel sil jo bestellingynformaasje en records net wiskje.",
      "action": "Ferlitte"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "select_location_error": "Fyn it plak fan ûntfangst fan 'e ferstjoering op' e kaart en klikje op de yndikator yn 'e midden fan' e kaart om it krekte adres fan 'e ûntfanger te bepalen.",
    "same_billing_address_desc": "It faktueradres is itselde as it ferstjoeradres.",
    "custom_billing_info_desc": "Jo kinne jo BELASTINGnûmer ynfiere en in oar adres ynstelle foar fakturearring.",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      "title": "Add Gift Card",
      "message": "Fier it kaartnûmer en feiligenskoade yn. In kadokaart wurdt tafoege oan jo akkount.",
      ...
      "add_action": "Card Registraasje"
    }
  },
  "product_comparison": {
    "title": "Ferlykje Product",
  ...
  "product_filter_menu": {
    ...
    "brands": "Merk",
    "main_shop_page": "Store haadside",
    "home": "Thús"
  },
  "product_rating_view": {
    "message": "Beste {user}, Jo hawwe dit produkt kocht. Wat tinke jo oer dit produkt?",
    "notification": {
      "title": "Lokwinske",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Jo bestelling is mei súkses tafoege. No kinne jo betelje troch direkte jild oerdracht en dan uploade de betelling ûntfangst op 'e oarder side.",
      "pay_title": "Betelling",
  ...
  "avocado": {
    ...
    "step1": "1. Fier de namme en details fan it produkt yn dat jo bestelle wolle en klikje op de knop taheakje.",
    ...
    "add_item": "Add item",
    "items_list": "List fan oanfrege produkten",
    "currency_msg": "Jo moatte it bedrach fan dizze bestelling betelje mei dizze munt.",
    "step2": "2. Nei it tafoegjen fan alle winske items, klikje jo op 'e knop foar beoardielingsfersyk. Op dit stadium sille wy de bestelling besjen en jo witte oer de priis. Troch op dizze keppeling te klikken, kinne jo de priis en betellingslink sjen.",
    "order_action": "Order registraasje",
    "show_all": "Lit alles sjen",
    "show_accepted": "Lit befêstige items sjen",
    "last_orders": "List fan jo resinte oarders",
    "pending_status": "ûnder beoardieling",
    "check_now": "Kontrolearje oarder",
    "add_new_order": "Meitsje nije oarder",
    "pay_online": "Betelje online",
    "pricing_not_completed_message": "Jo bestelling wurdt hifke. Jo bestelling sil gau wurde hifke en priis en jo kinne de bestelling betelje.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Meitsje de list mei produkten dy't jo wolle keapje troch de produktkoade te scannen.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Jo hawwe de ûntfangstôfbylding al opladen, wachtsje op ús goedkarring. As jo wizigje moatte, kinne jo de foarige ôfbylding ferfange troch in nije.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Ynskriuwing",
      "message": "Jo kinne de abonnemintsperioade kieze troch dizze tsjinst op deistige basis te keapjen. Lit de keaper witte as jo de standertwearden wolle feroarje dy't jo al ynfierd hawwe.",
  ...
  "rating": {
    "product_rating_message": "Dit produkt hat in wurdearring krigen fan {rate} fan de 5 stjerren en wurdearre troch {rate_count} minsken."
  },
  "related_products": {
    "card": {
      "title": "Ferkenne!",
      "same_tags_subtitle": "Fyn mear opmerklike relatearre items.",
      "same_category_subtitle": "Fyn mear opmerklike items yn dizze kategory."
    }
  }
};