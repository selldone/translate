export default {
  ...
  "footer": {
    ...
    "phone": "Mohala",
    "address": "Aterese",
    "copyright": "Ts'ebeliso ea litaba molemong oa seo e seng sa khoebo feela le mohloling (link with {shop_title}). Litokelo tsohle li boloketsoe {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      "title": "Keno ea Kopo",
      "message": "Sesebelisoa sena se hloka ho fihlella lintlha tsa akhaonto ea hau ea lebenkele. Sena se kenyelletsa ho fumana lebitso, nomoro ea mohala, aterese, lengolo-tsoibila, nalane ea odara, ho odara le ho beha maikutlo lebenkeleng lena.",
      "message_bold": "Netefatsa hore o sebelisa sesebelisoa sa semmuso sa lebenkele ho kena lebenkeleng lena."
    }
  },
  "sort": {
    "title": "Hlophisa ka",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_action": "Netefatsa Receipt ea Sehlahisoa",
      "confirm_received_info": "Tobetsa konopo ea tiiso haeba u fumane taelo. Haeba ho hlokahala, o tla khona ho fana ka lengolo-tsoibila haeba o fumana netefatso.",
      "Recipient": "Moamohedi",
      "bill": "Invoice",
      "name": "Lebitso",
      "tel": "Mohala",
    ...
    "basket_items": {
      "original_warranty": "Guarantee ea tšimoloho ea thepa",
      "return": "Kgutla",
      "table": {
  ...
  "return_request": {
    ...
    "note_input_message": "Hlalosa lebaka la ho khutlisa ntho ena haeba ho hlokahala.",
    "media_message": "U ka kenya setšoantšo, molumo kapa video ea sehlahisoa mona ho fumana tšehetso e betere bakeng sa tlhaiso-leseling ea boemo ba sehlahisoa. Ho khetha faele ho tla romella le ho netefatsa ka bo eona.",
    "video": "Video",
    "voice": "Lentsoe",
  ...
  "virtual_order_page": {
    "title": "Taelo",
    "info": {
      "title": "Sehlahisoa se Rekiloeng sa Virtual"
    }
  },
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Ho tlohela ho ingolisa lebenkeleng lena ho ke ke ha hlakola lintlha tsa odara le lirekoto.",
      "action": "Tloha"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "customer_club": "Setho sa Client Club",
    ...
    "support_cod": "Chelete ka Delivery",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Kenya nomoro ea karete le khoutu ea ts'ireletso. Karete ea limpho e tla kenngoa akhaonteng ea hau.",
  ...
  "product_rating_view": {
    "message": "Ratehang {user}, U rekile sehlahisoa sena. U nahana'ng ka sehlahisoa see?",
    "notification": {
      "title": "Bokang",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Re ananela nako ea hau ea ho iteanya le rona. Molaetsa oa hau o amohetsoe 'me sehlopha sa rona se ntse se o hlahloba. Re tla arabela kapele kamoo ho ka khonehang, 'me re leboha mamello ea hau nakong ena. Thahasello ea hau le maikutlo a hau ke tsa bohlokoa ho rona, 'me re ikemiselitse ho u fa tšehetso e molemo ka ho fetisisa."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Odara ea hau e kentsoe ka katleho. Hona joale o ka lefa ka ho fetisetsa chelete ka kotloloho ebe o kenya rasiti ea tefo leqepheng la odara.",
      "pay_title": "Tefo",
  ...
  "avocado": {
    ...
    "step1": "1. Kenya lebitso le lintlha tsa sehlahisoa seo u batlang ho se reka ebe u tobetsa konopo ea Add.",
    ...
    "step2": "2. Kamora ho kenyelletsa lintho tsohle tse lakatsehang, tobetsa konopo ea kopo ea tlhahlobo ea odara. Mothating ona, re tla hlahloba odara mme re u tsebise ka theko. Ka ho tobetsa sehokelo sena, u tla khona ho bona sehokelo sa theko le tefo.",
    ...
    "pricing_not_completed_message": "Odara ea hau e ntse e hlahlojoa. Odara ea hau e tla hlahlojoa le ho rekoa theko haufinyane 'me u tla khona ho lefa odara.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Etsa lethathamo la lihlahisoa tseo u batlang ho li reka ka ho hlahloba khoutu ea sehlahisoa.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ U se u kentse setšoantšo sa rasiti, emela tumello ea rona. Haeba o hloka ho fetola, o ka nkela setšoantšo se fetileng sebaka ka se secha.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Ngoliso",
      "message": "U ka khetha nako ea ho ngolisa ka ho reka tšebeletso ena letsatsi le leng le le leng. Tsebisa moreki haeba o batla ho fetola boleng ba kamehla boo o seng o bo kentse.",
