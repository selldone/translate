export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Adres",
    "copyright": "İçeriğin yalnızca ticari olmayan amaçlarla ve kaynağa atıfta bulunularak kullanılması ({shop_title} ile bağlantı). Tüm hakları {shop_title}'a aittir.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Bu uygulama, mağaza hesabı bilgilerinize erişim gerektirir. Buna ad, iletişim numarası, adres, e-posta, sipariş geçmişi, sipariş verme ve bu mağazada yorum gönderme erişimi dahildir.",
      "message_bold": "Bu mağazaya girmek için resmi mağaza uygulamasını kullandığınızdan emin olun."
    }
  },
  "sort": {
    "title": "Göre sırala",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Siparişi aldıysanız onay düğmesine tıklayın. Gerekirse, onay alırsanız bir tavsiye gönderebileceksiniz.",
      "Recipient": "alıcı",
      "bill": "Fatura",
      "name": "İsim",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Gerekirse bu öğeyi iade etme nedenini açıklayın.",
    "media_message": "Ürün durumu bilgileri için daha iyi destek almak için ürünün görselini, sesini veya videosunu buraya yükleyebilirsiniz. Dosyayı seçmek otomatik olarak gönderecek ve onaylayacaktır.",
    "video": "Video",
    "voice": "Ses",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Bu mağazaya abone olmak, sipariş bilgilerinizi ve kayıtlarınızı silmez.",
      "action": "Terk etmek"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Kart numarasını ve güvenlik kodunu girin. Hesabınıza bir hediye kartı eklenecektir.",
  ...
  "product_rating_view": {
    "message": "Sayın {user}, Bu ürünü satın aldınız. Bu ürün hakkında ne düşünüyorsunuz?",
    "notification": {
      "title": "tebrikler",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Siparişiniz başarıyla eklendi. Artık doğrudan para transferi ile ödeme yapabilir ve ardından ödeme makbuzunu sipariş sayfasına yükleyebilirsiniz.",
      "pay_title": "Ödeme",
  ...
  "avocado": {
    ...
    "step1": "1. Sipariş etmek istediğiniz ürünün adını ve detaylarını girin ve Ekle düğmesine tıklayın.",
    ...
    "step2": "2. İstenen tüm öğeleri ekledikten sonra, sipariş inceleme isteği düğmesine tıklayın. Bu aşamada siparişi inceleyip size fiyat hakkında bilgi vereceğiz. Bu linke tıklayarak fiyat ve ödeme linkini görebileceksiniz.",
    ...
    "pricing_not_completed_message": "Siparişiniz inceleniyor. Siparişiniz yakında incelenip fiyatlandırılacak ve siparişi ödeyebileceksiniz.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Ürün kodunu okutarak satın almak istediğiniz ürünlerin listesini oluşturun.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Fiş resmini zaten yüklediniz, onayımızı bekleyin. Değiştirmeniz gerekiyorsa, önceki resmi yenisiyle değiştirebilirsiniz.",
  ...
  "service_bill": {
    ...
    "booking": {
      ...
      "selected_checkin": "Müşteri tarafından seçilen check-in",
      "selected_checkout": "Müşteri tarafından seçilen check-out",
