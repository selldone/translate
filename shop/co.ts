export default {
  ...
  "footer": {
    ...
    "phone": "telefonu",
    "address": "Indirizzu",
    "copyright": "L'usu di u cuntenutu solu per scopi micca cummerciale è cun riferimentu à a fonte (ligame cù {shop_title}). Tutti i diritti riservati à {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Questa app richiede l'accessu à l'infurmazioni di u vostru contu di a tenda. Questu include l'accessu à u nome, u numeru di cuntattu, l'indirizzu, l'email, a storia di l'ordine, l'ordine è a publicazione di cumenti nantu à sta tenda.",
      "message_bold": "Assicuratevi di utilizà l'app ufficiale di a tenda per entra in questa tenda."
    }
  },
  "sort": {
    "title": "Ordine per",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Cliccate u buttone di cunferma s'ellu avete ricevutu l'ordine. Se necessariu, puderà mandà un riferimentu se ricevi cunferma.",
  ...
  "return_request": {
    ...
    "note_input_message": "Descrivite u mutivu di rinvià stu articulu se necessariu.",
    "media_message": "Pudete carricà l'imaghjini, l'audio o u video di u pruduttu quì per uttene un supportu megliu per l'infurmazioni di u statutu di u produttu. Selezziunà u schedariu hà da mandà automaticamente è cunfirmà.",
    "video": "Video",
    "voice": "Voce",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "L'annullamentu di l'abbonamentu à sta tenda ùn sguasserà micca l'infurmazioni è i registri di l'ordine.",
      "action": "Lasciate"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Inserite u numeru di carta è u codice di sicurità. Una carta rigalu serà aghjuntu à u vostru contu.",
  ...
  "product_rating_view": {
    "message": "Caru {user}, Avete acquistatu stu pruduttu. Chì ne pensate di stu pruduttu?",
    "notification": {
      "title": "Felicitazione",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "U vostru ordine hè statu aghjuntu cù successu. Avà pudete pagà per trasferimentu di soldi direttu è poi caricate a ricevuta di pagamentu in a pagina di l'ordine.",
      "pay_title": "Pagamentu",
  ...
  "avocado": {
    ...
    "step1": "1. Inserite u nome è i ditaglii di u pruduttu chì vulete ordene è cliccate nantu à u buttone Aggiungi.",
    ...
    "step2": "2. Dopu à aghjunghje tutti l 'articuli bramatu, cliccate nant'à u buttone dumanda di rivista ordine. À questu stadiu, avemu da riviseghjà l'ordine è vi farà sapè di u prezzu. Cliccà nant'à stu ligame, vi sarà capaci di vede u ligame prezzu è pagamentu.",
    ...
    "pricing_not_completed_message": "U vostru ordine hè in rivisione. U vostru ordine serà rivisatu è prezzu prestu è puderete pagà l'ordine.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Crea a lista di i prudutti chì vulete cumprà scannendu u codice di u produttu.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Avete digià caricatu l'imaghjini di a ricevuta, aspettate a nostra appruvazioni. Sè avete bisognu di cambià, pudete rimpiazzà l'imaghjina precedente cù una nova.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Abbonamentu",
      "message": "Pudete sceglie u periodu di abbunamentu per cumprà stu serviziu ogni ghjornu. Fate sapè à u cumpratore se vulete cambià i valori predeterminati chì avete digià inseritu.",
