...
export default {
  ...
  surveys: ["Assai male", "Male", "Normale", "Bene", "Eccellente"],
  ...
  shop: {
    ...
    native: {
      title: "Accessu à l'applicazione",
      message:
  ...
  sort: {
    ...
    nothing: "Nunda",
    most_views: "I più visti",
    most_likes: "I più populari",
    most_recent: "I più novi",
  ...
  product_info: {
    ...
    compare_add: "Aghjunghje à u paragone",
    compare_be_in_list: "In a lista di paragone",

    type: "Tipu",
    brand: "Marca",
    category: "Categoria",
    discount: "Scontu",
    track_price: "Seguità u prezzu",
    waiting_for_auction: "Aspettate l'asta ?",
    inform_auction: "Parlami di l'asta",
    return_in_days: "{days} ghjorni di garanzia di ritornu",
    support24h7: "Supportu 24 ore 7 ghjorni",
    support_normal: "Supportu per l'ore di travagliu",
    original_guarantee: "Garanzia originale",
    cod_payment: "Pagamentu à a consegna supportatu",
    ...
    offer_message: "Cumprate {min_quantity} è ottenite {percent}% di scontu nantu à questi articuli",
    up_to: "Finu à {per_order}x per ordine",
    get_free: "OTTENITE GRATIS",
    get_off: "OTTENITE {percent}% DI SCONTU",
  ...
  buy_button: {
    ...
    count_unit: "x",
    remove: "Elimina",
    add_to_basket: "Aghjunghje à u carrettu",
    buy: "Cumprà",
  ...
  basket_top_menu: {
    ...
    more: "Più...",
    accept_and_pay: "Finalizà l'ordine",
    items: "Articulu/i",
  },
  ...
  order_page: {
    ...
    payment: {
      ...
      delivery_fee_after: "Nisuna spesa di consegna pagata",

      total_price: "U prezzu tutale di l'articuli",
      total_items_discount: "Scontu nantu à l'articuli",
      total_price_after_offers: "Totale dopu l'applicazione di l'offerte",
      total_order_price_before_tax: "Prezzu tutale senza imposte",

      buyer_payment: "Quantità pagata da u cumpratore",
    ...
    delivery: {
      title: "Consegna",
      subtitle: "Infurmazione di u cumpratore",
      ...
      unit_no: "Numeru d'unità",
      postal_code: "Codice postale",
      description: "Descrizzione",
      order_delivered: "L'ordine hè statu consegnatu.",
      delivery_time: "Tempu di consegna",
      tracking_code: "Codice di seguimentu",
  ...
  return_request: {
    ...
    count_input_message: "Quanti articuli vulete riturnà?",
  ...
  user_profile: {
    ...
    leave_shop: "Lascià stu magazinu è sguassà tutti i livelli di cliente",
  ...
  basket_page: {
    ...
    customer_club: "Membru di u club clienti",
    customer_club_discount: "Scontu per i membri",
  ...
  basket_items: {
    items_unit: "x",
    lead_unit: "Ora",
    count_input: "Quantità",

    price_changed: "U prezzu hè cambiatu. Novu prezzu:",
    offer: "Ottenite {count}x articulu cù {percent}% di scontu",
    offer_free: "Ricevi {count}x gratisi",
  },
  ...
  user_gift_cards: {
    ...
    add_card_dialog: {
      ...
      info: "Nota: quandu cumprate da a tenda, vi sarà mostrata l'opzione di pagà cù carte rigalu. Se sceglite questa opzione, a quantità serà dedutta da u vostru saldo è applicata à u tutale di l'ordine.",
  ...
  product_filter_menu: {
    ...
    brands: "Marca",
    main_shop_page: "Pagina principale di u magazinu",
    home: "Casa",
  },
  ...
  master_payment: {
    notifications: {
      ...
      pay_by_cod: "U vostru ordine hè statu aghjuntu cum'è pagamentu à a consegna.",
      pay_by_dir:
      ...
      pay_title: "Pagamentu",
      qr_code_payment: "L'indirizzu QR di pagamentu hè statu creatu.",
  ...
  time_progress_bar: {
    ...
    title_no_start_end: "Senza periodu di tempu!",
  },
  ...
  avocado: {
    ...
    order_action: "Registrazione di l'ordine",
    ...
    add_new_order: "Fà un novu ordine",
    ...
    delete_item_dialog: {
      title: "Elimina l'articulu da u carrettu",
  ...
  service_bill: {
    ...
    booking: {
      title: "Prenotazione / Riservazione",
      message: "L'intervallu di date per riceve questu ordine hè statu sceltu da mè.",
