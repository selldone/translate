export default {
  ...
  "footer": {
    ...
    "phone": "Telefoon",
    "address": "Adres",
    "copyright": "Het gebruik van inhoud alleen voor niet-commerciële doeleinden en met bronvermelding (link met {shop_title}). Alle rechten voorbehouden aan {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Deze app vereist toegang tot uw winkelaccountgegevens. Dit omvat toegang tot naam, contactnummer, adres, e-mail, bestelgeschiedenis, bestellen en het plaatsen van opmerkingen over deze winkel.",
      "message_bold": "Zorg ervoor dat u de officiële winkel-app gebruikt om deze winkel binnen te gaan."
    }
  },
  "sort": {
    "title": "Sorteer op",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Klik op de bevestigingsknop als je de bestelling hebt ontvangen. Indien nodig kunt u een verwijzing indienen als u een bevestiging ontvangt.",
      "Recipient": "Ontvanger",
      "bill": "Factuur",
      "name": "Naam",
      "tel": "Telefoon",
  ...
  "return_request": {
    ...
    "note_input_message": "Beschrijf indien nodig de reden voor het retourneren van dit artikel.",
    "media_message": "U kunt hier afbeeldingen, audio of video van het product uploaden om betere ondersteuning te krijgen voor informatie over de productstatus. Het selecteren van het bestand wordt automatisch verzonden en bevestigd.",
    "video": "Video",
    "voice": "Stem",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Als u zich afmeldt voor deze winkel, worden uw bestelinformatie en -records niet verwijderd.",
      "action": "Vertrekken"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Voer het kaartnummer en de beveiligingscode in. Er wordt een cadeaubon aan uw account toegevoegd.",
  ...
  "product_rating_view": {
    "message": "Beste {user}, U heeft dit product gekocht. Wat vind je van dit product?",
    "notification": {
      "title": "gefeliciteerd",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Uw bestelling is succesvol toegevoegd. U kunt nu betalen via directe overboeking en vervolgens het betalingsbewijs uploaden op de bestelpagina.",
      "pay_title": "Betaling",
  ...
  "avocado": {
    ...
    "step1": "1. Voer de naam en details in van het product dat u wilt bestellen en klik op de knop Toevoegen.",
    ...
    "step2": "2. Nadat u alle gewenste artikelen heeft toegevoegd, klikt u op de knop Orderbeoordelingsverzoek. In dit stadium zullen we de bestelling beoordelen en u informeren over de prijs. Door op deze link te klikken, krijgt u de prijs- en betaallink te zien.",
    ...
    "pricing_not_completed_message": "Uw bestelling wordt beoordeeld. Uw bestelling wordt binnenkort beoordeeld en geprijsd en u kunt de bestelling betalen.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Maak de lijst met producten die u wilt kopen door de productcode te scannen.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Je hebt de afbeelding van de bon al geüpload, wacht op onze goedkeuring. Als u moet wijzigen, kunt u de vorige afbeelding vervangen door een nieuwe.",
