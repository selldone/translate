export default {
  ...
  "footer": {
    ...
    "phone": "फोन",
    "address": "पत्ता",
    "copyright": "सामग्रीचा वापर केवळ गैर-व्यावसायिक हेतूंसाठी आणि स्त्रोताच्या संदर्भात ({shop_title} सह दुवा). सर्व हक्क {shop_title} कडे राखीव आहेत.",
  ...
  "shop": {
    ...
    "native": {
      "title": "अर्ज लॉगिन",
      "message": "या अॅपला तुमच्या स्टोअर खात्याच्या माहितीमध्ये प्रवेश आवश्यक आहे. यामध्ये नाव, संपर्क क्रमांक, पत्ता, ईमेल, ऑर्डर इतिहास, ऑर्डर करणे आणि या स्टोअरवरील टिप्पण्या पोस्ट करणे यांचा समावेश आहे.",
      "message_bold": "या स्टोअरमध्ये प्रवेश करण्यासाठी अधिकृत स्टोअर अॅप वापरण्याची खात्री करा."
    }
  },
  "sort": {
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "तुम्हाला ऑर्डर मिळाल्यास पुष्टीकरण बटणावर क्लिक करा. आवश्यक असल्यास, तुम्हाला पुष्टीकरण मिळाल्यास तुम्ही रेफरल सबमिट करण्यास सक्षम असाल.",
  ...
  "return_request": {
    ...
    "note_input_message": "आवश्यक असल्यास हा आयटम परत करण्याचे कारण सांगा.",
    "media_message": "उत्पादन स्थिती माहितीसाठी अधिक चांगले समर्थन मिळविण्यासाठी तुम्ही उत्पादनाची प्रतिमा, ऑडिओ किंवा व्हिडिओ येथे अपलोड करू शकता. फाइल निवडल्याने आपोआप पाठवले जाईल आणि पुष्टी होईल.",
    "video": "व्हिडिओ",
    "voice": "आवाज",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "दुकान सोडा",
      "message": "या स्टोअरची सदस्यता रद्द केल्याने तुमची ऑर्डर माहिती आणि रेकॉर्ड हटवले जाणार नाहीत.",
      "action": "सोडा"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "कार्ड क्रमांक आणि सुरक्षा कोड प्रविष्ट करा. तुमच्या खात्यात भेट कार्ड जोडले जाईल.",
  ...
  "product_rating_view": {
    "message": "प्रिय {user}, तुम्ही हे उत्पादन खरेदी केले आहे. तुम्हाला या उत्पादनाबद्दल काय वाटते?",
    "notification": {
      "title": "अभिनंदन",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "तुमची ऑर्डर यशस्वीरित्या जोडली गेली आहे. आता तुम्ही थेट मनी ट्रान्सफरद्वारे पैसे देऊ शकता आणि नंतर ऑर्डर पृष्ठावर पेमेंट पावती अपलोड करू शकता.",
      "pay_title": "पेमेंट",
  ...
  "avocado": {
    ...
    "step1": "1. तुम्ही ऑर्डर करू इच्छित उत्पादनाचे नाव आणि तपशील प्रविष्ट करा आणि जोडा बटण क्लिक करा.",
    ...
    "step2": "2. सर्व इच्छित आयटम जोडल्यानंतर, ऑर्डर पुनरावलोकन विनंती बटणावर क्लिक करा. या टप्प्यावर, आम्ही ऑर्डरचे पुनरावलोकन करू आणि तुम्हाला किंमतीबद्दल कळवू. या लिंकवर क्लिक करून, तुम्ही किंमत आणि पेमेंट लिंक पाहण्यास सक्षम असाल.",
    ...
    "pricing_not_completed_message": "तुमच्या ऑर्डरचे पुनरावलोकन केले जात आहे. तुमच्या ऑर्डरचे लवकरच पुनरावलोकन केले जाईल आणि किंमत दिली जाईल आणि तुम्ही ऑर्डरचे पैसे भरण्यास सक्षम असाल.",
    "delete_item_dialog": {
    ...
    "select_address_message": "कृपया तुमचा पत्ता प्रविष्ट करा आणि नंतर तुम्ही ऑर्डर सबमिट करू शकता."
  },
  "hyper": {
    "title": "ऑर्डर निर्मिती",
    "message": "उत्पादन कोड स्कॅन करून तुम्हाला खरेदी करायच्या असलेल्या उत्पादनांची यादी तयार करा.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ तुम्ही आधीच पावतीची प्रतिमा अपलोड केली आहे, आमच्या मंजुरीची प्रतीक्षा करा. तुम्हाला बदलण्याची आवश्यकता असल्यास, तुम्ही मागील इमेज नवीनसह बदलू शकता.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "वर्गणी",
      "message": "तुम्ही ही सेवा दररोज खरेदी करून सदस्यत्व कालावधी निवडू शकता. आपण आधीच प्रविष्ट केलेली डीफॉल्ट मूल्ये बदलू इच्छित असल्यास खरेदीदारास कळवा.",
  ...
  "check_access": {
    ...
    "no_access_message": "दुर्दैवाने, तुम्हाला आमच्या स्टोअरमध्ये प्रवेश नाही.<br/> कृपया आमच्याशी संपर्क साधा."
  },
  "share_order": {
    "action": "ऑर्डर शेअर करा",
    "title": "ही ऑर्डर इतरांसोबत शेअर करा.",
    "message": "हा एक सुरक्षित दुवा आहे, फक्त तुमच्या ओळखीत असलेल्यांसोबत शेअर करा. या लिंकसह प्रत्येकजण तुमची ऑर्डर डुप्लिकेट करू शकतो आणि निवडलेला पत्ता पाहू शकतो. त्यात तुमच्या वर्तमान कार्टबद्दल माहिती असेल.",
