export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Cím",
    "copyright": "A tartalom csak nem kereskedelmi célokra és a forrásra való hivatkozással használható (link a következővel: {shop_title}). Minden jog fenntartva a(z) {shop_title} számára.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ez az alkalmazás hozzáférést igényel az áruházi fiókadataihoz. Ez magában foglalja a névhez, kapcsolattartási számhoz, címhez, e-mail címhez, rendelési előzményekhez, rendelésekhez és megjegyzések közzétételéhez való hozzáférést az üzletben.",
      "message_bold": "Ügyeljen arra, hogy a hivatalos áruház alkalmazást használja az áruházba való belépéshez."
    }
  },
  "sort": {
    "title": "Rendezés",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Kattintson a megerősítő gombra, ha megkapta a rendelést. Ha szükséges, beutalót küldhet, ha visszaigazolást kap.",
      "Recipient": "Befogadó",
      "bill": "Számla",
      "name": "Név",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Szükség esetén írja le a cikk visszaküldésének okát.",
    "media_message": "Ide töltheti fel a termék képét, hangját vagy videóját, hogy jobb támogatást kapjon a termékállapot-információkhoz. A fájl kiválasztása automatikusan elküldi és megerősíti.",
    "video": "Videó",
    "voice": "Hang",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Az áruházra való leiratkozás nem törli a rendelési adatait és nyilvántartásait.",
      "action": "Elhagy"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Adja meg a kártya számát és a biztonsági kódot. Ajándékkártya kerül hozzáadásra a fiókjához.",
  ...
  "product_rating_view": {
    "message": "Kedves {user}! Ön megvásárolta ezt a terméket. Mit gondol erről a termékről?",
    "notification": {
      "title": "Gratulálok",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Megrendelése sikeresen hozzáadva. Most már közvetlen pénzátutalással is fizethet, majd feltöltheti a fizetési bizonylatot a rendelési oldalon.",
      "pay_title": "Fizetés",
  ...
  "avocado": {
    ...
    "step1": "1. Adja meg a megrendelni kívánt termék nevét és adatait, majd kattintson a Hozzáadás gombra.",
    ...
    "step2": "2. Az összes kívánt tétel hozzáadása után kattintson a rendelés-ellenőrzés kérése gombra. Ebben a szakaszban felülvizsgáljuk a rendelést, és tájékoztatjuk Önt az árról. Erre a linkre kattintva megtekintheti az árat és a fizetési linket.",
    ...
    "pricing_not_completed_message": "Megrendelése felülvizsgálat alatt áll. Megrendelését hamarosan felülvizsgáljuk és árlistázzuk, és Ön ki tudja fizetni a rendelést.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "A termékkód beolvasásával hozza létre a megvásárolni kívánt termékek listáját.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Már feltöltötte a nyugta képét, várja meg jóváhagyásunkat. Ha módosítani kell, lecserélheti az előző képet egy újra.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Feliratkozás",
      "message": "Az előfizetési időszakot a szolgáltatás napi megvásárlásával választhatja ki. Tájékoztassa a vásárlót, ha módosítani szeretné a már megadott alapértelmezett értékeket.",
