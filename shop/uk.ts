export default {
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Ми цінуємо час, який ви приділили нам. Ваше повідомлення отримано, наша команда зараз розглядає його. Ми відповімо якомога швидше та дякуємо за ваше терпіння протягом цього часу. Ваш інтерес і відгуки важливі для нас, і ми прагнемо надати вам найкращу підтримку."
  },
  "master_payment": {
    "notifications": {
  ...
  "avocado": {
    ...
    "select_address_message": "Будь ласка, введіть свою адресу, після чого ви зможете відправити замовлення."
  },
  "hyper": {
  ...
  "check_access": {
    ...
    "no_access_message": "На жаль, ви не маєте доступу до нашого магазину.<br/> Будь ласка, зв'яжіться з нами."
  },
  "share_order": {
    "action": "Порядок поділу",
    "title": "Поділіться цим замовленням з іншими.",
    "message": "Це безпечне посилання, діліться ним лише з тими, кого ви знаєте. Кожен, хто має це посилання, може дублювати ваше замовлення та бачити вибрану адресу. Він міститиме інформацію про ваш поточний кошик.",
