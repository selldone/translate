...
export default {
  ...
  shop: {
    ...
    native: {
      title: "アプリケーションログイン",
      message:
        "このアプリは、ストアアカウント情報にアクセスする必要があります。これには、名前、連絡先番号、住所、電子メール、注文履歴、注文、およびこのストアへのコメントの投稿へのアクセスが含まれます。",
      message_bold:
  ...
  buy_button: {
    ...
    zip_pin_not_available_msg: "この地域では利用できません！",
    zip_pin_placeholder: "郵便番号/PINコードを選択...",
  },
  ...
  layout_shop: {
    shop_menu: {
      orders_history: "注文履歴",
      profile: "私のプロフィール",
      favorites: "お気に入りのアイテム",
      gift_cards: "ギフトカード",
      return_requests: "返品された注文",
      basket: "ショッピングカート",
    },
    user_menu: {
      my_shops: "マイストア",
    ...
    item_in_basket_message: "{count}点の商品がカートに入っています。",
  ...
  user_wallets: {
    title: "マイウォレット",
    subtitle: "対象条件を満たし、キャッシュバックプログラムが有効な場合、注文金額の一部がウォレットに付与されます。この残高は次回の購入に利用できます。"
  },
  /**
   * @see SWalletInput
   */
  wallet_input:{
    my_wallet_balance:'マイウォレット残高',
  },
  ...
  order_page: {
    ...
    payment: {
      ...
      payment_is_in_require_capture_message:
        "お支払いは受領しましたが、まだ売上確定されていません。",
      settle_the_earlier_bill_first: "先に以前の請求を精算してください！",
    },
    /** {@see SShopCustomerDeliveryInfoWidget} **/
    delivery: {
      title: "配達",
      subtitle: "バイヤー情報",
      confirm_received_action: "製品の領収書を確認する",
      confirm_received_info:
        "注文を受け取ったら、確認ボタンをクリックします。必要に応じて、確認を受け取った場合に紹介を送信できます。",
      Recipient: "受信者",
      bill: "請求書",
      name: "名前",
      tel: "電話",
  ...
  return_request: {
    title: "戻る",
    count_input: "返品数",
    count_input_message: "何個返品しますか？",
    reason_input: "返却理由",
    reason_input_message: "このアイテムを返品する理由を選択してください。",
    note_input: "説明",
    note_input_hint: "返品の理由を説明してください..",
    note_input_message:
      "必要に応じて、このアイテムを返品する理由を説明してください。",
    media_message:
      "ここに製品の画像、音声、またはビデオをアップロードして、製品のステータス情報のサポートを強化できます。ファイルを選択すると、自動的に送信および確認されます。",
    video: "ビデオ",
    voice: "声",
    add_action: "返品リクエストを送信する",
    notifications: "返品リクエストは正常に登録されました。",
  },
  ...
  user_profile: {
    ...
    my_profile: {
      title: "マイプロフィール",
      subtitle: "これはストアで使用する私の顧客プロフィール情報です。",
      edit_action: "プロフィールを編集"
    },
    subscribe_status: {
      subscribed: "メールで最新ニュースやプロモーションを受け取るよう登録しています。",
      unsubscribed: "メールでニュースやプロモーションを受け取る登録はしていません。"
    },
    my_club: {
      subtitle: "私のクラブレベルとその特典です。"
    },
    kyc: {
      subtitle: "これは私のグローバル本人確認情報です。"
    }
  ...
  basket_page: {
    ...
    receive_time: "希望納期",
    select_time: "配達時間を選択",
    no_select_time: "できるだけ早く",
    transportation_type: "配送タイプ",
    days_input: "配達日",
    days_input_label: "日々",
    ...
    cross_selling_discount: "コレクション割引",
    ...
    same_billing_address: "受取人情報と同じ請求情報",
    same_billing_address_desc:
      "請求先住所は配送先住所と同じです。",
    custom_billing_info: "別の請求情報",
    custom_billing_info_desc:
      "TAX 番号を入力し、請求先として別の住所を設定できます。",
    basket_empty: "バスケットが空です",
    extra_shipping_count: "{count}個の荷物をお届けします。",
    ...
    can_pay_cod_message:"この注文は配達時に現金で支払えます。",
  },
  ...
  basket_items: {
    ...
    offer: "{count} xアイテムを{percent}％オフで入手",
  ...
  addresses_page: {
    title: "私の住所",
    subtitle:"保存済み住所をここで確認し、新しい住所を簡単に追加できます。",
    new_action: "新しいアドレス",
    receiver: "受取人",
    address: "住所",
  ...
  return_requests: {
    title: "返品リクエスト",
    subtitle:"返品リクエストをここで確認できます。返品ポリシーがある商品は、注文ページから返品リクエストを送信できます。",
  },
  ...
  product_comparison: {
    ...
    list: {
      ...
      brand: "ブランド",
      warranty: "保証",
      variants_comparison: "製品バリエーションを比較する",
      spec: "技術仕様",
      pros: "長所",
      cons: "短所",
      ...
      rating: "評価",
      rating_count: "レビュー数",
      info: "この製品比較表は、次のリンクを送信して友達と共有したり、このリンクを保存して後でアクセスしたりできます。",
      copy_action: "比較リンクをコピー",
      check_list: ["はい", "もっている"],
      cross_list: ["いいえ", "していません"],
    },
  },
  /** {@see SCategoryFilter} **/
  product_filter_menu: {
  ...
  contact_us_form: {
    ...
    submitted_title: "お問い合わせいただきありがとうございます。",
    submitted_message:
      "ご連絡いただきありがとうございます。あなたのメッセージは受信され、私たちのチームが現在確認中です。できるだけ早くご対応させていただきますので、今しばらくお待ちいただきますようお願いいたします。お客様のご関心とフィードバックは当社にとって重要であり、可能な限り最高のサポートを提供することに尽力いたします。",
  },
  ...
  master_payment: {
    notifications: {
      ...
      pay_by_dir:
        "ご注文は正常に追加されました。これで、直接送金で支払い、注文ページに支払い領収書をアップロードできます。",
      pay_title: "支払い",
  ...
  /** {@see TimeProgressBar} **/
  time_progress_bar: {
    title_before_start: "最初に残った",
    title_between_start_end: "最後まで残った",
  ...
  avocado: {
    ...
    last_orders: "最近の注文のリスト",
    pending_status: "レビュー中",
    check_now: "注文を確認する",
    add_new_order: "新規注文する",
  ...
  service_bill: {
    task: {
      title: "やることリスト",
      message: "やりたい仕事のタイトルを指定し、購入者にそれがどこまで進んだかを知らせます。",
    },
    booking: {
      title: "予約/予約",
      message: "この注文は指定された時間に処理されます。お客様は希望の期間を選択しました。選択した期間に変更を加える場合は、お客様に知らせてください。",

      selected_checkin: "顧客による選択されたチェックイン",
      selected_checkout: "顧客による選択されたチェックアウト",
    ...
    subscription: {
      title: "サブスクリプション",
      message:
        "このサービスを毎日購入することで、サブスクリプション期間を選択できます。すでに入力したデフォルト値を変更するかどうかを購入者に知らせてください。",
  ...
  check_access: {
    ...
    no_access_message:
      "残念ながら、あなたは私たちの店にアクセスできません。<br/>お問い合わせください。",
  },
  ...
  share_order: {
    ...
    message:
      "これは安全なリンクです。知っている人だけに共有してください。このリンクを知っている人は誰でも、注文を複製して、選択した住所を確認できます。現在のカートに関する情報が含まれます。",
  ...
  rating: {
    product_rating_message:
      "この商品は5つ星中{rate}の評価を受け、{rate_count}人が評価しました。",
  },
  ...
  cross_selling: {
    title: "{product} と一緒に注文",
  },

  /** {@see SSmartSelectVendor} **/
  select_vendor: {
    item_title: "{vendor} のストアを見る",
  },
