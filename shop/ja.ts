export default {
  ...
  "footer": {
    ...
    "phone": "電話",
    "address": "住所",
    "copyright": "非営利目的でのみ、ソースを参照してコンテンツを使用する（{shop_title}とのリンク）。すべての権利は{shop_title}に帰属します。",
    "powered_by": "搭載",
    "privacy": "プライバシーポリシー",
    "term_of_use": "利用規約",
  ...
  "shop": {
    ...
    "native": {
      "title": "アプリケーションログイン",
      "message": "このアプリは、ストアアカウント情報にアクセスする必要があります。これには、名前、連絡先番号、住所、電子メール、注文履歴、注文、およびこのストアへのコメントの投稿へのアクセスが含まれます。",
      "message_bold": "このストアに入るには、必ず公式ストアアプリを使用してください。"
    }
  },
  "sort": {
    "title": "並び替え",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "注文を受け取ったら、確認ボタンをクリックします。必要に応じて、確認を受け取った場合に紹介を送信できます。",
      "Recipient": "受信者",
      "bill": "請求書",
      "name": "名前",
      "tel": "電話",
  ...
  "return_request": {
    ...
    "note_input_message": "必要に応じて、このアイテムを返品する理由を説明してください。",
    "media_message": "ここに製品の画像、音声、またはビデオをアップロードして、製品のステータス情報のサポートを強化できます。ファイルを選択すると、自動的に送信および確認されます。",
    "video": "ビデオ",
    "voice": "声",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "店を出る",
      "message": "このストアの購読を解除しても、注文情報とレコードは削除されません。",
      "action": "離れる"
    },
    "notifications": {
      "leave_success": "店を出る"
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      "title": "ギフトカードを追加する",
      "message": "カード番号とセキュリティコードを入力します。アカウントにギフトカードが追加されます。",
  ...
  "product_rating_view": {
    "message": "{user}様、この製品を購入しました。この商品についてどう思いますか？",
    "notification": {
      "title": "おめでとうございます",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "ご連絡いただきありがとうございます。あなたのメッセージは受信され、私たちのチームが現在確認中です。できるだけ早くご対応させていただきますので、今しばらくお待ちいただきますようお願いいたします。お客様のご関心とフィードバックは当社にとって重要であり、可能な限り最高のサポートを提供することに尽力いたします。"
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "ご注文は正常に追加されました。これで、直接送金で支払い、注文ページに支払い領収書をアップロードできます。",
      "pay_title": "支払い",
  ...
  "avocado": {
    ...
    "last_update": "最後の更新：",
    "step1": "1.注文する製品の名前と詳細を入力し、[追加]ボタンをクリックします。",
    ...
    "step2": "2.必要なアイテムをすべて追加したら、注文レビューリクエストボタンをクリックします。この段階で、注文を確認し、価格をお知らせします。このリンクをクリックすると、価格と支払いのリンクが表示されます。",
    "order_action": "注文登録",
    "show_all": "すべて表示する",
    ...
    "pricing_not_completed_message": "ご注文は審査中です。ご注文はまもなく確認され、価格が設定され、注文を支払うことができるようになります。",
    "delete_item_dialog": {
  ...
  "hyper": {
    "title": "注文の作成",
    "message": "製品コードをスキャンして、購入する製品のリストを作成します。",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔領収書の画像は既にアップロードされています。承認されるまでお待ちください。変更する必要がある場合は、前の画像を新しい画像に置き換えることができます。",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "サブスクリプション",
      "message": "このサービスを毎日購入することで、サブスクリプション期間を選択できます。すでに入力したデフォルト値を変更するかどうかを購入者に知らせてください。",
