export default {
  ...
  physical_order_page: {
    ...
    delivery: {
      title: "دریافت",
      subtitle: "مشخصات دریافت کننده سفارش",
  ...
  avocado: {
    ...
    step2:
      "2. بعد از افزودن تمام اقلام مورد نظر کلید درخواست بررسی سفارش را بزنید. در این مرحله سفارش توسط ما بررسی و قیمت گذاری خواهد شد. با سر زدین به همین لینک قادر به دیدن قیمت و لینک پرداخت خواهید بود.",
    ...
    delete_item_dialog: {
      ...
      message: "آیا می خواهید این آیتم را زا سبد خرید حذف نمایید؟",
      action: "بله، حذف شود",
    },
