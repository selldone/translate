export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Adres",
    "copyright": "Wykorzystywanie treści wyłącznie w celach niekomercyjnych i w odniesieniu do źródła (link z {shop_title}). Wszelkie prawa zastrzeżone dla {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ta aplikacja wymaga dostępu do informacji o Twoim koncie w sklepie. Obejmuje to dostęp do imienia i nazwiska, numeru kontaktowego, adresu, adresu e-mail, historii zamówień, składania zamówień i zamieszczania komentarzy w tym sklepie.",
      "message_bold": "Aby wejść do tego sklepu, skorzystaj z oficjalnej aplikacji sklepu."
    }
  },
  "sort": {
    "title": "Sortuj według",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Kliknij przycisk potwierdzenia, jeśli otrzymałeś zamówienie. W razie potrzeby będziesz mógł przesłać skierowanie, jeśli otrzymasz potwierdzenie.",
      "Recipient": "Odbiorca",
      "bill": "Faktura",
      "name": "Nazwać",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "W razie potrzeby opisz powód zwrotu tego przedmiotu.",
    "media_message": "Tutaj możesz przesłać obraz, dźwięk lub wideo produktu, aby uzyskać lepszą obsługę informacji o stanie produktu. Wybranie pliku spowoduje automatyczne wysłanie i potwierdzenie.",
    "video": "Wideo",
    "voice": "Głos",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Opuść sklep",
      "message": "Rezygnacja z subskrypcji tego sklepu nie spowoduje usunięcia informacji i zapisów dotyczących zamówienia.",
      "action": "Wyjechać"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Wprowadź numer karty i kod zabezpieczający. Karta podarunkowa zostanie dodana do Twojego konta.",
  ...
  "product_rating_view": {
    "message": "Drogi {user}, Kupiłeś ten produkt. Co myślisz o tym produkcie?",
    "notification": {
      "title": "Gratulacje",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Twoje zamówienie zostało pomyślnie dodane. Teraz możesz zapłacić przelewem bezpośrednim, a następnie przesłać potwierdzenie wpłaty na stronie zamówienia.",
      "pay_title": "Zapłata",
  ...
  "avocado": {
    ...
    "step1": "1. Wpisz nazwę i dane produktu, który chcesz zamówić i kliknij przycisk Dodaj.",
    ...
    "step2": "2. Po dodaniu wszystkich żądanych pozycji kliknij przycisk prośby o sprawdzenie zamówienia. Na tym etapie zapoznamy się z zamówieniem i poinformujemy o cenie. Klikając w ten link, będziesz mógł zobaczyć cenę i link do płatności.",
    ...
    "pricing_not_completed_message": "Twoje zamówienie jest sprawdzane. Twoje zamówienie zostanie wkrótce sprawdzone i wycenione, a Ty będziesz mógł zapłacić za zamówienie.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Utwórz listę produktów, które chcesz kupić, skanując kod produktu.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Przesłałeś już obraz paragonu, poczekaj na naszą akceptację. Jeśli musisz zmienić, możesz zastąpić poprzedni obraz nowym.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Subskrypcja",
      "message": "Okres subskrypcji możesz wybrać, kupując tę usługę codziennie. Powiadom kupującego, jeśli chcesz zmienić wprowadzone wcześniej wartości domyślne.",
