export default {
  ...
  "footer": {
    ...
    "phone": "ስልክ",
    "address": "አድራሻ",
    "copyright": "ይዘትን ለንግድ ላልሆኑ ዓላማዎች እና ከምንጩ ጋር በማጣቀስ ብቻ መጠቀም (ከ{shop_title} ጋር ያለው አገናኝ)። ሁሉም መብቶች ለ{shop_title} የተጠበቁ ናቸው።",
  ...
  "shop": {
    ...
    "native": {
      "title": "የመተግበሪያ መግቢያ",
      "message": "ይህ መተግበሪያ የማከማቻ መለያህን መረጃ መድረስን ይፈልጋል። ይህ የስም ፣ የእውቂያ ቁጥር ፣ አድራሻ ፣ ኢሜል ፣ የትዕዛዝ ታሪክ ፣ ማዘዝ እና በዚህ መደብር ላይ አስተያየቶችን መለጠፍን ያካትታል ።",
      "message_bold": "ወደዚህ መደብር ለመግባት ኦፊሴላዊውን የመደብር መተግበሪያ መጠቀምዎን ያረጋግጡ።"
    }
  },
  "sort": {
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "ትዕዛዙን ከተቀበሉ የማረጋገጫ ቁልፍን ጠቅ ያድርጉ። ካስፈለገ ማረጋገጫ ካገኙ ሪፈራል ማስገባት ይችላሉ።",
      "Recipient": "ተቀባይ",
      "bill": "ደረሰኝ",
      "name": "ስም",
      "tel": "ስልክ",
  ...
  "return_request": {
    ...
    "note_input_message": "አስፈላጊ ከሆነ ይህንን ንጥል የሚመልስበትን ምክንያት ይግለጹ።",
    "media_message": "ለምርት ሁኔታ መረጃ የተሻለ ድጋፍ ለማግኘት የምርቱን ምስል፣ ኦዲዮ ወይም ቪዲዮ እዚህ መስቀል ይችላሉ። ፋይሉን መምረጥ በራስ-ሰር ይልካል እና ያረጋግጣል።",
    "video": "ቪዲዮ",
    "voice": "ድምጽ",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "ሱቅ ይውጡ",
      "message": "የዚህ መደብር ደንበኝነት ምዝገባ መውጣት የትዕዛዝ መረጃዎን እና መዝገቦችን አይሰርዝም።",
      "action": "ተወው"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      "title": "የስጦታ ካርድ ያክሉ",
      "message": "የካርድ ቁጥሩን እና የደህንነት ኮድ ያስገቡ። የስጦታ ካርድ ወደ መለያዎ ይታከላል።",
  ...
  "product_rating_view": {
    "message": "ውድ {user}፣ ይህን ምርት ገዝተሃል። ስለዚህ ምርት ምን ያስባሉ?",
    "notification": {
      "title": "እንኳን ደስ አላችሁ",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "እኛን ለማነጋገር ጊዜዎን እናመሰግናለን። መልእክትህ ደርሷል እና ቡድናችን በአሁኑ ጊዜ እየገመገመው ነው። በተቻለ ፍጥነት ምላሽ እንሰጣለን, እና በዚህ ጊዜ ለትዕግስትዎ እናመሰግናለን. የእርስዎ ፍላጎት እና አስተያየት ለእኛ አስፈላጊ ናቸው፣ እና በተቻለ መጠን እርስዎን ለመርዳት ቁርጠኞች ነን።"
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "ትዕዛዝህ በተሳካ ሁኔታ ታክሏል። አሁን በቀጥታ ገንዘብ ማስተላለፍ መክፈል እና ከዚያም የክፍያ ደረሰኝ በትዕዛዝ ገጹ ላይ መጫን ይችላሉ.",
      "pay_title": "ክፍያ",
  ...
  "avocado": {
    ...
    "step1": "1. ለማዘዝ የሚፈልጉትን ምርት ስም እና ዝርዝሮችን ያስገቡ እና አክል ቁልፍን ጠቅ ያድርጉ።",
    ...
    "step2": "2. ሁሉንም የሚፈለጉትን እቃዎች ካከሉ በኋላ, የትዕዛዝ ግምገማ ጥያቄ አዝራርን ጠቅ ያድርጉ. በዚህ ደረጃ, ትዕዛዙን እንገመግማለን እና ስለ ዋጋው እናሳውቅዎታለን. ይህንን ሊንክ በመጫን የዋጋ እና የክፍያ ማያያዣውን ማየት ይችላሉ።",
    ...
    "pricing_not_completed_message": "ትዕዛዝህ እየተገመገመ ነው። ትዕዛዝዎ በቅርቡ ይገመገማል እና ዋጋ ይከፈላል እና ትዕዛዙን መክፈል ይችላሉ።",
    "delete_item_dialog": {
  ...
  "hyper": {
    "title": "ትዕዛዝ መፍጠር",
    "message": "የምርት ኮዱን በመቃኘት ለመግዛት የሚፈልጉትን ምርቶች ዝርዝር ይፍጠሩ።",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ የደረሰኙን ምስል አስቀድመህ ሰቅለሃል፣ መጽደቅህን ጠብቅ። መለወጥ ካስፈለገዎት የቀደመውን ምስል በአዲስ መተካት ይችላሉ።",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "የደንበኝነት ምዝገባ",
      "message": "ይህንን አገልግሎት በየቀኑ በመግዛት የምዝገባ ጊዜውን መምረጥ ይችላሉ። አስቀድመው ያስገቡትን ነባሪ እሴቶች መለወጥ ከፈለጉ ለገዢው ያሳውቁ።",
