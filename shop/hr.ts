export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Adresa",
    "copyright": "Korištenje sadržaja samo u nekomercijalne svrhe i s referencom na izvor (veza s {shop_title}). Sva prava pridržana za {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ova aplikacija zahtijeva pristup podacima o vašem računu trgovine. To uključuje pristup imenu, kontakt broju, adresi, e-pošti, povijesti narudžbi, naručivanju i objavljivanju komentara na ovoj trgovini.",
      "message_bold": "Svakako upotrijebite službenu aplikaciju trgovine za ulazak u ovu trgovinu."
    }
  },
  "sort": {
    "title": "Poredaj po",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Kliknite na gumb za potvrdu ako ste primili narudžbu. Ako je potrebno, moći ćete poslati uputnicu ako dobijete potvrdu.",
      "Recipient": "Primatelj",
      "bill": "Dostavnica",
      "name": "Ime",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Opišite razlog vraćanja ovog artikla ako je potrebno.",
    "media_message": "Ovdje možete prenijeti sliku, audio ili video proizvoda kako biste dobili bolju podršku za informacije o statusu proizvoda. Odabir datoteke automatski će se poslati i potvrditi.",
    "video": "Video",
    "voice": "Glas",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Otkazivanjem pretplate na ovu trgovinu neće se izbrisati podaci o vašoj narudžbi i zapisi.",
      "action": "Napustiti"
    },
    "notifications": {
  ...
  "basket_page": {
    ...
    "select_location_error": "Na karti pronađite mjesto primitka pošiljke i kliknite na indikator u sredini karte kako biste odredili točnu adresu primatelja.",
    "same_billing_address_desc": "Adresa za naplatu ista je kao adresa za dostavu.",
    "custom_billing_info_desc": "Možete unijeti svoj POREZNI broj i postaviti drugu adresu za naplatu.",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Unesite broj kartice i sigurnosni kod. Darovna kartica bit će dodana na vaš račun.",
  ...
  "product_rating_view": {
    "message": "Poštovani {user}, kupili ste ovaj proizvod. Što mislite o ovom proizvodu?",
    "notification": {
      "title": "Čestitam",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Vaša narudžba je uspješno dodana. Sada možete platiti izravnim prijenosom novca, a zatim prenijeti potvrdu o uplati na stranicu za narudžbu.",
      "pay_title": "Plaćanje",
  ...
  "avocado": {
    ...
    "step1": "1. Unesite naziv i detalje proizvoda koji želite naručiti i kliknite gumb Dodaj.",
    ...
    "step2": "2. Nakon što dodate sve željene artikle, kliknite na gumb Zahtjev za pregled narudžbe. U ovoj fazi pregledat ćemo narudžbu i obavijestiti vas o cijeni. Klikom na ovaj link moći ćete vidjeti cijenu i link za plaćanje.",
    ...
    "pricing_not_completed_message": "Vaša se narudžba pregledava. Vaša narudžba će uskoro biti pregledana i ocijenjena cijena te ćete moći platiti narudžbu.",
    "delete_item_dialog": {
    ...
    "select_address_message": "Unesite svoju adresu, a zatim možete predati narudžbu."
  },
  "hyper": {
    "title": "Kreiranje narudžbe",
    "message": "Napravite popis proizvoda koje želite kupiti skeniranjem koda proizvoda.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Već ste prenijeli sliku računa, pričekajte naše odobrenje. Ako trebate promijeniti, prethodnu sliku možete zamijeniti novom.",
  ...
  "share_order": {
    ...
    "message": "To je sigurna veza, dijelite je samo s onima koje poznajete. Svatko s ovom vezom može duplicirati vašu narudžbu i vidjeti odabranu adresu. Sadržat će informacije o vašoj trenutnoj košarici.",
  ...
  "rating": {
    "product_rating_message": "Ovaj je proizvod dobio ocjenu {rate} od 5 zvjezdica i ocijenilo ga je {rate_count} ljudi."
  },
  "related_products": {
    "card": {
      "title": "Istražiti!",
