export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Adresa",
    "copyright": "Použití obsahu pouze pro nekomerční účely as odkazem na zdroj (odkaz na {shop_title}). Všechna práva vyhrazena pro {shop_title}.",
    "powered_by": "Poháněno",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Tato aplikace vyžaduje přístup k informacím o vašem účtu obchodu. To zahrnuje přístup ke jménu, kontaktnímu číslu, adrese, e-mailu, historii objednávek, objednávání a přidávání komentářů k tomuto obchodu.",
      "message_bold": "Pro vstup do tohoto obchodu použijte oficiální aplikaci obchodu."
    }
  },
  "sort": {
  ...
  "product": {
    ...
    "spec": "Spec",
    "comments": "Komentáře",
    "related_products_title": "Související produkty",
    "price": "Cena",
    "rate": "Hodnotit",
    "comment": "Komentář",
    "warranty": "Záruka",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Pokud jste objednávku obdrželi, klikněte na potvrzovací tlačítko. V případě potřeby budete moci odeslat doporučení, pokud obdržíte potvrzení.",
      "Recipient": "Příjemce",
      "bill": "Faktura",
      "name": "název",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "V případě potřeby popište důvod vrácení této položky.",
    "media_message": "Zde můžete nahrát obrázek, zvuk nebo video produktu, abyste získali lepší podporu pro informace o stavu produktu. Výběr souboru automaticky odešle a potvrdí.",
    "video": "Video",
    "voice": "Hlas",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Odhlášením odběru tohoto obchodu se nesmažou informace a záznamy o vaší objednávce.",
      "action": "Odejít"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Zadejte číslo karty a bezpečnostní kód. K vašemu účtu bude přidána dárková karta.",
  ...
  "product_rating_view": {
    "message": "Vážený uživateli {user}, zakoupili jste tento produkt. Co si myslíte o tomto produktu?",
    "notification": {
      "title": "gratuluji",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Vaše objednávka byla úspěšně přidána. Nyní můžete platit přímým převodem peněz a poté nahrát potvrzení o platbě na stránku objednávky.",
  ...
  "avocado": {
    ...
    "step1": "1. Zadejte název a podrobnosti o produktu, který chcete objednat, a klikněte na tlačítko Přidat.",
    ...
    "step2": "2. Po přidání všech požadovaných položek klikněte na tlačítko žádosti o kontrolu objednávky. V této fázi objednávku zkontrolujeme a dáme vám vědět o ceně. Kliknutím na tento odkaz se vám zobrazí cena a odkaz k platbě.",
    ...
    "pricing_not_completed_message": "Vaše objednávka se kontroluje. Vaše objednávka bude brzy zkontrolována a naceněna a vy budete moci objednávku zaplatit.",
    "delete_item_dialog": {
    ...
    "select_address_message": "Zadejte prosím svou adresu a poté můžete odeslat objednávku."
  },
  "hyper": {
    "title": "Vytvoření objednávky",
    "message": "Vytvořte seznam produktů, které chcete koupit, naskenováním kódu produktu.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Obrázek účtenky jste již nahráli, počkejte na naše schválení. Pokud potřebujete změnit, můžete nahradit předchozí obrázek novým.",
  ...
  "check_access": {
    ...
    "no_access_message": "Bohužel nemáte přístup do našeho obchodu.<br/> Prosím kontaktujte nás."
  },
  "share_order": {
    "action": "Sdílejte objednávku",
    "title": "Sdílejte tuto objednávku s ostatními.",
    "message": "Je to zabezpečený odkaz, sdílejte jej pouze s těmi, které znáte. Každý s tímto odkazem může duplikovat vaši objednávku a zobrazit vybranou adresu. Bude obsahovat informace o vašem aktuálním košíku.",
