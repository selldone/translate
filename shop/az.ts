export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Ünvan",
    "copyright": "Məzmundan yalnız qeyri-kommersiya məqsədləri üçün və mənbəyə istinadla istifadə ({shop_title} ilə keçid). Bütün hüquqlar {shop_title} üçün qorunur.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Bu proqram mağaza hesabı məlumatlarınıza giriş tələb edir. Buraya ad, əlaqə nömrəsi, ünvan, e-poçt, sifariş tarixçəsi, sifariş və bu mağazada şərhlərin yerləşdirilməsi daxildir.",
      "message_bold": "Bu mağazaya daxil olmaq üçün rəsmi mağaza proqramından istifadə etdiyinizə əmin olun."
    }
  },
  "sort": {
    "title": "Sırala",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Sifariş almısınızsa, təsdiq düyməsini basın. Lazım gələrsə, təsdiq alsanız, müraciət göndərə biləcəksiniz.",
      "Recipient": "alıcı",
      "bill": "Faktura",
      "name": "ad",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Lazım gələrsə, bu elementi geri qaytarmağın səbəbini təsvir edin.",
    "media_message": "Məhsulun vəziyyəti haqqında məlumat üçün daha yaxşı dəstək almaq üçün məhsulun şəklini, audio və ya videosunu buraya yükləyə bilərsiniz. Faylın seçilməsi avtomatik olaraq göndəriləcək və təsdiqlənəcək.",
    "video": "Video",
    "voice": "Səs",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Bu mağazaya abunəlikdən çıxmaq sifariş məlumatlarınızı və qeydlərinizi silməyəcək.",
      "action": "tərk et"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Kart nömrəsini və təhlükəsizlik kodunu daxil edin. Hədiyyə kartı hesabınıza əlavə olunacaq.",
  ...
  "product_rating_view": {
    "message": "Hörmətli {user}, Siz bu məhsulu almısınız. Bu məhsul haqqında nə düşünürsünüz?",
    "notification": {
      "title": "Təbriklər",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Sifarişiniz uğurla əlavə edildi. İndi siz birbaşa pul köçürməsi ilə ödəyə və sonra ödəniş qəbzini sifariş səhifəsində yükləyə bilərsiniz.",
      "pay_title": "Ödəniş",
  ...
  "avocado": {
    ...
    "step1": "1. Sifariş etmək istədiyiniz məhsulun adını və təfərrüatlarını daxil edin və Əlavə et düyməsini sıxın.",
    ...
    "step2": "2. İstədiyiniz bütün elementləri əlavə etdikdən sonra sifarişin nəzərdən keçirilməsi sorğusu düyməsini klikləyin. Bu mərhələdə sifarişi nəzərdən keçirəcəyik və qiymət barədə sizə məlumat verəcəyik. Bu linkə klikləməklə qiymət və ödəniş linkinə baxa biləcəksiniz.",
    ...
    "pricing_not_completed_message": "Sifarişiniz nəzərdən keçirilir. Sifarişiniz tezliklə nəzərdən keçiriləcək və qiymət veriləcək və siz sifarişi ödəyə biləcəksiniz.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Məhsul kodunu skan edərək almaq istədiyiniz məhsulların siyahısını yaradın.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Siz artıq qəbz şəklini yükləmisiniz, təsdiqimizi gözləyin. Dəyişmək lazımdırsa, əvvəlki şəkli yenisi ilə əvəz edə bilərsiniz.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Abunəlik",
      "message": "Bu xidməti gündəlik olaraq almaqla abunəlik müddətini seçə bilərsiniz. Artıq daxil etdiyiniz standart dəyərləri dəyişdirmək istədiyinizi alıcıya bildirin.",
