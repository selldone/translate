export default {
  ...
  "footer": {
    ...
    "phone": "Tālrunis",
    "address": "Adrese",
    "copyright": "Satura izmantošana tikai nekomerciālos nolūkos un ar atsauci uz avotu (saite ar {shop_title}). Visas tiesības paturētas {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Šai lietotnei ir nepieciešama piekļuve jūsu veikala konta informācijai. Tas ietver piekļuvi vārdam, kontakttālruņa numuram, adresei, e-pastam, pasūtījumu vēsturei, pasūtīšanai un komentāru ievietošanai šajā veikalā.",
      "message_bold": "Lai ieietu šajā veikalā, noteikti izmantojiet oficiālo veikala lietotni."
    }
  },
  "sort": {
    "title": "Kārtot pēc",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Noklikšķiniet uz apstiprinājuma pogas, ja esat saņēmis pasūtījumu. Ja nepieciešams, varēsiet iesniegt nosūtījumu, saņemot apstiprinājumu.",
      "Recipient": "Saņēmējs",
      "bill": "Rēķins",
      "name": "Vārds",
      "tel": "Tālrunis",
  ...
  "return_request": {
    ...
    "note_input_message": "Ja nepieciešams, aprakstiet šīs preces atgriešanas iemeslu.",
    "media_message": "Šeit varat augšupielādēt produkta attēlu, audio vai video, lai iegūtu labāku produkta statusa informācijas atbalstu. Izvēloties failu, tas tiks automātiski nosūtīts un apstiprināts.",
    "video": "Video",
    "voice": "Balss",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Atceļot šī veikala abonementu, jūsu pasūtījuma informācija un ieraksti netiks dzēsti.",
      "action": "Aiziet"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Ievadiet kartes numuru un drošības kodu. Jūsu kontam tiks pievienota dāvanu karte.",
  ...
  "product_rating_view": {
    "message": "Cien. {user}! Jūs esat iegādājies šo produktu. Ko jūs domājat par šo produktu?",
    "notification": {
      "title": "Apsveicu",
  ...
  "contact_us_form": {
    ...
    "submitted_message": "Mēs novērtējam jūsu laiku, sazinoties ar mums. Jūsu ziņojums ir saņemts, un mūsu komanda to pašlaik izskata. Mēs atbildēsim, cik drīz vien iespējams, un pateicamies par jūsu pacietību šajā laikā. Jūsu interese un atsauksmes mums ir svarīgas, un mēs esam apņēmušies sniegt jums vislabāko iespējamo atbalstu."
  },
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Jūsu pasūtījums ir veiksmīgi pievienots. Tagad varat maksāt ar tiešo naudas pārskaitījumu un pēc tam pasūtījuma lapā augšupielādēt maksājuma kvīti.",
      "pay_title": "Maksājums",
  ...
  "avocado": {
    ...
    "step1": "1. Ievadiet tās preces nosaukumu un informāciju, kuru vēlaties pasūtīt, un noklikšķiniet uz pogas Pievienot.",
    ...
    "step2": "2. Pēc visu vajadzīgo preču pievienošanas noklikšķiniet uz pasūtījuma pārskatīšanas pieprasījuma pogas. Šajā posmā mēs izskatīsim pasūtījumu un informēsim jūs par cenu. Noklikšķinot uz šīs saites, jūs varēsiet redzēt cenas un maksājuma saiti.",
    ...
    "pricing_not_completed_message": "Jūsu pasūtījums tiek pārskatīts. Jūsu pasūtījums drīzumā tiks pārskatīts un noteikta cena, un jūs varēsiet apmaksāt pasūtījumu.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Izveidojiet to produktu sarakstu, kurus vēlaties iegādāties, skenējot preces kodu.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Jūs jau esat augšupielādējis kvīts attēlu, gaidiet mūsu apstiprinājumu. Ja nepieciešams mainīt, iepriekšējo attēlu var aizstāt ar jaunu.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Abonēšana",
      "message": "Jūs varat izvēlēties abonēšanas periodu, pērkot šo pakalpojumu katru dienu. Informējiet pircēju, ja vēlaties mainīt jau ievadītās noklusējuma vērtības.",
