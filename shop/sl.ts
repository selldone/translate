export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "naslov",
    "copyright": "Uporaba vsebine samo v nekomercialne namene in s sklicevanjem na vir (povezava z {shop_title}). Vse pravice pridržane za {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ta aplikacija zahteva dostop do podatkov o vašem računu trgovine. To vključuje dostop do imena, kontaktne številke, naslova, e-pošte, zgodovine naročil, naročanja in objavljanja komentarjev v tej trgovini.",
      "message_bold": "Za vstop v to trgovino uporabite uradno aplikacijo trgovine."
    }
  },
  "sort": {
    "title": "Razvrsti po",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Kliknite gumb za potrditev, če ste naročilo prejeli. Po potrebi boste lahko oddali napotnico, če boste prejeli potrditev.",
      "Recipient": "Prejemnik",
      "bill": "Račun",
      "name": "ime",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Po potrebi opišite razlog za vračilo tega artikla.",
    "media_message": "Tukaj lahko naložite sliko, zvok ali video izdelka, da dobite boljšo podporo za informacije o stanju izdelka. Izbira datoteke se samodejno pošlje in potrdi.",
    "video": "Video",
    "voice": "Glas",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Če se odjavite od te trgovine, ne boste izbrisali vaših podatkov o naročilu in zapisov.",
      "action": "odidi"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Vnesite številko kartice in varnostno kodo. Darilna kartica bo dodana na vaš račun.",
  ...
  "product_rating_view": {
    "message": "Spoštovani {user}, ta izdelek ste kupili. Kaj menite o tem izdelku?",
    "notification": {
      "title": "Čestitam",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Vaše naročilo je bilo uspešno dodano. Zdaj lahko plačate z neposrednim denarnim nakazilom in nato naložite potrdilo o plačilu na stran naročila.",
      "pay_title": "Plačilo",
  ...
  "avocado": {
    ...
    "step1": "1. Vnesite ime in podrobnosti izdelka, ki ga želite naročiti, in kliknite gumb Dodaj.",
    ...
    "step2": "2. Ko dodate vse želene artikle, kliknite na gumb Zahteva za pregled naročila. Na tej stopnji bomo naročilo pregledali in vas obvestili o ceni. S klikom na to povezavo si lahko ogledate povezavo cene in plačila.",
    ...
    "pricing_not_completed_message": "Vaše naročilo je v pregledu. Vaše naročilo bo kmalu pregledano in ocenjena cena in naročilo boste lahko plačali.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Ustvarite seznam izdelkov, ki jih želite kupiti, tako da skenirate kodo izdelka.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Sliko potrdila ste že naložili, počakajte na našo odobritev. Če morate spremeniti, lahko prejšnjo sliko zamenjate z novo.",
