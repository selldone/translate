export default {
  ...
  "footer": {
    ...
    "phone": "Telefon",
    "address": "Adresa",
    "copyright": "Korištenje sadržaja samo u nekomercijalne svrhe i uz upućivanje na izvor (link sa {shop_title}). Sva prava zadržana za {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Ova aplikacija zahtijeva pristup informacijama o vašem računu trgovine. Ovo uključuje pristup imenu, kontakt broju, adresi, emailu, istoriji narudžbi, naručivanju i objavljivanju komentara na ovoj prodavnici.",
      "message_bold": "Obavezno koristite zvaničnu aplikaciju trgovine da uđete u ovu trgovinu."
    }
  },
  "sort": {
    "title": "Sortiraj po",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Kliknite na dugme za potvrdu ako ste primili narudžbu. Ako je potrebno, moći ćete poslati uputnicu ako dobijete potvrdu.",
      "Recipient": "Primalac",
      "bill": "Račun",
      "name": "Ime",
      "tel": "Telefon",
  ...
  "return_request": {
    ...
    "note_input_message": "Opišite razlog za vraćanje ovog artikla ako je potrebno.",
    "media_message": "Ovdje možete prenijeti sliku, audio ili video proizvoda kako biste dobili bolju podršku za informacije o statusu proizvoda. Odabirom datoteke će se automatski poslati i potvrditi.",
    "video": "Video",
    "voice": "Glas",
  ...
  "basket_page": {
    ...
    "select_location_error": "Pronađite mjesto prijema pošiljke na mapi i kliknite na indikator u sredini karte kako biste odredili tačnu adresu primaoca.",
    "same_billing_address_desc": "Adresa za naplatu je ista kao i adresa za dostavu.",
    "custom_billing_info_desc": "Možete unijeti svoj PORESKI broj i postaviti drugu adresu za naplatu.",
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Unesite broj kartice i sigurnosni kod. Poklon kartica će biti dodana na vaš račun.",
  ...
  "product_rating_view": {
    "message": "Poštovani {user}, kupili ste ovaj proizvod. Šta mislite o ovom proizvodu?",
    "notification": {
      "title": "Čestitam",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Vaša narudžba je uspješno dodana. Sada možete platiti direktnim prijenosom novca, a zatim učitati potvrdu o uplati na stranicu za narudžbu.",
      "pay_title": "Plaćanje",
  ...
  "avocado": {
    ...
    "step1": "1. Unesite naziv i detalje proizvoda koji želite da naručite i kliknite na dugme Dodaj.",
    ...
    "step2": "2. Nakon što dodate sve željene artikle, kliknite na dugme Zahtjev za pregled narudžbe. U ovoj fazi ćemo pregledati narudžbu i obavijestiti vas o cijeni. Klikom na ovaj link moći ćete vidjeti cijenu i link za plaćanje.",
    ...
    "pricing_not_completed_message": "Vaša narudžba se pregledava. Vaša narudžba će uskoro biti pregledana i ocijenjena cijena te ćete moći platiti narudžbu.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Kreirajte listu proizvoda koje želite da kupite skeniranjem koda proizvoda.",
  ...
  "rating": {
    "product_rating_message": "Ovaj proizvod je dobio ocjenu {rate} od 5 zvjezdica i ocijenjeno od {rate_count} ljudi."
  },
  "related_products": {
    "card": {
      "title": "Istražiti!",
