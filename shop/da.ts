...
export default {
  ...
  buy_button: {
    ...
    zip_pin_not_available_msg: "Ikke tilgængelig på denne placering!",
    zip_pin_placeholder: "Vælg postnummer/PIN...",
  },
  ...
  product: {
    ...
    related_products_title: "Du vil måske også synes om",
  ...
  basket_top_menu: {
    ...
    more: "Mere ...",
    accept_and_pay: "Gå til betaling",
    items: "Vare(r)",
  },
  ...
  user_wallets: {
    ...
    subtitle: "Hvis du er berettiget, og et cashback-program er aktivt, bliver en del af din ordre krediteret til din tegnebog. Du kan bruge disse midler ved dit næste køb."
  },
  /**
   * @see SWalletInput
   */
  wallet_input:{
    my_wallet_balance:"Min tegnebogssaldo",
  },
  ...
  order_page: {
    ...
    payment: {
      ...
      payment_is_in_require_capture_message:
        "Vi har modtaget din betaling, men den er endnu ikke blevet registreret.",
      settle_the_earlier_bill_first: "Betal den tidligere regning først!",
    },
  ...
  return_request: {
    ...
    note_input_message:
      "Beskriv årsagen til at returnere denne vare, hvis det er nødvendigt.",
    media_message:
  ...
  user_profile: {
    ...
    my_profile: {
      title: "Min profil",
      subtitle: "Dette er mine kundeprofiloplysninger for butikken.",
      edit_action: "Rediger profil"
    },
    subscribe_status: {
      subscribed: "Jeg abonnerer på at modtage de seneste nyheder og kampagner via e-mail.",
      unsubscribed: "Jeg abonnerer ikke på at modtage nyheder eller kampagner via e-mail."
    },
    my_club: {
      subtitle: "Mit klubniveau og dets fordele."
    },
    kyc: {
      subtitle: "Dette er mine globale identifikationsoplysninger."
    }
  ...
  basket_page: {
    ...
    same_billing_address_desc:
      "Faktureringsadressen er den samme som forsendelsesadressen.",
    custom_billing_info: "Forskellige faktureringsoplysninger",
    custom_billing_info_desc:
      "Du kan indtaste dit SKAT-nummer og angive en anden adresse til fakturering.",
    basket_empty: "Kurven er tom",
    extra_shipping_count: "Du modtager {count} pakker.",
    select_location_error:
      "Find modtagelsesstedet for forsendelsen på kortet, og klik på indikatoren i midten af kortet for at bestemme modtagerens nøjagtige adresse.",
    ...
    can_pay_cod_message:"Du kan betale for denne ordre kontant ved levering.",
  },
  ...
  addresses_page: {
    title: "Mine adresser",
    subtitle:"Se dine gemte adresser her, og tilføj nemt en ny.",
  ...
  return_requests: {
    ...
    subtitle:"Se dine returanmodninger her. For varer med en returpolitik kan du indsende en returanmodning på ordresiden.",
  },
  ...
  product_rating_view: {
    message:
      "Kære {user}, du har købt dette produkt. Hvad synes du om dette produkt?",
    notification: {
      title: "Tillykke",
  ...
  contact_us_form: {
    ...
    submitted_message:
      "Vi sætter pris på din tid til at kontakte os. Din besked er modtaget, og vores team gennemgår den i øjeblikket. Vi vil svare så hurtigt som muligt, og vi takker for din tålmodighed i denne periode. Din interesse og feedback er vigtig for os, og vi er forpligtet til at give dig den bedst mulige support.",
  },
  ...
  avocado: {
    ...
    select_address_message:
      "Indtast venligst din adresse, og så kan du afgive ordren.",
  ...
  hyper: {
    ...
    message:
      "Opret listen over produkter, du ønsker at købe, ved at scanne produktkoden.",
  ...
  service_bill: {
    ...
    subscription: {
      title: "Abonnement",
      message:
        "Du kan vælge abonnementsperiode ved at købe denne service på daglig basis. Fortæl køberen, hvis du vil ændre de standardværdier, du allerede har indtastet.",
  ...
  check_access: {
    ...
    no_access_message:
      "Du har desværre ikke adgang til vores butik.<br/> Kontakt os venligst.",
  },
  ...
  share_order: {
    ...
    message:
      "Det er et sikkert link, del det kun med dem du kender. Alle med dette link kan duplikere din ordre og se den valgte adresse. Den vil indeholde oplysninger om din nuværende indkøbskurv.",
  ...
  rating: {
    product_rating_message:
      "Dette produkt har modtaget en vurdering på {rate} ud af 5 stjerner og bedømt af {rate_count} personer.",
  },
