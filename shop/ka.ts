export default {
  ...
  "avocado": {
    ...
    "select_address_message": "გთხოვთ შეიყვანოთ თქვენი მისამართი და შემდეგ შეკვეთის გაგზავნა შეგიძლიათ."
  },
  "hyper": {
  ...
  "check_access": {
    ...
    "no_access_message": "სამწუხაროდ, თქვენ არ გაქვთ წვდომა ჩვენს მაღაზიაში.<br/> Გთხოვთ, დაგვიკავშირდით."
  },
  "share_order": {
    "action": "გააზიარეთ შეკვეთა",
    "title": "გაუზიარეთ ეს შეკვეთა სხვებს.",
    "message": "ეს არის უსაფრთხო ბმული, გაუზიარეთ ის მხოლოდ მათ, ვინც იცნობთ. ყველას ამ ბმულით შეუძლია თქვენი შეკვეთის დუბლირება და არჩეული მისამართის ნახვა. ის შეიცავს ინფორმაციას თქვენი მიმდინარე კალათის შესახებ.",
