export default {
  ...
  "footer": {
    ...
    "phone": "Telepon",
    "address": "Alamat",
    "copyright": "Penggunaan konten hanya untuk tujuan non-komersial dan dengan mengacu pada sumbernya (tautan dengan {shop_title}). Semua hak dilindungi undang-undang untuk {shop_title}.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Aplikasi ini membutuhkan akses ke informasi akun toko Anda. Ini termasuk akses ke nama, nomor kontak, alamat, email, riwayat pesanan, pemesanan dan posting komentar di toko ini.",
      "message_bold": "Pastikan untuk menggunakan aplikasi toko resmi untuk memasuki toko ini."
    }
  },
  "sort": {
    "title": "Sortir dengan",
  ...
  "order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Klik tombol konfirmasi jika Anda menerima pesanan. Jika diperlukan, Anda akan dapat mengirimkan rujukan jika Anda menerima konfirmasi.",
      "Recipient": "Penerima",
      "bill": "Faktur",
      "name": "Nama",
      "tel": "Telepon",
  ...
  "return_request": {
    ...
    "note_input_message": "Jelaskan alasan pengembalian barang ini jika diperlukan.",
    "media_message": "Anda dapat mengunggah gambar, audio atau video produk di sini untuk mendapatkan dukungan yang lebih baik untuk informasi status produk. Memilih file akan secara otomatis mengirim dan mengkonfirmasi.",
    "video": "Video",
    "voice": "Suara",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      ...
      "message": "Berhenti berlangganan ke toko ini tidak akan menghapus informasi dan catatan pesanan Anda.",
      "action": "Meninggalkan"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Masukkan nomor kartu dan kode keamanan. Kartu hadiah akan ditambahkan ke akun Anda.",
  ...
  "product_filter_menu": {
    ...
    "brands": "Merek",
    "main_shop_page": "Toko halaman utama",
    "home": "Rumah"
  },
  "product_rating_view": {
    "message": "{pengguna} yang terhormat, Anda telah membeli produk ini. Apa pendapat Anda tentang produk ini?",
    "notification": {
      "title": "Selamat",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Pesanan Anda telah berhasil ditambahkan. Sekarang Anda dapat membayar dengan transfer uang langsung dan kemudian mengunggah tanda terima pembayaran di halaman pesanan.",
  ...
  "avocado": {
    ...
    "step1": "1. Masukkan nama dan detail produk yang ingin Anda pesan dan klik tombol Tambah.",
    ...
    "step2": "2. Setelah menambahkan semua item yang diinginkan, klik tombol permintaan peninjauan pesanan. Pada tahap ini, kami akan meninjau pesanan dan memberi tahu Anda tentang harganya. Dengan mengklik tautan ini, Anda akan dapat melihat tautan harga dan pembayaran.",
    ...
    "pricing_not_completed_message": "Pesanan Anda sedang ditinjau. Pesanan Anda akan segera ditinjau dan diberi harga dan Anda akan dapat membayar pesanan.",
    "delete_item_dialog": {
  ...
  "hyper": {
    ...
    "message": "Buat daftar produk yang ingin Anda beli dengan memindai kode produk.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "Anda sudah mengupload gambar resi, tunggu persetujuan kami. Jika Anda perlu mengubah, Anda dapat mengganti gambar sebelumnya dengan yang baru.",
