export default {
  ...
  "footer": {
    ...
    "phone": "Телефон",
    "address": "Дарек",
    "copyright": "Мазмунду коммерциялык эмес максаттарда жана булакка шилтеме менен колдонуу ({shop_title} менен шилтеме). Бардык укуктар {shop_title} үчүн корголгон.",
  ...
  "shop": {
    ...
    "native": {
      ...
      "message": "Бул колдонмо дүкөнүңүздүн каттоо эсебинин маалыматына кирүү мүмкүнчүлүгүн талап кылат. Бул дүкөндө аты-жөнү, байланыш номери, дареги, электрондук почтасы, заказ тарыхы, буйрутма берүү жана комментарийлерге кирүү мүмкүнчүлүгүн камтыйт.",
      "message_bold": "Бул дүкөнгө кирүү үчүн расмий дүкөн колдонмосун колдонууну унутпаңыз."
    }
  },
  "sort": {
    "title": "Иреттөө",
  ...
  "physical_order_page": {
    ...
    "delivery": {
      ...
      "confirm_received_info": "Эгер сиз заказ алган болсоңуз, ырастоо баскычын басыңыз. Зарыл болсо, ырастоо алсаңыз, жолдомо бере аласыз.",
      "Recipient": "Алуучу",
      "bill": "Эсеп-фактура",
      "name": "аты",
      "tel": "Телефон",
  ...
  "return_request": {
    ...
    "note_input_message": "Зарыл болсо, бул нерсени кайтаруунун себебин сүрөттөп бериңиз.",
    "media_message": "Продукттун статусу тууралуу маалыматты жакшыраак колдоо үчүн бул жерге буюмдун сүрөтүн, аудиосун же видеосун жүктөй аласыз. Файлды тандоо автоматтык түрдө жөнөтүлүп, ырасталат.",
    "video": "Video",
    "voice": "Үн",
  ...
  "user_profile": {
    ...
    "leave_dialog": {
      "title": "Дүкөндөн чык",
      "message": "Бул дүкөнгө жазылууну токтотуу буйрутмаңыздын маалыматын жана жазууларын жок кылбайт.",
      "action": "кет"
    },
    "notifications": {
  ...
  "user_gift_cards": {
    ...
    "add_card_dialog": {
      ...
      "message": "Картанын номерин жана коопсуздук кодун киргизиңиз. Белек картасы аккаунтуңузга кошулат.",
  ...
  "product_rating_view": {
    "message": "Урматтуу {user}, сиз бул өнүмдү сатып алдыңыз. Бул продукт жөнүндө эмне деп ойлойсуз?",
    "notification": {
      "title": "куттуктоо",
  ...
  "master_payment": {
    "notifications": {
      ...
      "pay_by_dir": "Буйрутмаңыз ийгиликтүү кошулду. Эми сиз түз акча которуу жолу менен төлөп, андан кийин төлөм дүмүрчөгүн буйрутма бетине жүктөй аласыз.",
      "pay_title": "Төлөм",
  ...
  "avocado": {
    ...
    "step1": "1. Заказ кылгыңыз келген буюмдун атын жана чоо-жайын киргизип, Кошуу баскычын басыңыз.",
    ...
    "step2": "2. Керектүү нерселердин бардыгын кошкондон кийин, буйрутманы карап чыгуу өтүнүчүн чыкылдатыңыз. Бул этапта биз буйрутманы карап чыгып, сизге бааны билдиребиз. Бул шилтемени басуу менен сиз бааны жана төлөм шилтемесин көрө аласыз.",
    ...
    "pricing_not_completed_message": "Буйрутмаңыз каралууда. Буйрутмаңыз жакында каралып, баасы коюлуп, буйрутманы төлөй аласыз.",
    "delete_item_dialog": {
    ...
    "select_address_message": "Сураныч, дарегиңизди киргизиңиз, андан кийин заказды тапшырсаңыз болот."
  },
  "hyper": {
    "title": "Заказ түзүү",
    "message": "Продукт кодун сканерлөө менен сатып алууну каалаган өнүмдөрдүн тизмесин түзүңүз.",
  ...
  "pending_payment": {
    ...
    "upload_payment_receipt_done": "✔ Сиз квитанциянын сүрөтүн жүктөдүңүз, биздин жактырууну күтүңүз. Эгер өзгөртүү керек болсо, мурунку сүрөттү жаңысына алмаштыра аласыз.",
  ...
  "service_bill": {
    ...
    "subscription": {
      "title": "Жазылуу",
      "message": "Бул кызматты күн сайын сатып алуу менен жазылуу мөөнөтүн тандай аласыз. Сиз буга чейин киргизген демейки маанилерди өзгөртүүнү кааласаңыз, сатып алуучуга кабарлаңыз.",
  ...
  "check_access": {
    ...
    "no_access_message": "Тилекке каршы, биздин дүкөнгө кире албайсыз.<br/> Сураныч, биз менен байланышыңыз."
  },
  "share_order": {
    "action": "Тартип бөлүшүү",
    "title": "Бул буйрукту башкалар менен бөлүшүңүз.",
    "message": "Бул коопсуз шилтеме, аны билгендериңиз менен гана бөлүшүңүз. Бул шилтемеси бар ар бир адам буйрутмаңыздын көчүрмөсүн жасап, тандалган даректи көрө алат. Ал учурдагы арабаң тууралуу маалыматты камтыйт.",
