export default {
  "experts_common": {
    ...
    "contracts": "Contratos",
    "start_end_date": "Fecha de inicio/finalización",
  ...
  "topics": {
    ...
    "debug": {
      ...
      "desc": "Soluciona errores y problemas en tu tienda."
    },
    "strategy": {
  ...
  "expert_page": {
    ...
    "who": {
      ...
      "spec1_title": "Maestros, tanto en su campo como en Selldone",
      "spec1_desc": "¡No necesitas ningún conocimiento de programación! Selldone se encarga de todas las actualizaciones. ¡Ponga todos sus esfuerzos en aumentar la venta!",
      "spec2_title": "Personas seleccionadas y comprometidas",
      "spec2_desc": "No se requiere codificación ni conocimientos técnicos. ¡Diga adiós a los costos adicionales, los problemas técnicos complejos y los obstáculos en el camino de su negocio en línea!",
      "spec3_title": "Trabajo profesional realizado por los más profesionales.",
      "spec3_desc": "¡No necesitas ningún conocimiento de programación! ¡Los mejores profesionales en Selldone para satisfacer tus necesidades!"
    },
    "expert_categories": "Categoría de servicios prestados por expertos",
  ...
  "expert_request_form": {
    ...
    "shop_id": "Tienda",
    "shop_id_message": "Elige entre tus tiendas existentes si necesitas más servicios.",
  ...
  "expert_requests": {
    ...
    "dialog": {
      "title": "Detalles de la solicitud de experto",
      "start_chat": "Iniciar negociación"
    }
  },
  "job_chat": {
  ...
  "expert_chat_box": {
    ...
    "folder_dialog": {
      ...
      "hide_new_folder": "Ocultar nueva carpeta",
  ...
  "add_job": {
    ...
    "notifications": {
      "edit": "Trabajo actualizado con éxito.",
      "add": "Nuevo trabajo creado con éxito"
    }
  },
  "contract_form": {
    ...
    "create_action": "Crear nuevo contrato",
    "notifications": {
      "add": "El nuevo contrato fue creado y enviado al usuario."
    }
  }
};