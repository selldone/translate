...
export default {
  local_service: "Lokaler Service für {country_name}",
  local_service_message: "Dieser Service ist ausschließlich für Nutzer gedacht, die in <u>{country_name}</u> leben und ihre Dienstleistungen und Produkte in diesem Land verkaufen.Sie dürfen nur die lokalen Dienste oder den internationalen Service von Selldone nutzen.Um diesen Service zu nutzen, müssen Sie die Gesetze von <b>{country_name}</b> und der <b>Europäischen Union</b> einhalten.",
  my_shops: "Meine Shops",
  select_language_dialog_title: "Führen Sie Ihr Geschäft in Ihrer bevorzugten Sprache",
  welcome_title: "Reduzieren Sie Ihre täglichen Entscheidungen auf eine einzige",
  welcome_subtitle: "Bauen, verwalten und skalieren Sie Ihr Geschäft wie Profis mit dem No-Code-Betriebssystem für Unternehmen – zur Abwicklung von Millionen von Bestellungen und zur Automatisierung Ihrer Arbeitsabläufe.",
  ...
  s1: {
    ...
    why_use_selldone_if_frustrated_from_wordpress_and_shopify: "Wenn Sie frustriert sind von fehlerhaften WordPress-Plugins, nicht skalierbaren Servern oder den kostspieligen und komplexen Setups von Shopify-Apps, dann ist Selldone die ideale Lösung für Sie."
  },
  video: {
    title: "Geben Sie Ihr Bestes.",
    msg: "Bieten Sie das schnellste Kauferlebnis / Verdienen Sie mehr $$$.",
    pacman: "Ich bin kein technischer Gründer",
    card_pos: {
      title: "Selldone POS",
      msg: "Verkaufen Sie persönlich mit einer Lösung ohne Einrichtungsgebühren."
    },
    card_ecommerce: {
      title: "Selldone E-Commerce",
      msg: "Verkaufen Sie online wie Profis."
    }
  },
  why: {
  ...
  how_it_work: {
    ...
    step4: {
      title: "Ein-Klick-Checkout: Einheitliches Checkout-Erlebnis weltweit.",
  ...
  onboarding: {
    ...
    enable_disable_features_msg: "Sie können diese Funktionen später aktivieren oder deaktivieren.",
    package_starter: {
      title: "Optionales Paket",
      subtitle: "Wir verstehen, dass Sie möglicherweise keine Zeit haben, Selldone einzurichten oder kennenzulernen. Nach der Registrierung erhalten Sie Zugang zu einem <b>All-in-One-Paket</b>, das Sie optional erwerben können. Es ist nur für <b>14 Tage</b> nach der Shop-Erstellung verfügbar.",
      include_items_title: "Es umfasst diese Dienste",
      include_items: ["Einrichtung der Shop-Einstellungen und des Erscheinungsbilds", "Einrichtung einer Versandmethode und einer Zahlungsmethode", "Gestaltung Ihrer Startseite", "Hilfe beim Importieren von Produkten mit Excel", "Hinzufügen Ihrer benutzerdefinierten Domain"]
    },
    sample: {
      title: "Beispieldaten installieren",
      description: "Starten Sie meinen Shop mit Beispieldaten wie Produkten, Kategorien und Blog-Beiträgen."
    },
    options: {
      ...
      pos: "Verkaufsstelle",
      blog: "Blog und CMS",
      community: "Community und Forum",
      ecommerce_desc: "Verkaufen Sie Ihre Produkte und Dienstleistungen online.",
      pos_desc: "Verkaufen Sie Ihre Produkte und Dienstleistungen persönlich.",
      blog_desc: "Leistungsstarkes CMS zum Veröffentlichen Ihrer Artikel und Beiträge.",
      community_desc: "Erstellen Sie Ihre eigene Community und Ihr Forum."
    },
    job: {
      title: "Wählen Sie Ihre Branche, um zu starten...",
      placeholder: "Migrieren Sie Ihr Geschäft zu Selldone OS – unabhängig davon, welche Plattform Sie derzeit verwenden."
    },
    shop_name: {
      title: "Geschäftsname",
    ...
    income: {
      ...
      msg: "Wählen Sie einen Bereich für Ihren gesamten monatlichen Umsatz.",
      Low: "Bis zu 5.000 USD",
      Medium: "5.000 USD ~ 50.000 USD",
      High: "50.000 USD ~ 1.000.000 USD",
      Extreme: "Über 1.000.000 USD"
    },
    step_1: "Zweck",
    step_2: "Konfiguration",
    step_3: "Konto"
  },
  notion: {
    title: "Arbeiten Sie mit verschiedenen Tools.",
    quote: "Wir glauben, dass eine Person im Zeitalter des Online-Handels etwas bewirken kann – auch wenn sie nicht viel Geld, keine technische Erfahrung und kein Bankkonto zur Begleichung von Rechnungen hat. Wir tun dies, indem wir eine sofort einsatzbereite Plattform mit unternehmensgerechten Tools schaffen, die als eines der zugänglichsten Betriebssysteme im Internet dient."
  },
  stop: {
    title: "Mehrere Gateways + Direkte Zahlung.",
    subtitle: "Eine virtuelle Brieftasche hilft Ihnen, Ihren Cashflow zu kontrollieren und Geld direkt über Ihre Zahlungsdienste zu empfangen, ohne dass Ihre E-Commerce-Plattform eingreift.",
    pacman: "Zahlungs-Plugins"
  },
  flow: {
    title: "Anpassbarer Checkout-Ablauf.",
    subtitle: "Gestalten Sie die Kundenreise und den Kaufablauf und experimentieren Sie mit den Ergebnissen.",
    pacman: "Checkout-Plugins"
  },
  business_model: {
    title: "Mehrere Geschäftsmodelle.",
    subtitle: "Richten Sie Ihr Geschäftsmodell visuell ein; alle komplexen Abläufe werden im Hintergrund angepasst.",
  ...
  login: {
    title: "Möchten Sie Ihr Geschäft visuell aufbauen, verwalten und skalieren?"
  },
  currencies: {
    title: "Währungen",
  ...
  convertible: {
    store_name: "Ihr Shop",
    variant_1: "Produktvariante Bernstein",
    variant_2: "Produktvariante Rot",
    buy: "Jetzt kaufen",
    price: "89 $",
    management: {
    ...
    payment: {
      ...
      check2: "Klarna",
      check2msg: "Jetzt kaufen, später bezahlen.",
      check3: "PayPal",
      check3msg: "Zahlung mit einem Klick."
    },
    checkout: {
      title: "Ihre Marke",
      online: "Online-Kunden",
      offline: "Persönliche Kunden"
    },
    design: {
  ...
  money_transfer: {
    ...
    bank: "Ihr Bankkonto",
    wallet: "Brieftasche",
    free_setup: "Kostenlose Einrichtung.",
    no_extra_fee: "Keine zusätzlichen Gebühren.",
    no_hidden_fee: "Keine versteckten Gebühren."
  },
  ...
  extra: {
    ...
    community: "Community und Feedback"
  },
  team: {
  ...
  panorama: {
    title: "#1 Business OS — <b class=\"bg-gradient-animate text-gradient my-1\">Alle Funktionen sind vorgefertigt.</b>",
  ...
  product_page: {
    title: "Das Ergebnis nach dem Hinzufügen Ihres ersten Produkts.",
    msg: "Verwirklichen Sie Ihre Ideen mit nur wenigen Klicks.",
    open_sample_product_link: "Live-Produkt öffnen",
    open_templates: "Vorlagen ansehen"
  },
  /** {@see CountrySupportBox} */
  support_box: {
    country_select_label: "Wählen Sie Ihr Land",
    we_support_message: "Wir unterstützen {country}",
    we_limited_support: "Wir unterstützen {country} eingeschränkt",
    support_message_long: "Erleben Sie nahtlose Online-Transaktionen in Ihrem Land mit Selldone! Neben professionellen Steuerberechnungen bieten wir vielfältige Zahlungsmethoden, einschließlich Barzahlung, POS, Banküberweisungen und mehr. Beginnen Sie damit, Ihr Geschäft auf einer Plattform aufzubauen, die die Anforderungen Ihres Landes umfassend unterstützt.",
    limited_support_message_long: "Online-Zahlungen sind in Ihrem Land möglicherweise nicht verfügbar, aber keine Sorge! Bei Selldone bieten wir weltweit Barzahlungen, Banküberweisungen und Nachnahme (COD) an. Sie können Ihr Online-Geschäft mit uns vertrauensvoll aufbauen und gleichzeitig die Vorschriften Ihres Landes und Europas einhalten. Für weitere Details oder um die Unterstützung von Online-Zahlungen in Ihrem Land anzufragen, kontaktieren Sie bitte unser Support-Team.",
    more_about_selldone_in_country: "Mehr über Selldone in Ihrem Land",
    tax: {
      title: "Steuerfreundlich",
      message: "Richten Sie einfach Steuerprofile für verschiedene Produktkategorien ein, die sich automatisch an die Länder und Bundesstaaten der Käufer anpassen. Bleiben Sie konform und erweitern Sie Ihre globale Reichweite."
    },
    global: {
      title: "Globaler Verkauf",
      message: "Erreichen Sie Kunden weltweit mit Selldones nahtloser internationaler Unterstützung. Skalieren Sie Ihr Geschäft global mit Leichtigkeit und Effizienz."
    },
    shipping: {
      title: "Lokaler & globaler Versand",
      message: "Integrationen mit lokalen und globalen Versanddienstleistern wie Shippo und Shipday sowie Optionen zur Selbstverwaltung von Kurieren sorgen überall für reibungslose Lieferprozesse."
    },
    erp: {
      title: "ERP-Integration",
      message: "Verbinden Sie sich nahtlos mit führenden ERPs über unser Open-Gateway und unseren API-Zugang – mit einfachen Ein-Klick-Integrationen für optimierte Geschäftsabläufe."
    }
  },
  hero: {
  ...
  make_your_shop: {
    ...
    coursera: "Coursera",
    gift_store: "Geschenkeladen",
    airbnb: "Airbnb",
    simple_store: "Einfacher Shop",
    tiktok: "TikTok-Shop"
  },
  /**
  ...
  show_its_simplicity: {
    ...
    page_builder: {
      ...
      subtitle: "Der erste intuitive Drag-and-drop-Seiten-Builder mit Inline-Bearbeitung.",
      try_action: "Seiten-Builder ausprobieren",
      see_collection_action: "Vorlagen ansehen"
    },
    ai: {
      title: "Integrierte KI-Funktionen",
      subtitle: "Die beste industrielle Hintergrundentfernung, Bildoptimierung, Inhaltserstellung, automatische Produkterstellung und mehr.",
      try_action: "Selldone Intelligence ausprobieren"
    },
    storefront: {
      title: "Live-Schaufenster",
      subtitle: "Erleben Sie das schnellste Einkaufserlebnis mit einer modernen PWA-Website, ohne eine einzige Zeile Code schreiben zu müssen.",
      see_action: "Demo-Schaufenster ansehen"
    },
    backoffice: {
      title: "Live-Backoffice",
      subtitle: "Verwalten Sie alles von einem Ort aus, ohne Plugins zu benötigen.",
      see_action: "Demo-Backoffice ansehen"
    }
  },
  /**
  ...
  pricing_compact: {
    ...
    subtitle: "Zugriff auf alle unternehmensgerechten Funktionen, um Ihr Geschäft mit unserem Umsatzbeteiligungsmodell zu starten und zu skalieren – zahlen Sie nichts im Voraus, sondern nur einen Anteil Ihres Umsatzes. Wir haben nur dann Erfolg, wenn Sie Erfolg haben. So minimieren Sie Ihre Kosten und maximieren Ihre Gewinne."
  },
  screenshots: {
    item_1: {
    ...
    item_2: {
      ...
      desc: "Verbinden Sie Ihren Shop einfach mit einem Print-on-Demand-Dropshipping-Service wie Printful und verkaufen Sie Ihre Kunstwerke auf bedruckten Materialien, ohne zusätzliche Plugins zu benötigen."
    },
    item_3: {
    ...
    item_4: {
      ...
      desc: "Die Zeitleiste einer Bestellung bietet einen detaillierten Überblick über alle Aktionen und Änderungen, die an der Bestellung vorgenommen wurden. Sie können leicht sehen, wer die Änderungen vorgenommen hat und wann sie durchgeführt wurden."
    },
    item_5: {
      title: "Vereinfachen Sie die Kommunikation mit Kunden und Verkäufern.",
    ...
    item_11: {
      ...
      desc: "Verknüpfen Sie Ihren Shop mit dem Google Merchant Center und synchronisieren Sie alle Artikel und Kategorien nahtlos, um sie auf Google zu bewerben."
    },
    item_12: {
      title: "Avocado – Verkaufen Sie Produkte einfach in sozialen Medien.",
      desc: "Mit Avocado können Sie Produkte in sozialen Medien verkaufen, ohne Produkte und Preise manuell hinzufügen zu müssen. Das Tool generiert automatisch einen Zahlungslink für Bestellungen und ermöglicht es Ihnen, benutzerdefinierte Rechnungen mit Zahlungslinks zu erstellen."
    },
    item_13: {
    ...
    item_15: {
      title: "Fördern Sie Kundenkäufe mit Rabatten, Angeboten, Gutscheinen und Gamification.",
    ...
    item_21: {
      ...
      desc: "Organisieren und segmentieren Sie Ihre Kundenbasis, analysieren Sie deren Lebenszeitwert, vergangene Online- und In-Store-Käufe und verfolgen Sie ihre Reise, um ihr Erlebnis zu verbessern und gleichzeitig ihre Privatsphäre zu respektieren."
    },
    item_22: {
    ...
    item_37: {
      ...
      desc: "Nutzen Sie die integrierte KI-Übersetzungsfunktion auf Unternehmensniveau, um Produktbeschreibungen mühelos mit nur einem Klick in verschiedene Sprachen zu übersetzen."
    },
    item_38: {
  ...
  payment_landing: {
    ...
    unlock_section: {
      ...
      subtitle: "Starten Sie noch heute Ihren Onlineshop! Verkaufen Sie Produkte, Dienstleistungen und Abonnements mühelos, schnell und einfach.",
      no_plugin: {
        title: "Mühelose Zahlungen, keine Plugins erforderlich",
        subtitle: "Machen Sie den Schritt in die Zukunft des E-Commerce mit Selldones nahtlosen, pluginfreien Zahlungslösungen für {payment}. Verabschieden Sie sich von komplexen Integrationen und genießen Sie ein direktes, sicheres und unkompliziertes Zahlungserlebnis."
      },
      experience: {
        title: "Makelloses Einkaufserlebnis, angetrieben von Selldone + {payment}",
        subtitle: "Verwandeln Sie Ihr E-Commerce-Erlebnis mit der benutzerfreundlichen Plattform von Selldone und der Zahlungsabwicklung von {payment}. Verabschieden Sie sich von schwerfälligen Schnittstellen und begrüßen Sie eine optimierte Einkaufsreise, die Ihre Kunden zurückkommen lässt."
      },
      boost: {
        title: "Steigern Sie Ihre Verkäufe mit den integrierten Zahlungen von Selldone",
        subtitle: "Warum sollten komplizierte Zahlungssysteme Sie ausbremsen? Mit der integrierten Zahlungslösung von {payment} können Sie sich auf das Wesentliche konzentrieren: mehr verkaufen. Beobachten Sie, wie Ihre Verkäufe steigen, während Sie Ihr Geschäft mühelos ausbauen."
      },
      security: {
        title: "Wo Sicherheit und Effizienz zusammenkommen",
        subtitle: "Die Wahl von Selldone + {payment} bedeutet, sich für erstklassige Sicherheit und unvergleichliche Effizienz zu entscheiden. Unser dediziertes Zahlungssystem stellt sicher, dass jede Transaktion sicher, schnell und absolut reibungslos verläuft."
      },
    ...
    how_to_add: {
      step_1: {
        ...
        subtitle: "Um Zahlungen in verschiedenen Währungen zu akzeptieren, müssen Sie für jede Währung ein Zahlungsgateway einrichten. Mit {payment} kann ein einzelnes Konto mehrere Gateways und Währungen in Ihrem Shop verwalten – ohne Einschränkungen! Stellen Sie sicher, dass Ihre gewünschte Währung unter Shop > Buchhaltung > Währungen in den Einstellungen Ihres Shops aufgeführt ist."
      },
      step_2: {
        step: "Schritt 2",
    ...
    integration: {
      title: "Mühelose E-Commerce-Integration mit {payment}",
      subtitle: "Starten Sie mit Selldone und verwalten Sie Ihr Geschäft mühelos. Keine Programmierung oder Plugins erforderlich!"
    },
    pay_after_earn: {
      title: "Zahlen Sie nur, wenn Sie Gewinn machen!",
      subtitle: "Starten Sie Ihr Geschäft mit unserem KOSTENLOSEN lebenslangen Plan! Zahlen Sie nur eine Gebühr von 0,5~2,0 %, sobald Sie beginnen, Geld zu verdienen."
    }
  },
  feature_page_builder: {
    title: "Verkaufsorientierter Seiten-Builder",
    message: "Gestalten Sie mühelos benutzerdefinierte Seiten mit unserer No-Code-Lösung. Ziehen Sie Elemente per Drag-and-drop, um Seiten zu erstellen, die auf Ihre Anforderungen zugeschnitten sind."
  },
  feature_items: {
    products: {
      title: "Intuitive Produktverwaltung",
      description: "Verwalten Sie Produkte einfach – Bilder per Drag-and-drop hinzufügen, Details bearbeiten und Ihren Workflow optimieren."
    },
    excel: {
      title: "Excel-Datenimport",
      description: "Importieren Sie Produkte, Kategorien und Kontakte mühelos über Excel-Dateien."
    },
    incentive: {
      title: "Verkaufsanreize",
      description: "Steigern Sie den Verkauf mit Rabatten, Gutscheinen, Geschenkkarten und spielerischen Angeboten."
    },
    loyalty: {
      title: "Kundentreue",
      description: "Richten Sie Clubs, Mitgliedschaften und Abonnements ein, um Kunden zu binden."
    },
    cashback: {
      title: "Cashback-Angebote",
      description: "Implementieren Sie vielfältige Cashback-Programme, um treue Käufer zu belohnen."
    },
    cross_selling: {
      title: "Cross-Selling-Tools",
      description: "Steigern Sie den Verkauf mit Cross-Selling; legen Sie Produktkollektionen und Rabatte fest."
    },
    accounting: {
    ...
    inventory: {
      ...
      description: "Überwachen Sie Lagerbestände, führen Sie Massenupdates über CSV durch und verwalten Sie effizient."
    },
    analytics: {
      title: "Fortgeschrittene Analysen",
      description: "Erhalten Sie Einblicke in Verkäufe, Kunden und Kampagnen mit detaillierten Daten."
    },
    social: {
      title: "Multi-Channel-Verkauf",
      description: "Verkaufen Sie über verschiedene Kanäle; verbinden Sie sich mit Marktplätzen und sozialen Medien und verfolgen Sie Quellen."
    },
    community: {
      title: "Community-Builder",
      description: "Binden Sie Kunden mit Foren, Blogs und Community-Funktionen ein."
    },
    security: {
      title: "Teamverwaltung",
      description: "Erstellen Sie Rollen, legen Sie Berechtigungen fest und verwalten Sie den Teamzugriff effizient."
    },
    pos: {
      title: "POS für den stationären Verkauf",
      description: "Vereinfachen Sie den Verkauf im Geschäft; verwalten Sie POS-Systeme und Transaktionen."
    },
    store: {
    ...
    pricing: {
      ...
      description: "Legen Sie intelligente Preise basierend auf Menge oder Kundenpräferenzen fest."
    },
    pod: {
      title: "Dropshipping-Integration",
      description: "Verbinden Sie sich mit POD-Diensten und verwalten Sie Dropshipping nahtlos."
    }
  }
};
