export default {
  ...
  stop: {
    ...
    subtitle:
      "راه حل های ساده و پیش پا افتاده شما را موفق نمی کند! اگر قصد دارید یک تجارت آنلاین جدی ایجاد کنید، سلدان برای شما مناسب است، اما اگر به دنبال یک راه حل ساده و غیر کارآمد هستید، سلدان انتخاب مناسبی برای شما نیست.",
  },
