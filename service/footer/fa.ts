...
export default {
  ...
  footer: {
    ...
    supported_countries_and_payments:"کشورها و روش های پرداخت پشتیبانی شده",

    affiliate_program: 'برنامه همکاری در فروش',
    business_idea: "ایده‌های کسب و کار",
    roadmap: "نقشه راه",
    apply_partner: "درخواست برای همکاری",
    partner: {
      title: "به عنوان شریک بپیوندید",
      subtitle: "ما به شرکای خود فرصت عالی برای گسترش کسب‌وکارشان و کسب درآمد ماهانه ثابت را ارائه می‌دهیم."
    },
    add_service: "افزودن خدمت",
    service: {
      title: "خدمت خود را یکپارچه کنید",
      subtitle: "خدمت خود را به هزاران کسب‌وکار ارزشمند امروز و میلیون‌ها کسب‌وکار فردا معرفی کنید!"
    },
    add_supplier: "افزودن تأمین‌کننده",
    supplier: {
      title: "به عنوان تأمین‌کننده بپیوندید",
      subtitle: "ما می‌توانیم محصولات شما را به هزاران فروشگاه فعال آنلاین و محلی در سراسر جهان برسانیم."
    },
   ...
   */
  press_view: {
    on_all_review_websites: "در تمام وب‌سایت‌های نقد و بررسی",
  }
